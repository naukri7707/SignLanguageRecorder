...
public static class IconSymbols
{
    ...
    public static string GetGlyphCode(this IconSymbol symbol)
    {
        return symbol switch
        {
            IconSymbol.VectorSquare => VectorSquare,
            IconSymbol.AccessPointNetwork => AccessPointNetwork,
            IconSymbol.AccessPoint => AccessPoint,
            IconSymbol.Account => Account,
            IconSymbol.AccountAlert => AccountAlert,
            IconSymbol.AccountBox => AccountBox,
            IconSymbol.AccountBoxOutline => AccountBoxOutline,
            IconSymbol.AccountCheck => AccountCheck,
            IconSymbol.AccountCircle => AccountCircle,
            IconSymbol.AccountConvert => AccountConvert,
            IconSymbol.AccountKey => AccountKey,
            IconSymbol.TooltipAccount => TooltipAccount,
            IconSymbol.AccountMinus => AccountMinus,
            IconSymbol.AccountMultiple => AccountMultiple,
            IconSymbol.AccountMultipleOutline => AccountMultipleOutline,
            IconSymbol.AccountMultiplePlus => AccountMultiplePlus,
            IconSymbol.AccountNetwork => AccountNetwork,
            IconSymbol.AccountOff => AccountOff,
            IconSymbol.AccountOutline => AccountOutline,
            IconSymbol.AccountPlus => AccountPlus,
            IconSymbol.AccountRemove => AccountRemove,
            IconSymbol.AccountSearch => AccountSearch,
            IconSymbol.AccountStar => AccountStar,
            IconSymbol.Orbit => Orbit,
            IconSymbol.AccountSwitch => AccountSwitch,
            IconSymbol.Adjust => Adjust,
            IconSymbol.AirConditioner => AirConditioner,
            IconSymbol.Airballoon => Airballoon,
            IconSymbol.Airplane => Airplane,
            IconSymbol.AirplaneOff => AirplaneOff,
            IconSymbol.CastVariant => CastVariant,
            IconSymbol.Alarm => Alarm,
            IconSymbol.AlarmCheck => AlarmCheck,
            IconSymbol.AlarmMultiple => AlarmMultiple,
            IconSymbol.AlarmOff => AlarmOff,
            IconSymbol.AlarmPlus => AlarmPlus,
            IconSymbol.Album => Album,
            IconSymbol.Alert => Alert,
            IconSymbol.AlertBox => AlertBox,
            IconSymbol.AlertCircle => AlertCircle,
            IconSymbol.AlertOctagon => AlertOctagon,
            IconSymbol.AlertOutline => AlertOutline,
            IconSymbol.Alpha => Alpha,
            IconSymbol.Alphabetical => Alphabetical,
            IconSymbol.Greenhouse => Greenhouse,
            IconSymbol.RollerbladeOff => RollerbladeOff,
            IconSymbol.Ambulance => Ambulance,
            IconSymbol.Amplifier => Amplifier,
            IconSymbol.Anchor => Anchor,
            IconSymbol.Android => Android,
            IconSymbol.WebPlus => WebPlus,
            IconSymbol.AndroidStudio => AndroidStudio,
            IconSymbol.Apple => Apple,
            IconSymbol.AppleFinder => AppleFinder,
            IconSymbol.AppleIos => AppleIos,
            IconSymbol.AppleIcloud => AppleIcloud,
            IconSymbol.AppleSafari => AppleSafari,
            IconSymbol.FontAwesome => FontAwesome,
            IconSymbol.Apps => Apps,
            IconSymbol.Archive => Archive,
            IconSymbol.ArrangeBringForward => ArrangeBringForward,
            IconSymbol.ArrangeBringToFront => ArrangeBringToFront,
            IconSymbol.ArrangeSendBackward => ArrangeSendBackward,
            IconSymbol.ArrangeSendToBack => ArrangeSendToBack,
            IconSymbol.ArrowAll => ArrowAll,
            IconSymbol.ArrowBottomLeft => ArrowBottomLeft,
            IconSymbol.ArrowBottomRight => ArrowBottomRight,
            IconSymbol.ArrowCollapseAll => ArrowCollapseAll,
            IconSymbol.ArrowDown => ArrowDown,
            IconSymbol.ArrowDownThick => ArrowDownThick,
            IconSymbol.ArrowDownBoldCircle => ArrowDownBoldCircle,
            IconSymbol.ArrowDownBoldCircleOutline => ArrowDownBoldCircleOutline,
            IconSymbol.ArrowDownBoldHexagonOutline => ArrowDownBoldHexagonOutline,
            IconSymbol.ArrowDownDropCircle => ArrowDownDropCircle,
            IconSymbol.ArrowDownDropCircleOutline => ArrowDownDropCircleOutline,
            IconSymbol.ArrowExpandAll => ArrowExpandAll,
            IconSymbol.ArrowLeft => ArrowLeft,
            IconSymbol.ArrowLeftThick => ArrowLeftThick,
            IconSymbol.ArrowLeftBoldCircle => ArrowLeftBoldCircle,
            IconSymbol.ArrowLeftBoldCircleOutline => ArrowLeftBoldCircleOutline,
            IconSymbol.ArrowLeftBoldHexagonOutline => ArrowLeftBoldHexagonOutline,
            IconSymbol.ArrowLeftDropCircle => ArrowLeftDropCircle,
            IconSymbol.ArrowLeftDropCircleOutline => ArrowLeftDropCircleOutline,
            IconSymbol.ArrowRight => ArrowRight,
            IconSymbol.ArrowRightThick => ArrowRightThick,
            IconSymbol.ArrowRightBoldCircle => ArrowRightBoldCircle,
            IconSymbol.ArrowRightBoldCircleOutline => ArrowRightBoldCircleOutline,
            IconSymbol.ArrowRightBoldHexagonOutline => ArrowRightBoldHexagonOutline,
            IconSymbol.ArrowRightDropCircle => ArrowRightDropCircle,
            IconSymbol.ArrowRightDropCircleOutline => ArrowRightDropCircleOutline,
            IconSymbol.ArrowTopLeft => ArrowTopLeft,
            IconSymbol.ArrowTopRight => ArrowTopRight,
            IconSymbol.ArrowUp => ArrowUp,
            IconSymbol.ArrowUpThick => ArrowUpThick,
            IconSymbol.ArrowUpBoldCircle => ArrowUpBoldCircle,
            IconSymbol.ArrowUpBoldCircleOutline => ArrowUpBoldCircleOutline,
            IconSymbol.ArrowUpBoldHexagonOutline => ArrowUpBoldHexagonOutline,
            IconSymbol.ArrowUpDropCircle => ArrowUpDropCircle,
            IconSymbol.ArrowUpDropCircleOutline => ArrowUpDropCircleOutline,
            IconSymbol.Assistant => Assistant,
            IconSymbol.At => At,
            IconSymbol.Attachment => Attachment,
            IconSymbol.BookMusic => BookMusic,
            IconSymbol.AutoFix => AutoFix,
            IconSymbol.AutoUpload => AutoUpload,
            IconSymbol.Autorenew => Autorenew,
            IconSymbol.AvTimer => AvTimer,
            IconSymbol.Baby => Baby,
            IconSymbol.Backburger => Backburger,
            IconSymbol.Backspace => Backspace,
            IconSymbol.BackupRestore => BackupRestore,
            IconSymbol.Bank => Bank,
            IconSymbol.Barcode => Barcode,
            IconSymbol.BarcodeScan => BarcodeScan,
            IconSymbol.Barley => Barley,
            IconSymbol.Barrel => Barrel,
            IconSymbol.IncognitoOff => IncognitoOff,
            IconSymbol.Basket => Basket,
            IconSymbol.BasketFill => BasketFill,
            IconSymbol.BasketUnfill => BasketUnfill,
            IconSymbol.Battery => Battery,
            IconSymbol.Battery10 => Battery10,
            IconSymbol.Battery20 => Battery20,
            IconSymbol.Battery30 => Battery30,
            IconSymbol.Battery40 => Battery40,
            IconSymbol.Battery50 => Battery50,
            IconSymbol.Battery60 => Battery60,
            IconSymbol.Battery70 => Battery70,
            IconSymbol.Battery80 => Battery80,
            IconSymbol.Battery90 => Battery90,
            IconSymbol.BatteryAlert => BatteryAlert,
            IconSymbol.BatteryCharging => BatteryCharging,
            IconSymbol.BatteryCharging100 => BatteryCharging100,
            IconSymbol.BatteryCharging20 => BatteryCharging20,
            IconSymbol.BatteryCharging30 => BatteryCharging30,
            IconSymbol.BatteryCharging40 => BatteryCharging40,
            IconSymbol.BatteryCharging60 => BatteryCharging60,
            IconSymbol.BatteryCharging80 => BatteryCharging80,
            IconSymbol.BatteryCharging90 => BatteryCharging90,
            IconSymbol.BatteryMinusVariant => BatteryMinusVariant,
            IconSymbol.BatteryNegative => BatteryNegative,
            IconSymbol.BatteryOutline => BatteryOutline,
            IconSymbol.BatteryPlusVariant => BatteryPlusVariant,
            IconSymbol.BatteryPositive => BatteryPositive,
            IconSymbol.BatteryUnknown => BatteryUnknown,
            IconSymbol.Beach => Beach,
            IconSymbol.Flask => Flask,
            IconSymbol.FlaskEmpty => FlaskEmpty,
            IconSymbol.FlaskEmptyOutline => FlaskEmptyOutline,
            IconSymbol.FlaskOutline => FlaskOutline,
            IconSymbol.BunkBedOutline => BunkBedOutline,
            IconSymbol.Beer => Beer,
            IconSymbol.BedOutline => BedOutline,
            IconSymbol.Bell => Bell,
            IconSymbol.BellOff => BellOff,
            IconSymbol.BellOutline => BellOutline,
            IconSymbol.BellPlus => BellPlus,
            IconSymbol.BellRing => BellRing,
            IconSymbol.BellRingOutline => BellRingOutline,
            IconSymbol.BellSleep => BellSleep,
            IconSymbol.Beta => Beta,
            IconSymbol.BookCross => BookCross,
            IconSymbol.Bike => Bike,
            IconSymbol.MicrosoftBing => MicrosoftBing,
            IconSymbol.Binoculars => Binoculars,
            IconSymbol.Bio => Bio,
            IconSymbol.Biohazard => Biohazard,
            IconSymbol.Bitbucket => Bitbucket,
            IconSymbol.BlackMesa => BlackMesa,
            IconSymbol.ShieldRefresh => ShieldRefresh,
            IconSymbol.BlenderSoftware => BlenderSoftware,
            IconSymbol.Blinds => Blinds,
            IconSymbol.BlockHelper => BlockHelper,
            IconSymbol.ApplicationEdit => ApplicationEdit,
            IconSymbol.Bluetooth => Bluetooth,
            IconSymbol.BluetoothAudio => BluetoothAudio,
            IconSymbol.BluetoothConnect => BluetoothConnect,
            IconSymbol.BluetoothOff => BluetoothOff,
            IconSymbol.BluetoothSettings => BluetoothSettings,
            IconSymbol.BluetoothTransfer => BluetoothTransfer,
            IconSymbol.Blur => Blur,
            IconSymbol.BlurLinear => BlurLinear,
            IconSymbol.BlurOff => BlurOff,
            IconSymbol.BlurRadial => BlurRadial,
            IconSymbol.Bone => Bone,
            IconSymbol.Book => Book,
            IconSymbol.BookMultiple => BookMultiple,
            IconSymbol.PauseBox => PauseBox,
            IconSymbol.BookOpen => BookOpen,
            IconSymbol.BookOpenBlankVariant => BookOpenBlankVariant,
            IconSymbol.BookVariant => BookVariant,
            IconSymbol.Bookmark => Bookmark,
            IconSymbol.BookmarkCheck => BookmarkCheck,
            IconSymbol.BookmarkMusic => BookmarkMusic,
            IconSymbol.BookmarkOutline => BookmarkOutline,
            IconSymbol.BookmarkPlusOutline => BookmarkPlusOutline,
            IconSymbol.BookmarkPlus => BookmarkPlus,
            IconSymbol.BookmarkRemove => BookmarkRemove,
            IconSymbol.BorderAll => BorderAll,
            IconSymbol.BorderBottom => BorderBottom,
            IconSymbol.BorderColor => BorderColor,
            IconSymbol.BorderHorizontal => BorderHorizontal,
            IconSymbol.BorderInside => BorderInside,
            IconSymbol.BorderLeft => BorderLeft,
            IconSymbol.BorderNone => BorderNone,
            IconSymbol.BorderOutside => BorderOutside,
            IconSymbol.BorderRight => BorderRight,
            IconSymbol.BorderStyle => BorderStyle,
            IconSymbol.BorderTop => BorderTop,
            IconSymbol.BorderVertical => BorderVertical,
            IconSymbol.Bowling => Bowling,
            IconSymbol.Box => Box,
            IconSymbol.BoxCutter => BoxCutter,
            IconSymbol.Briefcase => Briefcase,
            IconSymbol.BriefcaseCheck => BriefcaseCheck,
            IconSymbol.BriefcaseDownload => BriefcaseDownload,
            IconSymbol.BriefcaseUpload => BriefcaseUpload,
            IconSymbol.Brightness1 => Brightness1,
            IconSymbol.Brightness2 => Brightness2,
            IconSymbol.Brightness3 => Brightness3,
            IconSymbol.Brightness4 => Brightness4,
            IconSymbol.Brightness5 => Brightness5,
            IconSymbol.Brightness6 => Brightness6,
            IconSymbol.Brightness7 => Brightness7,
            IconSymbol.BrightnessAuto => BrightnessAuto,
            IconSymbol.Broom => Broom,
            IconSymbol.Brush => Brush,
            IconSymbol.Bug => Bug,
            IconSymbol.BulletinBoard => BulletinBoard,
            IconSymbol.Bullhorn => Bullhorn,
            IconSymbol.Bus => Bus,
            IconSymbol.Cached => Cached,
            IconSymbol.Cake => Cake,
            IconSymbol.CakeLayered => CakeLayered,
            IconSymbol.CakeVariant => CakeVariant,
            IconSymbol.Calculator => Calculator,
            IconSymbol.Calendar => Calendar,
            IconSymbol.CalendarBlank => CalendarBlank,
            IconSymbol.CalendarCheck => CalendarCheck,
            IconSymbol.CalendarClock => CalendarClock,
            IconSymbol.CalendarMultiple => CalendarMultiple,
            IconSymbol.CalendarMultipleCheck => CalendarMultipleCheck,
            IconSymbol.CalendarPlus => CalendarPlus,
            IconSymbol.CalendarRemove => CalendarRemove,
            IconSymbol.CalendarText => CalendarText,
            IconSymbol.CalendarToday => CalendarToday,
            IconSymbol.CallMade => CallMade,
            IconSymbol.CallMerge => CallMerge,
            IconSymbol.CallMissed => CallMissed,
            IconSymbol.CallReceived => CallReceived,
            IconSymbol.CallSplit => CallSplit,
            IconSymbol.Camcorder => Camcorder,
            IconSymbol.VideoBox => VideoBox,
            IconSymbol.VideoBoxOff => VideoBoxOff,
            IconSymbol.CamcorderOff => CamcorderOff,
            IconSymbol.Camera => Camera,
            IconSymbol.CameraEnhance => CameraEnhance,
            IconSymbol.CameraFront => CameraFront,
            IconSymbol.CameraFrontVariant => CameraFrontVariant,
            IconSymbol.CameraIris => CameraIris,
            IconSymbol.CameraPartyMode => CameraPartyMode,
            IconSymbol.CameraRear => CameraRear,
            IconSymbol.CameraRearVariant => CameraRearVariant,
            IconSymbol.CameraSwitch => CameraSwitch,
            IconSymbol.CameraTimer => CameraTimer,
            IconSymbol.Candycane => Candycane,
            IconSymbol.Car => Car,
            IconSymbol.CarBattery => CarBattery,
            IconSymbol.CarConnected => CarConnected,
            IconSymbol.CarWash => CarWash,
            IconSymbol.Carrot => Carrot,
            IconSymbol.Cart => Cart,
            IconSymbol.CartOutline => CartOutline,
            IconSymbol.CartPlus => CartPlus,
            IconSymbol.CaseSensitiveAlt => CaseSensitiveAlt,
            IconSymbol.Cash => Cash,
            IconSymbol.Cash100 => Cash100,
            IconSymbol.CashMultiple => CashMultiple,
            IconSymbol.CheckboxBlankBadgeOutline => CheckboxBlankBadgeOutline,
            IconSymbol.Cast => Cast,
            IconSymbol.CastConnected => CastConnected,
            IconSymbol.Castle => Castle,
            IconSymbol.Cat => Cat,
            IconSymbol.Cellphone => Cellphone,
            IconSymbol.TrayArrowUp => TrayArrowUp,
            IconSymbol.CellphoneBasic => CellphoneBasic,
            IconSymbol.CellphoneDock => CellphoneDock,
            IconSymbol.TrayArrowDown => TrayArrowDown,
            IconSymbol.CellphoneLink => CellphoneLink,
            IconSymbol.CellphoneLinkOff => CellphoneLinkOff,
            IconSymbol.CellphoneSettings => CellphoneSettings,
            IconSymbol.Certificate => Certificate,
            IconSymbol.ChairSchool => ChairSchool,
            IconSymbol.ChartArc => ChartArc,
            IconSymbol.ChartAreaspline => ChartAreaspline,
            IconSymbol.ChartBar => ChartBar,
            IconSymbol.ChartHistogram => ChartHistogram,
            IconSymbol.ChartLine => ChartLine,
            IconSymbol.ChartPie => ChartPie,
            IconSymbol.Check => Check,
            IconSymbol.CheckAll => CheckAll,
            IconSymbol.CheckboxBlank => CheckboxBlank,
            IconSymbol.CheckboxBlankCircle => CheckboxBlankCircle,
            IconSymbol.CheckboxBlankCircleOutline => CheckboxBlankCircleOutline,
            IconSymbol.CheckboxBlankOutline => CheckboxBlankOutline,
            IconSymbol.CheckboxMarked => CheckboxMarked,
            IconSymbol.CheckboxMarkedCircle => CheckboxMarkedCircle,
            IconSymbol.CheckboxMarkedCircleOutline => CheckboxMarkedCircleOutline,
            IconSymbol.CheckboxMarkedOutline => CheckboxMarkedOutline,
            IconSymbol.CheckboxMultipleBlank => CheckboxMultipleBlank,
            IconSymbol.CheckboxMultipleBlankOutline => CheckboxMultipleBlankOutline,
            IconSymbol.CheckboxMultipleMarked => CheckboxMultipleMarked,
            IconSymbol.CheckboxMultipleMarkedOutline => CheckboxMultipleMarkedOutline,
            IconSymbol.Checkerboard => Checkerboard,
            IconSymbol.ChemicalWeapon => ChemicalWeapon,
            IconSymbol.ChevronDoubleDown => ChevronDoubleDown,
            IconSymbol.ChevronDoubleLeft => ChevronDoubleLeft,
            IconSymbol.ChevronDoubleRight => ChevronDoubleRight,
            IconSymbol.ChevronDoubleUp => ChevronDoubleUp,
            IconSymbol.ChevronDown => ChevronDown,
            IconSymbol.ChevronLeft => ChevronLeft,
            IconSymbol.ChevronRight => ChevronRight,
            IconSymbol.ChevronUp => ChevronUp,
            IconSymbol.Church => Church,
            IconSymbol.RollerSkateOff => RollerSkateOff,
            IconSymbol.City => City,
            IconSymbol.Clipboard => Clipboard,
            IconSymbol.ClipboardAccount => ClipboardAccount,
            IconSymbol.ClipboardAlert => ClipboardAlert,
            IconSymbol.ClipboardArrowDown => ClipboardArrowDown,
            IconSymbol.ClipboardArrowLeft => ClipboardArrowLeft,
            IconSymbol.ClipboardOutline => ClipboardOutline,
            IconSymbol.ClipboardText => ClipboardText,
            IconSymbol.ClipboardCheck => ClipboardCheck,
            IconSymbol.Clippy => Clippy,
            IconSymbol.ClockOutline => ClockOutline,
            IconSymbol.ClockEnd => ClockEnd,
            IconSymbol.ClockFast => ClockFast,
            IconSymbol.ClockIn => ClockIn,
            IconSymbol.ClockOut => ClockOut,
            IconSymbol.ClockStart => ClockStart,
            IconSymbol.Close => Close,
            IconSymbol.CloseBox => CloseBox,
            IconSymbol.CloseBoxOutline => CloseBoxOutline,
            IconSymbol.CloseCircle => CloseCircle,
            IconSymbol.CloseCircleOutline => CloseCircleOutline,
            IconSymbol.CloseNetwork => CloseNetwork,
            IconSymbol.CloseOctagon => CloseOctagon,
            IconSymbol.CloseOctagonOutline => CloseOctagonOutline,
            IconSymbol.ClosedCaption => ClosedCaption,
            IconSymbol.Cloud => Cloud,
            IconSymbol.CloudCheck => CloudCheck,
            IconSymbol.CloudCircle => CloudCircle,
            IconSymbol.CloudDownload => CloudDownload,
            IconSymbol.CloudOutline => CloudOutline,
            IconSymbol.CloudOffOutline => CloudOffOutline,
            IconSymbol.CloudPrint => CloudPrint,
            IconSymbol.CloudPrintOutline => CloudPrintOutline,
            IconSymbol.CloudUpload => CloudUpload,
            IconSymbol.CodeArray => CodeArray,
            IconSymbol.CodeBraces => CodeBraces,
            IconSymbol.CodeBrackets => CodeBrackets,
            IconSymbol.CodeEqual => CodeEqual,
            IconSymbol.CodeGreaterThan => CodeGreaterThan,
            IconSymbol.CodeGreaterThanOrEqual => CodeGreaterThanOrEqual,
            IconSymbol.CodeLessThan => CodeLessThan,
            IconSymbol.CodeLessThanOrEqual => CodeLessThanOrEqual,
            IconSymbol.CodeNotEqual => CodeNotEqual,
            IconSymbol.CodeNotEqualVariant => CodeNotEqualVariant,
            IconSymbol.CodeParentheses => CodeParentheses,
            IconSymbol.CodeString => CodeString,
            IconSymbol.CodeTags => CodeTags,
            IconSymbol.Codepen => Codepen,
            IconSymbol.Coffee => Coffee,
            IconSymbol.CoffeeToGo => CoffeeToGo,
            IconSymbol.BellBadgeOutline => BellBadgeOutline,
            IconSymbol.ColorHelper => ColorHelper,
            IconSymbol.Comment => Comment,
            IconSymbol.CommentAccount => CommentAccount,
            IconSymbol.CommentAccountOutline => CommentAccountOutline,
            IconSymbol.CommentAlert => CommentAlert,
            IconSymbol.CommentAlertOutline => CommentAlertOutline,
            IconSymbol.CommentCheck => CommentCheck,
            IconSymbol.CommentCheckOutline => CommentCheckOutline,
            IconSymbol.CommentMultipleOutline => CommentMultipleOutline,
            IconSymbol.CommentOutline => CommentOutline,
            IconSymbol.CommentPlusOutline => CommentPlusOutline,
            IconSymbol.CommentProcessing => CommentProcessing,
            IconSymbol.CommentProcessingOutline => CommentProcessingOutline,
            IconSymbol.CommentQuestionOutline => CommentQuestionOutline,
            IconSymbol.CommentRemoveOutline => CommentRemoveOutline,
            IconSymbol.CommentText => CommentText,
            IconSymbol.CommentTextOutline => CommentTextOutline,
            IconSymbol.Compare => Compare,
            IconSymbol.Compass => Compass,
            IconSymbol.CompassOutline => CompassOutline,
            IconSymbol.Console => Console,
            IconSymbol.CardAccountMail => CardAccountMail,
            IconSymbol.ContentCopy => ContentCopy,
            IconSymbol.ContentCut => ContentCut,
            IconSymbol.ContentDuplicate => ContentDuplicate,
            IconSymbol.ContentPaste => ContentPaste,
            IconSymbol.ContentSave => ContentSave,
            IconSymbol.ContentSaveAll => ContentSaveAll,
            IconSymbol.Contrast => Contrast,
            IconSymbol.ContrastBox => ContrastBox,
            IconSymbol.ContrastCircle => ContrastCircle,
            IconSymbol.Cookie => Cookie,
            IconSymbol.Counter => Counter,
            IconSymbol.Cow => Cow,
            IconSymbol.CreditCardOutline => CreditCardOutline,
            IconSymbol.CreditCardMultipleOutline => CreditCardMultipleOutline,
            IconSymbol.CreditCardScanOutline => CreditCardScanOutline,
            IconSymbol.Crop => Crop,
            IconSymbol.CropFree => CropFree,
            IconSymbol.CropLandscape => CropLandscape,
            IconSymbol.CropPortrait => CropPortrait,
            IconSymbol.CropSquare => CropSquare,
            IconSymbol.Crosshairs => Crosshairs,
            IconSymbol.CrosshairsGps => CrosshairsGps,
            IconSymbol.Crown => Crown,
            IconSymbol.Cube => Cube,
            IconSymbol.CubeOutline => CubeOutline,
            IconSymbol.CubeSend => CubeSend,
            IconSymbol.CubeUnfolded => CubeUnfolded,
            IconSymbol.Cup => Cup,
            IconSymbol.CupWater => CupWater,
            IconSymbol.CurrencyBtc => CurrencyBtc,
            IconSymbol.CurrencyEur => CurrencyEur,
            IconSymbol.CurrencyGbp => CurrencyGbp,
            IconSymbol.CurrencyInr => CurrencyInr,
            IconSymbol.CurrencyNgn => CurrencyNgn,
            IconSymbol.CurrencyRub => CurrencyRub,
            IconSymbol.CurrencyTry => CurrencyTry,
            IconSymbol.DeleteVariant => DeleteVariant,
            IconSymbol.Delete => Delete,
            IconSymbol.DecimalIncrease => DecimalIncrease,
            IconSymbol.DecimalDecrease => DecimalDecrease,
            IconSymbol.DebugStepOver => DebugStepOver,
            IconSymbol.DebugStepOut => DebugStepOut,
            IconSymbol.DebugStepInto => DebugStepInto,
            IconSymbol.DatabasePlus => DatabasePlus,
            IconSymbol.DatabaseMinus => DatabaseMinus,
            IconSymbol.Database => Database,
            IconSymbol.CursorPointer => CursorPointer,
            IconSymbol.CursorMove => CursorMove,
            IconSymbol.CursorDefaultOutline => CursorDefaultOutline,
            IconSymbol.CursorDefault => CursorDefault,
            IconSymbol.CurrencyUsd => CurrencyUsd,
            IconSymbol.Delta => Delta,
            IconSymbol.Deskphone => Deskphone,
            IconSymbol.VectorPoint => VectorPoint,
            IconSymbol.DesktopTower => DesktopTower,
            IconSymbol.Details => Details,
            IconSymbol.Deviantart => Deviantart,
            IconSymbol.DiamondStone => DiamondStone,
            IconSymbol.AbTesting => AbTesting,
            IconSymbol.Dice1 => Dice1,
            IconSymbol.Dice2 => Dice2,
            IconSymbol.Dice3 => Dice3,
            IconSymbol.Dice4 => Dice4,
            IconSymbol.Dice5 => Dice5,
            IconSymbol.Dice6 => Dice6,
            IconSymbol.Directions => Directions,
            IconSymbol.DiscAlert => DiscAlert,
            IconSymbol.Disqus => Disqus,
            IconSymbol.VideoPlusOutline => VideoPlusOutline,
            IconSymbol.Division => Division,
            IconSymbol.DivisionBox => DivisionBox,
            IconSymbol.Dns => Dns,
            IconSymbol.Domain => Domain,
            IconSymbol.DotsHorizontal => DotsHorizontal,
            IconSymbol.DotsVertical => DotsVertical,
            IconSymbol.Download => Download,
            IconSymbol.Drag => Drag,
            IconSymbol.DragHorizontal => DragHorizontal,
            IconSymbol.DragVertical => DragVertical,
            IconSymbol.Drawing => Drawing,
            IconSymbol.DrawingBox => DrawingBox,
            IconSymbol.ShieldRefreshOutline => ShieldRefreshOutline,
            IconSymbol.CalendarRefresh => CalendarRefresh,
            IconSymbol.Drone => Drone,
            IconSymbol.Dropbox => Dropbox,
            IconSymbol.Drupal => Drupal,
            IconSymbol.Duck => Duck,
            IconSymbol.Dumbbell => Dumbbell,
            IconSymbol.Earth => Earth,
            IconSymbol.EarthOff => EarthOff,
            IconSymbol.MicrosoftEdge => MicrosoftEdge,
            IconSymbol.Eject => Eject,
            IconSymbol.ElevationDecline => ElevationDecline,
            IconSymbol.ElevationRise => ElevationRise,
            IconSymbol.Elevator => Elevator,
            IconSymbol.Email => Email,
            IconSymbol.EmailOpen => EmailOpen,
            IconSymbol.EmailOutline => EmailOutline,
            IconSymbol.EmailLock => EmailLock,
            IconSymbol.EmoticonOutline => EmoticonOutline,
            IconSymbol.EmoticonCoolOutline => EmoticonCoolOutline,
            IconSymbol.EmoticonDevilOutline => EmoticonDevilOutline,
            IconSymbol.EmoticonHappyOutline => EmoticonHappyOutline,
            IconSymbol.EmoticonNeutralOutline => EmoticonNeutralOutline,
            IconSymbol.EmoticonPoop => EmoticonPoop,
            IconSymbol.EmoticonSadOutline => EmoticonSadOutline,
            IconSymbol.EmoticonTongue => EmoticonTongue,
            IconSymbol.Engine => Engine,
            IconSymbol.EngineOutline => EngineOutline,
            IconSymbol.Equal => Equal,
            IconSymbol.EqualBox => EqualBox,
            IconSymbol.Eraser => Eraser,
            IconSymbol.Escalator => Escalator,
            IconSymbol.Ethernet => Ethernet,
            IconSymbol.EthernetCable => EthernetCable,
            IconSymbol.EthernetCableOff => EthernetCableOff,
            IconSymbol.CalendarRefreshOutline => CalendarRefreshOutline,
            IconSymbol.Evernote => Evernote,
            IconSymbol.Exclamation => Exclamation,
            IconSymbol.ExitToApp => ExitToApp,
            IconSymbol.Export => Export,
            IconSymbol.Eye => Eye,
            IconSymbol.EyeOff => EyeOff,
            IconSymbol.Eyedropper => Eyedropper,
            IconSymbol.EyedropperVariant => EyedropperVariant,
            IconSymbol.Facebook => Facebook,
            IconSymbol.OrderAlphabeticalAscending => OrderAlphabeticalAscending,
            IconSymbol.FacebookMessenger => FacebookMessenger,
            IconSymbol.Factory => Factory,
            IconSymbol.Fan => Fan,
            IconSymbol.FastForward => FastForward,
            IconSymbol.Fax => Fax,
            IconSymbol.Ferry => Ferry,
            IconSymbol.File => File,
            IconSymbol.FileChart => FileChart,
            IconSymbol.FileCheck => FileCheck,
            IconSymbol.FileCloud => FileCloud,
            IconSymbol.FileDelimited => FileDelimited,
            IconSymbol.FileDocument => FileDocument,
            IconSymbol.TextBox => TextBox,
            IconSymbol.FileExcel => FileExcel,
            IconSymbol.FileExcelBox => FileExcelBox,
            IconSymbol.FileExport => FileExport,
            IconSymbol.FileFind => FileFind,
            IconSymbol.FileImage => FileImage,
            IconSymbol.FileImport => FileImport,
            IconSymbol.FileLock => FileLock,
            IconSymbol.FileMultiple => FileMultiple,
            IconSymbol.FileMusic => FileMusic,
            IconSymbol.FileOutline => FileOutline,
            IconSymbol.FileJpgBox => FileJpgBox,
            IconSymbol.FilePdfBox => FilePdfBox,
            IconSymbol.FilePowerpoint => FilePowerpoint,
            IconSymbol.FilePowerpointBox => FilePowerpointBox,
            IconSymbol.FilePresentationBox => FilePresentationBox,
            IconSymbol.FileSend => FileSend,
            IconSymbol.FileVideo => FileVideo,
            IconSymbol.FileWord => FileWord,
            IconSymbol.FileWordBox => FileWordBox,
            IconSymbol.FileCode => FileCode,
            IconSymbol.Film => Film,
            IconSymbol.Filmstrip => Filmstrip,
            IconSymbol.FilmstripOff => FilmstripOff,
            IconSymbol.Filter => Filter,
            IconSymbol.FilterOutline => FilterOutline,
            IconSymbol.FilterRemove => FilterRemove,
            IconSymbol.FilterRemoveOutline => FilterRemoveOutline,
            IconSymbol.FilterVariant => FilterVariant,
            IconSymbol.Fingerprint => Fingerprint,
            IconSymbol.Fire => Fire,
            IconSymbol.Firefox => Firefox,
            IconSymbol.Fish => Fish,
            IconSymbol.Flag => Flag,
            IconSymbol.FlagCheckered => FlagCheckered,
            IconSymbol.FlagOutline => FlagOutline,
            IconSymbol.FlagVariantOutline => FlagVariantOutline,
            IconSymbol.FlagTriangle => FlagTriangle,
            IconSymbol.FlagVariant => FlagVariant,
            IconSymbol.Flash => Flash,
            IconSymbol.FlashAuto => FlashAuto,
            IconSymbol.FlashOff => FlashOff,
            IconSymbol.Flashlight => Flashlight,
            IconSymbol.FlashlightOff => FlashlightOff,
            IconSymbol.StarHalf => StarHalf,
            IconSymbol.FlipToBack => FlipToBack,
            IconSymbol.FlipToFront => FlipToFront,
            IconSymbol.Floppy => Floppy,
            IconSymbol.Flower => Flower,
            IconSymbol.Folder => Folder,
            IconSymbol.FolderAccount => FolderAccount,
            IconSymbol.FolderDownload => FolderDownload,
            IconSymbol.FolderGoogleDrive => FolderGoogleDrive,
            IconSymbol.FolderImage => FolderImage,
            IconSymbol.FolderLock => FolderLock,
            IconSymbol.FolderLockOpen => FolderLockOpen,
            IconSymbol.FolderMove => FolderMove,
            IconSymbol.FolderMultiple => FolderMultiple,
            IconSymbol.FolderMultipleImage => FolderMultipleImage,
            IconSymbol.FolderMultipleOutline => FolderMultipleOutline,
            IconSymbol.FolderOutline => FolderOutline,
            IconSymbol.FolderPlus => FolderPlus,
            IconSymbol.FolderRemove => FolderRemove,
            IconSymbol.FolderUpload => FolderUpload,
            IconSymbol.Food => Food,
            IconSymbol.FoodApple => FoodApple,
            IconSymbol.FoodVariant => FoodVariant,
            IconSymbol.Football => Football,
            IconSymbol.FootballAustralian => FootballAustralian,
            IconSymbol.FootballHelmet => FootballHelmet,
            IconSymbol.FormatAlignCenter => FormatAlignCenter,
            IconSymbol.FormatAlignJustify => FormatAlignJustify,
            IconSymbol.FormatAlignLeft => FormatAlignLeft,
            IconSymbol.FormatAlignRight => FormatAlignRight,
            IconSymbol.FormatBold => FormatBold,
            IconSymbol.FormatClear => FormatClear,
            IconSymbol.FormatColorFill => FormatColorFill,
            IconSymbol.FormatFloatCenter => FormatFloatCenter,
            IconSymbol.FormatFloatLeft => FormatFloatLeft,
            IconSymbol.FormatFloatNone => FormatFloatNone,
            IconSymbol.FormatFloatRight => FormatFloatRight,
            IconSymbol.FormatHeader1 => FormatHeader1,
            IconSymbol.FormatHeader2 => FormatHeader2,
            IconSymbol.FormatHeader3 => FormatHeader3,
            IconSymbol.FormatHeader4 => FormatHeader4,
            IconSymbol.FormatHeader5 => FormatHeader5,
            IconSymbol.FormatHeader6 => FormatHeader6,
            IconSymbol.FormatHeaderDecrease => FormatHeaderDecrease,
            IconSymbol.FormatHeaderEqual => FormatHeaderEqual,
            IconSymbol.FormatHeaderIncrease => FormatHeaderIncrease,
            IconSymbol.FormatHeaderPound => FormatHeaderPound,
            IconSymbol.FormatIndentDecrease => FormatIndentDecrease,
            IconSymbol.FormatIndentIncrease => FormatIndentIncrease,
            IconSymbol.FormatItalic => FormatItalic,
            IconSymbol.FormatLineSpacing => FormatLineSpacing,
            IconSymbol.FormatListBulleted => FormatListBulleted,
            IconSymbol.FormatListBulletedType => FormatListBulletedType,
            IconSymbol.FormatListNumbered => FormatListNumbered,
            IconSymbol.FormatPaint => FormatPaint,
            IconSymbol.FormatParagraph => FormatParagraph,
            IconSymbol.FormatQuoteClose => FormatQuoteClose,
            IconSymbol.FormatSize => FormatSize,
            IconSymbol.FormatStrikethrough => FormatStrikethrough,
            IconSymbol.FormatStrikethroughVariant => FormatStrikethroughVariant,
            IconSymbol.FormatSubscript => FormatSubscript,
            IconSymbol.FormatSuperscript => FormatSuperscript,
            IconSymbol.FormatText => FormatText,
            IconSymbol.FormatPilcrowArrowRight => FormatPilcrowArrowRight,
            IconSymbol.FormatPilcrowArrowLeft => FormatPilcrowArrowLeft,
            IconSymbol.FormatUnderline => FormatUnderline,
            IconSymbol.FormatWrapInline => FormatWrapInline,
            IconSymbol.FormatWrapSquare => FormatWrapSquare,
            IconSymbol.FormatWrapTight => FormatWrapTight,
            IconSymbol.FormatWrapTopBottom => FormatWrapTopBottom,
            IconSymbol.Forum => Forum,
            IconSymbol.Forward => Forward,
            IconSymbol.Bowl => Bowl,
            IconSymbol.FridgeOutline => FridgeOutline,
            IconSymbol.Fridge => Fridge,
            IconSymbol.FridgeTop => FridgeTop,
            IconSymbol.FridgeBottom => FridgeBottom,
            IconSymbol.Fullscreen => Fullscreen,
            IconSymbol.FullscreenExit => FullscreenExit,
            IconSymbol.Function => Function,
            IconSymbol.Gamepad => Gamepad,
            IconSymbol.GamepadVariant => GamepadVariant,
            IconSymbol.GasStation => GasStation,
            IconSymbol.Gate => Gate,
            IconSymbol.Gauge => Gauge,
            IconSymbol.Gavel => Gavel,
            IconSymbol.GenderFemale => GenderFemale,
            IconSymbol.GenderMale => GenderMale,
            IconSymbol.GenderMaleFemale => GenderMaleFemale,
            IconSymbol.GenderTransgender => GenderTransgender,
            IconSymbol.Ghost => Ghost,
            IconSymbol.GiftOutline => GiftOutline,
            IconSymbol.Git => Git,
            IconSymbol.CardAccountDetailsStar => CardAccountDetailsStar,
            IconSymbol.Github => Github,
            IconSymbol.GlassFlute => GlassFlute,
            IconSymbol.GlassMug => GlassMug,
            IconSymbol.GlassStange => GlassStange,
            IconSymbol.GlassTulip => GlassTulip,
            IconSymbol.BowlOutline => BowlOutline,
            IconSymbol.Glasses => Glasses,
            IconSymbol.Gmail => Gmail,
            IconSymbol.Gnome => Gnome,
            IconSymbol.Google => Google,
            IconSymbol.GoogleCardboard => GoogleCardboard,
            IconSymbol.GoogleChrome => GoogleChrome,
            IconSymbol.GoogleCircles => GoogleCircles,
            IconSymbol.GoogleCirclesCommunities => GoogleCirclesCommunities,
            IconSymbol.GoogleCirclesExtended => GoogleCirclesExtended,
            IconSymbol.GoogleCirclesGroup => GoogleCirclesGroup,
            IconSymbol.Controller => Controller,
            IconSymbol.ControllerOff => ControllerOff,
            IconSymbol.GoogleDrive => GoogleDrive,
            IconSymbol.GoogleEarth => GoogleEarth,
            IconSymbol.GoogleGlass => GoogleGlass,
            IconSymbol.GoogleNearby => GoogleNearby,
            IconSymbol.VideoMinusOutline => VideoMinusOutline,
            IconSymbol.MicrosoftTeams => MicrosoftTeams,
            IconSymbol.GooglePlay => GooglePlay,
            IconSymbol.GooglePlus => GooglePlus,
            IconSymbol.OrderBoolAscending => OrderBoolAscending,
            IconSymbol.GoogleTranslate => GoogleTranslate,
            IconSymbol.GoogleClassroom => GoogleClassroom,
            IconSymbol.Grid => Grid,
            IconSymbol.GridOff => GridOff,
            IconSymbol.Group => Group,
            IconSymbol.GuitarElectric => GuitarElectric,
            IconSymbol.GuitarPick => GuitarPick,
            IconSymbol.GuitarPickOutline => GuitarPickOutline,
            IconSymbol.HandPointingRight => HandPointingRight,
            IconSymbol.Hanger => Hanger,
            IconSymbol.GoogleHangouts => GoogleHangouts,
            IconSymbol.Harddisk => Harddisk,
            IconSymbol.Headphones => Headphones,
            IconSymbol.HeadphonesBox => HeadphonesBox,
            IconSymbol.HeadphonesSettings => HeadphonesSettings,
            IconSymbol.Headset => Headset,
            IconSymbol.HeadsetDock => HeadsetDock,
            IconSymbol.HeadsetOff => HeadsetOff,
            IconSymbol.Heart => Heart,
            IconSymbol.HeartBox => HeartBox,
            IconSymbol.HeartBoxOutline => HeartBoxOutline,
            IconSymbol.HeartBroken => HeartBroken,
            IconSymbol.HeartOutline => HeartOutline,
            IconSymbol.Help => Help,
            IconSymbol.HelpCircle => HelpCircle,
            IconSymbol.Hexagon => Hexagon,
            IconSymbol.HexagonOutline => HexagonOutline,
            IconSymbol.History => History,
            IconSymbol.Hololens => Hololens,
            IconSymbol.Home => Home,
            IconSymbol.HomeModern => HomeModern,
            IconSymbol.HomeVariant => HomeVariant,
            IconSymbol.Hops => Hops,
            IconSymbol.HospitalBox => HospitalBox,
            IconSymbol.HospitalBuilding => HospitalBuilding,
            IconSymbol.HospitalMarker => HospitalMarker,
            IconSymbol.Bed => Bed,
            IconSymbol.BowlMixOutline => BowlMixOutline,
            IconSymbol.Pot => Pot,
            IconSymbol.Human => Human,
            IconSymbol.HumanChild => HumanChild,
            IconSymbol.HumanMaleFemale => HumanMaleFemale,
            IconSymbol.Image => Image,
            IconSymbol.ImageAlbum => ImageAlbum,
            IconSymbol.ImageArea => ImageArea,
            IconSymbol.ImageAreaClose => ImageAreaClose,
            IconSymbol.ImageBroken => ImageBroken,
            IconSymbol.ImageBrokenVariant => ImageBrokenVariant,
            IconSymbol.ImageMultipleOutline => ImageMultipleOutline,
            IconSymbol.ImageFilterBlackWhite => ImageFilterBlackWhite,
            IconSymbol.ImageFilterCenterFocus => ImageFilterCenterFocus,
            IconSymbol.ImageFilterCenterFocusWeak => ImageFilterCenterFocusWeak,
            IconSymbol.ImageFilterDrama => ImageFilterDrama,
            IconSymbol.ImageFilterFrames => ImageFilterFrames,
            IconSymbol.ImageFilterHdr => ImageFilterHdr,
            IconSymbol.ImageFilterNone => ImageFilterNone,
            IconSymbol.ImageFilterTiltShift => ImageFilterTiltShift,
            IconSymbol.ImageFilterVintage => ImageFilterVintage,
            IconSymbol.ImageMultiple => ImageMultiple,
            IconSymbol.Import => Import,
            IconSymbol.InboxArrowDown => InboxArrowDown,
            IconSymbol.Information => Information,
            IconSymbol.InformationOutline => InformationOutline,
            IconSymbol.Instagram => Instagram,
            IconSymbol.PotOutline => PotOutline,
            IconSymbol.MicrosoftInternetExplorer => MicrosoftInternetExplorer,
            IconSymbol.InvertColors => InvertColors,
            IconSymbol.Jeepney => Jeepney,
            IconSymbol.Jira => Jira,
            IconSymbol.Jsfiddle => Jsfiddle,
            IconSymbol.Keg => Keg,
            IconSymbol.Key => Key,
            IconSymbol.KeyChange => KeyChange,
            IconSymbol.KeyMinus => KeyMinus,
            IconSymbol.KeyPlus => KeyPlus,
            IconSymbol.KeyRemove => KeyRemove,
            IconSymbol.KeyVariant => KeyVariant,
            IconSymbol.Keyboard => Keyboard,
            IconSymbol.KeyboardBackspace => KeyboardBackspace,
            IconSymbol.KeyboardCaps => KeyboardCaps,
            IconSymbol.KeyboardClose => KeyboardClose,
            IconSymbol.KeyboardOff => KeyboardOff,
            IconSymbol.KeyboardReturn => KeyboardReturn,
            IconSymbol.KeyboardTab => KeyboardTab,
            IconSymbol.KeyboardVariant => KeyboardVariant,
            IconSymbol.Kodi => Kodi,
            IconSymbol.Label => Label,
            IconSymbol.LabelOutline => LabelOutline,
            IconSymbol.Lan => Lan,
            IconSymbol.LanConnect => LanConnect,
            IconSymbol.LanDisconnect => LanDisconnect,
            IconSymbol.LanPending => LanPending,
            IconSymbol.LanguageCsharp => LanguageCsharp,
            IconSymbol.LanguageCss3 => LanguageCss3,
            IconSymbol.LanguageHtml5 => LanguageHtml5,
            IconSymbol.LanguageJavascript => LanguageJavascript,
            IconSymbol.LanguagePhp => LanguagePhp,
            IconSymbol.LanguagePython => LanguagePython,
            IconSymbol.ContactlessPaymentCircle => ContactlessPaymentCircle,
            IconSymbol.Laptop => Laptop,
            IconSymbol.MagazineRifle => MagazineRifle,
            IconSymbol.MagazinePistol => MagazinePistol,
            IconSymbol.KeyboardTabReverse => KeyboardTabReverse,
            IconSymbol.PotSteamOutline => PotSteamOutline,
            IconSymbol.Launch => Launch,
            IconSymbol.Layers => Layers,
            IconSymbol.LayersOff => LayersOff,
            IconSymbol.Leaf => Leaf,
            IconSymbol.LedOff => LedOff,
            IconSymbol.LedOn => LedOn,
            IconSymbol.LedOutline => LedOutline,
            IconSymbol.LedVariantOff => LedVariantOff,
            IconSymbol.LedVariantOn => LedVariantOn,
            IconSymbol.LedVariantOutline => LedVariantOutline,
            IconSymbol.Library => Library,
            IconSymbol.FilmstripBox => FilmstripBox,
            IconSymbol.MusicBoxMultiple => MusicBoxMultiple,
            IconSymbol.PlusBoxMultiple => PlusBoxMultiple,
            IconSymbol.Lightbulb => Lightbulb,
            IconSymbol.LightbulbOutline => LightbulbOutline,
            IconSymbol.Link => Link,
            IconSymbol.LinkOff => LinkOff,
            IconSymbol.LinkVariant => LinkVariant,
            IconSymbol.LinkVariantOff => LinkVariantOff,
            IconSymbol.Linkedin => Linkedin,
            IconSymbol.SortReverseVariant => SortReverseVariant,
            IconSymbol.Linux => Linux,
            IconSymbol.Lock => Lock,
            IconSymbol.LockOpen => LockOpen,
            IconSymbol.LockOpenOutline => LockOpenOutline,
            IconSymbol.LockOutline => LockOutline,
            IconSymbol.Login => Login,
            IconSymbol.Logout => Logout,
            IconSymbol.Looks => Looks,
            IconSymbol.Loupe => Loupe,
            IconSymbol.Lumx => Lumx,
            IconSymbol.Magnet => Magnet,
            IconSymbol.MagnetOn => MagnetOn,
            IconSymbol.Magnify => Magnify,
            IconSymbol.MagnifyMinus => MagnifyMinus,
            IconSymbol.MagnifyPlus => MagnifyPlus,
            IconSymbol.PlusCircleMultiple => PlusCircleMultiple,
            IconSymbol.Map => Map,
            IconSymbol.MapMarker => MapMarker,
            IconSymbol.MapMarkerCircle => MapMarkerCircle,
            IconSymbol.MapMarkerMultiple => MapMarkerMultiple,
            IconSymbol.MapMarkerOff => MapMarkerOff,
            IconSymbol.MapMarkerRadius => MapMarkerRadius,
            IconSymbol.Margin => Margin,
            IconSymbol.LanguageMarkdown => LanguageMarkdown,
            IconSymbol.MarkerCheck => MarkerCheck,
            IconSymbol.GlassCocktail => GlassCocktail,
            IconSymbol.MaterialUi => MaterialUi,
            IconSymbol.MathCompass => MathCompass,
            IconSymbol.Stackpath => Stackpath,
            IconSymbol.MinusCircleMultiple => MinusCircleMultiple,
            IconSymbol.Memory => Memory,
            IconSymbol.Menu => Menu,
            IconSymbol.MenuDown => MenuDown,
            IconSymbol.MenuLeft => MenuLeft,
            IconSymbol.MenuRight => MenuRight,
            IconSymbol.MenuUp => MenuUp,
            IconSymbol.Message => Message,
            IconSymbol.MessageAlert => MessageAlert,
            IconSymbol.MessageDraw => MessageDraw,
            IconSymbol.MessageImage => MessageImage,
            IconSymbol.MessageOutline => MessageOutline,
            IconSymbol.MessageProcessing => MessageProcessing,
            IconSymbol.MessageReply => MessageReply,
            IconSymbol.MessageReplyText => MessageReplyText,
            IconSymbol.MessageText => MessageText,
            IconSymbol.MessageTextOutline => MessageTextOutline,
            IconSymbol.MessageVideo => MessageVideo,
            IconSymbol.Microphone => Microphone,
            IconSymbol.MicrophoneOff => MicrophoneOff,
            IconSymbol.MicrophoneOutline => MicrophoneOutline,
            IconSymbol.MicrophoneSettings => MicrophoneSettings,
            IconSymbol.MicrophoneVariant => MicrophoneVariant,
            IconSymbol.MicrophoneVariantOff => MicrophoneVariantOff,
            IconSymbol.Microsoft => Microsoft,
            IconSymbol.Minecraft => Minecraft,
            IconSymbol.Minus => Minus,
            IconSymbol.MinusBox => MinusBox,
            IconSymbol.MinusCircle => MinusCircle,
            IconSymbol.MinusCircleOutline => MinusCircleOutline,
            IconSymbol.MinusNetwork => MinusNetwork,
            IconSymbol.Monitor => Monitor,
            IconSymbol.MonitorMultiple => MonitorMultiple,
            IconSymbol.More => More,
            IconSymbol.Motorbike => Motorbike,
            IconSymbol.Mouse => Mouse,
            IconSymbol.MouseOff => MouseOff,
            IconSymbol.MouseVariant => MouseVariant,
            IconSymbol.MouseVariantOff => MouseVariantOff,
            IconSymbol.Movie => Movie,
            IconSymbol.Multiplication => Multiplication,
            IconSymbol.MultiplicationBox => MultiplicationBox,
            IconSymbol.MusicBox => MusicBox,
            IconSymbol.MusicBoxOutline => MusicBoxOutline,
            IconSymbol.MusicCircle => MusicCircle,
            IconSymbol.MusicNote => MusicNote,
            IconSymbol.MusicNoteHalf => MusicNoteHalf,
            IconSymbol.MusicNoteOff => MusicNoteOff,
            IconSymbol.MusicNoteQuarter => MusicNoteQuarter,
            IconSymbol.MusicNoteSixteenth => MusicNoteSixteenth,
            IconSymbol.MusicNoteWhole => MusicNoteWhole,
            IconSymbol.Nature => Nature,
            IconSymbol.NaturePeople => NaturePeople,
            IconSymbol.Navigation => Navigation,
            IconSymbol.Needle => Needle,
            IconSymbol.SmokeDetector => SmokeDetector,
            IconSymbol.Thermostat => Thermostat,
            IconSymbol.NewBox => NewBox,
            IconSymbol.Newspaper => Newspaper,
            IconSymbol.Nfc => Nfc,
            IconSymbol.NfcTap => NfcTap,
            IconSymbol.NfcVariant => NfcVariant,
            IconSymbol.Nodejs => Nodejs,
            IconSymbol.Note => Note,
            IconSymbol.NoteOutline => NoteOutline,
            IconSymbol.NotePlus => NotePlus,
            IconSymbol.NotePlusOutline => NotePlusOutline,
            IconSymbol.NoteText => NoteText,
            IconSymbol.NotificationClearAll => NotificationClearAll,
            IconSymbol.Numeric => Numeric,
            IconSymbol.Numeric0Box => Numeric0Box,
            IconSymbol.Numeric0BoxMultipleOutline => Numeric0BoxMultipleOutline,
            IconSymbol.Numeric0BoxOutline => Numeric0BoxOutline,
            IconSymbol.Numeric1Box => Numeric1Box,
            IconSymbol.Numeric1BoxMultipleOutline => Numeric1BoxMultipleOutline,
            IconSymbol.Numeric1BoxOutline => Numeric1BoxOutline,
            IconSymbol.Numeric2Box => Numeric2Box,
            IconSymbol.Numeric2BoxMultipleOutline => Numeric2BoxMultipleOutline,
            IconSymbol.Numeric2BoxOutline => Numeric2BoxOutline,
            IconSymbol.Numeric3Box => Numeric3Box,
            IconSymbol.Numeric3BoxMultipleOutline => Numeric3BoxMultipleOutline,
            IconSymbol.Numeric3BoxOutline => Numeric3BoxOutline,
            IconSymbol.Numeric4Box => Numeric4Box,
            IconSymbol.Numeric4BoxOutline => Numeric4BoxOutline,
            IconSymbol.Numeric5BoxMultipleOutline => Numeric5BoxMultipleOutline,
            IconSymbol.Numeric5BoxOutline => Numeric5BoxOutline,
            IconSymbol.Numeric5Box => Numeric5Box,
            IconSymbol.Numeric4BoxMultipleOutline => Numeric4BoxMultipleOutline,
            IconSymbol.Numeric6Box => Numeric6Box,
            IconSymbol.Numeric6BoxMultipleOutline => Numeric6BoxMultipleOutline,
            IconSymbol.Numeric6BoxOutline => Numeric6BoxOutline,
            IconSymbol.Numeric7Box => Numeric7Box,
            IconSymbol.Numeric7BoxMultipleOutline => Numeric7BoxMultipleOutline,
            IconSymbol.Numeric7BoxOutline => Numeric7BoxOutline,
            IconSymbol.Numeric8Box => Numeric8Box,
            IconSymbol.Numeric8BoxMultipleOutline => Numeric8BoxMultipleOutline,
            IconSymbol.Numeric8BoxOutline => Numeric8BoxOutline,
            IconSymbol.Numeric9Box => Numeric9Box,
            IconSymbol.Numeric9BoxMultipleOutline => Numeric9BoxMultipleOutline,
            IconSymbol.Numeric9BoxOutline => Numeric9BoxOutline,
            IconSymbol.Numeric9PlusBox => Numeric9PlusBox,
            IconSymbol.Numeric9PlusBoxMultipleOutline => Numeric9PlusBoxMultipleOutline,
            IconSymbol.Numeric9PlusBoxOutline => Numeric9PlusBoxOutline,
            IconSymbol.Nutrition => Nutrition,
            IconSymbol.Octagon => Octagon,
            IconSymbol.OctagonOutline => OctagonOutline,
            IconSymbol.Odnoklassniki => Odnoklassniki,
            IconSymbol.MicrosoftOffice => MicrosoftOffice,
            IconSymbol.Oil => Oil,
            IconSymbol.CoolantTemperature => CoolantTemperature,
            IconSymbol.Omega => Omega,
            IconSymbol.MicrosoftOnedrive => MicrosoftOnedrive,
            IconSymbol.OpenInApp => OpenInApp,
            IconSymbol.OpenInNew => OpenInNew,
            IconSymbol.Openid => Openid,
            IconSymbol.Opera => Opera,
            IconSymbol.Ornament => Ornament,
            IconSymbol.OrnamentVariant => OrnamentVariant,
            IconSymbol.InboxArrowUp => InboxArrowUp,
            IconSymbol.Owl => Owl,
            IconSymbol.Package => Package,
            IconSymbol.PackageDown => PackageDown,
            IconSymbol.PackageUp => PackageUp,
            IconSymbol.PackageVariant => PackageVariant,
            IconSymbol.PackageVariantClosed => PackageVariantClosed,
            IconSymbol.Palette => Palette,
            IconSymbol.PaletteAdvanced => PaletteAdvanced,
            IconSymbol.Panda => Panda,
            IconSymbol.Pandora => Pandora,
            IconSymbol.Panorama => Panorama,
            IconSymbol.PanoramaFisheye => PanoramaFisheye,
            IconSymbol.PanoramaHorizontalOutline => PanoramaHorizontalOutline,
            IconSymbol.PanoramaVerticalOutline => PanoramaVerticalOutline,
            IconSymbol.PanoramaWideAngleOutline => PanoramaWideAngleOutline,
            IconSymbol.PaperCutVertical => PaperCutVertical,
            IconSymbol.Paperclip => Paperclip,
            IconSymbol.Parking => Parking,
            IconSymbol.Pause => Pause,
            IconSymbol.PauseCircle => PauseCircle,
            IconSymbol.PauseCircleOutline => PauseCircleOutline,
            IconSymbol.PauseOctagon => PauseOctagon,
            IconSymbol.PauseOctagonOutline => PauseOctagonOutline,
            IconSymbol.Paw => Paw,
            IconSymbol.Pen => Pen,
            IconSymbol.Pencil => Pencil,
            IconSymbol.PencilBox => PencilBox,
            IconSymbol.PencilBoxOutline => PencilBoxOutline,
            IconSymbol.PencilLock => PencilLock,
            IconSymbol.PencilOff => PencilOff,
            IconSymbol.Percent => Percent,
            IconSymbol.MortarPestlePlus => MortarPestlePlus,
            IconSymbol.Phone => Phone,
            IconSymbol.PhoneBluetooth => PhoneBluetooth,
            IconSymbol.PhoneForward => PhoneForward,
            IconSymbol.PhoneHangup => PhoneHangup,
            IconSymbol.PhoneInTalk => PhoneInTalk,
            IconSymbol.PhoneIncoming => PhoneIncoming,
            IconSymbol.PhoneLock => PhoneLock,
            IconSymbol.PhoneLog => PhoneLog,
            IconSymbol.PhoneMissed => PhoneMissed,
            IconSymbol.PhoneOutgoing => PhoneOutgoing,
            IconSymbol.PhonePaused => PhonePaused,
            IconSymbol.PhoneSettings => PhoneSettings,
            IconSymbol.PhoneVoip => PhoneVoip,
            IconSymbol.Pi => Pi,
            IconSymbol.PiBox => PiBox,
            IconSymbol.Pig => Pig,
            IconSymbol.Pill => Pill,
            IconSymbol.Pin => Pin,
            IconSymbol.PinOff => PinOff,
            IconSymbol.PineTree => PineTree,
            IconSymbol.PineTreeBox => PineTreeBox,
            IconSymbol.Pinterest => Pinterest,
            IconSymbol.ContactlessPaymentCircleOutline => ContactlessPaymentCircleOutline,
            IconSymbol.Pizza => Pizza,
            IconSymbol.Play => Play,
            IconSymbol.PlayBoxOutline => PlayBoxOutline,
            IconSymbol.PlayCircle => PlayCircle,
            IconSymbol.PlayCircleOutline => PlayCircleOutline,
            IconSymbol.PlayPause => PlayPause,
            IconSymbol.PlayProtectedContent => PlayProtectedContent,
            IconSymbol.PlaylistMinus => PlaylistMinus,
            IconSymbol.PlaylistPlay => PlaylistPlay,
            IconSymbol.PlaylistPlus => PlaylistPlus,
            IconSymbol.PlaylistRemove => PlaylistRemove,
            IconSymbol.SonyPlaystation => SonyPlaystation,
            IconSymbol.Plus => Plus,
            IconSymbol.PlusBox => PlusBox,
            IconSymbol.PlusCircle => PlusCircle,
            IconSymbol.PlusCircleMultipleOutline => PlusCircleMultipleOutline,
            IconSymbol.PlusCircleOutline => PlusCircleOutline,
            IconSymbol.PlusNetwork => PlusNetwork,
            IconSymbol.Sledding => Sledding,
            IconSymbol.WallSconceFlatVariant => WallSconceFlatVariant,
            IconSymbol.Pokeball => Pokeball,
            IconSymbol.Polaroid => Polaroid,
            IconSymbol.Poll => Poll,
            IconSymbol.AccountEye => AccountEye,
            IconSymbol.Polymer => Polymer,
            IconSymbol.Popcorn => Popcorn,
            IconSymbol.Pound => Pound,
            IconSymbol.PoundBox => PoundBox,
            IconSymbol.Power => Power,
            IconSymbol.PowerSettings => PowerSettings,
            IconSymbol.PowerSocket => PowerSocket,
            IconSymbol.Presentation => Presentation,
            IconSymbol.PresentationPlay => PresentationPlay,
            IconSymbol.Printer => Printer,
            IconSymbol.Printer3d => Printer3d,
            IconSymbol.PrinterAlert => PrinterAlert,
            IconSymbol.ProfessionalHexagon => ProfessionalHexagon,
            IconSymbol.Projector => Projector,
            IconSymbol.ProjectorScreen => ProjectorScreen,
            IconSymbol.Pulse => Pulse,
            IconSymbol.Puzzle => Puzzle,
            IconSymbol.Qrcode => Qrcode,
            IconSymbol.QrcodeScan => QrcodeScan,
            IconSymbol.Quadcopter => Quadcopter,
            IconSymbol.QualityHigh => QualityHigh,
            IconSymbol.BookMultipleOutline => BookMultipleOutline,
            IconSymbol.Radar => Radar,
            IconSymbol.Radiator => Radiator,
            IconSymbol.Radio => Radio,
            IconSymbol.RadioHandheld => RadioHandheld,
            IconSymbol.RadioTower => RadioTower,
            IconSymbol.Radioactive => Radioactive,
            IconSymbol.RadioboxMarked => RadioboxMarked,
            IconSymbol.RaspberryPi => RaspberryPi,
            IconSymbol.RayEnd => RayEnd,
            IconSymbol.RayEndArrow => RayEndArrow,
            IconSymbol.RayStart => RayStart,
            IconSymbol.RayStartArrow => RayStartArrow,
            IconSymbol.RayStartEnd => RayStartEnd,
            IconSymbol.RayVertex => RayVertex,
            IconSymbol.Lastpass => Lastpass,
            IconSymbol.Read => Read,
            IconSymbol.YoutubeTv => YoutubeTv,
            IconSymbol.ReceiptText => ReceiptText,
            IconSymbol.Record => Record,
            IconSymbol.RecordRec => RecordRec,
            IconSymbol.Recycle => Recycle,
            IconSymbol.Reddit => Reddit,
            IconSymbol.Redo => Redo,
            IconSymbol.RedoVariant => RedoVariant,
            IconSymbol.Refresh => Refresh,
            IconSymbol.Regex => Regex,
            IconSymbol.RelativeScale => RelativeScale,
            IconSymbol.Reload => Reload,
            IconSymbol.Remote => Remote,
            IconSymbol.RenameBox => RenameBox,
            IconSymbol.Repeat => Repeat,
            IconSymbol.RepeatOff => RepeatOff,
            IconSymbol.RepeatOnce => RepeatOnce,
            IconSymbol.Replay => Replay,
            IconSymbol.Reply => Reply,
            IconSymbol.ReplyAll => ReplyAll,
            IconSymbol.Reproduction => Reproduction,
            IconSymbol.ResizeBottomRight => ResizeBottomRight,
            IconSymbol.Responsive => Responsive,
            IconSymbol.Rewind => Rewind,
            IconSymbol.Ribbon => Ribbon,
            IconSymbol.Road => Road,
            IconSymbol.RoadVariant => RoadVariant,
            IconSymbol.Rocket => Rocket,
            IconSymbol.Rotate3dVariant => Rotate3dVariant,
            IconSymbol.RotateLeft => RotateLeft,
            IconSymbol.RotateLeftVariant => RotateLeftVariant,
            IconSymbol.RotateRight => RotateRight,
            IconSymbol.RotateRightVariant => RotateRightVariant,
            IconSymbol.RouterWireless => RouterWireless,
            IconSymbol.Routes => Routes,
            IconSymbol.Rss => Rss,
            IconSymbol.RssBox => RssBox,
            IconSymbol.Ruler => Ruler,
            IconSymbol.RunFast => RunFast,
            IconSymbol.Sale => Sale,
            IconSymbol.Satellite => Satellite,
            IconSymbol.SatelliteVariant => SatelliteVariant,
            IconSymbol.Scale => Scale,
            IconSymbol.ScaleBathroom => ScaleBathroom,
            IconSymbol.School => School,
            IconSymbol.ScreenRotation => ScreenRotation,
            IconSymbol.Screwdriver => Screwdriver,
            IconSymbol.ScriptOutline => ScriptOutline,
            IconSymbol.ScreenRotationLock => ScreenRotationLock,
            IconSymbol.Sd => Sd,
            IconSymbol.Seal => Seal,
            IconSymbol.SeatFlat => SeatFlat,
            IconSymbol.SeatFlatAngled => SeatFlatAngled,
            IconSymbol.SeatIndividualSuite => SeatIndividualSuite,
            IconSymbol.SeatLegroomExtra => SeatLegroomExtra,
            IconSymbol.SeatLegroomNormal => SeatLegroomNormal,
            IconSymbol.SeatLegroomReduced => SeatLegroomReduced,
            IconSymbol.SeatReclineExtra => SeatReclineExtra,
            IconSymbol.SeatReclineNormal => SeatReclineNormal,
            IconSymbol.Security => Security,
            IconSymbol.SecurityNetwork => SecurityNetwork,
            IconSymbol.Select => Select,
            IconSymbol.SelectAll => SelectAll,
            IconSymbol.SelectInverse => SelectInverse,
            IconSymbol.SelectOff => SelectOff,
            IconSymbol.Selection => Selection,
            IconSymbol.Send => Send,
            IconSymbol.Server => Server,
            IconSymbol.ServerMinus => ServerMinus,
            IconSymbol.ServerNetwork => ServerNetwork,
            IconSymbol.ServerNetworkOff => ServerNetworkOff,
            IconSymbol.ServerOff => ServerOff,
            IconSymbol.ServerPlus => ServerPlus,
            IconSymbol.ServerRemove => ServerRemove,
            IconSymbol.ServerSecurity => ServerSecurity,
            IconSymbol.Cog => Cog,
            IconSymbol.CogBox => CogBox,
            IconSymbol.ShapePlus => ShapePlus,
            IconSymbol.Share => Share,
            IconSymbol.ShareVariant => ShareVariant,
            IconSymbol.Shield => Shield,
            IconSymbol.ShieldOutline => ShieldOutline,
            IconSymbol.Shopping => Shopping,
            IconSymbol.ShoppingMusic => ShoppingMusic,
            IconSymbol.Shredder => Shredder,
            IconSymbol.Shuffle => Shuffle,
            IconSymbol.ShuffleDisabled => ShuffleDisabled,
            IconSymbol.ShuffleVariant => ShuffleVariant,
            IconSymbol.Sigma => Sigma,
            IconSymbol.SignCaution => SignCaution,
            IconSymbol.Signal => Signal,
            IconSymbol.Silverware => Silverware,
            IconSymbol.SilverwareFork => SilverwareFork,
            IconSymbol.SilverwareSpoon => SilverwareSpoon,
            IconSymbol.SilverwareVariant => SilverwareVariant,
            IconSymbol.Sim => Sim,
            IconSymbol.SimAlert => SimAlert,
            IconSymbol.SimOff => SimOff,
            IconSymbol.Sitemap => Sitemap,
            IconSymbol.SkipBackward => SkipBackward,
            IconSymbol.SkipForward => SkipForward,
            IconSymbol.SkipNext => SkipNext,
            IconSymbol.SkipPrevious => SkipPrevious,
            IconSymbol.Skype => Skype,
            IconSymbol.SkypeBusiness => SkypeBusiness,
            IconSymbol.Slack => Slack,
            IconSymbol.Sleep => Sleep,
            IconSymbol.SleepOff => SleepOff,
            IconSymbol.Smoking => Smoking,
            IconSymbol.SmokingOff => SmokingOff,
            IconSymbol.Snapchat => Snapchat,
            IconSymbol.Snowman => Snowman,
            IconSymbol.Soccer => Soccer,
            IconSymbol.Sofa => Sofa,
            IconSymbol.Sort => Sort,
            IconSymbol.SortAlphabeticalVariant => SortAlphabeticalVariant,
            IconSymbol.SortAscending => SortAscending,
            IconSymbol.SortDescending => SortDescending,
            IconSymbol.SortNumericVariant => SortNumericVariant,
            IconSymbol.SortVariant => SortVariant,
            IconSymbol.Soundcloud => Soundcloud,
            IconSymbol.SourceFork => SourceFork,
            IconSymbol.SourcePull => SourcePull,
            IconSymbol.Speaker => Speaker,
            IconSymbol.SpeakerOff => SpeakerOff,
            IconSymbol.Speedometer => Speedometer,
            IconSymbol.Spellcheck => Spellcheck,
            IconSymbol.Spotify => Spotify,
            IconSymbol.Spotlight => Spotlight,
            IconSymbol.SpotlightBeam => SpotlightBeam,
            IconSymbol.BookRemoveMultipleOutline => BookRemoveMultipleOutline,
            IconSymbol.AccountSwitchOutline => AccountSwitchOutline,
            IconSymbol.StackOverflow => StackOverflow,
            IconSymbol.Stairs => Stairs,
            IconSymbol.Star => Star,
            IconSymbol.StarCircle => StarCircle,
            IconSymbol.StarHalfFull => StarHalfFull,
            IconSymbol.StarOff => StarOff,
            IconSymbol.StarOutline => StarOutline,
            IconSymbol.Steam => Steam,
            IconSymbol.Steering => Steering,
            IconSymbol.StepBackward => StepBackward,
            IconSymbol.StepBackward2 => StepBackward2,
            IconSymbol.StepForward => StepForward,
            IconSymbol.StepForward2 => StepForward2,
            IconSymbol.Stethoscope => Stethoscope,
            IconSymbol.Stocking => Stocking,
            IconSymbol.Stop => Stop,
            IconSymbol.Store => Store,
            IconSymbol.Store24Hour => Store24Hour,
            IconSymbol.Stove => Stove,
            IconSymbol.SubwayVariant => SubwayVariant,
            IconSymbol.Sunglasses => Sunglasses,
            IconSymbol.SwapHorizontal => SwapHorizontal,
            IconSymbol.SwapVertical => SwapVertical,
            IconSymbol.Swim => Swim,
            IconSymbol.Switch => Switch,
            IconSymbol.Sword => Sword,
            IconSymbol.Sync => Sync,
            IconSymbol.SyncAlert => SyncAlert,
            IconSymbol.SyncOff => SyncOff,
            IconSymbol.Tab => Tab,
            IconSymbol.TabUnselected => TabUnselected,
            IconSymbol.Table => Table,
            IconSymbol.TableColumnPlusAfter => TableColumnPlusAfter,
            IconSymbol.TableColumnPlusBefore => TableColumnPlusBefore,
            IconSymbol.TableColumnRemove => TableColumnRemove,
            IconSymbol.TableColumnWidth => TableColumnWidth,
            IconSymbol.TableEdit => TableEdit,
            IconSymbol.TableLarge => TableLarge,
            IconSymbol.TableRowHeight => TableRowHeight,
            IconSymbol.TableRowPlusAfter => TableRowPlusAfter,
            IconSymbol.TableRowPlusBefore => TableRowPlusBefore,
            IconSymbol.TableRowRemove => TableRowRemove,
            IconSymbol.Tablet => Tablet,
            IconSymbol.ReceiptOutline => ReceiptOutline,
            IconSymbol.Tangram => Tangram,
            IconSymbol.Tag => Tag,
            IconSymbol.TagFaces => TagFaces,
            IconSymbol.TagMultiple => TagMultiple,
            IconSymbol.TagOutline => TagOutline,
            IconSymbol.TagTextOutline => TagTextOutline,
            IconSymbol.Target => Target,
            IconSymbol.Taxi => Taxi,
            IconSymbol.Teamviewer => Teamviewer,
            IconSymbol.Skateboarding => Skateboarding,
            IconSymbol.Television => Television,
            IconSymbol.TelevisionGuide => TelevisionGuide,
            IconSymbol.TemperatureCelsius => TemperatureCelsius,
            IconSymbol.TemperatureFahrenheit => TemperatureFahrenheit,
            IconSymbol.TemperatureKelvin => TemperatureKelvin,
            IconSymbol.TennisBall => TennisBall,
            IconSymbol.Tent => Tent,
            IconSymbol.MicrophoneMessage => MicrophoneMessage,
            IconSymbol.MicrophoneMessageOff => MicrophoneMessageOff,
            IconSymbol.Texture => Texture,
            IconSymbol.Theater => Theater,
            IconSymbol.ThemeLightDark => ThemeLightDark,
            IconSymbol.Thermometer => Thermometer,
            IconSymbol.ThermometerLines => ThermometerLines,
            IconSymbol.ThumbDown => ThumbDown,
            IconSymbol.ThumbDownOutline => ThumbDownOutline,
            IconSymbol.ThumbUp => ThumbUp,
            IconSymbol.ThumbUpOutline => ThumbUpOutline,
            IconSymbol.ThumbsUpDown => ThumbsUpDown,
            IconSymbol.Ticket => Ticket,
            IconSymbol.TicketAccount => TicketAccount,
            IconSymbol.TicketConfirmation => TicketConfirmation,
            IconSymbol.Tie => Tie,
            IconSymbol.Timelapse => Timelapse,
            IconSymbol.TimerOutline => TimerOutline,
            IconSymbol.Timer10 => Timer10,
            IconSymbol.Timer3 => Timer3,
            IconSymbol.TimerOffOutline => TimerOffOutline,
            IconSymbol.TimerSand => TimerSand,
            IconSymbol.Timetable => Timetable,
            IconSymbol.ToggleSwitch => ToggleSwitch,
            IconSymbol.ToggleSwitchOff => ToggleSwitchOff,
            IconSymbol.Tooltip => Tooltip,
            IconSymbol.TooltipEdit => TooltipEdit,
            IconSymbol.TooltipImage => TooltipImage,
            IconSymbol.TooltipOutline => TooltipOutline,
            IconSymbol.TooltipPlusOutline => TooltipPlusOutline,
            IconSymbol.TooltipText => TooltipText,
            IconSymbol.ToothOutline => ToothOutline,
            IconSymbol.CloudRefresh => CloudRefresh,
            IconSymbol.TrafficLight => TrafficLight,
            IconSymbol.Train => Train,
            IconSymbol.Tram => Tram,
            IconSymbol.Transcribe => Transcribe,
            IconSymbol.TranscribeClose => TranscribeClose,
            IconSymbol.TransferRight => TransferRight,
            IconSymbol.Tree => Tree,
            IconSymbol.Trello => Trello,
            IconSymbol.TrendingDown => TrendingDown,
            IconSymbol.TrendingNeutral => TrendingNeutral,
            IconSymbol.TrendingUp => TrendingUp,
            IconSymbol.Triangle => Triangle,
            IconSymbol.TriangleOutline => TriangleOutline,
            IconSymbol.Trophy => Trophy,
            IconSymbol.TrophyAward => TrophyAward,
            IconSymbol.TrophyOutline => TrophyOutline,
            IconSymbol.TrophyVariant => TrophyVariant,
            IconSymbol.TrophyVariantOutline => TrophyVariantOutline,
            IconSymbol.Truck => Truck,
            IconSymbol.TruckDelivery => TruckDelivery,
            IconSymbol.TshirtCrewOutline => TshirtCrewOutline,
            IconSymbol.TshirtVOutline => TshirtVOutline,
            IconSymbol.FileRefreshOutline => FileRefreshOutline,
            IconSymbol.FolderRefreshOutline => FolderRefreshOutline,
            IconSymbol.Twitch => Twitch,
            IconSymbol.Twitter => Twitter,
            IconSymbol.OrderNumericAscending => OrderNumericAscending,
            IconSymbol.OrderNumericDescending => OrderNumericDescending,
            IconSymbol.RepeatVariant => RepeatVariant,
            IconSymbol.Ubuntu => Ubuntu,
            IconSymbol.Umbraco => Umbraco,
            IconSymbol.Umbrella => Umbrella,
            IconSymbol.UmbrellaOutline => UmbrellaOutline,
            IconSymbol.Undo => Undo,
            IconSymbol.UndoVariant => UndoVariant,
            IconSymbol.UnfoldLessHorizontal => UnfoldLessHorizontal,
            IconSymbol.UnfoldMoreHorizontal => UnfoldMoreHorizontal,
            IconSymbol.Ungroup => Ungroup,
            IconSymbol.WebRemove => WebRemove,
            IconSymbol.Upload => Upload,
            IconSymbol.Usb => Usb,
            IconSymbol.VectorArrangeAbove => VectorArrangeAbove,
            IconSymbol.VectorArrangeBelow => VectorArrangeBelow,
            IconSymbol.VectorCircle => VectorCircle,
            IconSymbol.VectorCircleVariant => VectorCircleVariant,
            IconSymbol.VectorCombine => VectorCombine,
            IconSymbol.VectorCurve => VectorCurve,
            IconSymbol.VectorDifference => VectorDifference,
            IconSymbol.VectorDifferenceAb => VectorDifferenceAb,
            IconSymbol.VectorDifferenceBa => VectorDifferenceBa,
            IconSymbol.VectorIntersection => VectorIntersection,
            IconSymbol.VectorLine => VectorLine,
            IconSymbol.VectorPointSelect => VectorPointSelect,
            IconSymbol.VectorPolygon => VectorPolygon,
            IconSymbol.VectorPolyline => VectorPolyline,
            IconSymbol.VectorSelection => VectorSelection,
            IconSymbol.VectorTriangle => VectorTriangle,
            IconSymbol.VectorUnion => VectorUnion,
            IconSymbol.ShieldCheck => ShieldCheck,
            IconSymbol.Vibrate => Vibrate,
            IconSymbol.Video => Video,
            IconSymbol.VideoOff => VideoOff,
            IconSymbol.VideoSwitch => VideoSwitch,
            IconSymbol.ViewAgenda => ViewAgenda,
            IconSymbol.ViewArray => ViewArray,
            IconSymbol.ViewCarousel => ViewCarousel,
            IconSymbol.ViewColumn => ViewColumn,
            IconSymbol.ViewDashboard => ViewDashboard,
            IconSymbol.ViewDay => ViewDay,
            IconSymbol.ViewGrid => ViewGrid,
            IconSymbol.ViewHeadline => ViewHeadline,
            IconSymbol.ViewList => ViewList,
            IconSymbol.ViewModule => ViewModule,
            IconSymbol.ViewQuilt => ViewQuilt,
            IconSymbol.ViewStream => ViewStream,
            IconSymbol.ViewWeek => ViewWeek,
            IconSymbol.Vimeo => Vimeo,
            IconSymbol.Buffet => Buffet,
            IconSymbol.HandsPray => HandsPray,
            IconSymbol.CreditCardWirelessOff => CreditCardWirelessOff,
            IconSymbol.CreditCardWirelessOffOutline => CreditCardWirelessOffOutline,
            IconSymbol.Vlc => Vlc,
            IconSymbol.Voicemail => Voicemail,
            IconSymbol.VolumeHigh => VolumeHigh,
            IconSymbol.VolumeLow => VolumeLow,
            IconSymbol.VolumeMedium => VolumeMedium,
            IconSymbol.VolumeOff => VolumeOff,
            IconSymbol.Vpn => Vpn,
            IconSymbol.Walk => Walk,
            IconSymbol.Wallet => Wallet,
            IconSymbol.WalletGiftcard => WalletGiftcard,
            IconSymbol.WalletMembership => WalletMembership,
            IconSymbol.WalletTravel => WalletTravel,
            IconSymbol.Wan => Wan,
            IconSymbol.Watch => Watch,
            IconSymbol.WatchExport => WatchExport,
            IconSymbol.WatchImport => WatchImport,
            IconSymbol.Water => Water,
            IconSymbol.WaterOff => WaterOff,
            IconSymbol.WaterPercent => WaterPercent,
            IconSymbol.WaterPump => WaterPump,
            IconSymbol.WeatherCloudy => WeatherCloudy,
            IconSymbol.WeatherFog => WeatherFog,
            IconSymbol.WeatherHail => WeatherHail,
            IconSymbol.WeatherLightning => WeatherLightning,
            IconSymbol.WeatherNight => WeatherNight,
            IconSymbol.WeatherPartlyCloudy => WeatherPartlyCloudy,
            IconSymbol.WeatherPouring => WeatherPouring,
            IconSymbol.WeatherRainy => WeatherRainy,
            IconSymbol.WeatherSnowy => WeatherSnowy,
            IconSymbol.WeatherSunny => WeatherSunny,
            IconSymbol.WeatherSunset => WeatherSunset,
            IconSymbol.WeatherSunsetDown => WeatherSunsetDown,
            IconSymbol.WeatherSunsetUp => WeatherSunsetUp,
            IconSymbol.WeatherWindy => WeatherWindy,
            IconSymbol.WeatherWindyVariant => WeatherWindyVariant,
            IconSymbol.Web => Web,
            IconSymbol.Webcam => Webcam,
            IconSymbol.Weight => Weight,
            IconSymbol.WeightKilogram => WeightKilogram,
            IconSymbol.Whatsapp => Whatsapp,
            IconSymbol.WheelchairAccessibility => WheelchairAccessibility,
            IconSymbol.WhiteBalanceAuto => WhiteBalanceAuto,
            IconSymbol.WhiteBalanceIncandescent => WhiteBalanceIncandescent,
            IconSymbol.WhiteBalanceIridescent => WhiteBalanceIridescent,
            IconSymbol.WhiteBalanceSunny => WhiteBalanceSunny,
            IconSymbol.Wifi => Wifi,
            IconSymbol.WifiOff => WifiOff,
            IconSymbol.NintendoWii => NintendoWii,
            IconSymbol.Wikipedia => Wikipedia,
            IconSymbol.WindowClose => WindowClose,
            IconSymbol.WindowClosed => WindowClosed,
            IconSymbol.WindowMaximize => WindowMaximize,
            IconSymbol.WindowMinimize => WindowMinimize,
            IconSymbol.WindowOpen => WindowOpen,
            IconSymbol.WindowRestore => WindowRestore,
            IconSymbol.MicrosoftWindows => MicrosoftWindows,
            IconSymbol.Wordpress => Wordpress,
            IconSymbol.AccountHardHat => AccountHardHat,
            IconSymbol.Wrap => Wrap,
            IconSymbol.Wrench => Wrench,
            IconSymbol.ContactsOutline => ContactsOutline,
            IconSymbol.MicrosoftXbox => MicrosoftXbox,
            IconSymbol.MicrosoftXboxController => MicrosoftXboxController,
            IconSymbol.MicrosoftXboxControllerOff => MicrosoftXboxControllerOff,
            IconSymbol.TableFurniture => TableFurniture,
            IconSymbol.SortAlphabeticalAscending => SortAlphabeticalAscending,
            IconSymbol.Firewire => Firewire,
            IconSymbol.SortAlphabeticalDescending => SortAlphabeticalDescending,
            IconSymbol.Xml => Xml,
            IconSymbol.Yeast => Yeast,
            IconSymbol.DatabaseRefresh => DatabaseRefresh,
            IconSymbol.Youtube => Youtube,
            IconSymbol.ZipBox => ZipBox,
            IconSymbol.SurroundSound => SurroundSound,
            IconSymbol.VectorRectangle => VectorRectangle,
            IconSymbol.PlaylistCheck => PlaylistCheck,
            IconSymbol.FormatLineStyle => FormatLineStyle,
            IconSymbol.FormatLineWeight => FormatLineWeight,
            IconSymbol.Translate => Translate,
            IconSymbol.AccountVoice => AccountVoice,
            IconSymbol.Opacity => Opacity,
            IconSymbol.NearMe => NearMe,
            IconSymbol.ClockAlertOutline => ClockAlertOutline,
            IconSymbol.HumanPregnant => HumanPregnant,
            IconSymbol.StickerCircleOutline => StickerCircleOutline,
            IconSymbol.ScaleBalance => ScaleBalance,
            IconSymbol.CardAccountDetails => CardAccountDetails,
            IconSymbol.AccountMultipleMinus => AccountMultipleMinus,
            IconSymbol.AirplaneLanding => AirplaneLanding,
            IconSymbol.AirplaneTakeoff => AirplaneTakeoff,
            IconSymbol.AlertCircleOutline => AlertCircleOutline,
            IconSymbol.Altimeter => Altimeter,
            IconSymbol.Animation => Animation,
            IconSymbol.BookMinus => BookMinus,
            IconSymbol.BookOpenPageVariant => BookOpenPageVariant,
            IconSymbol.BookPlus => BookPlus,
            IconSymbol.Boombox => Boombox,
            IconSymbol.Bullseye => Bullseye,
            IconSymbol.CommentRemove => CommentRemove,
            IconSymbol.CameraOff => CameraOff,
            IconSymbol.CheckCircle => CheckCircle,
            IconSymbol.CheckCircleOutline => CheckCircleOutline,
            IconSymbol.Candle => Candle,
            IconSymbol.ChartBubble => ChartBubble,
            IconSymbol.CreditCardOffOutline => CreditCardOffOutline,
            IconSymbol.CupOff => CupOff,
            IconSymbol.Copyright => Copyright,
            IconSymbol.CursorText => CursorText,
            IconSymbol.DeleteForever => DeleteForever,
            IconSymbol.DeleteSweep => DeleteSweep,
            IconSymbol.DiceD20Outline => DiceD20Outline,
            IconSymbol.DiceD4Outline => DiceD4Outline,
            IconSymbol.DiceD8Outline => DiceD8Outline,
            IconSymbol.DiceD6Outline => DiceD6Outline,
            IconSymbol.Disc => Disc,
            IconSymbol.EmailOpenOutline => EmailOpenOutline,
            IconSymbol.EmailVariant => EmailVariant,
            IconSymbol.EvStation => EvStation,
            IconSymbol.FoodForkDrink => FoodForkDrink,
            IconSymbol.FoodOff => FoodOff,
            IconSymbol.FormatTitle => FormatTitle,
            IconSymbol.GoogleMaps => GoogleMaps,
            IconSymbol.HeartPulse => HeartPulse,
            IconSymbol.Highway => Highway,
            IconSymbol.HomeMapMarker => HomeMapMarker,
            IconSymbol.Incognito => Incognito,
            IconSymbol.Kettle => Kettle,
            IconSymbol.LockPlus => LockPlus,
            IconSymbol.LogoutVariant => LogoutVariant,
            IconSymbol.MusicNoteBluetooth => MusicNoteBluetooth,
            IconSymbol.MusicNoteBluetoothOff => MusicNoteBluetoothOff,
            IconSymbol.PageFirst => PageFirst,
            IconSymbol.PageLast => PageLast,
            IconSymbol.PhoneClassic => PhoneClassic,
            IconSymbol.PriorityHigh => PriorityHigh,
            IconSymbol.PriorityLow => PriorityLow,
            IconSymbol.Qqchat => Qqchat,
            IconSymbol.Pool => Pool,
            IconSymbol.RoundedCorner => RoundedCorner,
            IconSymbol.Rowing => Rowing,
            IconSymbol.Saxophone => Saxophone,
            IconSymbol.SignalVariant => SignalVariant,
            IconSymbol.StackExchange => StackExchange,
            IconSymbol.SubdirectoryArrowLeft => SubdirectoryArrowLeft,
            IconSymbol.SubdirectoryArrowRight => SubdirectoryArrowRight,
            IconSymbol.FormTextbox => FormTextbox,
            IconSymbol.Violin => Violin,
            IconSymbol.MicrosoftVisualStudio => MicrosoftVisualStudio,
            IconSymbol.Wechat => Wechat,
            IconSymbol.Watermark => Watermark,
            IconSymbol.FileHidden => FileHidden,
            IconSymbol.ApplicationOutline => ApplicationOutline,
            IconSymbol.ArrowCollapse => ArrowCollapse,
            IconSymbol.ArrowExpand => ArrowExpand,
            IconSymbol.BowlMix => BowlMix,
            IconSymbol.Bridge => Bridge,
            IconSymbol.ApplicationEditOutline => ApplicationEditOutline,
            IconSymbol.Chip => Chip,
            IconSymbol.ContentSaveSettings => ContentSaveSettings,
            IconSymbol.Dialpad => Dialpad,
            IconSymbol.BookAlphabet => BookAlphabet,
            IconSymbol.FormatHorizontalAlignCenter => FormatHorizontalAlignCenter,
            IconSymbol.FormatHorizontalAlignLeft => FormatHorizontalAlignLeft,
            IconSymbol.FormatHorizontalAlignRight => FormatHorizontalAlignRight,
            IconSymbol.FormatVerticalAlignBottom => FormatVerticalAlignBottom,
            IconSymbol.FormatVerticalAlignCenter => FormatVerticalAlignCenter,
            IconSymbol.FormatVerticalAlignTop => FormatVerticalAlignTop,
            IconSymbol.LineScan => LineScan,
            IconSymbol.HelpCircleOutline => HelpCircleOutline,
            IconSymbol.CodeJson => CodeJson,
            IconSymbol.Lambda => Lambda,
            IconSymbol.Matrix => Matrix,
            IconSymbol.Meteor => Meteor,
            IconSymbol.CloseCircleMultiple => CloseCircleMultiple,
            IconSymbol.SigmaLower => SigmaLower,
            IconSymbol.SourceBranch => SourceBranch,
            IconSymbol.SourceMerge => SourceMerge,
            IconSymbol.Tune => Tune,
            IconSymbol.Webhook => Webhook,
            IconSymbol.AccountSettings => AccountSettings,
            IconSymbol.AccountDetails => AccountDetails,
            IconSymbol.AppleKeyboardCaps => AppleKeyboardCaps,
            IconSymbol.AppleKeyboardCommand => AppleKeyboardCommand,
            IconSymbol.AppleKeyboardControl => AppleKeyboardControl,
            IconSymbol.AppleKeyboardOption => AppleKeyboardOption,
            IconSymbol.AppleKeyboardShift => AppleKeyboardShift,
            IconSymbol.BoxShadow => BoxShadow,
            IconSymbol.Cards => Cards,
            IconSymbol.CardsOutline => CardsOutline,
            IconSymbol.CardsPlayingOutline => CardsPlayingOutline,
            IconSymbol.CheckboxMultipleBlankCircle => CheckboxMultipleBlankCircle,
            IconSymbol.CheckboxMultipleBlankCircleOutline => CheckboxMultipleBlankCircleOutline,
            IconSymbol.CheckboxMultipleMarkedCircle => CheckboxMultipleMarkedCircle,
            IconSymbol.CheckboxMultipleMarkedCircleOutline => CheckboxMultipleMarkedCircleOutline,
            IconSymbol.CloudSync => CloudSync,
            IconSymbol.Collage => Collage,
            IconSymbol.DirectionsFork => DirectionsFork,
            IconSymbol.EraserVariant => EraserVariant,
            IconSymbol.FaceMan => FaceMan,
            IconSymbol.FaceManProfile => FaceManProfile,
            IconSymbol.FileTree => FileTree,
            IconSymbol.FormatAnnotationPlus => FormatAnnotationPlus,
            IconSymbol.GasCylinder => GasCylinder,
            IconSymbol.GreasePencil => GreasePencil,
            IconSymbol.HumanFemale => HumanFemale,
            IconSymbol.HumanGreetingVariant => HumanGreetingVariant,
            IconSymbol.HumanHandsdown => HumanHandsdown,
            IconSymbol.HumanHandsup => HumanHandsup,
            IconSymbol.HumanMale => HumanMale,
            IconSymbol.InformationVariant => InformationVariant,
            IconSymbol.LeadPencil => LeadPencil,
            IconSymbol.MapMarkerMinus => MapMarkerMinus,
            IconSymbol.MapMarkerPlus => MapMarkerPlus,
            IconSymbol.Marker => Marker,
            IconSymbol.MessagePlus => MessagePlus,
            IconSymbol.Microscope => Microscope,
            IconSymbol.MoveResize => MoveResize,
            IconSymbol.MoveResizeVariant => MoveResizeVariant,
            IconSymbol.PawOff => PawOff,
            IconSymbol.PhoneMinus => PhoneMinus,
            IconSymbol.PhonePlus => PhonePlus,
            IconSymbol.PotSteam => PotSteam,
            IconSymbol.PotMix => PotMix,
            IconSymbol.SerialPort => SerialPort,
            IconSymbol.ShapeCirclePlus => ShapeCirclePlus,
            IconSymbol.ShapePolygonPlus => ShapePolygonPlus,
            IconSymbol.ShapeRectanglePlus => ShapeRectanglePlus,
            IconSymbol.ShapeSquarePlus => ShapeSquarePlus,
            IconSymbol.SkipNextCircle => SkipNextCircle,
            IconSymbol.SkipNextCircleOutline => SkipNextCircleOutline,
            IconSymbol.SkipPreviousCircle => SkipPreviousCircle,
            IconSymbol.SkipPreviousCircleOutline => SkipPreviousCircleOutline,
            IconSymbol.Spray => Spray,
            IconSymbol.StopCircle => StopCircle,
            IconSymbol.StopCircleOutline => StopCircleOutline,
            IconSymbol.TestTube => TestTube,
            IconSymbol.TextShadow => TextShadow,
            IconSymbol.TuneVertical => TuneVertical,
            IconSymbol.CartOff => CartOff,
            IconSymbol.ChartGantt => ChartGantt,
            IconSymbol.ChartScatterPlotHexbin => ChartScatterPlotHexbin,
            IconSymbol.ChartTimeline => ChartTimeline,
            IconSymbol.GlobeLight => GlobeLight,
            IconSymbol.FileRestore => FileRestore,
            IconSymbol.LanguageC => LanguageC,
            IconSymbol.LanguageCpp => LanguageCpp,
            IconSymbol.LanguageXaml => LanguageXaml,
            IconSymbol.Creation => Creation,
            IconSymbol.ApplicationCog => ApplicationCog,
            IconSymbol.CreditCardPlusOutline => CreditCardPlusOutline,
            IconSymbol.PotMixOutline => PotMixOutline,
            IconSymbol.BowTie => BowTie,
            IconSymbol.CalendarRange => CalendarRange,
            IconSymbol.CurrencyUsdOff => CurrencyUsdOff,
            IconSymbol.FlashRedEye => FlashRedEye,
            IconSymbol.Oar => Oar,
            IconSymbol.Piano => Piano,
            IconSymbol.WeatherLightningRainy => WeatherLightningRainy,
            IconSymbol.WeatherSnowyRainy => WeatherSnowyRainy,
            IconSymbol.YinYang => YinYang,
            IconSymbol.TowerBeach => TowerBeach,
            IconSymbol.TowerFire => TowerFire,
            IconSymbol.DeleteCircle => DeleteCircle,
            IconSymbol.Dna => Dna,
            IconSymbol.Hamburger => Hamburger,
            IconSymbol.Gondola => Gondola,
            IconSymbol.Inbox => Inbox,
            IconSymbol.ReorderHorizontal => ReorderHorizontal,
            IconSymbol.ReorderVertical => ReorderVertical,
            IconSymbol.ShieldHome => ShieldHome,
            IconSymbol.TagHeart => TagHeart,
            IconSymbol.Skull => Skull,
            IconSymbol.Solid => Solid,
            IconSymbol.AlarmSnooze => AlarmSnooze,
            IconSymbol.BabyCarriage => BabyCarriage,
            IconSymbol.BeakerOutline => BeakerOutline,
            IconSymbol.Bomb => Bomb,
            IconSymbol.CalendarQuestion => CalendarQuestion,
            IconSymbol.CameraBurst => CameraBurst,
            IconSymbol.CodeTagsCheck => CodeTagsCheck,
            IconSymbol.CircleMultipleOutline => CircleMultipleOutline,
            IconSymbol.CropRotate => CropRotate,
            IconSymbol.DeveloperBoard => DeveloperBoard,
            IconSymbol.PianoOff => PianoOff,
            IconSymbol.SkateOff => SkateOff,
            IconSymbol.MessageStar => MessageStar,
            IconSymbol.EmoticonDeadOutline => EmoticonDeadOutline,
            IconSymbol.EmoticonExcitedOutline => EmoticonExcitedOutline,
            IconSymbol.FolderStar => FolderStar,
            IconSymbol.FormatColorText => FormatColorText,
            IconSymbol.FormatSection => FormatSection,
            IconSymbol.GradientVertical => GradientVertical,
            IconSymbol.HomeOutline => HomeOutline,
            IconSymbol.MessageBulleted => MessageBulleted,
            IconSymbol.MessageBulletedOff => MessageBulletedOff,
            IconSymbol.Nuke => Nuke,
            IconSymbol.PowerPlug => PowerPlug,
            IconSymbol.PowerPlugOff => PowerPlugOff,
            IconSymbol.Publish => Publish,
            IconSymbol.CreditCardMarker => CreditCardMarker,
            IconSymbol.Robot => Robot,
            IconSymbol.FormatRotate90 => FormatRotate90,
            IconSymbol.Scanner => Scanner,
            IconSymbol.Subway => Subway,
            IconSymbol.TimerSandEmpty => TimerSandEmpty,
            IconSymbol.TransitTransfer => TransitTransfer,
            IconSymbol.Unity => Unity,
            IconSymbol.Update => Update,
            IconSymbol.WatchVibrate => WatchVibrate,
            IconSymbol.Angular => Angular,
            IconSymbol.Dolby => Dolby,
            IconSymbol.Emby => Emby,
            IconSymbol.Lamp => Lamp,
            IconSymbol.MenuDownOutline => MenuDownOutline,
            IconSymbol.MenuUpOutline => MenuUpOutline,
            IconSymbol.NoteMultiple => NoteMultiple,
            IconSymbol.NoteMultipleOutline => NoteMultipleOutline,
            IconSymbol.Plex => Plex,
            IconSymbol.ShieldAirplane => ShieldAirplane,
            IconSymbol.AccountEdit => AccountEdit,
            IconSymbol.AlertDecagram => AlertDecagram,
            IconSymbol.AllInclusive => AllInclusive,
            IconSymbol.Angularjs => Angularjs,
            IconSymbol.ArrowDownBox => ArrowDownBox,
            IconSymbol.ArrowLeftBox => ArrowLeftBox,
            IconSymbol.ArrowRightBox => ArrowRightBox,
            IconSymbol.ArrowUpBox => ArrowUpBox,
            IconSymbol.Asterisk => Asterisk,
            IconSymbol.BombOff => BombOff,
            IconSymbol.Bootstrap => Bootstrap,
            IconSymbol.CardsVariant => CardsVariant,
            IconSymbol.ClipboardFlow => ClipboardFlow,
            IconSymbol.CloseOutline => CloseOutline,
            IconSymbol.CoffeeOutline => CoffeeOutline,
            IconSymbol.Contacts => Contacts,
            IconSymbol.DeleteEmpty => DeleteEmpty,
            IconSymbol.EarthBox => EarthBox,
            IconSymbol.EarthBoxOff => EarthBoxOff,
            IconSymbol.EmailAlert => EmailAlert,
            IconSymbol.EyeOutline => EyeOutline,
            IconSymbol.EyeOffOutline => EyeOffOutline,
            IconSymbol.FastForwardOutline => FastForwardOutline,
            IconSymbol.Feather => Feather,
            IconSymbol.FindReplace => FindReplace,
            IconSymbol.FlashOutline => FlashOutline,
            IconSymbol.FormatFont => FormatFont,
            IconSymbol.FormatPageBreak => FormatPageBreak,
            IconSymbol.FormatPilcrow => FormatPilcrow,
            IconSymbol.Garage => Garage,
            IconSymbol.GarageOpen => GarageOpen,
            IconSymbol.CardAccountDetailsStarOutline => CardAccountDetailsStarOutline,
            IconSymbol.GoogleKeep => GoogleKeep,
            IconSymbol.Snowmobile => Snowmobile,
            IconSymbol.HeartHalfFull => HeartHalfFull,
            IconSymbol.HeartHalf => HeartHalf,
            IconSymbol.HeartHalfOutline => HeartHalfOutline,
            IconSymbol.HexagonMultiple => HexagonMultiple,
            IconSymbol.Hook => Hook,
            IconSymbol.HookOff => HookOff,
            IconSymbol.Infinity => Infinity,
            IconSymbol.LanguageSwift => LanguageSwift,
            IconSymbol.LanguageTypescript => LanguageTypescript,
            IconSymbol.LaptopOff => LaptopOff,
            IconSymbol.LightbulbOn => LightbulbOn,
            IconSymbol.LightbulbOnOutline => LightbulbOnOutline,
            IconSymbol.LockPattern => LockPattern,
            IconSymbol.FolderZip => FolderZip,
            IconSymbol.MagnifyMinusOutline => MagnifyMinusOutline,
            IconSymbol.MagnifyPlusOutline => MagnifyPlusOutline,
            IconSymbol.Mailbox => Mailbox,
            IconSymbol.MedicalBag => MedicalBag,
            IconSymbol.MessageSettings => MessageSettings,
            IconSymbol.MessageCog => MessageCog,
            IconSymbol.MinusBoxOutline => MinusBoxOutline,
            IconSymbol.Network => Network,
            IconSymbol.DownloadNetwork => DownloadNetwork,
            IconSymbol.HelpNetwork => HelpNetwork,
            IconSymbol.UploadNetwork => UploadNetwork,
            IconSymbol.Npm => Npm,
            IconSymbol.Nut => Nut,
            IconSymbol.Octagram => Octagram,
            IconSymbol.PageLayoutBody => PageLayoutBody,
            IconSymbol.PageLayoutFooter => PageLayoutFooter,
            IconSymbol.PageLayoutHeader => PageLayoutHeader,
            IconSymbol.PageLayoutSidebarLeft => PageLayoutSidebarLeft,
            IconSymbol.PageLayoutSidebarRight => PageLayoutSidebarRight,
            IconSymbol.PencilCircle => PencilCircle,
            IconSymbol.PentagonOutline => PentagonOutline,
            IconSymbol.Pentagon => Pentagon,
            IconSymbol.Pillar => Pillar,
            IconSymbol.Pistol => Pistol,
            IconSymbol.PlusBoxOutline => PlusBoxOutline,
            IconSymbol.PlusOutline => PlusOutline,
            IconSymbol.Prescription => Prescription,
            IconSymbol.PrinterSettings => PrinterSettings,
            IconSymbol.React => React,
            IconSymbol.Restart => Restart,
            IconSymbol.RewindOutline => RewindOutline,
            IconSymbol.Rhombus => Rhombus,
            IconSymbol.RhombusOutline => RhombusOutline,
            IconSymbol.RobotVacuum => RobotVacuum,
            IconSymbol.Run => Run,
            IconSymbol.SearchWeb => SearchWeb,
            IconSymbol.Shovel => Shovel,
            IconSymbol.ShovelOff => ShovelOff,
            IconSymbol.Signal2g => Signal2g,
            IconSymbol.Signal3g => Signal3g,
            IconSymbol.Signal4g => Signal4g,
            IconSymbol.SignalHspa => SignalHspa,
            IconSymbol.SignalHspaPlus => SignalHspaPlus,
            IconSymbol.Snowflake => Snowflake,
            IconSymbol.SourceCommit => SourceCommit,
            IconSymbol.SourceCommitEnd => SourceCommitEnd,
            IconSymbol.SourceCommitEndLocal => SourceCommitEndLocal,
            IconSymbol.SourceCommitLocal => SourceCommitLocal,
            IconSymbol.SourceCommitNextLocal => SourceCommitNextLocal,
            IconSymbol.SourceCommitStart => SourceCommitStart,
            IconSymbol.SourceCommitStartNextLocal => SourceCommitStartNextLocal,
            IconSymbol.SpeakerWireless => SpeakerWireless,
            IconSymbol.StadiumVariant => StadiumVariant,
            IconSymbol.Svg => Svg,
            IconSymbol.TagPlus => TagPlus,
            IconSymbol.TagRemove => TagRemove,
            IconSymbol.TicketPercent => TicketPercent,
            IconSymbol.Tilde => Tilde,
            IconSymbol.TreasureChest => TreasureChest,
            IconSymbol.TruckTrailer => TruckTrailer,
            IconSymbol.ViewParallel => ViewParallel,
            IconSymbol.ViewSequential => ViewSequential,
            IconSymbol.WashingMachine => WashingMachine,
            IconSymbol.Webpack => Webpack,
            IconSymbol.Widgets => Widgets,
            IconSymbol.NintendoWiiu => NintendoWiiu,
            IconSymbol.ArrowDownBold => ArrowDownBold,
            IconSymbol.ArrowDownBoldBox => ArrowDownBoldBox,
            IconSymbol.ArrowDownBoldBoxOutline => ArrowDownBoldBoxOutline,
            IconSymbol.ArrowLeftBold => ArrowLeftBold,
            IconSymbol.ArrowLeftBoldBox => ArrowLeftBoldBox,
            IconSymbol.ArrowLeftBoldBoxOutline => ArrowLeftBoldBoxOutline,
            IconSymbol.ArrowRightBold => ArrowRightBold,
            IconSymbol.ArrowRightBoldBox => ArrowRightBoldBox,
            IconSymbol.ArrowRightBoldBoxOutline => ArrowRightBoldBoxOutline,
            IconSymbol.ArrowUpBold => ArrowUpBold,
            IconSymbol.ArrowUpBoldBox => ArrowUpBoldBox,
            IconSymbol.ArrowUpBoldBoxOutline => ArrowUpBoldBoxOutline,
            IconSymbol.Cancel => Cancel,
            IconSymbol.FileAccount => FileAccount,
            IconSymbol.GestureDoubleTap => GestureDoubleTap,
            IconSymbol.GestureSwipeDown => GestureSwipeDown,
            IconSymbol.GestureSwipeLeft => GestureSwipeLeft,
            IconSymbol.GestureSwipeRight => GestureSwipeRight,
            IconSymbol.GestureSwipeUp => GestureSwipeUp,
            IconSymbol.GestureTap => GestureTap,
            IconSymbol.GestureTwoDoubleTap => GestureTwoDoubleTap,
            IconSymbol.GestureTwoTap => GestureTwoTap,
            IconSymbol.HumbleBundle => HumbleBundle,
            IconSymbol.Kickstarter => Kickstarter,
            IconSymbol.Netflix => Netflix,
            IconSymbol.MicrosoftOnenote => MicrosoftOnenote,
            IconSymbol.WallSconceRound => WallSconceRound,
            IconSymbol.FolderRefresh => FolderRefresh,
            IconSymbol.VectorRadius => VectorRadius,
            IconSymbol.MicrosoftXboxControllerBatteryAlert => MicrosoftXboxControllerBatteryAlert,
            IconSymbol.MicrosoftXboxControllerBatteryEmpty => MicrosoftXboxControllerBatteryEmpty,
            IconSymbol.MicrosoftXboxControllerBatteryFull => MicrosoftXboxControllerBatteryFull,
            IconSymbol.MicrosoftXboxControllerBatteryLow => MicrosoftXboxControllerBatteryLow,
            IconSymbol.MicrosoftXboxControllerBatteryMedium => MicrosoftXboxControllerBatteryMedium,
            IconSymbol.MicrosoftXboxControllerBatteryUnknown => MicrosoftXboxControllerBatteryUnknown,
            IconSymbol.ClipboardPlus => ClipboardPlus,
            IconSymbol.FilePlus => FilePlus,
            IconSymbol.FormatAlignBottom => FormatAlignBottom,
            IconSymbol.FormatAlignMiddle => FormatAlignMiddle,
            IconSymbol.FormatAlignTop => FormatAlignTop,
            IconSymbol.FormatListChecks => FormatListChecks,
            IconSymbol.FormatQuoteOpen => FormatQuoteOpen,
            IconSymbol.GridLarge => GridLarge,
            IconSymbol.HeartOff => HeartOff,
            IconSymbol.Music => Music,
            IconSymbol.MusicOff => MusicOff,
            IconSymbol.TabPlus => TabPlus,
            IconSymbol.VolumePlus => VolumePlus,
            IconSymbol.VolumeMinus => VolumeMinus,
            IconSymbol.VolumeMute => VolumeMute,
            IconSymbol.UnfoldLessVertical => UnfoldLessVertical,
            IconSymbol.UnfoldMoreVertical => UnfoldMoreVertical,
            IconSymbol.Taco => Taco,
            IconSymbol.SquareOutline => SquareOutline,
            IconSymbol.Square => Square,
            IconSymbol.AlertOctagram => AlertOctagram,
            IconSymbol.Atom => Atom,
            IconSymbol.CeilingLight => CeilingLight,
            IconSymbol.ChartBarStacked => ChartBarStacked,
            IconSymbol.ChartLineStacked => ChartLineStacked,
            IconSymbol.Decagram => Decagram,
            IconSymbol.DecagramOutline => DecagramOutline,
            IconSymbol.DiceMultiple => DiceMultiple,
            IconSymbol.DiceD10Outline => DiceD10Outline,
            IconSymbol.FolderOpen => FolderOpen,
            IconSymbol.GuitarAcoustic => GuitarAcoustic,
            IconSymbol.Loading => Loading,
            IconSymbol.LockReset => LockReset,
            IconSymbol.Ninja => Ninja,
            IconSymbol.OctagramOutline => OctagramOutline,
            IconSymbol.PencilCircleOutline => PencilCircleOutline,
            IconSymbol.SelectionOff => SelectionOff,
            IconSymbol.SetAll => SetAll,
            IconSymbol.SetCenter => SetCenter,
            IconSymbol.SetCenterRight => SetCenterRight,
            IconSymbol.SetLeft => SetLeft,
            IconSymbol.SetLeftCenter => SetLeftCenter,
            IconSymbol.SetLeftRight => SetLeftRight,
            IconSymbol.SetNone => SetNone,
            IconSymbol.SetRight => SetRight,
            IconSymbol.ShieldHalfFull => ShieldHalfFull,
            IconSymbol.SignDirection => SignDirection,
            IconSymbol.SignText => SignText,
            IconSymbol.SignalOff => SignalOff,
            IconSymbol.SquareRoot => SquareRoot,
            IconSymbol.StickerEmoji => StickerEmoji,
            IconSymbol.Summit => Summit,
            IconSymbol.SwordCross => SwordCross,
            IconSymbol.TruckFast => TruckFast,
            IconSymbol.WebCheck => WebCheck,
            IconSymbol.CastOff => CastOff,
            IconSymbol.HelpBox => HelpBox,
            IconSymbol.TimerSandFull => TimerSandFull,
            IconSymbol.Waves => Waves,
            IconSymbol.AlarmBell => AlarmBell,
            IconSymbol.AlarmLight => AlarmLight,
            IconSymbol.VideoSwitchOutline => VideoSwitchOutline,
            IconSymbol.CheckDecagram => CheckDecagram,
            IconSymbol.ArrowCollapseDown => ArrowCollapseDown,
            IconSymbol.ArrowCollapseLeft => ArrowCollapseLeft,
            IconSymbol.ArrowCollapseRight => ArrowCollapseRight,
            IconSymbol.ArrowCollapseUp => ArrowCollapseUp,
            IconSymbol.ArrowExpandDown => ArrowExpandDown,
            IconSymbol.ArrowExpandLeft => ArrowExpandLeft,
            IconSymbol.ArrowExpandRight => ArrowExpandRight,
            IconSymbol.ArrowExpandUp => ArrowExpandUp,
            IconSymbol.BookLock => BookLock,
            IconSymbol.BookLockOpen => BookLockOpen,
            IconSymbol.BusArticulatedEnd => BusArticulatedEnd,
            IconSymbol.BusArticulatedFront => BusArticulatedFront,
            IconSymbol.BusDoubleDecker => BusDoubleDecker,
            IconSymbol.BusSchool => BusSchool,
            IconSymbol.BusSide => BusSide,
            IconSymbol.CameraGopro => CameraGopro,
            IconSymbol.CameraMeteringCenter => CameraMeteringCenter,
            IconSymbol.CameraMeteringMatrix => CameraMeteringMatrix,
            IconSymbol.CameraMeteringPartial => CameraMeteringPartial,
            IconSymbol.CameraMeteringSpot => CameraMeteringSpot,
            IconSymbol.Cannabis => Cannabis,
            IconSymbol.CarConvertible => CarConvertible,
            IconSymbol.CarEstate => CarEstate,
            IconSymbol.CarHatchback => CarHatchback,
            IconSymbol.CarPickup => CarPickup,
            IconSymbol.CarSide => CarSide,
            IconSymbol.CarSports => CarSports,
            IconSymbol.Caravan => Caravan,
            IconSymbol.Cctv => Cctv,
            IconSymbol.ChartDonut => ChartDonut,
            IconSymbol.ChartDonutVariant => ChartDonutVariant,
            IconSymbol.ChartLineVariant => ChartLineVariant,
            IconSymbol.ChiliHot => ChiliHot,
            IconSymbol.ChiliMedium => ChiliMedium,
            IconSymbol.ChiliMild => ChiliMild,
            IconSymbol.CloudBraces => CloudBraces,
            IconSymbol.CloudTags => CloudTags,
            IconSymbol.ConsoleLine => ConsoleLine,
            IconSymbol.Corn => Corn,
            IconSymbol.FolderZipOutline => FolderZipOutline,
            IconSymbol.CurrencyCny => CurrencyCny,
            IconSymbol.CurrencyEth => CurrencyEth,
            IconSymbol.CurrencyJpy => CurrencyJpy,
            IconSymbol.CurrencyKrw => CurrencyKrw,
            IconSymbol.CurrencySign => CurrencySign,
            IconSymbol.CurrencyTwd => CurrencyTwd,
            IconSymbol.DesktopClassic => DesktopClassic,
            IconSymbol.DipSwitch => DipSwitch,
            IconSymbol.Donkey => Donkey,
            IconSymbol.DotsHorizontalCircle => DotsHorizontalCircle,
            IconSymbol.DotsVerticalCircle => DotsVerticalCircle,
            IconSymbol.EarHearing => EarHearing,
            IconSymbol.Elephant => Elephant,
            IconSymbol.Storefront => Storefront,
            IconSymbol.FoodCroissant => FoodCroissant,
            IconSymbol.Forklift => Forklift,
            IconSymbol.Fuel => Fuel,
            IconSymbol.Gesture => Gesture,
            IconSymbol.GoogleAnalytics => GoogleAnalytics,
            IconSymbol.GoogleAssistant => GoogleAssistant,
            IconSymbol.HeadphonesOff => HeadphonesOff,
            IconSymbol.HighDefinition => HighDefinition,
            IconSymbol.HomeAssistant => HomeAssistant,
            IconSymbol.HomeAutomation => HomeAutomation,
            IconSymbol.HomeCircle => HomeCircle,
            IconSymbol.LanguageGo => LanguageGo,
            IconSymbol.LanguageR => LanguageR,
            IconSymbol.LavaLamp => LavaLamp,
            IconSymbol.LedStrip => LedStrip,
            IconSymbol.Locker => Locker,
            IconSymbol.LockerMultiple => LockerMultiple,
            IconSymbol.MapMarkerOutline => MapMarkerOutline,
            IconSymbol.Metronome => Metronome,
            IconSymbol.MetronomeTick => MetronomeTick,
            IconSymbol.MicroSd => MicroSd,
            IconSymbol.FacebookGaming => FacebookGaming,
            IconSymbol.MovieRoll => MovieRoll,
            IconSymbol.Mushroom => Mushroom,
            IconSymbol.MushroomOutline => MushroomOutline,
            IconSymbol.NintendoSwitch => NintendoSwitch,
            IconSymbol.Null => Null,
            IconSymbol.Passport => Passport,
            IconSymbol.MoleculeCo2 => MoleculeCo2,
            IconSymbol.Pipe => Pipe,
            IconSymbol.PipeDisconnected => PipeDisconnected,
            IconSymbol.PowerSocketEu => PowerSocketEu,
            IconSymbol.PowerSocketUk => PowerSocketUk,
            IconSymbol.PowerSocketUs => PowerSocketUs,
            IconSymbol.Rice => Rice,
            IconSymbol.Ring => Ring,
            IconSymbol.Sass => Sass,
            IconSymbol.SendLock => SendLock,
            IconSymbol.SoySauce => SoySauce,
            IconSymbol.StandardDefinition => StandardDefinition,
            IconSymbol.SurroundSound20 => SurroundSound20,
            IconSymbol.SurroundSound31 => SurroundSound31,
            IconSymbol.SurroundSound51 => SurroundSound51,
            IconSymbol.SurroundSound71 => SurroundSound71,
            IconSymbol.TelevisionClassic => TelevisionClassic,
            IconSymbol.FormTextboxPassword => FormTextboxPassword,
            IconSymbol.ThoughtBubble => ThoughtBubble,
            IconSymbol.ThoughtBubbleOutline => ThoughtBubbleOutline,
            IconSymbol.Trackpad => Trackpad,
            IconSymbol.UltraHighDefinition => UltraHighDefinition,
            IconSymbol.VanPassenger => VanPassenger,
            IconSymbol.VanUtility => VanUtility,
            IconSymbol.Vanish => Vanish,
            IconSymbol.Video3d => Video3d,
            IconSymbol.Wall => Wall,
            IconSymbol.Xmpp => Xmpp,
            IconSymbol.AccountMultiplePlusOutline => AccountMultiplePlusOutline,
            IconSymbol.AccountPlusOutline => AccountPlusOutline,
            IconSymbol.CreditCardWireless => CreditCardWireless,
            IconSymbol.AccountMusic => AccountMusic,
            IconSymbol.Atlassian => Atlassian,
            IconSymbol.MicrosoftAzure => MicrosoftAzure,
            IconSymbol.Basketball => Basketball,
            IconSymbol.BatteryChargingWireless => BatteryChargingWireless,
            IconSymbol.BatteryChargingWireless10 => BatteryChargingWireless10,
            IconSymbol.BatteryChargingWireless20 => BatteryChargingWireless20,
            IconSymbol.BatteryChargingWireless30 => BatteryChargingWireless30,
            IconSymbol.BatteryChargingWireless40 => BatteryChargingWireless40,
            IconSymbol.BatteryChargingWireless50 => BatteryChargingWireless50,
            IconSymbol.BatteryChargingWireless60 => BatteryChargingWireless60,
            IconSymbol.BatteryChargingWireless70 => BatteryChargingWireless70,
            IconSymbol.BatteryChargingWireless80 => BatteryChargingWireless80,
            IconSymbol.BatteryChargingWireless90 => BatteryChargingWireless90,
            IconSymbol.BatteryChargingWirelessAlert => BatteryChargingWirelessAlert,
            IconSymbol.BatteryChargingWirelessOutline => BatteryChargingWirelessOutline,
            IconSymbol.Bitcoin => Bitcoin,
            IconSymbol.BriefcaseOutline => BriefcaseOutline,
            IconSymbol.CellphoneWireless => CellphoneWireless,
            IconSymbol.Clover => Clover,
            IconSymbol.CommentQuestion => CommentQuestion,
            IconSymbol.ContentSaveOutline => ContentSaveOutline,
            IconSymbol.DeleteRestore => DeleteRestore,
            IconSymbol.Door => Door,
            IconSymbol.DoorClosed => DoorClosed,
            IconSymbol.DoorOpen => DoorOpen,
            IconSymbol.FanOff => FanOff,
            IconSymbol.FilePercent => FilePercent,
            IconSymbol.Finance => Finance,
            IconSymbol.LightningBoltCircle => LightningBoltCircle,
            IconSymbol.FloorPlan => FloorPlan,
            IconSymbol.ForumOutline => ForumOutline,
            IconSymbol.Golf => Golf,
            IconSymbol.Receipt => Receipt,
            IconSymbol.GuyFawkesMask => GuyFawkesMask,
            IconSymbol.HomeAccount => HomeAccount,
            IconSymbol.HomeHeart => HomeHeart,
            IconSymbol.HotTub => HotTub,
            IconSymbol.Hulu => Hulu,
            IconSymbol.IceCream => IceCream,
            IconSymbol.ImageOff => ImageOff,
            IconSymbol.Karate => Karate,
            IconSymbol.Ladybug => Ladybug,
            IconSymbol.Notebook => Notebook,
            IconSymbol.PhoneReturn => PhoneReturn,
            IconSymbol.PokerChip => PokerChip,
            IconSymbol.Shape => Shape,
            IconSymbol.ShapeOutline => ShapeOutline,
            IconSymbol.ShipWheel => ShipWheel,
            IconSymbol.SoccerField => SoccerField,
            IconSymbol.TableColumn => TableColumn,
            IconSymbol.TableOfContents => TableOfContents,
            IconSymbol.TableRow => TableRow,
            IconSymbol.TableSettings => TableSettings,
            IconSymbol.TelevisionBox => TelevisionBox,
            IconSymbol.TelevisionClassicOff => TelevisionClassicOff,
            IconSymbol.TelevisionOff => TelevisionOff,
            IconSymbol.TowTruck => TowTruck,
            IconSymbol.UploadMultiple => UploadMultiple,
            IconSymbol.Video4kBox => Video4kBox,
            IconSymbol.VideoInputAntenna => VideoInputAntenna,
            IconSymbol.VideoInputComponent => VideoInputComponent,
            IconSymbol.VideoInputHdmi => VideoInputHdmi,
            IconSymbol.VideoInputSvideo => VideoInputSvideo,
            IconSymbol.ViewDashboardVariant => ViewDashboardVariant,
            IconSymbol.Vuejs => Vuejs,
            IconSymbol.Xamarin => Xamarin,
            IconSymbol.HumanMaleBoardPoll => HumanMaleBoardPoll,
            IconSymbol.YoutubeStudio => YoutubeStudio,
            IconSymbol.YoutubeGaming => YoutubeGaming,
            IconSymbol.AccountGroup => AccountGroup,
            IconSymbol.CameraSwitchOutline => CameraSwitchOutline,
            IconSymbol.Airport => Airport,
            IconSymbol.ArrowCollapseHorizontal => ArrowCollapseHorizontal,
            IconSymbol.ArrowCollapseVertical => ArrowCollapseVertical,
            IconSymbol.ArrowExpandHorizontal => ArrowExpandHorizontal,
            IconSymbol.ArrowExpandVertical => ArrowExpandVertical,
            IconSymbol.AugmentedReality => AugmentedReality,
            IconSymbol.Badminton => Badminton,
            IconSymbol.Baseball => Baseball,
            IconSymbol.BaseballBat => BaseballBat,
            IconSymbol.BottleWine => BottleWine,
            IconSymbol.CheckOutline => CheckOutline,
            IconSymbol.CheckboxIntermediate => CheckboxIntermediate,
            IconSymbol.ChessKing => ChessKing,
            IconSymbol.ChessKnight => ChessKnight,
            IconSymbol.ChessPawn => ChessPawn,
            IconSymbol.ChessQueen => ChessQueen,
            IconSymbol.ChessRook => ChessRook,
            IconSymbol.ChessBishop => ChessBishop,
            IconSymbol.ClipboardPulse => ClipboardPulse,
            IconSymbol.ClipboardPulseOutline => ClipboardPulseOutline,
            IconSymbol.CommentMultiple => CommentMultiple,
            IconSymbol.CommentTextMultiple => CommentTextMultiple,
            IconSymbol.CommentTextMultipleOutline => CommentTextMultipleOutline,
            IconSymbol.Crane => Crane,
            IconSymbol.Curling => Curling,
            IconSymbol.CurrencyBdt => CurrencyBdt,
            IconSymbol.CurrencyKzt => CurrencyKzt,
            IconSymbol.DatabaseSearch => DatabaseSearch,
            IconSymbol.DiceD12Outline => DiceD12Outline,
            IconSymbol.Docker => Docker,
            IconSymbol.DoorbellVideo => DoorbellVideo,
            IconSymbol.Ethereum => Ethereum,
            IconSymbol.EyePlus => EyePlus,
            IconSymbol.EyePlusOutline => EyePlusOutline,
            IconSymbol.EyeSettings => EyeSettings,
            IconSymbol.EyeSettingsOutline => EyeSettingsOutline,
            IconSymbol.FileQuestion => FileQuestion,
            IconSymbol.FolderNetwork => FolderNetwork,
            IconSymbol.FunctionVariant => FunctionVariant,
            IconSymbol.GarageAlert => GarageAlert,
            IconSymbol.GaugeEmpty => GaugeEmpty,
            IconSymbol.GaugeFull => GaugeFull,
            IconSymbol.GaugeLow => GaugeLow,
            IconSymbol.GlassWine => GlassWine,
            IconSymbol.Graphql => Graphql,
            IconSymbol.HighDefinitionBox => HighDefinitionBox,
            IconSymbol.HockeyPuck => HockeyPuck,
            IconSymbol.HockeySticks => HockeySticks,
            IconSymbol.HomeAlert => HomeAlert,
            IconSymbol.ImagePlus => ImagePlus,
            IconSymbol.Jquery => Jquery,
            IconSymbol.Lifebuoy => Lifebuoy,
            IconSymbol.MixedReality => MixedReality,
            IconSymbol.Nativescript => Nativescript,
            IconSymbol.Onepassword => Onepassword,
            IconSymbol.Patreon => Patreon,
            IconSymbol.CloseCircleMultipleOutline => CloseCircleMultipleOutline,
            IconSymbol.Peace => Peace,
            IconSymbol.PhoneRotateLandscape => PhoneRotateLandscape,
            IconSymbol.PhoneRotatePortrait => PhoneRotatePortrait,
            IconSymbol.Pier => Pier,
            IconSymbol.PierCrane => PierCrane,
            IconSymbol.PipeLeak => PipeLeak,
            IconSymbol.Piston => Piston,
            IconSymbol.PlayNetwork => PlayNetwork,
            IconSymbol.Reminder => Reminder,
            IconSymbol.RoomService => RoomService,
            IconSymbol.Salesforce => Salesforce,
            IconSymbol.ShieldAccount => ShieldAccount,
            IconSymbol.HumanMaleBoard => HumanMaleBoard,
            IconSymbol.ThermostatBox => ThermostatBox,
            IconSymbol.Tractor => Tractor,
            IconSymbol.VectorEllipse => VectorEllipse,
            IconSymbol.VirtualReality => VirtualReality,
            IconSymbol.WatchExportVariant => WatchExportVariant,
            IconSymbol.WatchImportVariant => WatchImportVariant,
            IconSymbol.WatchVariant => WatchVariant,
            IconSymbol.WeatherHurricane => WeatherHurricane,
            IconSymbol.AccountHeart => AccountHeart,
            IconSymbol.Alien => Alien,
            IconSymbol.Anvil => Anvil,
            IconSymbol.BatteryCharging10 => BatteryCharging10,
            IconSymbol.BatteryCharging50 => BatteryCharging50,
            IconSymbol.BatteryCharging70 => BatteryCharging70,
            IconSymbol.BatteryChargingOutline => BatteryChargingOutline,
            IconSymbol.BedEmpty => BedEmpty,
            IconSymbol.BorderAllVariant => BorderAllVariant,
            IconSymbol.BorderBottomVariant => BorderBottomVariant,
            IconSymbol.BorderLeftVariant => BorderLeftVariant,
            IconSymbol.BorderNoneVariant => BorderNoneVariant,
            IconSymbol.BorderRightVariant => BorderRightVariant,
            IconSymbol.BorderTopVariant => BorderTopVariant,
            IconSymbol.CalendarEdit => CalendarEdit,
            IconSymbol.ClipboardCheckOutline => ClipboardCheckOutline,
            IconSymbol.ConsoleNetwork => ConsoleNetwork,
            IconSymbol.FileCompare => FileCompare,
            IconSymbol.FireTruck => FireTruck,
            IconSymbol.FolderKey => FolderKey,
            IconSymbol.FolderKeyNetwork => FolderKeyNetwork,
            IconSymbol.ExpansionCard => ExpansionCard,
            IconSymbol.Kayaking => Kayaking,
            IconSymbol.InboxMultiple => InboxMultiple,
            IconSymbol.LanguageLua => LanguageLua,
            IconSymbol.LockSmart => LockSmart,
            IconSymbol.MicrophoneMinus => MicrophoneMinus,
            IconSymbol.MicrophonePlus => MicrophonePlus,
            IconSymbol.PaletteSwatch => PaletteSwatch,
            IconSymbol.PeriodicTable => PeriodicTable,
            IconSymbol.Pickaxe => Pickaxe,
            IconSymbol.QrcodeEdit => QrcodeEdit,
            IconSymbol.RemoteDesktop => RemoteDesktop,
            IconSymbol.Sausage => Sausage,
            IconSymbol.CogOutline => CogOutline,
            IconSymbol.SignalCellular1 => SignalCellular1,
            IconSymbol.SignalCellular2 => SignalCellular2,
            IconSymbol.SignalCellular3 => SignalCellular3,
            IconSymbol.SignalCellularOutline => SignalCellularOutline,
            IconSymbol.Ssh => Ssh,
            IconSymbol.SwapHorizontalVariant => SwapHorizontalVariant,
            IconSymbol.SwapVerticalVariant => SwapVerticalVariant,
            IconSymbol.Tooth => Tooth,
            IconSymbol.TrainVariant => TrainVariant,
            IconSymbol.AccountMultipleCheck => AccountMultipleCheck,
            IconSymbol.Application => Application,
            IconSymbol.Arch => Arch,
            IconSymbol.Axe => Axe,
            IconSymbol.BullseyeArrow => BullseyeArrow,
            IconSymbol.BusClock => BusClock,
            IconSymbol.CameraAccount => CameraAccount,
            IconSymbol.CameraImage => CameraImage,
            IconSymbol.CarLimousine => CarLimousine,
            IconSymbol.CardsClub => CardsClub,
            IconSymbol.CardsDiamond => CardsDiamond,
            IconSymbol.CardsSpade => CardsSpade,
            IconSymbol.CellphoneText => CellphoneText,
            IconSymbol.CellphoneMessage => CellphoneMessage,
            IconSymbol.ChartMultiline => ChartMultiline,
            IconSymbol.CircleEditOutline => CircleEditOutline,
            IconSymbol.Cogs => Cogs,
            IconSymbol.CreditCardSettingsOutline => CreditCardSettingsOutline,
            IconSymbol.DeathStar => DeathStar,
            IconSymbol.DeathStarVariant => DeathStarVariant,
            IconSymbol.Debian => Debian,
            IconSymbol.Fedora => Fedora,
            IconSymbol.FileUndo => FileUndo,
            IconSymbol.FloorLamp => FloorLamp,
            IconSymbol.FolderEdit => FolderEdit,
            IconSymbol.FormatColumns => FormatColumns,
            IconSymbol.Freebsd => Freebsd,
            IconSymbol.GateAnd => GateAnd,
            IconSymbol.GateNand => GateNand,
            IconSymbol.GateNor => GateNor,
            IconSymbol.GateNot => GateNot,
            IconSymbol.GateOr => GateOr,
            IconSymbol.GateXnor => GateXnor,
            IconSymbol.GateXor => GateXor,
            IconSymbol.Gentoo => Gentoo,
            IconSymbol.GlobeModel => GlobeModel,
            IconSymbol.Hammer => Hammer,
            IconSymbol.HomeLock => HomeLock,
            IconSymbol.HomeLockOpen => HomeLockOpen,
            IconSymbol.LinuxMint => LinuxMint,
            IconSymbol.LockAlert => LockAlert,
            IconSymbol.LockQuestion => LockQuestion,
            IconSymbol.MapMarkerDistance => MapMarkerDistance,
            IconSymbol.Midi => Midi,
            IconSymbol.MidiPort => MidiPort,
            IconSymbol.Nas => Nas,
            IconSymbol.NetworkStrength1 => NetworkStrength1,
            IconSymbol.NetworkStrength1Alert => NetworkStrength1Alert,
            IconSymbol.NetworkStrength2 => NetworkStrength2,
            IconSymbol.NetworkStrength2Alert => NetworkStrength2Alert,
            IconSymbol.NetworkStrength3 => NetworkStrength3,
            IconSymbol.NetworkStrength3Alert => NetworkStrength3Alert,
            IconSymbol.NetworkStrength4 => NetworkStrength4,
            IconSymbol.NetworkStrength4Alert => NetworkStrength4Alert,
            IconSymbol.NetworkStrengthOff => NetworkStrengthOff,
            IconSymbol.NetworkStrengthOffOutline => NetworkStrengthOffOutline,
            IconSymbol.NetworkStrengthOutline => NetworkStrengthOutline,
            IconSymbol.PlaySpeed => PlaySpeed,
            IconSymbol.PlaylistEdit => PlaylistEdit,
            IconSymbol.PowerCycle => PowerCycle,
            IconSymbol.PowerOff => PowerOff,
            IconSymbol.PowerOn => PowerOn,
            IconSymbol.PowerSleep => PowerSleep,
            IconSymbol.PowerSocketAu => PowerSocketAu,
            IconSymbol.PowerStandby => PowerStandby,
            IconSymbol.Rabbit => Rabbit,
            IconSymbol.RobotVacuumVariant => RobotVacuumVariant,
            IconSymbol.SatelliteUplink => SatelliteUplink,
            IconSymbol.ScannerOff => ScannerOff,
            IconSymbol.BookMinusMultipleOutline => BookMinusMultipleOutline,
            IconSymbol.SquareEditOutline => SquareEditOutline,
            IconSymbol.SortNumericAscendingVariant => SortNumericAscendingVariant,
            IconSymbol.SteeringOff => SteeringOff,
            IconSymbol.TableSearch => TableSearch,
            IconSymbol.TagMinus => TagMinus,
            IconSymbol.TestTubeEmpty => TestTubeEmpty,
            IconSymbol.TestTubeOff => TestTubeOff,
            IconSymbol.TicketOutline => TicketOutline,
            IconSymbol.TrackLight => TrackLight,
            IconSymbol.Transition => Transition,
            IconSymbol.TransitionMasked => TransitionMasked,
            IconSymbol.TumbleDryer => TumbleDryer,
            IconSymbol.FileRefresh => FileRefresh,
            IconSymbol.VideoAccount => VideoAccount,
            IconSymbol.VideoImage => VideoImage,
            IconSymbol.VideoStabilization => VideoStabilization,
            IconSymbol.WallSconce => WallSconce,
            IconSymbol.WallSconceFlat => WallSconceFlat,
            IconSymbol.WallSconceRoundVariant => WallSconceRoundVariant,
            IconSymbol.WifiStrength1 => WifiStrength1,
            IconSymbol.WifiStrength1Alert => WifiStrength1Alert,
            IconSymbol.WifiStrength1Lock => WifiStrength1Lock,
            IconSymbol.WifiStrength2 => WifiStrength2,
            IconSymbol.WifiStrength2Alert => WifiStrength2Alert,
            IconSymbol.WifiStrength2Lock => WifiStrength2Lock,
            IconSymbol.WifiStrength3 => WifiStrength3,
            IconSymbol.WifiStrength3Alert => WifiStrength3Alert,
            IconSymbol.WifiStrength3Lock => WifiStrength3Lock,
            IconSymbol.WifiStrength4 => WifiStrength4,
            IconSymbol.WifiStrength4Alert => WifiStrength4Alert,
            IconSymbol.WifiStrength4Lock => WifiStrength4Lock,
            IconSymbol.WifiStrengthAlertOutline => WifiStrengthAlertOutline,
            IconSymbol.WifiStrengthLockOutline => WifiStrengthLockOutline,
            IconSymbol.WifiStrengthOff => WifiStrengthOff,
            IconSymbol.WifiStrengthOffOutline => WifiStrengthOffOutline,
            IconSymbol.WifiStrengthOutline => WifiStrengthOutline,
            IconSymbol.PinOffOutline => PinOffOutline,
            IconSymbol.PinOutline => PinOutline,
            IconSymbol.ShareOutline => ShareOutline,
            IconSymbol.TrackpadLock => TrackpadLock,
            IconSymbol.AccountBoxMultiple => AccountBoxMultiple,
            IconSymbol.AccountSearchOutline => AccountSearchOutline,
            IconSymbol.AccountFilter => AccountFilter,
            IconSymbol.AngleAcute => AngleAcute,
            IconSymbol.AngleObtuse => AngleObtuse,
            IconSymbol.AngleRight => AngleRight,
            IconSymbol.AnimationPlay => AnimationPlay,
            IconSymbol.ArrowSplitHorizontal => ArrowSplitHorizontal,
            IconSymbol.ArrowSplitVertical => ArrowSplitVertical,
            IconSymbol.AudioVideo => AudioVideo,
            IconSymbol.Battery10Bluetooth => Battery10Bluetooth,
            IconSymbol.Battery20Bluetooth => Battery20Bluetooth,
            IconSymbol.Battery30Bluetooth => Battery30Bluetooth,
            IconSymbol.Battery40Bluetooth => Battery40Bluetooth,
            IconSymbol.Battery50Bluetooth => Battery50Bluetooth,
            IconSymbol.Battery60Bluetooth => Battery60Bluetooth,
            IconSymbol.Battery70Bluetooth => Battery70Bluetooth,
            IconSymbol.Battery80Bluetooth => Battery80Bluetooth,
            IconSymbol.Battery90Bluetooth => Battery90Bluetooth,
            IconSymbol.BatteryAlertBluetooth => BatteryAlertBluetooth,
            IconSymbol.BatteryBluetooth => BatteryBluetooth,
            IconSymbol.BatteryBluetoothVariant => BatteryBluetoothVariant,
            IconSymbol.BatteryUnknownBluetooth => BatteryUnknownBluetooth,
            IconSymbol.Dharmachakra => Dharmachakra,
            IconSymbol.CalendarSearch => CalendarSearch,
            IconSymbol.CellphoneRemove => CellphoneRemove,
            IconSymbol.CellphoneKey => CellphoneKey,
            IconSymbol.CellphoneLock => CellphoneLock,
            IconSymbol.CellphoneOff => CellphoneOff,
            IconSymbol.CellphoneCog => CellphoneCog,
            IconSymbol.CellphoneSound => CellphoneSound,
            IconSymbol.Cross => Cross,
            IconSymbol.Clock => Clock,
            IconSymbol.ClockAlert => ClockAlert,
            IconSymbol.CloudSearch => CloudSearch,
            IconSymbol.CloudSearchOutline => CloudSearchOutline,
            IconSymbol.Cordova => Cordova,
            IconSymbol.Cryengine => Cryengine,
            IconSymbol.Cupcake => Cupcake,
            IconSymbol.SineWave => SineWave,
            IconSymbol.CurrentDc => CurrentDc,
            IconSymbol.DatabaseImport => DatabaseImport,
            IconSymbol.DatabaseExport => DatabaseExport,
            IconSymbol.DeskLamp => DeskLamp,
            IconSymbol.DiscPlayer => DiscPlayer,
            IconSymbol.EmailSearch => EmailSearch,
            IconSymbol.EmailSearchOutline => EmailSearchOutline,
            IconSymbol.Exponent => Exponent,
            IconSymbol.ExponentBox => ExponentBox,
            IconSymbol.FileDownload => FileDownload,
            IconSymbol.FileDownloadOutline => FileDownloadOutline,
            IconSymbol.Firebase => Firebase,
            IconSymbol.FolderSearch => FolderSearch,
            IconSymbol.FolderSearchOutline => FolderSearchOutline,
            IconSymbol.FormatListCheckbox => FormatListCheckbox,
            IconSymbol.Fountain => Fountain,
            IconSymbol.GoogleFit => GoogleFit,
            IconSymbol.GreaterThan => GreaterThan,
            IconSymbol.GreaterThanOrEqual => GreaterThanOrEqual,
            IconSymbol.HardHat => HardHat,
            IconSymbol.HeadphonesBluetooth => HeadphonesBluetooth,
            IconSymbol.HeartCircle => HeartCircle,
            IconSymbol.HeartCircleOutline => HeartCircleOutline,
            IconSymbol.Om => Om,
            IconSymbol.HomeMinus => HomeMinus,
            IconSymbol.HomePlus => HomePlus,
            IconSymbol.ImageOutline => ImageOutline,
            IconSymbol.ImageSearch => ImageSearch,
            IconSymbol.ImageSearchOutline => ImageSearchOutline,
            IconSymbol.StarCrescent => StarCrescent,
            IconSymbol.StarDavid => StarDavid,
            IconSymbol.KeyboardOutline => KeyboardOutline,
            IconSymbol.LessThan => LessThan,
            IconSymbol.LessThanOrEqual => LessThanOrEqual,
            IconSymbol.LightSwitch => LightSwitch,
            IconSymbol.LockClock => LockClock,
            IconSymbol.MagnifyClose => MagnifyClose,
            IconSymbol.MapMinus => MapMinus,
            IconSymbol.MapOutline => MapOutline,
            IconSymbol.MapPlus => MapPlus,
            IconSymbol.MapSearch => MapSearch,
            IconSymbol.MapSearchOutline => MapSearchOutline,
            IconSymbol.MaterialDesign => MaterialDesign,
            IconSymbol.Medal => Medal,
            IconSymbol.MicrosoftDynamics365 => MicrosoftDynamics365,
            IconSymbol.MonitorCellphone => MonitorCellphone,
            IconSymbol.MonitorCellphoneStar => MonitorCellphoneStar,
            IconSymbol.MouseBluetooth => MouseBluetooth,
            IconSymbol.Muffin => Muffin,
            IconSymbol.NotEqual => NotEqual,
            IconSymbol.NotEqualVariant => NotEqualVariant,
            IconSymbol.OrderBoolAscendingVariant => OrderBoolAscendingVariant,
            IconSymbol.OrderBoolDescendingVariant => OrderBoolDescendingVariant,
            IconSymbol.OfficeBuilding => OfficeBuilding,
            IconSymbol.PlusMinus => PlusMinus,
            IconSymbol.PlusMinusBox => PlusMinusBox,
            IconSymbol.Podcast => Podcast,
            IconSymbol.ProgressCheck => ProgressCheck,
            IconSymbol.ProgressClock => ProgressClock,
            IconSymbol.ProgressDownload => ProgressDownload,
            IconSymbol.ProgressUpload => ProgressUpload,
            IconSymbol.Qi => Qi,
            IconSymbol.RecordPlayer => RecordPlayer,
            IconSymbol.Restore => Restore,
            IconSymbol.ShieldOffOutline => ShieldOffOutline,
            IconSymbol.ShieldLock => ShieldLock,
            IconSymbol.ShieldOff => ShieldOff,
            IconSymbol.SetTopBox => SetTopBox,
            IconSymbol.Shower => Shower,
            IconSymbol.ShowerHead => ShowerHead,
            IconSymbol.SpeakerBluetooth => SpeakerBluetooth,
            IconSymbol.SquareRootBox => SquareRootBox,
            IconSymbol.StarCircleOutline => StarCircleOutline,
            IconSymbol.StarFace => StarFace,
            IconSymbol.TableMergeCells => TableMergeCells,
            IconSymbol.TabletCellphone => TabletCellphone,
            IconSymbol.Text => Text,
            IconSymbol.TextShort => TextShort,
            IconSymbol.TextLong => TextLong,
            IconSymbol.Toilet => Toilet,
            IconSymbol.Toolbox => Toolbox,
            IconSymbol.ToolboxOutline => ToolboxOutline,
            IconSymbol.Tournament => Tournament,
            IconSymbol.TwoFactorAuthentication => TwoFactorAuthentication,
            IconSymbol.UmbrellaClosed => UmbrellaClosed,
            IconSymbol.Unreal => Unreal,
            IconSymbol.VideoMinus => VideoMinus,
            IconSymbol.VideoPlus => VideoPlus,
            IconSymbol.Volleyball => Volleyball,
            IconSymbol.WeightPound => WeightPound,
            IconSymbol.Whistle => Whistle,
            IconSymbol.ArrowBottomLeftBoldOutline => ArrowBottomLeftBoldOutline,
            IconSymbol.ArrowBottomLeftThick => ArrowBottomLeftThick,
            IconSymbol.ArrowBottomRightBoldOutline => ArrowBottomRightBoldOutline,
            IconSymbol.ArrowBottomRightThick => ArrowBottomRightThick,
            IconSymbol.ArrowDecision => ArrowDecision,
            IconSymbol.ArrowDecisionAuto => ArrowDecisionAuto,
            IconSymbol.ArrowDecisionAutoOutline => ArrowDecisionAutoOutline,
            IconSymbol.ArrowDecisionOutline => ArrowDecisionOutline,
            IconSymbol.ArrowDownBoldOutline => ArrowDownBoldOutline,
            IconSymbol.ArrowLeftBoldOutline => ArrowLeftBoldOutline,
            IconSymbol.ArrowLeftRightBoldOutline => ArrowLeftRightBoldOutline,
            IconSymbol.ArrowRightBoldOutline => ArrowRightBoldOutline,
            IconSymbol.ArrowTopLeftBoldOutline => ArrowTopLeftBoldOutline,
            IconSymbol.ArrowTopLeftThick => ArrowTopLeftThick,
            IconSymbol.ArrowTopRightBoldOutline => ArrowTopRightBoldOutline,
            IconSymbol.ArrowTopRightThick => ArrowTopRightThick,
            IconSymbol.ArrowUpBoldOutline => ArrowUpBoldOutline,
            IconSymbol.ArrowUpDownBoldOutline => ArrowUpDownBoldOutline,
            IconSymbol.Ballot => Ballot,
            IconSymbol.BallotOutline => BallotOutline,
            IconSymbol.Betamax => Betamax,
            IconSymbol.BookmarkMinus => BookmarkMinus,
            IconSymbol.BookmarkMinusOutline => BookmarkMinusOutline,
            IconSymbol.BookmarkOff => BookmarkOff,
            IconSymbol.BookmarkOffOutline => BookmarkOffOutline,
            IconSymbol.Braille => Braille,
            IconSymbol.Brain => Brain,
            IconSymbol.CalendarHeart => CalendarHeart,
            IconSymbol.CalendarStar => CalendarStar,
            IconSymbol.Cassette => Cassette,
            IconSymbol.CellphoneArrowDown => CellphoneArrowDown,
            IconSymbol.ChevronDownBox => ChevronDownBox,
            IconSymbol.ChevronDownBoxOutline => ChevronDownBoxOutline,
            IconSymbol.ChevronLeftBox => ChevronLeftBox,
            IconSymbol.ChevronLeftBoxOutline => ChevronLeftBoxOutline,
            IconSymbol.ChevronRightBox => ChevronRightBox,
            IconSymbol.ChevronRightBoxOutline => ChevronRightBoxOutline,
            IconSymbol.ChevronUpBox => ChevronUpBox,
            IconSymbol.ChevronUpBoxOutline => ChevronUpBoxOutline,
            IconSymbol.CircleMedium => CircleMedium,
            IconSymbol.CircleSmall => CircleSmall,
            IconSymbol.CloudAlert => CloudAlert,
            IconSymbol.CommentArrowLeft => CommentArrowLeft,
            IconSymbol.CommentArrowLeftOutline => CommentArrowLeftOutline,
            IconSymbol.CommentArrowRight => CommentArrowRight,
            IconSymbol.CommentArrowRightOutline => CommentArrowRightOutline,
            IconSymbol.CommentPlus => CommentPlus,
            IconSymbol.CurrencyPhp => CurrencyPhp,
            IconSymbol.DeleteOutline => DeleteOutline,
            IconSymbol.VectorPointEdit => VectorPointEdit,
            IconSymbol.DownloadMultiple => DownloadMultiple,
            IconSymbol.EightTrack => EightTrack,
            IconSymbol.EmailPlus => EmailPlus,
            IconSymbol.EmailPlusOutline => EmailPlusOutline,
            IconSymbol.TextBoxOutline => TextBoxOutline,
            IconSymbol.FileDocumentOutline => FileDocumentOutline,
            IconSymbol.FloppyVariant => FloppyVariant,
            IconSymbol.FlowerOutline => FlowerOutline,
            IconSymbol.FlowerTulip => FlowerTulip,
            IconSymbol.FlowerTulipOutline => FlowerTulipOutline,
            IconSymbol.FormatFontSizeDecrease => FormatFontSizeDecrease,
            IconSymbol.FormatFontSizeIncrease => FormatFontSizeIncrease,
            IconSymbol.GhostOff => GhostOff,
            IconSymbol.GoogleLens => GoogleLens,
            IconSymbol.GoogleSpreadsheet => GoogleSpreadsheet,
            IconSymbol.ImageMove => ImageMove,
            IconSymbol.KeyboardSettings => KeyboardSettings,
            IconSymbol.KeyboardSettingsOutline => KeyboardSettingsOutline,
            IconSymbol.Knife => Knife,
            IconSymbol.KnifeMilitary => KnifeMilitary,
            IconSymbol.LayersOffOutline => LayersOffOutline,
            IconSymbol.LayersOutline => LayersOutline,
            IconSymbol.Lighthouse => Lighthouse,
            IconSymbol.LighthouseOn => LighthouseOn,
            IconSymbol.MapLegend => MapLegend,
            IconSymbol.MenuLeftOutline => MenuLeftOutline,
            IconSymbol.MenuRightOutline => MenuRightOutline,
            IconSymbol.MessageAlertOutline => MessageAlertOutline,
            IconSymbol.MiniSd => MiniSd,
            IconSymbol.Minidisc => Minidisc,
            IconSymbol.MonitorDashboard => MonitorDashboard,
            IconSymbol.Pirate => Pirate,
            IconSymbol.PokemonGo => PokemonGo,
            IconSymbol.Powershell => Powershell,
            IconSymbol.PrinterWireless => PrinterWireless,
            IconSymbol.QualityLow => QualityLow,
            IconSymbol.QualityMedium => QualityMedium,
            IconSymbol.ReflectHorizontal => ReflectHorizontal,
            IconSymbol.ReflectVertical => ReflectVertical,
            IconSymbol.RhombusMedium => RhombusMedium,
            IconSymbol.RhombusSplit => RhombusSplit,
            IconSymbol.ShieldAccountOutline => ShieldAccountOutline,
            IconSymbol.SquareMedium => SquareMedium,
            IconSymbol.SquareMediumOutline => SquareMediumOutline,
            IconSymbol.SquareSmall => SquareSmall,
            IconSymbol.Subtitles => Subtitles,
            IconSymbol.SubtitlesOutline => SubtitlesOutline,
            IconSymbol.TableBorder => TableBorder,
            IconSymbol.ToggleSwitchOffOutline => ToggleSwitchOffOutline,
            IconSymbol.ToggleSwitchOutline => ToggleSwitchOutline,
            IconSymbol.Vhs => Vhs,
            IconSymbol.VideoVintage => VideoVintage,
            IconSymbol.ViewDashboardOutline => ViewDashboardOutline,
            IconSymbol.MicrosoftVisualStudioCode => MicrosoftVisualStudioCode,
            IconSymbol.Vote => Vote,
            IconSymbol.VoteOutline => VoteOutline,
            IconSymbol.MicrosoftWindowsClassic => MicrosoftWindowsClassic,
            IconSymbol.MicrosoftXboxControllerBatteryCharging => MicrosoftXboxControllerBatteryCharging,
            IconSymbol.ZipDisk => ZipDisk,
            IconSymbol.AspectRatio => AspectRatio,
            IconSymbol.Babel => Babel,
            IconSymbol.Balloon => Balloon,
            IconSymbol.BankTransfer => BankTransfer,
            IconSymbol.BankTransferIn => BankTransferIn,
            IconSymbol.BankTransferOut => BankTransferOut,
            IconSymbol.BriefcaseMinus => BriefcaseMinus,
            IconSymbol.BriefcasePlus => BriefcasePlus,
            IconSymbol.BriefcaseRemove => BriefcaseRemove,
            IconSymbol.BriefcaseSearch => BriefcaseSearch,
            IconSymbol.BugCheck => BugCheck,
            IconSymbol.BugCheckOutline => BugCheckOutline,
            IconSymbol.BugOutline => BugOutline,
            IconSymbol.CalendarAlert => CalendarAlert,
            IconSymbol.CalendarMultiselect => CalendarMultiselect,
            IconSymbol.CalendarWeek => CalendarWeek,
            IconSymbol.CalendarWeekBegin => CalendarWeekBegin,
            IconSymbol.CellphoneScreenshot => CellphoneScreenshot,
            IconSymbol.CityVariant => CityVariant,
            IconSymbol.CityVariantOutline => CityVariantOutline,
            IconSymbol.ClipboardTextOutline => ClipboardTextOutline,
            IconSymbol.CloudQuestion => CloudQuestion,
            IconSymbol.CommentEye => CommentEye,
            IconSymbol.CommentEyeOutline => CommentEyeOutline,
            IconSymbol.CommentSearch => CommentSearch,
            IconSymbol.CommentSearchOutline => CommentSearchOutline,
            IconSymbol.Contain => Contain,
            IconSymbol.ContainEnd => ContainEnd,
            IconSymbol.ContainStart => ContainStart,
            IconSymbol.Dlna => Dlna,
            IconSymbol.Doctor => Doctor,
            IconSymbol.Dog => Dog,
            IconSymbol.DogSide => DogSide,
            IconSymbol.EarHearingOff => EarHearingOff,
            IconSymbol.EngineOff => EngineOff,
            IconSymbol.EngineOffOutline => EngineOffOutline,
            IconSymbol.ExitRun => ExitRun,
            IconSymbol.FeatureSearch => FeatureSearch,
            IconSymbol.FeatureSearchOutline => FeatureSearchOutline,
            IconSymbol.FileAlert => FileAlert,
            IconSymbol.FileAlertOutline => FileAlertOutline,
            IconSymbol.FileUpload => FileUpload,
            IconSymbol.FileUploadOutline => FileUploadOutline,
            IconSymbol.HandFrontRight => HandFrontRight,
            IconSymbol.HandOkay => HandOkay,
            IconSymbol.HandPeace => HandPeace,
            IconSymbol.HandPeaceVariant => HandPeaceVariant,
            IconSymbol.HandPointingDown => HandPointingDown,
            IconSymbol.HandPointingLeft => HandPointingLeft,
            IconSymbol.HandPointingUp => HandPointingUp,
            IconSymbol.HeartMultiple => HeartMultiple,
            IconSymbol.HeartMultipleOutline => HeartMultipleOutline,
            IconSymbol.Horseshoe => Horseshoe,
            IconSymbol.HumanFemaleBoy => HumanFemaleBoy,
            IconSymbol.HumanFemaleFemale => HumanFemaleFemale,
            IconSymbol.HumanFemaleGirl => HumanFemaleGirl,
            IconSymbol.HumanMaleBoy => HumanMaleBoy,
            IconSymbol.HumanMaleGirl => HumanMaleGirl,
            IconSymbol.HumanMaleMale => HumanMaleMale,
            IconSymbol.Ip => Ip,
            IconSymbol.IpNetwork => IpNetwork,
            IconSymbol.Litecoin => Litecoin,
            IconSymbol.MagnifyMinusCursor => MagnifyMinusCursor,
            IconSymbol.MagnifyPlusCursor => MagnifyPlusCursor,
            IconSymbol.MenuSwap => MenuSwap,
            IconSymbol.MenuSwapOutline => MenuSwapOutline,
            IconSymbol.PuzzleOutline => PuzzleOutline,
            IconSymbol.RegisteredTrademark => RegisteredTrademark,
            IconSymbol.Resize => Resize,
            IconSymbol.RouterWirelessSettings => RouterWirelessSettings,
            IconSymbol.Safe => Safe,
            IconSymbol.ScissorsCutting => ScissorsCutting,
            IconSymbol.SelectDrag => SelectDrag,
            IconSymbol.SelectionDrag => SelectionDrag,
            IconSymbol.SettingsHelper => SettingsHelper,
            IconSymbol.Signal5g => Signal5g,
            IconSymbol.SilverwareForkKnife => SilverwareForkKnife,
            IconSymbol.Smog => Smog,
            IconSymbol.SolarPower => SolarPower,
            IconSymbol.StarBox => StarBox,
            IconSymbol.StarBoxOutline => StarBoxOutline,
            IconSymbol.TablePlus => TablePlus,
            IconSymbol.TableRemove => TableRemove,
            IconSymbol.TargetVariant => TargetVariant,
            IconSymbol.Trademark => Trademark,
            IconSymbol.TrashCan => TrashCan,
            IconSymbol.TrashCanOutline => TrashCanOutline,
            IconSymbol.TshirtCrew => TshirtCrew,
            IconSymbol.TshirtV => TshirtV,
            IconSymbol.ZodiacAquarius => ZodiacAquarius,
            IconSymbol.ZodiacAries => ZodiacAries,
            IconSymbol.ZodiacCancer => ZodiacCancer,
            IconSymbol.ZodiacCapricorn => ZodiacCapricorn,
            IconSymbol.ZodiacGemini => ZodiacGemini,
            IconSymbol.ZodiacLeo => ZodiacLeo,
            IconSymbol.ZodiacLibra => ZodiacLibra,
            IconSymbol.ZodiacPisces => ZodiacPisces,
            IconSymbol.ZodiacSagittarius => ZodiacSagittarius,
            IconSymbol.ZodiacScorpio => ZodiacScorpio,
            IconSymbol.ZodiacTaurus => ZodiacTaurus,
            IconSymbol.ZodiacVirgo => ZodiacVirgo,
            IconSymbol.AccountChild => AccountChild,
            IconSymbol.AccountChildCircle => AccountChildCircle,
            IconSymbol.AccountSupervisor => AccountSupervisor,
            IconSymbol.AccountSupervisorCircle => AccountSupervisorCircle,
            IconSymbol.Ampersand => Ampersand,
            IconSymbol.WebOff => WebOff,
            IconSymbol.AnimationOutline => AnimationOutline,
            IconSymbol.AnimationPlayOutline => AnimationPlayOutline,
            IconSymbol.BellOffOutline => BellOffOutline,
            IconSymbol.BellPlusOutline => BellPlusOutline,
            IconSymbol.BellSleepOutline => BellSleepOutline,
            IconSymbol.BookMinusMultiple => BookMinusMultiple,
            IconSymbol.BookPlusMultiple => BookPlusMultiple,
            IconSymbol.BookRemoveMultiple => BookRemoveMultiple,
            IconSymbol.BookRemove => BookRemove,
            IconSymbol.BriefcaseEdit => BriefcaseEdit,
            IconSymbol.BusAlert => BusAlert,
            IconSymbol.CalculatorVariant => CalculatorVariant,
            IconSymbol.CapsLock => CapsLock,
            IconSymbol.CashRefund => CashRefund,
            IconSymbol.Checkbook => Checkbook,
            IconSymbol.CircleSlice1 => CircleSlice1,
            IconSymbol.CircleSlice2 => CircleSlice2,
            IconSymbol.CircleSlice3 => CircleSlice3,
            IconSymbol.CircleSlice4 => CircleSlice4,
            IconSymbol.CircleSlice5 => CircleSlice5,
            IconSymbol.CircleSlice6 => CircleSlice6,
            IconSymbol.CircleSlice7 => CircleSlice7,
            IconSymbol.CircleSlice8 => CircleSlice8,
            IconSymbol.CollapseAll => CollapseAll,
            IconSymbol.CollapseAllOutline => CollapseAllOutline,
            IconSymbol.CreditCardRefundOutline => CreditCardRefundOutline,
            IconSymbol.DatabaseCheck => DatabaseCheck,
            IconSymbol.DatabaseLock => DatabaseLock,
            IconSymbol.DesktopTowerMonitor => DesktopTowerMonitor,
            IconSymbol.Dishwasher => Dishwasher,
            IconSymbol.DogService => DogService,
            IconSymbol.DotNet => DotNet,
            IconSymbol.Egg => Egg,
            IconSymbol.EggEaster => EggEaster,
            IconSymbol.EmailCheck => EmailCheck,
            IconSymbol.EmailCheckOutline => EmailCheckOutline,
            IconSymbol.Et => Et,
            IconSymbol.ExpandAll => ExpandAll,
            IconSymbol.ExpandAllOutline => ExpandAllOutline,
            IconSymbol.FileCabinet => FileCabinet,
            IconSymbol.TextBoxMultiple => TextBoxMultiple,
            IconSymbol.TextBoxMultipleOutline => TextBoxMultipleOutline,
            IconSymbol.FileMove => FileMove,
            IconSymbol.FolderClock => FolderClock,
            IconSymbol.FolderClockOutline => FolderClockOutline,
            IconSymbol.FormatAnnotationMinus => FormatAnnotationMinus,
            IconSymbol.GesturePinch => GesturePinch,
            IconSymbol.GestureSpread => GestureSpread,
            IconSymbol.GestureSwipeHorizontal => GestureSwipeHorizontal,
            IconSymbol.GestureSwipeVertical => GestureSwipeVertical,
            IconSymbol.Hail => Hail,
            IconSymbol.Helicopter => Helicopter,
            IconSymbol.HexagonSlice1 => HexagonSlice1,
            IconSymbol.HexagonSlice2 => HexagonSlice2,
            IconSymbol.HexagonSlice3 => HexagonSlice3,
            IconSymbol.HexagonSlice4 => HexagonSlice4,
            IconSymbol.HexagonSlice5 => HexagonSlice5,
            IconSymbol.HexagonSlice6 => HexagonSlice6,
            IconSymbol.Hexagram => Hexagram,
            IconSymbol.HexagramOutline => HexagramOutline,
            IconSymbol.LabelOff => LabelOff,
            IconSymbol.LabelOffOutline => LabelOffOutline,
            IconSymbol.LabelVariant => LabelVariant,
            IconSymbol.LabelVariantOutline => LabelVariantOutline,
            IconSymbol.LanguageRubyOnRails => LanguageRubyOnRails,
            IconSymbol.Laravel => Laravel,
            IconSymbol.Mastodon => Mastodon,
            IconSymbol.SortNumericDescendingVariant => SortNumericDescendingVariant,
            IconSymbol.MinusCircleMultipleOutline => MinusCircleMultipleOutline,
            IconSymbol.MusicCircleOutline => MusicCircleOutline,
            IconSymbol.Pinwheel => Pinwheel,
            IconSymbol.PinwheelOutline => PinwheelOutline,
            IconSymbol.RadiatorDisabled => RadiatorDisabled,
            IconSymbol.RadiatorOff => RadiatorOff,
            IconSymbol.SelectCompare => SelectCompare,
            IconSymbol.ShieldPlus => ShieldPlus,
            IconSymbol.ShieldPlusOutline => ShieldPlusOutline,
            IconSymbol.ShieldRemove => ShieldRemove,
            IconSymbol.ShieldRemoveOutline => ShieldRemoveOutline,
            IconSymbol.BookPlusMultipleOutline => BookPlusMultipleOutline,
            IconSymbol.SinaWeibo => SinaWeibo,
            IconSymbol.SprayBottle => SprayBottle,
            IconSymbol.Squeegee => Squeegee,
            IconSymbol.StarFourPoints => StarFourPoints,
            IconSymbol.StarFourPointsOutline => StarFourPointsOutline,
            IconSymbol.StarThreePoints => StarThreePoints,
            IconSymbol.StarThreePointsOutline => StarThreePointsOutline,
            IconSymbol.Symfony => Symfony,
            IconSymbol.Variable => Variable,
            IconSymbol.VectorBezier => VectorBezier,
            IconSymbol.Wiper => Wiper,
            IconSymbol.ZWave => ZWave,
            IconSymbol.Zend => Zend,
            IconSymbol.AccountMinusOutline => AccountMinusOutline,
            IconSymbol.AccountRemoveOutline => AccountRemoveOutline,
            IconSymbol.AlphaA => AlphaA,
            IconSymbol.AlphaB => AlphaB,
            IconSymbol.AlphaC => AlphaC,
            IconSymbol.AlphaD => AlphaD,
            IconSymbol.AlphaE => AlphaE,
            IconSymbol.AlphaF => AlphaF,
            IconSymbol.AlphaG => AlphaG,
            IconSymbol.AlphaH => AlphaH,
            IconSymbol.AlphaI => AlphaI,
            IconSymbol.AlphaJ => AlphaJ,
            IconSymbol.AlphaK => AlphaK,
            IconSymbol.AlphaL => AlphaL,
            IconSymbol.AlphaM => AlphaM,
            IconSymbol.AlphaN => AlphaN,
            IconSymbol.AlphaO => AlphaO,
            IconSymbol.AlphaP => AlphaP,
            IconSymbol.AlphaQ => AlphaQ,
            IconSymbol.AlphaR => AlphaR,
            IconSymbol.AlphaS => AlphaS,
            IconSymbol.AlphaT => AlphaT,
            IconSymbol.AlphaU => AlphaU,
            IconSymbol.AlphaV => AlphaV,
            IconSymbol.AlphaW => AlphaW,
            IconSymbol.AlphaX => AlphaX,
            IconSymbol.AlphaY => AlphaY,
            IconSymbol.AlphaZ => AlphaZ,
            IconSymbol.AlphaABox => AlphaABox,
            IconSymbol.AlphaBBox => AlphaBBox,
            IconSymbol.AlphaCBox => AlphaCBox,
            IconSymbol.AlphaDBox => AlphaDBox,
            IconSymbol.AlphaEBox => AlphaEBox,
            IconSymbol.AlphaFBox => AlphaFBox,
            IconSymbol.AlphaGBox => AlphaGBox,
            IconSymbol.AlphaHBox => AlphaHBox,
            IconSymbol.AlphaIBox => AlphaIBox,
            IconSymbol.AlphaJBox => AlphaJBox,
            IconSymbol.AlphaKBox => AlphaKBox,
            IconSymbol.AlphaLBox => AlphaLBox,
            IconSymbol.AlphaMBox => AlphaMBox,
            IconSymbol.AlphaNBox => AlphaNBox,
            IconSymbol.AlphaOBox => AlphaOBox,
            IconSymbol.AlphaPBox => AlphaPBox,
            IconSymbol.AlphaQBox => AlphaQBox,
            IconSymbol.AlphaRBox => AlphaRBox,
            IconSymbol.AlphaSBox => AlphaSBox,
            IconSymbol.AlphaTBox => AlphaTBox,
            IconSymbol.AlphaUBox => AlphaUBox,
            IconSymbol.AlphaVBox => AlphaVBox,
            IconSymbol.AlphaWBox => AlphaWBox,
            IconSymbol.AlphaXBox => AlphaXBox,
            IconSymbol.AlphaYBox => AlphaYBox,
            IconSymbol.AlphaZBox => AlphaZBox,
            IconSymbol.Bulldozer => Bulldozer,
            IconSymbol.BullhornOutline => BullhornOutline,
            IconSymbol.CalendarExport => CalendarExport,
            IconSymbol.CalendarImport => CalendarImport,
            IconSymbol.ChevronDownCircle => ChevronDownCircle,
            IconSymbol.ChevronDownCircleOutline => ChevronDownCircleOutline,
            IconSymbol.ChevronLeftCircle => ChevronLeftCircle,
            IconSymbol.ChevronLeftCircleOutline => ChevronLeftCircleOutline,
            IconSymbol.ChevronRightCircle => ChevronRightCircle,
            IconSymbol.ChevronRightCircleOutline => ChevronRightCircleOutline,
            IconSymbol.ChevronUpCircle => ChevronUpCircle,
            IconSymbol.ChevronUpCircleOutline => ChevronUpCircleOutline,
            IconSymbol.ContentSaveSettingsOutline => ContentSaveSettingsOutline,
            IconSymbol.CrystalBall => CrystalBall,
            IconSymbol.Ember => Ember,
            IconSymbol.FacebookWorkplace => FacebookWorkplace,
            IconSymbol.FileReplace => FileReplace,
            IconSymbol.FileReplaceOutline => FileReplaceOutline,
            IconSymbol.FormatLetterCase => FormatLetterCase,
            IconSymbol.FormatLetterCaseLower => FormatLetterCaseLower,
            IconSymbol.FormatLetterCaseUpper => FormatLetterCaseUpper,
            IconSymbol.LanguageJava => LanguageJava,
            IconSymbol.CircleMultiple => CircleMultiple,
            IconSymbol.Numeric1 => Numeric1,
            IconSymbol.Numeric2 => Numeric2,
            IconSymbol.Numeric3 => Numeric3,
            IconSymbol.Numeric4 => Numeric4,
            IconSymbol.Numeric5 => Numeric5,
            IconSymbol.Numeric6 => Numeric6,
            IconSymbol.Numeric7 => Numeric7,
            IconSymbol.Numeric8 => Numeric8,
            IconSymbol.Numeric9 => Numeric9,
            IconSymbol.Origin => Origin,
            IconSymbol.Resistor => Resistor,
            IconSymbol.ResistorNodes => ResistorNodes,
            IconSymbol.RobotIndustrial => RobotIndustrial,
            IconSymbol.ShoeFormal => ShoeFormal,
            IconSymbol.ShoeHeel => ShoeHeel,
            IconSymbol.SiloOutline => SiloOutline,
            IconSymbol.BoxCutterOff => BoxCutterOff,
            IconSymbol.TabMinus => TabMinus,
            IconSymbol.TabRemove => TabRemove,
            IconSymbol.TapeMeasure => TapeMeasure,
            IconSymbol.Telescope => Telescope,
            IconSymbol.Yahoo => Yahoo,
            IconSymbol.AccountAlertOutline => AccountAlertOutline,
            IconSymbol.AccountArrowLeft => AccountArrowLeft,
            IconSymbol.AccountArrowLeftOutline => AccountArrowLeftOutline,
            IconSymbol.AccountArrowRight => AccountArrowRight,
            IconSymbol.AccountArrowRightOutline => AccountArrowRightOutline,
            IconSymbol.AccountCircleOutline => AccountCircleOutline,
            IconSymbol.AccountClock => AccountClock,
            IconSymbol.AccountClockOutline => AccountClockOutline,
            IconSymbol.AccountGroupOutline => AccountGroupOutline,
            IconSymbol.AccountQuestion => AccountQuestion,
            IconSymbol.AccountQuestionOutline => AccountQuestionOutline,
            IconSymbol.Artstation => Artstation,
            IconSymbol.BackspaceOutline => BackspaceOutline,
            IconSymbol.BarleyOff => BarleyOff,
            IconSymbol.Barn => Barn,
            IconSymbol.Bat => Bat,
            IconSymbol.ApplicationSettings => ApplicationSettings,
            IconSymbol.Billiards => Billiards,
            IconSymbol.BilliardsRack => BilliardsRack,
            IconSymbol.BookOpenOutline => BookOpenOutline,
            IconSymbol.BookOutline => BookOutline,
            IconSymbol.BoxingGlove => BoxingGlove,
            IconSymbol.CalendarBlankOutline => CalendarBlankOutline,
            IconSymbol.CalendarOutline => CalendarOutline,
            IconSymbol.CalendarRangeOutline => CalendarRangeOutline,
            IconSymbol.CameraControl => CameraControl,
            IconSymbol.CameraEnhanceOutline => CameraEnhanceOutline,
            IconSymbol.CarDoor => CarDoor,
            IconSymbol.CarElectric => CarElectric,
            IconSymbol.CarKey => CarKey,
            IconSymbol.CarMultiple => CarMultiple,
            IconSymbol.Card => Card,
            IconSymbol.CardBulleted => CardBulleted,
            IconSymbol.CardBulletedOff => CardBulletedOff,
            IconSymbol.CardBulletedOffOutline => CardBulletedOffOutline,
            IconSymbol.CardBulletedOutline => CardBulletedOutline,
            IconSymbol.CardBulletedSettings => CardBulletedSettings,
            IconSymbol.CardBulletedSettingsOutline => CardBulletedSettingsOutline,
            IconSymbol.CardOutline => CardOutline,
            IconSymbol.CardText => CardText,
            IconSymbol.CardTextOutline => CardTextOutline,
            IconSymbol.Chat => Chat,
            IconSymbol.ChatAlert => ChatAlert,
            IconSymbol.ChatProcessing => ChatProcessing,
            IconSymbol.ChefHat => ChefHat,
            IconSymbol.CloudDownloadOutline => CloudDownloadOutline,
            IconSymbol.CloudUploadOutline => CloudUploadOutline,
            IconSymbol.Coffin => Coffin,
            IconSymbol.CompassOff => CompassOff,
            IconSymbol.CompassOffOutline => CompassOffOutline,
            IconSymbol.ControllerClassic => ControllerClassic,
            IconSymbol.ControllerClassicOutline => ControllerClassicOutline,
            IconSymbol.CubeScan => CubeScan,
            IconSymbol.CurrencyBrl => CurrencyBrl,
            IconSymbol.DatabaseEdit => DatabaseEdit,
            IconSymbol.DeathlyHallows => DeathlyHallows,
            IconSymbol.DeleteCircleOutline => DeleteCircleOutline,
            IconSymbol.DeleteForeverOutline => DeleteForeverOutline,
            IconSymbol.Diamond => Diamond,
            IconSymbol.DiamondOutline => DiamondOutline,
            IconSymbol.DnsOutline => DnsOutline,
            IconSymbol.DotsHorizontalCircleOutline => DotsHorizontalCircleOutline,
            IconSymbol.DotsVerticalCircleOutline => DotsVerticalCircleOutline,
            IconSymbol.DownloadOutline => DownloadOutline,
            IconSymbol.DragVariant => DragVariant,
            IconSymbol.EjectOutline => EjectOutline,
            IconSymbol.EmailMarkAsUnread => EmailMarkAsUnread,
            IconSymbol.ExportVariant => ExportVariant,
            IconSymbol.EyeCircle => EyeCircle,
            IconSymbol.EyeCircleOutline => EyeCircleOutline,
            IconSymbol.FaceManOutline => FaceManOutline,
            IconSymbol.FileFindOutline => FileFindOutline,
            IconSymbol.FileRemove => FileRemove,
            IconSymbol.FlagMinus => FlagMinus,
            IconSymbol.FlagPlus => FlagPlus,
            IconSymbol.FlagRemove => FlagRemove,
            IconSymbol.FolderAccountOutline => FolderAccountOutline,
            IconSymbol.FolderPlusOutline => FolderPlusOutline,
            IconSymbol.FolderRemoveOutline => FolderRemoveOutline,
            IconSymbol.FolderStarOutline => FolderStarOutline,
            IconSymbol.Gitlab => Gitlab,
            IconSymbol.Gog => Gog,
            IconSymbol.GraveStone => GraveStone,
            IconSymbol.Halloween => Halloween,
            IconSymbol.HatFedora => HatFedora,
            IconSymbol.HelpRhombus => HelpRhombus,
            IconSymbol.HelpRhombusOutline => HelpRhombusOutline,
            IconSymbol.HomeVariantOutline => HomeVariantOutline,
            IconSymbol.InboxMultipleOutline => InboxMultipleOutline,
            IconSymbol.LibraryShelves => LibraryShelves,
            IconSymbol.Mapbox => Mapbox,
            IconSymbol.MenuOpen => MenuOpen,
            IconSymbol.Molecule => Molecule,
            IconSymbol.OneUp => OneUp,
            IconSymbol.OpenSourceInitiative => OpenSourceInitiative,
            IconSymbol.PacMan => PacMan,
            IconSymbol.PageNext => PageNext,
            IconSymbol.PageNextOutline => PageNextOutline,
            IconSymbol.PagePrevious => PagePrevious,
            IconSymbol.PagePreviousOutline => PagePreviousOutline,
            IconSymbol.Pan => Pan,
            IconSymbol.PanBottomLeft => PanBottomLeft,
            IconSymbol.PanBottomRight => PanBottomRight,
            IconSymbol.PanDown => PanDown,
            IconSymbol.PanHorizontal => PanHorizontal,
            IconSymbol.PanLeft => PanLeft,
            IconSymbol.PanRight => PanRight,
            IconSymbol.PanTopLeft => PanTopLeft,
            IconSymbol.PanTopRight => PanTopRight,
            IconSymbol.PanUp => PanUp,
            IconSymbol.PanVertical => PanVertical,
            IconSymbol.Pumpkin => Pumpkin,
            IconSymbol.Rollupjs => Rollupjs,
            IconSymbol.Script => Script,
            IconSymbol.ScriptText => ScriptText,
            IconSymbol.ScriptTextOutline => ScriptTextOutline,
            IconSymbol.ShieldKey => ShieldKey,
            IconSymbol.ShieldKeyOutline => ShieldKeyOutline,
            IconSymbol.SkullCrossbones => SkullCrossbones,
            IconSymbol.SkullCrossbonesOutline => SkullCrossbonesOutline,
            IconSymbol.SkullOutline => SkullOutline,
            IconSymbol.SpaceInvaders => SpaceInvaders,
            IconSymbol.SpiderWeb => SpiderWeb,
            IconSymbol.ViewSplitHorizontal => ViewSplitHorizontal,
            IconSymbol.ViewSplitVertical => ViewSplitVertical,
            IconSymbol.SwapHorizontalBold => SwapHorizontalBold,
            IconSymbol.SwapVerticalBold => SwapVerticalBold,
            IconSymbol.TagHeartOutline => TagHeartOutline,
            IconSymbol.TargetAccount => TargetAccount,
            IconSymbol.Timeline => Timeline,
            IconSymbol.TimelineOutline => TimelineOutline,
            IconSymbol.TimelineText => TimelineText,
            IconSymbol.TimelineTextOutline => TimelineTextOutline,
            IconSymbol.TooltipImageOutline => TooltipImageOutline,
            IconSymbol.TooltipPlus => TooltipPlus,
            IconSymbol.TooltipTextOutline => TooltipTextOutline,
            IconSymbol.TrainCar => TrainCar,
            IconSymbol.Triforce => Triforce,
            IconSymbol.Ubisoft => Ubisoft,
            IconSymbol.VideoOffOutline => VideoOffOutline,
            IconSymbol.VideoOutline => VideoOutline,
            IconSymbol.WalletOutline => WalletOutline,
            IconSymbol.Waze => Waze,
            IconSymbol.WrapDisabled => WrapDisabled,
            IconSymbol.WrenchOutline => WrenchOutline,
            IconSymbol.AccessPointNetworkOff => AccessPointNetworkOff,
            IconSymbol.AccountCheckOutline => AccountCheckOutline,
            IconSymbol.AccountHeartOutline => AccountHeartOutline,
            IconSymbol.AccountKeyOutline => AccountKeyOutline,
            IconSymbol.AccountMultipleMinusOutline => AccountMultipleMinusOutline,
            IconSymbol.AccountNetworkOutline => AccountNetworkOutline,
            IconSymbol.AccountOffOutline => AccountOffOutline,
            IconSymbol.AccountStarOutline => AccountStarOutline,
            IconSymbol.Airbag => Airbag,
            IconSymbol.AlarmLightOutline => AlarmLightOutline,
            IconSymbol.AlphaABoxOutline => AlphaABoxOutline,
            IconSymbol.AlphaACircle => AlphaACircle,
            IconSymbol.AlphaACircleOutline => AlphaACircleOutline,
            IconSymbol.AlphaBBoxOutline => AlphaBBoxOutline,
            IconSymbol.AlphaBCircle => AlphaBCircle,
            IconSymbol.AlphaBCircleOutline => AlphaBCircleOutline,
            IconSymbol.AlphaCBoxOutline => AlphaCBoxOutline,
            IconSymbol.AlphaCCircle => AlphaCCircle,
            IconSymbol.AlphaCCircleOutline => AlphaCCircleOutline,
            IconSymbol.AlphaDBoxOutline => AlphaDBoxOutline,
            IconSymbol.AlphaDCircle => AlphaDCircle,
            IconSymbol.AlphaDCircleOutline => AlphaDCircleOutline,
            IconSymbol.AlphaEBoxOutline => AlphaEBoxOutline,
            IconSymbol.AlphaECircle => AlphaECircle,
            IconSymbol.AlphaECircleOutline => AlphaECircleOutline,
            IconSymbol.AlphaFBoxOutline => AlphaFBoxOutline,
            IconSymbol.AlphaFCircle => AlphaFCircle,
            IconSymbol.AlphaFCircleOutline => AlphaFCircleOutline,
            IconSymbol.AlphaGBoxOutline => AlphaGBoxOutline,
            IconSymbol.AlphaGCircle => AlphaGCircle,
            IconSymbol.AlphaGCircleOutline => AlphaGCircleOutline,
            IconSymbol.AlphaHBoxOutline => AlphaHBoxOutline,
            IconSymbol.AlphaHCircle => AlphaHCircle,
            IconSymbol.AlphaHCircleOutline => AlphaHCircleOutline,
            IconSymbol.AlphaIBoxOutline => AlphaIBoxOutline,
            IconSymbol.AlphaICircle => AlphaICircle,
            IconSymbol.AlphaICircleOutline => AlphaICircleOutline,
            IconSymbol.AlphaJBoxOutline => AlphaJBoxOutline,
            IconSymbol.AlphaJCircle => AlphaJCircle,
            IconSymbol.AlphaJCircleOutline => AlphaJCircleOutline,
            IconSymbol.AlphaKBoxOutline => AlphaKBoxOutline,
            IconSymbol.AlphaKCircle => AlphaKCircle,
            IconSymbol.AlphaKCircleOutline => AlphaKCircleOutline,
            IconSymbol.AlphaLBoxOutline => AlphaLBoxOutline,
            IconSymbol.AlphaLCircle => AlphaLCircle,
            IconSymbol.AlphaLCircleOutline => AlphaLCircleOutline,
            IconSymbol.AlphaMBoxOutline => AlphaMBoxOutline,
            IconSymbol.AlphaMCircle => AlphaMCircle,
            IconSymbol.AlphaMCircleOutline => AlphaMCircleOutline,
            IconSymbol.AlphaNBoxOutline => AlphaNBoxOutline,
            IconSymbol.AlphaNCircle => AlphaNCircle,
            IconSymbol.AlphaNCircleOutline => AlphaNCircleOutline,
            IconSymbol.AlphaOBoxOutline => AlphaOBoxOutline,
            IconSymbol.AlphaOCircle => AlphaOCircle,
            IconSymbol.AlphaOCircleOutline => AlphaOCircleOutline,
            IconSymbol.AlphaPBoxOutline => AlphaPBoxOutline,
            IconSymbol.AlphaPCircle => AlphaPCircle,
            IconSymbol.AlphaPCircleOutline => AlphaPCircleOutline,
            IconSymbol.AlphaQBoxOutline => AlphaQBoxOutline,
            IconSymbol.AlphaQCircle => AlphaQCircle,
            IconSymbol.AlphaQCircleOutline => AlphaQCircleOutline,
            IconSymbol.AlphaRBoxOutline => AlphaRBoxOutline,
            IconSymbol.AlphaRCircle => AlphaRCircle,
            IconSymbol.AlphaRCircleOutline => AlphaRCircleOutline,
            IconSymbol.AlphaSBoxOutline => AlphaSBoxOutline,
            IconSymbol.AlphaSCircle => AlphaSCircle,
            IconSymbol.AlphaSCircleOutline => AlphaSCircleOutline,
            IconSymbol.AlphaTBoxOutline => AlphaTBoxOutline,
            IconSymbol.AlphaTCircle => AlphaTCircle,
            IconSymbol.AlphaTCircleOutline => AlphaTCircleOutline,
            IconSymbol.AlphaUBoxOutline => AlphaUBoxOutline,
            IconSymbol.AlphaUCircle => AlphaUCircle,
            IconSymbol.AlphaUCircleOutline => AlphaUCircleOutline,
            IconSymbol.AlphaVBoxOutline => AlphaVBoxOutline,
            IconSymbol.AlphaVCircle => AlphaVCircle,
            IconSymbol.AlphaVCircleOutline => AlphaVCircleOutline,
            IconSymbol.AlphaWBoxOutline => AlphaWBoxOutline,
            IconSymbol.AlphaWCircle => AlphaWCircle,
            IconSymbol.AlphaWCircleOutline => AlphaWCircleOutline,
            IconSymbol.AlphaXBoxOutline => AlphaXBoxOutline,
            IconSymbol.AlphaXCircle => AlphaXCircle,
            IconSymbol.AlphaXCircleOutline => AlphaXCircleOutline,
            IconSymbol.AlphaYBoxOutline => AlphaYBoxOutline,
            IconSymbol.AlphaYCircle => AlphaYCircle,
            IconSymbol.AlphaYCircleOutline => AlphaYCircleOutline,
            IconSymbol.AlphaZBoxOutline => AlphaZBoxOutline,
            IconSymbol.AlphaZCircle => AlphaZCircle,
            IconSymbol.AlphaZCircleOutline => AlphaZCircleOutline,
            IconSymbol.BallotRecount => BallotRecount,
            IconSymbol.BallotRecountOutline => BallotRecountOutline,
            IconSymbol.BasketballHoop => BasketballHoop,
            IconSymbol.BasketballHoopOutline => BasketballHoopOutline,
            IconSymbol.BriefcaseDownloadOutline => BriefcaseDownloadOutline,
            IconSymbol.BriefcaseEditOutline => BriefcaseEditOutline,
            IconSymbol.BriefcaseMinusOutline => BriefcaseMinusOutline,
            IconSymbol.BriefcasePlusOutline => BriefcasePlusOutline,
            IconSymbol.BriefcaseRemoveOutline => BriefcaseRemoveOutline,
            IconSymbol.BriefcaseSearchOutline => BriefcaseSearchOutline,
            IconSymbol.BriefcaseUploadOutline => BriefcaseUploadOutline,
            IconSymbol.CalendarCheckOutline => CalendarCheckOutline,
            IconSymbol.CalendarRemoveOutline => CalendarRemoveOutline,
            IconSymbol.CalendarTextOutline => CalendarTextOutline,
            IconSymbol.CarBrakeAbs => CarBrakeAbs,
            IconSymbol.CarBrakeAlert => CarBrakeAlert,
            IconSymbol.CarEsp => CarEsp,
            IconSymbol.CarLightDimmed => CarLightDimmed,
            IconSymbol.CarLightFog => CarLightFog,
            IconSymbol.CarLightHigh => CarLightHigh,
            IconSymbol.CarTireAlert => CarTireAlert,
            IconSymbol.CartArrowRight => CartArrowRight,
            IconSymbol.Charity => Charity,
            IconSymbol.ChartBellCurve => ChartBellCurve,
            IconSymbol.CheckboxMultipleOutline => CheckboxMultipleOutline,
            IconSymbol.CheckboxOutline => CheckboxOutline,
            IconSymbol.CheckNetwork => CheckNetwork,
            IconSymbol.CheckNetworkOutline => CheckNetworkOutline,
            IconSymbol.ClipboardAccountOutline => ClipboardAccountOutline,
            IconSymbol.ClipboardArrowDownOutline => ClipboardArrowDownOutline,
            IconSymbol.ClipboardArrowUp => ClipboardArrowUp,
            IconSymbol.ClipboardArrowUpOutline => ClipboardArrowUpOutline,
            IconSymbol.ClipboardPlay => ClipboardPlay,
            IconSymbol.ClipboardPlayOutline => ClipboardPlayOutline,
            IconSymbol.ClipboardTextPlay => ClipboardTextPlay,
            IconSymbol.ClipboardTextPlayOutline => ClipboardTextPlayOutline,
            IconSymbol.CloseBoxMultiple => CloseBoxMultiple,
            IconSymbol.CloseBoxMultipleOutline => CloseBoxMultipleOutline,
            IconSymbol.CloseNetworkOutline => CloseNetworkOutline,
            IconSymbol.ConsoleNetworkOutline => ConsoleNetworkOutline,
            IconSymbol.CurrencyIls => CurrencyIls,
            IconSymbol.DeleteSweepOutline => DeleteSweepOutline,
            IconSymbol.Diameter => Diameter,
            IconSymbol.DiameterOutline => DiameterOutline,
            IconSymbol.DiameterVariant => DiameterVariant,
            IconSymbol.DownloadNetworkOutline => DownloadNetworkOutline,
            IconSymbol.DumpTruck => DumpTruck,
            IconSymbol.Emoticon => Emoticon,
            IconSymbol.EmoticonAngry => EmoticonAngry,
            IconSymbol.EmoticonAngryOutline => EmoticonAngryOutline,
            IconSymbol.EmoticonCool => EmoticonCool,
            IconSymbol.EmoticonCry => EmoticonCry,
            IconSymbol.EmoticonCryOutline => EmoticonCryOutline,
            IconSymbol.EmoticonDead => EmoticonDead,
            IconSymbol.EmoticonDevil => EmoticonDevil,
            IconSymbol.EmoticonExcited => EmoticonExcited,
            IconSymbol.EmoticonHappy => EmoticonHappy,
            IconSymbol.EmoticonKiss => EmoticonKiss,
            IconSymbol.EmoticonKissOutline => EmoticonKissOutline,
            IconSymbol.EmoticonNeutral => EmoticonNeutral,
            IconSymbol.EmoticonPoopOutline => EmoticonPoopOutline,
            IconSymbol.EmoticonSad => EmoticonSad,
            IconSymbol.EmoticonTongueOutline => EmoticonTongueOutline,
            IconSymbol.EmoticonWink => EmoticonWink,
            IconSymbol.EmoticonWinkOutline => EmoticonWinkOutline,
            IconSymbol.Eslint => Eslint,
            IconSymbol.FaceRecognition => FaceRecognition,
            IconSymbol.FileSearch => FileSearch,
            IconSymbol.FileSearchOutline => FileSearchOutline,
            IconSymbol.FileTable => FileTable,
            IconSymbol.FileTableOutline => FileTableOutline,
            IconSymbol.FolderKeyNetworkOutline => FolderKeyNetworkOutline,
            IconSymbol.FolderNetworkOutline => FolderNetworkOutline,
            IconSymbol.FolderText => FolderText,
            IconSymbol.FolderTextOutline => FolderTextOutline,
            IconSymbol.FoodAppleOutline => FoodAppleOutline,
            IconSymbol.Fuse => Fuse,
            IconSymbol.FuseBlade => FuseBlade,
            IconSymbol.GoogleAds => GoogleAds,
            IconSymbol.GoogleStreetView => GoogleStreetView,
            IconSymbol.HazardLights => HazardLights,
            IconSymbol.HelpNetworkOutline => HelpNetworkOutline,
            IconSymbol.ApplicationBrackets => ApplicationBrackets,
            IconSymbol.ApplicationBracketsOutline => ApplicationBracketsOutline,
            IconSymbol.ImageSizeSelectActual => ImageSizeSelectActual,
            IconSymbol.ImageSizeSelectLarge => ImageSizeSelectLarge,
            IconSymbol.ImageSizeSelectSmall => ImageSizeSelectSmall,
            IconSymbol.IpNetworkOutline => IpNetworkOutline,
            IconSymbol.Ipod => Ipod,
            IconSymbol.LanguageHaskell => LanguageHaskell,
            IconSymbol.LeafMaple => LeafMaple,
            IconSymbol.LinkPlus => LinkPlus,
            IconSymbol.MapMarkerCheck => MapMarkerCheck,
            IconSymbol.MathCos => MathCos,
            IconSymbol.MathSin => MathSin,
            IconSymbol.MathTan => MathTan,
            IconSymbol.Microwave => Microwave,
            IconSymbol.MinusNetworkOutline => MinusNetworkOutline,
            IconSymbol.NetworkOff => NetworkOff,
            IconSymbol.NetworkOffOutline => NetworkOffOutline,
            IconSymbol.NetworkOutline => NetworkOutline,
            IconSymbol.Numeric1Circle => Numeric1Circle,
            IconSymbol.Numeric1CircleOutline => Numeric1CircleOutline,
            IconSymbol.Numeric2Circle => Numeric2Circle,
            IconSymbol.Numeric2CircleOutline => Numeric2CircleOutline,
            IconSymbol.Numeric3Circle => Numeric3Circle,
            IconSymbol.Numeric3CircleOutline => Numeric3CircleOutline,
            IconSymbol.Numeric4Circle => Numeric4Circle,
            IconSymbol.Numeric4CircleOutline => Numeric4CircleOutline,
            IconSymbol.Numeric5Circle => Numeric5Circle,
            IconSymbol.Numeric5CircleOutline => Numeric5CircleOutline,
            IconSymbol.Numeric6Circle => Numeric6Circle,
            IconSymbol.Numeric6CircleOutline => Numeric6CircleOutline,
            IconSymbol.Numeric7Circle => Numeric7Circle,
            IconSymbol.Numeric7CircleOutline => Numeric7CircleOutline,
            IconSymbol.Numeric8Circle => Numeric8Circle,
            IconSymbol.Numeric8CircleOutline => Numeric8CircleOutline,
            IconSymbol.Numeric9Circle => Numeric9Circle,
            IconSymbol.Numeric9CircleOutline => Numeric9CircleOutline,
            IconSymbol.Numeric9PlusCircle => Numeric9PlusCircle,
            IconSymbol.Numeric9PlusCircleOutline => Numeric9PlusCircleOutline,
            IconSymbol.Parachute => Parachute,
            IconSymbol.ParachuteOutline => ParachuteOutline,
            IconSymbol.PencilOutline => PencilOutline,
            IconSymbol.PlayNetworkOutline => PlayNetworkOutline,
            IconSymbol.PlaylistMusic => PlaylistMusic,
            IconSymbol.PlaylistMusicOutline => PlaylistMusicOutline,
            IconSymbol.PlusNetworkOutline => PlusNetworkOutline,
            IconSymbol.PostageStamp => PostageStamp,
            IconSymbol.ProgressAlert => ProgressAlert,
            IconSymbol.ProgressWrench => ProgressWrench,
            IconSymbol.RadioAm => RadioAm,
            IconSymbol.RadioFm => RadioFm,
            IconSymbol.Radius => Radius,
            IconSymbol.RadiusOutline => RadiusOutline,
            IconSymbol.RulerSquare => RulerSquare,
            IconSymbol.Seat => Seat,
            IconSymbol.SeatOutline => SeatOutline,
            IconSymbol.Seatbelt => Seatbelt,
            IconSymbol.Sheep => Sheep,
            IconSymbol.ShieldAirplaneOutline => ShieldAirplaneOutline,
            IconSymbol.ShieldCheckOutline => ShieldCheckOutline,
            IconSymbol.ShieldCross => ShieldCross,
            IconSymbol.ShieldCrossOutline => ShieldCrossOutline,
            IconSymbol.ShieldHomeOutline => ShieldHomeOutline,
            IconSymbol.ShieldLockOutline => ShieldLockOutline,
            IconSymbol.SortVariantLock => SortVariantLock,
            IconSymbol.SortVariantLockOpen => SortVariantLockOpen,
            IconSymbol.SourceRepository => SourceRepository,
            IconSymbol.SourceRepositoryMultiple => SourceRepositoryMultiple,
            IconSymbol.Spa => Spa,
            IconSymbol.SpaOutline => SpaOutline,
            IconSymbol.ToasterOven => ToasterOven,
            IconSymbol.TruckCheck => TruckCheck,
            IconSymbol.Turnstile => Turnstile,
            IconSymbol.TurnstileOutline => TurnstileOutline,
            IconSymbol.Turtle => Turtle,
            IconSymbol.UploadNetworkOutline => UploadNetworkOutline,
            IconSymbol.VibrateOff => VibrateOff,
            IconSymbol.WatchVibrateOff => WatchVibrateOff,
            IconSymbol.ArrowDownCircle => ArrowDownCircle,
            IconSymbol.ArrowDownCircleOutline => ArrowDownCircleOutline,
            IconSymbol.ArrowLeftCircle => ArrowLeftCircle,
            IconSymbol.ArrowLeftCircleOutline => ArrowLeftCircleOutline,
            IconSymbol.ArrowRightCircle => ArrowRightCircle,
            IconSymbol.ArrowRightCircleOutline => ArrowRightCircleOutline,
            IconSymbol.ArrowUpCircle => ArrowUpCircle,
            IconSymbol.ArrowUpCircleOutline => ArrowUpCircleOutline,
            IconSymbol.AccountTie => AccountTie,
            IconSymbol.AlertBoxOutline => AlertBoxOutline,
            IconSymbol.AlertDecagramOutline => AlertDecagramOutline,
            IconSymbol.AlertOctagonOutline => AlertOctagonOutline,
            IconSymbol.AlertOctagramOutline => AlertOctagramOutline,
            IconSymbol.Ammunition => Ammunition,
            IconSymbol.AccountMusicOutline => AccountMusicOutline,
            IconSymbol.Beaker => Beaker,
            IconSymbol.Blender => Blender,
            IconSymbol.BloodBag => BloodBag,
            IconSymbol.CrossBolnisi => CrossBolnisi,
            IconSymbol.BreadSlice => BreadSlice,
            IconSymbol.BreadSliceOutline => BreadSliceOutline,
            IconSymbol.BriefcaseAccount => BriefcaseAccount,
            IconSymbol.BriefcaseAccountOutline => BriefcaseAccountOutline,
            IconSymbol.BrightnessPercent => BrightnessPercent,
            IconSymbol.Bullet => Bullet,
            IconSymbol.CashRegister => CashRegister,
            IconSymbol.CrossCeltic => CrossCeltic,
            IconSymbol.CrossOutline => CrossOutline,
            IconSymbol.ClipboardAlertOutline => ClipboardAlertOutline,
            IconSymbol.ClipboardArrowLeftOutline => ClipboardArrowLeftOutline,
            IconSymbol.ClipboardArrowRight => ClipboardArrowRight,
            IconSymbol.ClipboardArrowRightOutline => ClipboardArrowRightOutline,
            IconSymbol.ContentSaveEdit => ContentSaveEdit,
            IconSymbol.ContentSaveEditOutline => ContentSaveEditOutline,
            IconSymbol.CursorDefaultClick => CursorDefaultClick,
            IconSymbol.CursorDefaultClickOutline => CursorDefaultClickOutline,
            IconSymbol.DatabaseSync => DatabaseSync,
            IconSymbol.DatabaseRemove => DatabaseRemove,
            IconSymbol.DatabaseSettings => DatabaseSettings,
            IconSymbol.DramaMasks => DramaMasks,
            IconSymbol.EmailBox => EmailBox,
            IconSymbol.EyeCheck => EyeCheck,
            IconSymbol.EyeCheckOutline => EyeCheckOutline,
            IconSymbol.FastForward30 => FastForward30,
            IconSymbol.OrderAlphabeticalDescending => OrderAlphabeticalDescending,
            IconSymbol.FlowerPoppy => FlowerPoppy,
            IconSymbol.FolderPound => FolderPound,
            IconSymbol.FolderPoundOutline => FolderPoundOutline,
            IconSymbol.FolderSync => FolderSync,
            IconSymbol.FolderSyncOutline => FolderSyncOutline,
            IconSymbol.FormatListNumberedRtl => FormatListNumberedRtl,
            IconSymbol.FormatTextWrappingClip => FormatTextWrappingClip,
            IconSymbol.FormatTextWrappingOverflow => FormatTextWrappingOverflow,
            IconSymbol.FormatTextWrappingWrap => FormatTextWrappingWrap,
            IconSymbol.FormatTextbox => FormatTextbox,
            IconSymbol.FountainPen => FountainPen,
            IconSymbol.FountainPenTip => FountainPenTip,
            IconSymbol.HeartBrokenOutline => HeartBrokenOutline,
            IconSymbol.HomeCity => HomeCity,
            IconSymbol.HomeCityOutline => HomeCityOutline,
            IconSymbol.Hubspot => Hubspot,
            IconSymbol.FilmstripBoxMultiple => FilmstripBoxMultiple,
            IconSymbol.PlayBoxMultiple => PlayBoxMultiple,
            IconSymbol.LinkBox => LinkBox,
            IconSymbol.LinkBoxOutline => LinkBoxOutline,
            IconSymbol.LinkBoxVariant => LinkBoxVariant,
            IconSymbol.LinkBoxVariantOutline => LinkBoxVariantOutline,
            IconSymbol.MapClock => MapClock,
            IconSymbol.MapClockOutline => MapClockOutline,
            IconSymbol.MapMarkerPath => MapMarkerPath,
            IconSymbol.MotherNurse => MotherNurse,
            IconSymbol.MicrosoftOutlook => MicrosoftOutlook,
            IconSymbol.PerspectiveLess => PerspectiveLess,
            IconSymbol.PerspectiveMore => PerspectiveMore,
            IconSymbol.Podium => Podium,
            IconSymbol.PodiumBronze => PodiumBronze,
            IconSymbol.PodiumGold => PodiumGold,
            IconSymbol.PodiumSilver => PodiumSilver,
            IconSymbol.Quora => Quora,
            IconSymbol.Rewind10 => Rewind10,
            IconSymbol.RollerSkate => RollerSkate,
            IconSymbol.Rollerblade => Rollerblade,
            IconSymbol.LanguageRuby => LanguageRuby,
            IconSymbol.Sack => Sack,
            IconSymbol.SackPercent => SackPercent,
            IconSymbol.SafetyGoggles => SafetyGoggles,
            IconSymbol.SelectColor => SelectColor,
            IconSymbol.SelectionEllipse => SelectionEllipse,
            IconSymbol.ShieldLinkVariant => ShieldLinkVariant,
            IconSymbol.ShieldLinkVariantOutline => ShieldLinkVariantOutline,
            IconSymbol.Skate => Skate,
            IconSymbol.SkewLess => SkewLess,
            IconSymbol.SkewMore => SkewMore,
            IconSymbol.SpeakerMultiple => SpeakerMultiple,
            IconSymbol.Stamper => Stamper,
            IconSymbol.Tank => Tank,
            IconSymbol.Tortoise => Tortoise,
            IconSymbol.TransitConnection => TransitConnection,
            IconSymbol.TransitConnectionVariant => TransitConnectionVariant,
            IconSymbol.TransmissionTower => TransmissionTower,
            IconSymbol.WeightGram => WeightGram,
            IconSymbol.YoutubeSubscription => YoutubeSubscription,
            IconSymbol.Zigbee => Zigbee,
            IconSymbol.EmailAlertOutline => EmailAlertOutline,
            IconSymbol.AirFilter => AirFilter,
            IconSymbol.AirPurifier => AirPurifier,
            IconSymbol.Mosque => Mosque,
            IconSymbol.AppsBox => AppsBox,
            IconSymbol.Atm => Atm,
            IconSymbol.Axis => Axis,
            IconSymbol.AxisArrow => AxisArrow,
            IconSymbol.AxisArrowLock => AxisArrowLock,
            IconSymbol.AxisLock => AxisLock,
            IconSymbol.AxisXArrow => AxisXArrow,
            IconSymbol.AxisXArrowLock => AxisXArrowLock,
            IconSymbol.AxisXRotateClockwise => AxisXRotateClockwise,
            IconSymbol.AxisXRotateCounterclockwise => AxisXRotateCounterclockwise,
            IconSymbol.AxisXYArrowLock => AxisXYArrowLock,
            IconSymbol.AxisYArrow => AxisYArrow,
            IconSymbol.AxisYArrowLock => AxisYArrowLock,
            IconSymbol.AxisYRotateClockwise => AxisYRotateClockwise,
            IconSymbol.AxisYRotateCounterclockwise => AxisYRotateCounterclockwise,
            IconSymbol.AxisZArrow => AxisZArrow,
            IconSymbol.AxisZArrowLock => AxisZArrowLock,
            IconSymbol.AxisZRotateClockwise => AxisZRotateClockwise,
            IconSymbol.AxisZRotateCounterclockwise => AxisZRotateCounterclockwise,
            IconSymbol.BellAlert => BellAlert,
            IconSymbol.BellCircle => BellCircle,
            IconSymbol.BellCircleOutline => BellCircleOutline,
            IconSymbol.CalendarMinus => CalendarMinus,
            IconSymbol.CameraOutline => CameraOutline,
            IconSymbol.CarBrakeHold => CarBrakeHold,
            IconSymbol.CarBrakeParking => CarBrakeParking,
            IconSymbol.CarCruiseControl => CarCruiseControl,
            IconSymbol.CarDefrostFront => CarDefrostFront,
            IconSymbol.CarDefrostRear => CarDefrostRear,
            IconSymbol.CarParkingLights => CarParkingLights,
            IconSymbol.CarTractionControl => CarTractionControl,
            IconSymbol.BagCarryOnCheck => BagCarryOnCheck,
            IconSymbol.CartArrowDown => CartArrowDown,
            IconSymbol.CartArrowUp => CartArrowUp,
            IconSymbol.CartMinus => CartMinus,
            IconSymbol.CartRemove => CartRemove,
            IconSymbol.ContactlessPayment => ContactlessPayment,
            IconSymbol.CreativeCommons => CreativeCommons,
            IconSymbol.CreditCardWirelessOutline => CreditCardWirelessOutline,
            IconSymbol.Cricket => Cricket,
            IconSymbol.DevTo => DevTo,
            IconSymbol.DomainOff => DomainOff,
            IconSymbol.FaceAgent => FaceAgent,
            IconSymbol.FastForward10 => FastForward10,
            IconSymbol.Flare => Flare,
            IconSymbol.FormatTextRotationDown => FormatTextRotationDown,
            IconSymbol.FormatTextRotationNone => FormatTextRotationNone,
            IconSymbol.Forwardburger => Forwardburger,
            IconSymbol.GestureSwipe => GestureSwipe,
            IconSymbol.GestureTapHold => GestureTapHold,
            IconSymbol.FileGifBox => FileGifBox,
            IconSymbol.GoKart => GoKart,
            IconSymbol.GoKartTrack => GoKartTrack,
            IconSymbol.Goodreads => Goodreads,
            IconSymbol.Grain => Grain,
            IconSymbol.Hdr => Hdr,
            IconSymbol.HdrOff => HdrOff,
            IconSymbol.Hiking => Hiking,
            IconSymbol.HomeFloor1 => HomeFloor1,
            IconSymbol.HomeFloor2 => HomeFloor2,
            IconSymbol.HomeFloor3 => HomeFloor3,
            IconSymbol.HomeFloorA => HomeFloorA,
            IconSymbol.HomeFloorB => HomeFloorB,
            IconSymbol.HomeFloorG => HomeFloorG,
            IconSymbol.HomeFloorL => HomeFloorL,
            IconSymbol.Kabaddi => Kabaddi,
            IconSymbol.MailboxOpen => MailboxOpen,
            IconSymbol.MailboxOpenOutline => MailboxOpenOutline,
            IconSymbol.MailboxOpenUp => MailboxOpenUp,
            IconSymbol.MailboxOpenUpOutline => MailboxOpenUpOutline,
            IconSymbol.MailboxOutline => MailboxOutline,
            IconSymbol.MailboxUp => MailboxUp,
            IconSymbol.MailboxUpOutline => MailboxUpOutline,
            IconSymbol.MixedMartialArts => MixedMartialArts,
            IconSymbol.MonitorOff => MonitorOff,
            IconSymbol.MotionSensor => MotionSensor,
            IconSymbol.PointOfSale => PointOfSale,
            IconSymbol.RacingHelmet => RacingHelmet,
            IconSymbol.Racquetball => Racquetball,
            IconSymbol.RestartOff => RestartOff,
            IconSymbol.Rewind30 => Rewind30,
            IconSymbol.RoomServiceOutline => RoomServiceOutline,
            IconSymbol.RotateOrbit => RotateOrbit,
            IconSymbol.Rugby => Rugby,
            IconSymbol.ShieldSearch => ShieldSearch,
            IconSymbol.SolarPanel => SolarPanel,
            IconSymbol.SolarPanelLarge => SolarPanelLarge,
            IconSymbol.SubwayAlertVariant => SubwayAlertVariant,
            IconSymbol.Tea => Tea,
            IconSymbol.TeaOutline => TeaOutline,
            IconSymbol.Tennis => Tennis,
            IconSymbol.TransferDown => TransferDown,
            IconSymbol.TransferLeft => TransferLeft,
            IconSymbol.TransferUp => TransferUp,
            IconSymbol.TrophyBroken => TrophyBroken,
            IconSymbol.WindTurbine => WindTurbine,
            IconSymbol.WiperWash => WiperWash,
            IconSymbol.BadgeAccount => BadgeAccount,
            IconSymbol.BadgeAccountAlert => BadgeAccountAlert,
            IconSymbol.BadgeAccountAlertOutline => BadgeAccountAlertOutline,
            IconSymbol.BadgeAccountOutline => BadgeAccountOutline,
            IconSymbol.CardAccountDetailsOutline => CardAccountDetailsOutline,
            IconSymbol.AirHorn => AirHorn,
            IconSymbol.ApplicationExport => ApplicationExport,
            IconSymbol.ApplicationImport => ApplicationImport,
            IconSymbol.Bandage => Bandage,
            IconSymbol.BankMinus => BankMinus,
            IconSymbol.BankPlus => BankPlus,
            IconSymbol.BankRemove => BankRemove,
            IconSymbol.Bolt => Bolt,
            IconSymbol.Bugle => Bugle,
            IconSymbol.Cactus => Cactus,
            IconSymbol.CameraWireless => CameraWireless,
            IconSymbol.CameraWirelessOutline => CameraWirelessOutline,
            IconSymbol.CashMarker => CashMarker,
            IconSymbol.ChevronTripleDown => ChevronTripleDown,
            IconSymbol.ChevronTripleLeft => ChevronTripleLeft,
            IconSymbol.ChevronTripleRight => ChevronTripleRight,
            IconSymbol.ChevronTripleUp => ChevronTripleUp,
            IconSymbol.ClosedCaptionOutline => ClosedCaptionOutline,
            IconSymbol.CreditCardMarkerOutline => CreditCardMarkerOutline,
            IconSymbol.DivingFlippers => DivingFlippers,
            IconSymbol.DivingHelmet => DivingHelmet,
            IconSymbol.DivingScubaMask => DivingScubaMask,
            IconSymbol.DivingScubaFlag => DivingScubaFlag,
            IconSymbol.DivingScubaTank => DivingScubaTank,
            IconSymbol.DivingScubaTankMultiple => DivingScubaTankMultiple,
            IconSymbol.DivingSnorkel => DivingSnorkel,
            IconSymbol.FileCancel => FileCancel,
            IconSymbol.FileCancelOutline => FileCancelOutline,
            IconSymbol.FileDocumentEdit => FileDocumentEdit,
            IconSymbol.FileDocumentEditOutline => FileDocumentEditOutline,
            IconSymbol.FileEye => FileEye,
            IconSymbol.FileEyeOutline => FileEyeOutline,
            IconSymbol.FolderAlert => FolderAlert,
            IconSymbol.FolderAlertOutline => FolderAlertOutline,
            IconSymbol.FolderEditOutline => FolderEditOutline,
            IconSymbol.FolderOpenOutline => FolderOpenOutline,
            IconSymbol.FormatListBulletedSquare => FormatListBulletedSquare,
            IconSymbol.GantryCrane => GantryCrane,
            IconSymbol.HomeFloor0 => HomeFloor0,
            IconSymbol.HomeFloorNegative1 => HomeFloorNegative1,
            IconSymbol.HomeGroup => HomeGroup,
            IconSymbol.Jabber => Jabber,
            IconSymbol.KeyOutline => KeyOutline,
            IconSymbol.Leak => Leak,
            IconSymbol.LeakOff => LeakOff,
            IconSymbol.MarkerCancel => MarkerCancel,
            IconSymbol.Mine => Mine,
            IconSymbol.MonitorLock => MonitorLock,
            IconSymbol.MonitorStar => MonitorStar,
            IconSymbol.MovieOutline => MovieOutline,
            IconSymbol.MusicNotePlus => MusicNotePlus,
            IconSymbol.Nail => Nail,
            IconSymbol.Ocarina => Ocarina,
            IconSymbol.PassportBiometric => PassportBiometric,
            IconSymbol.PenLock => PenLock,
            IconSymbol.PenMinus => PenMinus,
            IconSymbol.PenOff => PenOff,
            IconSymbol.PenPlus => PenPlus,
            IconSymbol.PenRemove => PenRemove,
            IconSymbol.PencilLockOutline => PencilLockOutline,
            IconSymbol.PencilMinus => PencilMinus,
            IconSymbol.PencilMinusOutline => PencilMinusOutline,
            IconSymbol.PencilOffOutline => PencilOffOutline,
            IconSymbol.PencilPlus => PencilPlus,
            IconSymbol.PencilPlusOutline => PencilPlusOutline,
            IconSymbol.PencilRemove => PencilRemove,
            IconSymbol.PencilRemoveOutline => PencilRemoveOutline,
            IconSymbol.PhoneOff => PhoneOff,
            IconSymbol.PhoneOutline => PhoneOutline,
            IconSymbol.PiHole => PiHole,
            IconSymbol.PlaylistStar => PlaylistStar,
            IconSymbol.ScrewFlatTop => ScrewFlatTop,
            IconSymbol.ScrewLag => ScrewLag,
            IconSymbol.ScrewMachineFlatTop => ScrewMachineFlatTop,
            IconSymbol.ScrewMachineRoundTop => ScrewMachineRoundTop,
            IconSymbol.ScrewRoundTop => ScrewRoundTop,
            IconSymbol.SendCircle => SendCircle,
            IconSymbol.SendCircleOutline => SendCircleOutline,
            IconSymbol.ShoePrint => ShoePrint,
            IconSymbol.Signature => Signature,
            IconSymbol.SignatureFreehand => SignatureFreehand,
            IconSymbol.SignatureImage => SignatureImage,
            IconSymbol.SignatureText => SignatureText,
            IconSymbol.SlopeDownhill => SlopeDownhill,
            IconSymbol.SlopeUphill => SlopeUphill,
            IconSymbol.ThermometerAlert => ThermometerAlert,
            IconSymbol.ThermometerChevronDown => ThermometerChevronDown,
            IconSymbol.ThermometerChevronUp => ThermometerChevronUp,
            IconSymbol.ThermometerMinus => ThermometerMinus,
            IconSymbol.ThermometerPlus => ThermometerPlus,
            IconSymbol.TranslateOff => TranslateOff,
            IconSymbol.UploadOutline => UploadOutline,
            IconSymbol.VolumeVariantOff => VolumeVariantOff,
            IconSymbol.Wallpaper => Wallpaper,
            IconSymbol.WaterOutline => WaterOutline,
            IconSymbol.WifiStar => WifiStar,
            IconSymbol.PaletteOutline => PaletteOutline,
            IconSymbol.BadgeAccountHorizontal => BadgeAccountHorizontal,
            IconSymbol.BadgeAccountHorizontalOutline => BadgeAccountHorizontalOutline,
            IconSymbol.Aws => Aws,
            IconSymbol.BagPersonal => BagPersonal,
            IconSymbol.BagPersonalOff => BagPersonalOff,
            IconSymbol.BagPersonalOffOutline => BagPersonalOffOutline,
            IconSymbol.BagPersonalOutline => BagPersonalOutline,
            IconSymbol.Biathlon => Biathlon,
            IconSymbol.BookmarkMultiple => BookmarkMultiple,
            IconSymbol.BookmarkMultipleOutline => BookmarkMultipleOutline,
            IconSymbol.CalendarMonth => CalendarMonth,
            IconSymbol.CalendarMonthOutline => CalendarMonthOutline,
            IconSymbol.CameraRetake => CameraRetake,
            IconSymbol.CameraRetakeOutline => CameraRetakeOutline,
            IconSymbol.CarBack => CarBack,
            IconSymbol.CarOff => CarOff,
            IconSymbol.CastEducation => CastEducation,
            IconSymbol.CheckBold => CheckBold,
            IconSymbol.CheckUnderline => CheckUnderline,
            IconSymbol.CheckUnderlineCircle => CheckUnderlineCircle,
            IconSymbol.CheckUnderlineCircleOutline => CheckUnderlineCircleOutline,
            IconSymbol.CircularSaw => CircularSaw,
            IconSymbol.Comma => Comma,
            IconSymbol.CommaBoxOutline => CommaBoxOutline,
            IconSymbol.CommaCircle => CommaCircle,
            IconSymbol.CommaCircleOutline => CommaCircleOutline,
            IconSymbol.ContentSaveMove => ContentSaveMove,
            IconSymbol.ContentSaveMoveOutline => ContentSaveMoveOutline,
            IconSymbol.FileCheckOutline => FileCheckOutline,
            IconSymbol.FileMusicOutline => FileMusicOutline,
            IconSymbol.CommaBox => CommaBox,
            IconSymbol.FileVideoOutline => FileVideoOutline,
            IconSymbol.FilePngBox => FilePngBox,
            IconSymbol.Fireplace => Fireplace,
            IconSymbol.FireplaceOff => FireplaceOff,
            IconSymbol.Firework => Firework,
            IconSymbol.FormatColorHighlight => FormatColorHighlight,
            IconSymbol.FormatTextVariant => FormatTextVariant,
            IconSymbol.GamepadCircle => GamepadCircle,
            IconSymbol.GamepadCircleDown => GamepadCircleDown,
            IconSymbol.GamepadCircleLeft => GamepadCircleLeft,
            IconSymbol.GamepadCircleOutline => GamepadCircleOutline,
            IconSymbol.GamepadCircleRight => GamepadCircleRight,
            IconSymbol.GamepadCircleUp => GamepadCircleUp,
            IconSymbol.GamepadDown => GamepadDown,
            IconSymbol.GamepadLeft => GamepadLeft,
            IconSymbol.GamepadRight => GamepadRight,
            IconSymbol.GamepadRound => GamepadRound,
            IconSymbol.GamepadRoundDown => GamepadRoundDown,
            IconSymbol.GamepadRoundLeft => GamepadRoundLeft,
            IconSymbol.GamepadRoundOutline => GamepadRoundOutline,
            IconSymbol.GamepadRoundRight => GamepadRoundRight,
            IconSymbol.GamepadRoundUp => GamepadRoundUp,
            IconSymbol.GamepadUp => GamepadUp,
            IconSymbol.Gatsby => Gatsby,
            IconSymbol.Gift => Gift,
            IconSymbol.Grill => Grill,
            IconSymbol.HandBackLeft => HandBackLeft,
            IconSymbol.HandBackRight => HandBackRight,
            IconSymbol.HandSaw => HandSaw,
            IconSymbol.ImageFrame => ImageFrame,
            IconSymbol.InvertColorsOff => InvertColorsOff,
            IconSymbol.KeyboardOffOutline => KeyboardOffOutline,
            IconSymbol.LayersMinus => LayersMinus,
            IconSymbol.LayersPlus => LayersPlus,
            IconSymbol.LayersRemove => LayersRemove,
            IconSymbol.LightbulbOff => LightbulbOff,
            IconSymbol.LightbulbOffOutline => LightbulbOffOutline,
            IconSymbol.MonitorScreenshot => MonitorScreenshot,
            IconSymbol.IceCreamOff => IceCreamOff,
            IconSymbol.NfcSearchVariant => NfcSearchVariant,
            IconSymbol.NfcVariantOff => NfcVariantOff,
            IconSymbol.NotebookMultiple => NotebookMultiple,
            IconSymbol.HoopHouse => HoopHouse,
            IconSymbol.PictureInPictureBottomRight => PictureInPictureBottomRight,
            IconSymbol.PictureInPictureBottomRightOutline => PictureInPictureBottomRightOutline,
            IconSymbol.PictureInPictureTopRight => PictureInPictureTopRight,
            IconSymbol.PictureInPictureTopRightOutline => PictureInPictureTopRightOutline,
            IconSymbol.Printer3dNozzle => Printer3dNozzle,
            IconSymbol.Printer3dNozzleOutline => Printer3dNozzleOutline,
            IconSymbol.PrinterOff => PrinterOff,
            IconSymbol.Rectangle => Rectangle,
            IconSymbol.RectangleOutline => RectangleOutline,
            IconSymbol.Rivet => Rivet,
            IconSymbol.SawBlade => SawBlade,
            IconSymbol.Seed => Seed,
            IconSymbol.SeedOutline => SeedOutline,
            IconSymbol.SignalDistanceVariant => SignalDistanceVariant,
            IconSymbol.Spade => Spade,
            IconSymbol.Sprout => Sprout,
            IconSymbol.SproutOutline => SproutOutline,
            IconSymbol.TableTennis => TableTennis,
            IconSymbol.TreeOutline => TreeOutline,
            IconSymbol.ViewComfy => ViewComfy,
            IconSymbol.ViewCompact => ViewCompact,
            IconSymbol.ViewCompactOutline => ViewCompactOutline,
            IconSymbol.Vuetify => Vuetify,
            IconSymbol.WeatherCloudyArrowRight => WeatherCloudyArrowRight,
            IconSymbol.MicrosoftXboxControllerMenu => MicrosoftXboxControllerMenu,
            IconSymbol.MicrosoftXboxControllerView => MicrosoftXboxControllerView,
            IconSymbol.AlarmNote => AlarmNote,
            IconSymbol.AlarmNoteOff => AlarmNoteOff,
            IconSymbol.ArrowLeftRight => ArrowLeftRight,
            IconSymbol.ArrowLeftRightBold => ArrowLeftRightBold,
            IconSymbol.ArrowTopLeftBottomRight => ArrowTopLeftBottomRight,
            IconSymbol.ArrowTopLeftBottomRightBold => ArrowTopLeftBottomRightBold,
            IconSymbol.ArrowTopRightBottomLeft => ArrowTopRightBottomLeft,
            IconSymbol.ArrowTopRightBottomLeftBold => ArrowTopRightBottomLeftBold,
            IconSymbol.ArrowUpDown => ArrowUpDown,
            IconSymbol.ArrowUpDownBold => ArrowUpDownBold,
            IconSymbol.AtomVariant => AtomVariant,
            IconSymbol.BabyFace => BabyFace,
            IconSymbol.BabyFaceOutline => BabyFaceOutline,
            IconSymbol.BackspaceReverse => BackspaceReverse,
            IconSymbol.BackspaceReverseOutline => BackspaceReverseOutline,
            IconSymbol.BankOutline => BankOutline,
            IconSymbol.BellAlertOutline => BellAlertOutline,
            IconSymbol.BookPlay => BookPlay,
            IconSymbol.BookPlayOutline => BookPlayOutline,
            IconSymbol.BookSearch => BookSearch,
            IconSymbol.BookSearchOutline => BookSearchOutline,
            IconSymbol.BoomGate => BoomGate,
            IconSymbol.BoomGateAlert => BoomGateAlert,
            IconSymbol.BoomGateAlertOutline => BoomGateAlertOutline,
            IconSymbol.BoomGateArrowDown => BoomGateArrowDown,
            IconSymbol.BoomGateArrowDownOutline => BoomGateArrowDownOutline,
            IconSymbol.BoomGateOutline => BoomGateOutline,
            IconSymbol.BoomGateArrowUp => BoomGateArrowUp,
            IconSymbol.BoomGateArrowUpOutline => BoomGateArrowUpOutline,
            IconSymbol.CalendarSync => CalendarSync,
            IconSymbol.CalendarSyncOutline => CalendarSyncOutline,
            IconSymbol.CellphoneNfc => CellphoneNfc,
            IconSymbol.ChartAreasplineVariant => ChartAreasplineVariant,
            IconSymbol.ChartScatterPlot => ChartScatterPlot,
            IconSymbol.ChartTimelineVariant => ChartTimelineVariant,
            IconSymbol.ChartTree => ChartTree,
            IconSymbol.CircleDouble => CircleDouble,
            IconSymbol.CircleExpand => CircleExpand,
            IconSymbol.ClockDigital => ClockDigital,
            IconSymbol.CardAccountMailOutline => CardAccountMailOutline,
            IconSymbol.CardAccountPhone => CardAccountPhone,
            IconSymbol.CardAccountPhoneOutline => CardAccountPhoneOutline,
            IconSymbol.AccountCowboyHat => AccountCowboyHat,
            IconSymbol.CurrencyRial => CurrencyRial,
            IconSymbol.DeleteEmptyOutline => DeleteEmptyOutline,
            IconSymbol.Dolly => Dolly,
            IconSymbol.ElectricSwitch => ElectricSwitch,
            IconSymbol.Ellipse => Ellipse,
            IconSymbol.EllipseOutline => EllipseOutline,
            IconSymbol.Equalizer => Equalizer,
            IconSymbol.EqualizerOutline => EqualizerOutline,
            IconSymbol.FerrisWheel => FerrisWheel,
            IconSymbol.FileDelimitedOutline => FileDelimitedOutline,
            IconSymbol.TextBoxCheck => TextBoxCheck,
            IconSymbol.TextBoxCheckOutline => TextBoxCheckOutline,
            IconSymbol.TextBoxMinus => TextBoxMinus,
            IconSymbol.TextBoxMinusOutline => TextBoxMinusOutline,
            IconSymbol.TextBoxPlus => TextBoxPlus,
            IconSymbol.TextBoxPlusOutline => TextBoxPlusOutline,
            IconSymbol.TextBoxRemove => TextBoxRemove,
            IconSymbol.TextBoxRemoveOutline => TextBoxRemoveOutline,
            IconSymbol.TextBoxSearch => TextBoxSearch,
            IconSymbol.TextBoxSearchOutline => TextBoxSearchOutline,
            IconSymbol.FileImageOutline => FileImageOutline,
            IconSymbol.FingerprintOff => FingerprintOff,
            IconSymbol.FormatListBulletedTriangle => FormatListBulletedTriangle,
            IconSymbol.FormatOverline => FormatOverline,
            IconSymbol.FrequentlyAskedQuestions => FrequentlyAskedQuestions,
            IconSymbol.GamepadSquare => GamepadSquare,
            IconSymbol.GamepadSquareOutline => GamepadSquareOutline,
            IconSymbol.GamepadVariantOutline => GamepadVariantOutline,
            IconSymbol.GasStationOutline => GasStationOutline,
            IconSymbol.GooglePodcast => GooglePodcast,
            IconSymbol.HomeAnalytics => HomeAnalytics,
            IconSymbol.Mail => Mail,
            IconSymbol.MapCheck => MapCheck,
            IconSymbol.MapCheckOutline => MapCheckOutline,
            IconSymbol.RulerSquareCompass => RulerSquareCompass,
            IconSymbol.NotebookOutline => NotebookOutline,
            IconSymbol.Penguin => Penguin,
            IconSymbol.RadioactiveOff => RadioactiveOff,
            IconSymbol.RecordCircle => RecordCircle,
            IconSymbol.RecordCircleOutline => RecordCircleOutline,
            IconSymbol.RemoteOff => RemoteOff,
            IconSymbol.RemoteTv => RemoteTv,
            IconSymbol.RemoteTvOff => RemoteTvOff,
            IconSymbol.Rotate3d => Rotate3d,
            IconSymbol.SailBoat => SailBoat,
            IconSymbol.ScatterPlot => ScatterPlot,
            IconSymbol.ScatterPlotOutline => ScatterPlotOutline,
            IconSymbol.Segment => Segment,
            IconSymbol.ShieldAlert => ShieldAlert,
            IconSymbol.ShieldAlertOutline => ShieldAlertOutline,
            IconSymbol.TabletDashboard => TabletDashboard,
            IconSymbol.TelevisionPlay => TelevisionPlay,
            IconSymbol.Unicode => Unicode,
            IconSymbol.Video3dVariant => Video3dVariant,
            IconSymbol.VideoWireless => VideoWireless,
            IconSymbol.VideoWirelessOutline => VideoWirelessOutline,
            IconSymbol.AccountVoiceOff => AccountVoiceOff,
            IconSymbol.Bacteria => Bacteria,
            IconSymbol.BacteriaOutline => BacteriaOutline,
            IconSymbol.CalendarAccount => CalendarAccount,
            IconSymbol.CalendarAccountOutline => CalendarAccountOutline,
            IconSymbol.CalendarWeekend => CalendarWeekend,
            IconSymbol.CalendarWeekendOutline => CalendarWeekendOutline,
            IconSymbol.CameraPlus => CameraPlus,
            IconSymbol.CameraPlusOutline => CameraPlusOutline,
            IconSymbol.Campfire => Campfire,
            IconSymbol.ChatOutline => ChatOutline,
            IconSymbol.Cpu32Bit => Cpu32Bit,
            IconSymbol.Cpu64Bit => Cpu64Bit,
            IconSymbol.CreditCardClock => CreditCardClock,
            IconSymbol.CreditCardClockOutline => CreditCardClockOutline,
            IconSymbol.EmailEdit => EmailEdit,
            IconSymbol.EmailEditOutline => EmailEditOutline,
            IconSymbol.EmailMinus => EmailMinus,
            IconSymbol.EmailMinusOutline => EmailMinusOutline,
            IconSymbol.EmailMultiple => EmailMultiple,
            IconSymbol.EmailMultipleOutline => EmailMultipleOutline,
            IconSymbol.EmailOpenMultiple => EmailOpenMultiple,
            IconSymbol.EmailOpenMultipleOutline => EmailOpenMultipleOutline,
            IconSymbol.FileCad => FileCad,
            IconSymbol.FileCadBox => FileCadBox,
            IconSymbol.FilePlusOutline => FilePlusOutline,
            IconSymbol.FilterMinus => FilterMinus,
            IconSymbol.FilterMinusOutline => FilterMinusOutline,
            IconSymbol.FilterPlus => FilterPlus,
            IconSymbol.FilterPlusOutline => FilterPlusOutline,
            IconSymbol.FireExtinguisher => FireExtinguisher,
            IconSymbol.Fishbowl => Fishbowl,
            IconSymbol.FishbowlOutline => FishbowlOutline,
            IconSymbol.FitToPage => FitToPage,
            IconSymbol.FitToPageOutline => FitToPageOutline,
            IconSymbol.FlashAlert => FlashAlert,
            IconSymbol.FlashAlertOutline => FlashAlertOutline,
            IconSymbol.HeartFlash => HeartFlash,
            IconSymbol.HomeFlood => HomeFlood,
            IconSymbol.HumanMaleHeight => HumanMaleHeight,
            IconSymbol.HumanMaleHeightVariant => HumanMaleHeightVariant,
            IconSymbol.IcePop => IcePop,
            IconSymbol.Identifier => Identifier,
            IconSymbol.ImageFilterCenterFocusStrong => ImageFilterCenterFocusStrong,
            IconSymbol.ImageFilterCenterFocusStrongOutline => ImageFilterCenterFocusStrongOutline,
            IconSymbol.Jellyfish => Jellyfish,
            IconSymbol.JellyfishOutline => JellyfishOutline,
            IconSymbol.Lasso => Lasso,
            IconSymbol.MusicBoxMultipleOutline => MusicBoxMultipleOutline,
            IconSymbol.MapMarkerAlert => MapMarkerAlert,
            IconSymbol.MapMarkerAlertOutline => MapMarkerAlertOutline,
            IconSymbol.MapMarkerQuestion => MapMarkerQuestion,
            IconSymbol.MapMarkerQuestionOutline => MapMarkerQuestionOutline,
            IconSymbol.MapMarkerRemove => MapMarkerRemove,
            IconSymbol.MapMarkerRemoveVariant => MapMarkerRemoveVariant,
            IconSymbol.Necklace => Necklace,
            IconSymbol.NewspaperMinus => NewspaperMinus,
            IconSymbol.NewspaperPlus => NewspaperPlus,
            IconSymbol.Numeric0BoxMultiple => Numeric0BoxMultiple,
            IconSymbol.Numeric1BoxMultiple => Numeric1BoxMultiple,
            IconSymbol.Numeric2BoxMultiple => Numeric2BoxMultiple,
            IconSymbol.Numeric3BoxMultiple => Numeric3BoxMultiple,
            IconSymbol.Numeric4BoxMultiple => Numeric4BoxMultiple,
            IconSymbol.Numeric5BoxMultiple => Numeric5BoxMultiple,
            IconSymbol.Numeric6BoxMultiple => Numeric6BoxMultiple,
            IconSymbol.Numeric7BoxMultiple => Numeric7BoxMultiple,
            IconSymbol.Numeric8BoxMultiple => Numeric8BoxMultiple,
            IconSymbol.Numeric9BoxMultiple => Numeric9BoxMultiple,
            IconSymbol.Numeric9PlusBoxMultiple => Numeric9PlusBoxMultiple,
            IconSymbol.OilLamp => OilLamp,
            IconSymbol.PhoneAlert => PhoneAlert,
            IconSymbol.PlayOutline => PlayOutline,
            IconSymbol.Purse => Purse,
            IconSymbol.PurseOutline => PurseOutline,
            IconSymbol.RailroadLight => RailroadLight,
            IconSymbol.ReplyAllOutline => ReplyAllOutline,
            IconSymbol.ReplyOutline => ReplyOutline,
            IconSymbol.RssOff => RssOff,
            IconSymbol.SelectionEllipseArrowInside => SelectionEllipseArrowInside,
            IconSymbol.ShareOff => ShareOff,
            IconSymbol.ShareOffOutline => ShareOffOutline,
            IconSymbol.SkipBackwardOutline => SkipBackwardOutline,
            IconSymbol.SkipForwardOutline => SkipForwardOutline,
            IconSymbol.SkipNextOutline => SkipNextOutline,
            IconSymbol.SkipPreviousOutline => SkipPreviousOutline,
            IconSymbol.SnowflakeAlert => SnowflakeAlert,
            IconSymbol.SnowflakeVariant => SnowflakeVariant,
            IconSymbol.StretchToPage => StretchToPage,
            IconSymbol.StretchToPageOutline => StretchToPageOutline,
            IconSymbol.Typewriter => Typewriter,
            IconSymbol.Wave => Wave,
            IconSymbol.WeatherCloudyAlert => WeatherCloudyAlert,
            IconSymbol.WeatherHazy => WeatherHazy,
            IconSymbol.WeatherNightPartlyCloudy => WeatherNightPartlyCloudy,
            IconSymbol.WeatherPartlyLightning => WeatherPartlyLightning,
            IconSymbol.WeatherPartlyRainy => WeatherPartlyRainy,
            IconSymbol.WeatherPartlySnowy => WeatherPartlySnowy,
            IconSymbol.WeatherPartlySnowyRainy => WeatherPartlySnowyRainy,
            IconSymbol.WeatherSnowyHeavy => WeatherSnowyHeavy,
            IconSymbol.WeatherSunnyAlert => WeatherSunnyAlert,
            IconSymbol.WeatherTornado => WeatherTornado,
            IconSymbol.BabyBottle => BabyBottle,
            IconSymbol.BabyBottleOutline => BabyBottleOutline,
            IconSymbol.BagCarryOn => BagCarryOn,
            IconSymbol.BagCarryOnOff => BagCarryOnOff,
            IconSymbol.BagChecked => BagChecked,
            IconSymbol.Baguette => Baguette,
            IconSymbol.BusMultiple => BusMultiple,
            IconSymbol.CarShiftPattern => CarShiftPattern,
            IconSymbol.CellphoneInformation => CellphoneInformation,
            IconSymbol.ContentSaveAlert => ContentSaveAlert,
            IconSymbol.ContentSaveAlertOutline => ContentSaveAlertOutline,
            IconSymbol.ContentSaveAllOutline => ContentSaveAllOutline,
            IconSymbol.CrosshairsOff => CrosshairsOff,
            IconSymbol.Cupboard => Cupboard,
            IconSymbol.CupboardOutline => CupboardOutline,
            IconSymbol.ChairRolling => ChairRolling,
            IconSymbol.Draw => Draw,
            IconSymbol.Dresser => Dresser,
            IconSymbol.DresserOutline => DresserOutline,
            IconSymbol.EmoticonFrown => EmoticonFrown,
            IconSymbol.EmoticonFrownOutline => EmoticonFrownOutline,
            IconSymbol.FocusAuto => FocusAuto,
            IconSymbol.FocusField => FocusField,
            IconSymbol.FocusFieldHorizontal => FocusFieldHorizontal,
            IconSymbol.FocusFieldVertical => FocusFieldVertical,
            IconSymbol.FootPrint => FootPrint,
            IconSymbol.Handball => Handball,
            IconSymbol.HomeThermometer => HomeThermometer,
            IconSymbol.HomeThermometerOutline => HomeThermometerOutline,
            IconSymbol.KettleOutline => KettleOutline,
            IconSymbol.Latitude => Latitude,
            IconSymbol.LayersTriple => LayersTriple,
            IconSymbol.LayersTripleOutline => LayersTripleOutline,
            IconSymbol.Longitude => Longitude,
            IconSymbol.LanguageMarkdownOutline => LanguageMarkdownOutline,
            IconSymbol.Merge => Merge,
            IconSymbol.Middleware => Middleware,
            IconSymbol.MiddlewareOutline => MiddlewareOutline,
            IconSymbol.MonitorSpeaker => MonitorSpeaker,
            IconSymbol.MonitorSpeakerOff => MonitorSpeakerOff,
            IconSymbol.MoonFirstQuarter => MoonFirstQuarter,
            IconSymbol.MoonFull => MoonFull,
            IconSymbol.MoonLastQuarter => MoonLastQuarter,
            IconSymbol.MoonNew => MoonNew,
            IconSymbol.MoonWaningCrescent => MoonWaningCrescent,
            IconSymbol.MoonWaningGibbous => MoonWaningGibbous,
            IconSymbol.MoonWaxingCrescent => MoonWaxingCrescent,
            IconSymbol.MoonWaxingGibbous => MoonWaxingGibbous,
            IconSymbol.MusicAccidentalDoubleFlat => MusicAccidentalDoubleFlat,
            IconSymbol.MusicAccidentalDoubleSharp => MusicAccidentalDoubleSharp,
            IconSymbol.MusicAccidentalFlat => MusicAccidentalFlat,
            IconSymbol.MusicAccidentalNatural => MusicAccidentalNatural,
            IconSymbol.MusicAccidentalSharp => MusicAccidentalSharp,
            IconSymbol.MusicClefAlto => MusicClefAlto,
            IconSymbol.MusicClefBass => MusicClefBass,
            IconSymbol.MusicClefTreble => MusicClefTreble,
            IconSymbol.MusicNoteEighthDotted => MusicNoteEighthDotted,
            IconSymbol.MusicNoteHalfDotted => MusicNoteHalfDotted,
            IconSymbol.MusicNoteOffOutline => MusicNoteOffOutline,
            IconSymbol.MusicNoteOutline => MusicNoteOutline,
            IconSymbol.MusicNoteQuarterDotted => MusicNoteQuarterDotted,
            IconSymbol.MusicNoteSixteenthDotted => MusicNoteSixteenthDotted,
            IconSymbol.MusicNoteWholeDotted => MusicNoteWholeDotted,
            IconSymbol.MusicRestEighth => MusicRestEighth,
            IconSymbol.MusicRestHalf => MusicRestHalf,
            IconSymbol.MusicRestQuarter => MusicRestQuarter,
            IconSymbol.MusicRestSixteenth => MusicRestSixteenth,
            IconSymbol.MusicRestWhole => MusicRestWhole,
            IconSymbol.Numeric10Box => Numeric10Box,
            IconSymbol.Numeric10BoxOutline => Numeric10BoxOutline,
            IconSymbol.PageLayoutHeaderFooter => PageLayoutHeaderFooter,
            IconSymbol.PatioHeater => PatioHeater,
            IconSymbol.Warehouse => Warehouse,
            IconSymbol.SelectGroup => SelectGroup,
            IconSymbol.ShieldCar => ShieldCar,
            IconSymbol.ShoppingSearch => ShoppingSearch,
            IconSymbol.SpeedometerMedium => SpeedometerMedium,
            IconSymbol.SpeedometerSlow => SpeedometerSlow,
            IconSymbol.TableLargePlus => TableLargePlus,
            IconSymbol.TableLargeRemove => TableLargeRemove,
            IconSymbol.TelevisionPause => TelevisionPause,
            IconSymbol.TelevisionStop => TelevisionStop,
            IconSymbol.TransitDetour => TransitDetour,
            IconSymbol.VideoInputScart => VideoInputScart,
            IconSymbol.ViewGridPlus => ViewGridPlus,
            IconSymbol.WalletPlus => WalletPlus,
            IconSymbol.WalletPlusOutline => WalletPlusOutline,
            IconSymbol.Wardrobe => Wardrobe,
            IconSymbol.WardrobeOutline => WardrobeOutline,
            IconSymbol.WaterBoiler => WaterBoiler,
            IconSymbol.WaterPumpOff => WaterPumpOff,
            IconSymbol.WebBox => WebBox,
            IconSymbol.TimelineAlert => TimelineAlert,
            IconSymbol.TimelinePlus => TimelinePlus,
            IconSymbol.TimelinePlusOutline => TimelinePlusOutline,
            IconSymbol.TimelineAlertOutline => TimelineAlertOutline,
            IconSymbol.TimelineQuestion => TimelineQuestion,
            IconSymbol.TimelineQuestionOutline => TimelineQuestionOutline,
            IconSymbol.HomeExportOutline => HomeExportOutline,
            IconSymbol.HomeImportOutline => HomeImportOutline,
            IconSymbol.AccountFilterOutline => AccountFilterOutline,
            IconSymbol.ApproximatelyEqual => ApproximatelyEqual,
            IconSymbol.ApproximatelyEqualBox => ApproximatelyEqualBox,
            IconSymbol.BabyCarriageOff => BabyCarriageOff,
            IconSymbol.Bee => Bee,
            IconSymbol.BeeFlower => BeeFlower,
            IconSymbol.CarChildSeat => CarChildSeat,
            IconSymbol.CarSeat => CarSeat,
            IconSymbol.CarSeatCooler => CarSeatCooler,
            IconSymbol.CarSeatHeater => CarSeatHeater,
            IconSymbol.ChartBellCurveCumulative => ChartBellCurveCumulative,
            IconSymbol.ClockCheck => ClockCheck,
            IconSymbol.ClockCheckOutline => ClockCheckOutline,
            IconSymbol.CoffeeOff => CoffeeOff,
            IconSymbol.CoffeeOffOutline => CoffeeOffOutline,
            IconSymbol.CreditCardMinus => CreditCardMinus,
            IconSymbol.CreditCardMinusOutline => CreditCardMinusOutline,
            IconSymbol.CreditCardRemove => CreditCardRemove,
            IconSymbol.CreditCardRemoveOutline => CreditCardRemoveOutline,
            IconSymbol.Devices => Devices,
            IconSymbol.EmailNewsletter => EmailNewsletter,
            IconSymbol.ExpansionCardVariant => ExpansionCardVariant,
            IconSymbol.PowerSocketCh => PowerSocketCh,
            IconSymbol.FileSwap => FileSwap,
            IconSymbol.FileSwapOutline => FileSwapOutline,
            IconSymbol.FolderSwap => FolderSwap,
            IconSymbol.FolderSwapOutline => FolderSwapOutline,
            IconSymbol.FormatLetterEndsWith => FormatLetterEndsWith,
            IconSymbol.FormatLetterMatches => FormatLetterMatches,
            IconSymbol.FormatLetterStartsWith => FormatLetterStartsWith,
            IconSymbol.FormatTextRotationAngleDown => FormatTextRotationAngleDown,
            IconSymbol.FormatTextRotationAngleUp => FormatTextRotationAngleUp,
            IconSymbol.FormatTextRotationDownVertical => FormatTextRotationDownVertical,
            IconSymbol.FormatTextRotationUp => FormatTextRotationUp,
            IconSymbol.FormatTextRotationVertical => FormatTextRotationVertical,
            IconSymbol.IdCard => IdCard,
            IconSymbol.ImageAutoAdjust => ImageAutoAdjust,
            IconSymbol.KeyWireless => KeyWireless,
            IconSymbol.License => License,
            IconSymbol.LocationEnter => LocationEnter,
            IconSymbol.LocationExit => LocationExit,
            IconSymbol.LockOpenVariant => LockOpenVariant,
            IconSymbol.LockOpenVariantOutline => LockOpenVariantOutline,
            IconSymbol.MathIntegral => MathIntegral,
            IconSymbol.MathIntegralBox => MathIntegralBox,
            IconSymbol.MathNorm => MathNorm,
            IconSymbol.MathNormBox => MathNormBox,
            IconSymbol.MessageLock => MessageLock,
            IconSymbol.MessageTextLock => MessageTextLock,
            IconSymbol.MovieOpen => MovieOpen,
            IconSymbol.MovieOpenOutline => MovieOpenOutline,
            IconSymbol.BedQueen => BedQueen,
            IconSymbol.BedKingOutline => BedKingOutline,
            IconSymbol.BedKing => BedKing,
            IconSymbol.BedDoubleOutline => BedDoubleOutline,
            IconSymbol.BedDouble => BedDouble,
            IconSymbol.MicrosoftAzureDevops => MicrosoftAzureDevops,
            IconSymbol.ArmFlexOutline => ArmFlexOutline,
            IconSymbol.ArmFlex => ArmFlex,
            IconSymbol.Protocol => Protocol,
            IconSymbol.SealVariant => SealVariant,
            IconSymbol.SelectPlace => SelectPlace,
            IconSymbol.BedQueenOutline => BedQueenOutline,
            IconSymbol.SignDirectionPlus => SignDirectionPlus,
            IconSymbol.SignDirectionRemove => SignDirectionRemove,
            IconSymbol.SilverwareClean => SilverwareClean,
            IconSymbol.SlashForward => SlashForward,
            IconSymbol.SlashForwardBox => SlashForwardBox,
            IconSymbol.SwapHorizontalCircle => SwapHorizontalCircle,
            IconSymbol.SwapHorizontalCircleOutline => SwapHorizontalCircleOutline,
            IconSymbol.SwapVerticalCircle => SwapVerticalCircle,
            IconSymbol.SwapVerticalCircleOutline => SwapVerticalCircleOutline,
            IconSymbol.TankerTruck => TankerTruck,
            IconSymbol.TextureBox => TextureBox,
            IconSymbol.TramSide => TramSide,
            IconSymbol.VectorLink => VectorLink,
            IconSymbol.Numeric10 => Numeric10,
            IconSymbol.Numeric10BoxMultiple => Numeric10BoxMultiple,
            IconSymbol.Numeric10BoxMultipleOutline => Numeric10BoxMultipleOutline,
            IconSymbol.Numeric10Circle => Numeric10Circle,
            IconSymbol.Numeric10CircleOutline => Numeric10CircleOutline,
            IconSymbol.Numeric9Plus => Numeric9Plus,
            IconSymbol.CreditCard => CreditCard,
            IconSymbol.CreditCardMultiple => CreditCardMultiple,
            IconSymbol.CreditCardOff => CreditCardOff,
            IconSymbol.CreditCardPlus => CreditCardPlus,
            IconSymbol.CreditCardRefund => CreditCardRefund,
            IconSymbol.CreditCardScan => CreditCardScan,
            IconSymbol.CreditCardSettings => CreditCardSettings,
            IconSymbol.Hospital => Hospital,
            IconSymbol.HospitalBoxOutline => HospitalBoxOutline,
            IconSymbol.OilTemperature => OilTemperature,
            IconSymbol.Stadium => Stadium,
            IconSymbol.ZipBoxOutline => ZipBoxOutline,
            IconSymbol.AccountEditOutline => AccountEditOutline,
            IconSymbol.Peanut => Peanut,
            IconSymbol.PeanutOff => PeanutOff,
            IconSymbol.PeanutOutline => PeanutOutline,
            IconSymbol.PeanutOffOutline => PeanutOffOutline,
            IconSymbol.SignDirectionMinus => SignDirectionMinus,
            IconSymbol.NewspaperVariant => NewspaperVariant,
            IconSymbol.NewspaperVariantMultiple => NewspaperVariantMultiple,
            IconSymbol.NewspaperVariantMultipleOutline => NewspaperVariantMultipleOutline,
            IconSymbol.NewspaperVariantOutline => NewspaperVariantOutline,
            IconSymbol.Overscan => Overscan,
            IconSymbol.PigVariant => PigVariant,
            IconSymbol.PiggyBank => PiggyBank,
            IconSymbol.Post => Post,
            IconSymbol.PostOutline => PostOutline,
            IconSymbol.AccountBoxMultipleOutline => AccountBoxMultipleOutline,
            IconSymbol.AirballoonOutline => AirballoonOutline,
            IconSymbol.AlphabeticalOff => AlphabeticalOff,
            IconSymbol.AlphabeticalVariant => AlphabeticalVariant,
            IconSymbol.AlphabeticalVariantOff => AlphabeticalVariantOff,
            IconSymbol.ApacheKafka => ApacheKafka,
            IconSymbol.Billboard => Billboard,
            IconSymbol.BlindsOpen => BlindsOpen,
            IconSymbol.BusStop => BusStop,
            IconSymbol.BusStopCovered => BusStopCovered,
            IconSymbol.BusStopUncovered => BusStopUncovered,
            IconSymbol.Car2Plus => Car2Plus,
            IconSymbol.Car3Plus => Car3Plus,
            IconSymbol.CarBrakeRetarder => CarBrakeRetarder,
            IconSymbol.CarClutch => CarClutch,
            IconSymbol.CarCoolantLevel => CarCoolantLevel,
            IconSymbol.CarTurbocharger => CarTurbocharger,
            IconSymbol.CarWindshield => CarWindshield,
            IconSymbol.CarWindshieldOutline => CarWindshieldOutline,
            IconSymbol.CardsDiamondOutline => CardsDiamondOutline,
            IconSymbol.CastAudio => CastAudio,
            IconSymbol.CellphonePlay => CellphonePlay,
            IconSymbol.CoachLamp => CoachLamp,
            IconSymbol.CommentQuote => CommentQuote,
            IconSymbol.CommentQuoteOutline => CommentQuoteOutline,
            IconSymbol.DominoMask => DominoMask,
            IconSymbol.ElectronFramework => ElectronFramework,
            IconSymbol.Excavator => Excavator,
            IconSymbol.EyeMinus => EyeMinus,
            IconSymbol.EyeMinusOutline => EyeMinusOutline,
            IconSymbol.FileAccountOutline => FileAccountOutline,
            IconSymbol.FileChartOutline => FileChartOutline,
            IconSymbol.FileCloudOutline => FileCloudOutline,
            IconSymbol.FileCodeOutline => FileCodeOutline,
            IconSymbol.FileExcelBoxOutline => FileExcelBoxOutline,
            IconSymbol.FileExcelOutline => FileExcelOutline,
            IconSymbol.FileExportOutline => FileExportOutline,
            IconSymbol.FileImportOutline => FileImportOutline,
            IconSymbol.FileLockOutline => FileLockOutline,
            IconSymbol.FileMoveOutline => FileMoveOutline,
            IconSymbol.FileMultipleOutline => FileMultipleOutline,
            IconSymbol.FilePercentOutline => FilePercentOutline,
            IconSymbol.FilePowerpointBoxOutline => FilePowerpointBoxOutline,
            IconSymbol.FilePowerpointOutline => FilePowerpointOutline,
            IconSymbol.FileQuestionOutline => FileQuestionOutline,
            IconSymbol.FileRemoveOutline => FileRemoveOutline,
            IconSymbol.FileRestoreOutline => FileRestoreOutline,
            IconSymbol.FileSendOutline => FileSendOutline,
            IconSymbol.FileStar => FileStar,
            IconSymbol.FileStarOutline => FileStarOutline,
            IconSymbol.FileUndoOutline => FileUndoOutline,
            IconSymbol.FileWordBoxOutline => FileWordBoxOutline,
            IconSymbol.FileWordOutline => FileWordOutline,
            IconSymbol.FilterVariantRemove => FilterVariantRemove,
            IconSymbol.FloorLampDual => FloorLampDual,
            IconSymbol.FloorLampTorchiereVariant => FloorLampTorchiereVariant,
            IconSymbol.FruitCherries => FruitCherries,
            IconSymbol.FruitCitrus => FruitCitrus,
            IconSymbol.FruitGrapes => FruitGrapes,
            IconSymbol.FruitGrapesOutline => FruitGrapesOutline,
            IconSymbol.FruitPineapple => FruitPineapple,
            IconSymbol.FruitWatermelon => FruitWatermelon,
            IconSymbol.GoogleMyBusiness => GoogleMyBusiness,
            IconSymbol.Graph => Graph,
            IconSymbol.GraphOutline => GraphOutline,
            IconSymbol.HarddiskPlus => HarddiskPlus,
            IconSymbol.HarddiskRemove => HarddiskRemove,
            IconSymbol.HomeCircleOutline => HomeCircleOutline,
            IconSymbol.InstrumentTriangle => InstrumentTriangle,
            IconSymbol.Island => Island,
            IconSymbol.KeyboardSpace => KeyboardSpace,
            IconSymbol.LedStripVariant => LedStripVariant,
            IconSymbol.NumericNegative1 => NumericNegative1,
            IconSymbol.OilLevel => OilLevel,
            IconSymbol.OutdoorLamp => OutdoorLamp,
            IconSymbol.PalmTree => PalmTree,
            IconSymbol.PartyPopper => PartyPopper,
            IconSymbol.PrinterPos => PrinterPos,
            IconSymbol.Robber => Robber,
            IconSymbol.RoutesClock => RoutesClock,
            IconSymbol.ScaleOff => ScaleOff,
            IconSymbol.CogTransfer => CogTransfer,
            IconSymbol.CogTransferOutline => CogTransferOutline,
            IconSymbol.ShieldSun => ShieldSun,
            IconSymbol.ShieldSunOutline => ShieldSunOutline,
            IconSymbol.Sprinkler => Sprinkler,
            IconSymbol.SprinklerVariant => SprinklerVariant,
            IconSymbol.TableChair => TableChair,
            IconSymbol.Terraform => Terraform,
            IconSymbol.Toaster => Toaster,
            IconSymbol.Tools => Tools,
            IconSymbol.Transfer => Transfer,
            IconSymbol.Valve => Valve,
            IconSymbol.ValveClosed => ValveClosed,
            IconSymbol.ValveOpen => ValveOpen,
            IconSymbol.VideoCheck => VideoCheck,
            IconSymbol.VideoCheckOutline => VideoCheckOutline,
            IconSymbol.WaterWell => WaterWell,
            IconSymbol.WaterWellOutline => WaterWellOutline,
            IconSymbol.BedSingle => BedSingle,
            IconSymbol.BedSingleOutline => BedSingleOutline,
            IconSymbol.BookInformationVariant => BookInformationVariant,
            IconSymbol.BottleSoda => BottleSoda,
            IconSymbol.BottleSodaClassic => BottleSodaClassic,
            IconSymbol.BottleSodaOutline => BottleSodaOutline,
            IconSymbol.CalendarBlankMultiple => CalendarBlankMultiple,
            IconSymbol.CardSearch => CardSearch,
            IconSymbol.CardSearchOutline => CardSearchOutline,
            IconSymbol.FaceWomanProfile => FaceWomanProfile,
            IconSymbol.FaceWoman => FaceWoman,
            IconSymbol.FaceWomanOutline => FaceWomanOutline,
            IconSymbol.FileSettings => FileSettings,
            IconSymbol.FileSettingsOutline => FileSettingsOutline,
            IconSymbol.FileCog => FileCog,
            IconSymbol.FileCogOutline => FileCogOutline,
            IconSymbol.FolderSettings => FolderSettings,
            IconSymbol.FolderSettingsOutline => FolderSettingsOutline,
            IconSymbol.FolderCog => FolderCog,
            IconSymbol.FolderCogOutline => FolderCogOutline,
            IconSymbol.FuriganaHorizontal => FuriganaHorizontal,
            IconSymbol.FuriganaVertical => FuriganaVertical,
            IconSymbol.GolfTee => GolfTee,
            IconSymbol.Lungs => Lungs,
            IconSymbol.MathLog => MathLog,
            IconSymbol.Moped => Moped,
            IconSymbol.RouterNetwork => RouterNetwork,
            IconSymbol.RomanNumeral2 => RomanNumeral2,
            IconSymbol.RomanNumeral3 => RomanNumeral3,
            IconSymbol.RomanNumeral4 => RomanNumeral4,
            IconSymbol.RomanNumeral6 => RomanNumeral6,
            IconSymbol.RomanNumeral7 => RomanNumeral7,
            IconSymbol.RomanNumeral8 => RomanNumeral8,
            IconSymbol.RomanNumeral9 => RomanNumeral9,
            IconSymbol.SolderingIron => SolderingIron,
            IconSymbol.Stomach => Stomach,
            IconSymbol.TableEye => TableEye,
            IconSymbol.FormTextarea => FormTextarea,
            IconSymbol.Trumpet => Trumpet,
            IconSymbol.AccountCash => AccountCash,
            IconSymbol.AccountCashOutline => AccountCashOutline,
            IconSymbol.AirHumidifier => AirHumidifier,
            IconSymbol.Ansible => Ansible,
            IconSymbol.Api => Api,
            IconSymbol.Bicycle => Bicycle,
            IconSymbol.CarDoorLock => CarDoorLock,
            IconSymbol.CoatRack => CoatRack,
            IconSymbol.CoffeeMaker => CoffeeMaker,
            IconSymbol.WebMinus => WebMinus,
            IconSymbol.Decimal => Decimal,
            IconSymbol.DecimalComma => DecimalComma,
            IconSymbol.DecimalCommaDecrease => DecimalCommaDecrease,
            IconSymbol.DecimalCommaIncrease => DecimalCommaIncrease,
            IconSymbol.DeleteAlert => DeleteAlert,
            IconSymbol.DeleteAlertOutline => DeleteAlertOutline,
            IconSymbol.DeleteOff => DeleteOff,
            IconSymbol.DeleteOffOutline => DeleteOffOutline,
            IconSymbol.DockBottom => DockBottom,
            IconSymbol.DockLeft => DockLeft,
            IconSymbol.DockRight => DockRight,
            IconSymbol.DockWindow => DockWindow,
            IconSymbol.DomainPlus => DomainPlus,
            IconSymbol.DomainRemove => DomainRemove,
            IconSymbol.DoorClosedLock => DoorClosedLock,
            IconSymbol.DownloadOff => DownloadOff,
            IconSymbol.DownloadOffOutline => DownloadOffOutline,
            IconSymbol.FlagMinusOutline => FlagMinusOutline,
            IconSymbol.FlagPlusOutline => FlagPlusOutline,
            IconSymbol.FlagRemoveOutline => FlagRemoveOutline,
            IconSymbol.FolderHome => FolderHome,
            IconSymbol.FolderHomeOutline => FolderHomeOutline,
            IconSymbol.FolderInformation => FolderInformation,
            IconSymbol.FolderInformationOutline => FolderInformationOutline,
            IconSymbol.IvBag => IvBag,
            IconSymbol.LinkLock => LinkLock,
            IconSymbol.MessagePlusOutline => MessagePlusOutline,
            IconSymbol.PhoneCancel => PhoneCancel,
            IconSymbol.SmartCard => SmartCard,
            IconSymbol.SmartCardOutline => SmartCardOutline,
            IconSymbol.SmartCardReader => SmartCardReader,
            IconSymbol.SmartCardReaderOutline => SmartCardReaderOutline,
            IconSymbol.StorefrontOutline => StorefrontOutline,
            IconSymbol.ThermometerHigh => ThermometerHigh,
            IconSymbol.ThermometerLow => ThermometerLow,
            IconSymbol.Ufo => Ufo,
            IconSymbol.UfoOutline => UfoOutline,
            IconSymbol.UploadOff => UploadOff,
            IconSymbol.UploadOffOutline => UploadOffOutline,
            IconSymbol.AccountChildOutline => AccountChildOutline,
            IconSymbol.AccountSettingsOutline => AccountSettingsOutline,
            IconSymbol.AccountTieOutline => AccountTieOutline,
            IconSymbol.AlienOutline => AlienOutline,
            IconSymbol.BatteryAlertVariant => BatteryAlertVariant,
            IconSymbol.BatteryAlertVariantOutline => BatteryAlertVariantOutline,
            IconSymbol.BeehiveOutline => BeehiveOutline,
            IconSymbol.Boomerang => Boomerang,
            IconSymbol.BriefcaseClock => BriefcaseClock,
            IconSymbol.BriefcaseClockOutline => BriefcaseClockOutline,
            IconSymbol.CellphoneMessageOff => CellphoneMessageOff,
            IconSymbol.CircleOffOutline => CircleOffOutline,
            IconSymbol.ClipboardList => ClipboardList,
            IconSymbol.ClipboardListOutline => ClipboardListOutline,
            IconSymbol.CodeBracesBox => CodeBracesBox,
            IconSymbol.CodeParenthesesBox => CodeParenthesesBox,
            IconSymbol.Consolidate => Consolidate,
            IconSymbol.ElectricSwitchClosed => ElectricSwitchClosed,
            IconSymbol.EmailArrowLeft => EmailArrowLeft,
            IconSymbol.EmailArrowLeftOutline => EmailArrowLeftOutline,
            IconSymbol.EmailArrowRight => EmailArrowRight,
            IconSymbol.EmailArrowRightOutline => EmailArrowRightOutline,
            IconSymbol.EmoticonConfused => EmoticonConfused,
            IconSymbol.EmoticonConfusedOutline => EmoticonConfusedOutline,
            IconSymbol.Epsilon => Epsilon,
            IconSymbol.FileTableBox => FileTableBox,
            IconSymbol.FileTableBoxMultiple => FileTableBoxMultiple,
            IconSymbol.FileTableBoxMultipleOutline => FileTableBoxMultipleOutline,
            IconSymbol.FileTableBoxOutline => FileTableBoxOutline,
            IconSymbol.FilterMenu => FilterMenu,
            IconSymbol.FilterMenuOutline => FilterMenuOutline,
            IconSymbol.FlipHorizontal => FlipHorizontal,
            IconSymbol.FlipVertical => FlipVertical,
            IconSymbol.FolderDownloadOutline => FolderDownloadOutline,
            IconSymbol.FolderHeart => FolderHeart,
            IconSymbol.FolderHeartOutline => FolderHeartOutline,
            IconSymbol.FolderKeyOutline => FolderKeyOutline,
            IconSymbol.FolderUploadOutline => FolderUploadOutline,
            IconSymbol.Gamma => Gamma,
            IconSymbol.HairDryer => HairDryer,
            IconSymbol.HairDryerOutline => HairDryerOutline,
            IconSymbol.HandHeart => HandHeart,
            IconSymbol.HexagonMultipleOutline => HexagonMultipleOutline,
            IconSymbol.HorizontalRotateClockwise => HorizontalRotateClockwise,
            IconSymbol.HorizontalRotateCounterclockwise => HorizontalRotateCounterclockwise,
            IconSymbol.ApplicationArray => ApplicationArray,
            IconSymbol.ApplicationArrayOutline => ApplicationArrayOutline,
            IconSymbol.ApplicationBraces => ApplicationBraces,
            IconSymbol.ApplicationBracesOutline => ApplicationBracesOutline,
            IconSymbol.ApplicationParentheses => ApplicationParentheses,
            IconSymbol.ApplicationParenthesesOutline => ApplicationParenthesesOutline,
            IconSymbol.ApplicationVariable => ApplicationVariable,
            IconSymbol.ApplicationVariableOutline => ApplicationVariableOutline,
            IconSymbol.Khanda => Khanda,
            IconSymbol.Kubernetes => Kubernetes,
            IconSymbol.LinkVariantMinus => LinkVariantMinus,
            IconSymbol.LinkVariantPlus => LinkVariantPlus,
            IconSymbol.LinkVariantRemove => LinkVariantRemove,
            IconSymbol.MapMarkerDown => MapMarkerDown,
            IconSymbol.MapMarkerUp => MapMarkerUp,
            IconSymbol.MonitorShimmer => MonitorShimmer,
            IconSymbol.Nix => Nix,
            IconSymbol.Nuxt => Nuxt,
            IconSymbol.PowerSocketDe => PowerSocketDe,
            IconSymbol.PowerSocketFr => PowerSocketFr,
            IconSymbol.PowerSocketJp => PowerSocketJp,
            IconSymbol.ProgressClose => ProgressClose,
            IconSymbol.ReloadAlert => ReloadAlert,
            IconSymbol.RestartAlert => RestartAlert,
            IconSymbol.RestoreAlert => RestoreAlert,
            IconSymbol.Shaker => Shaker,
            IconSymbol.ShakerOutline => ShakerOutline,
            IconSymbol.TelevisionShimmer => TelevisionShimmer,
            IconSymbol.VariableBox => VariableBox,
            IconSymbol.FilterVariantMinus => FilterVariantMinus,
            IconSymbol.FilterVariantPlus => FilterVariantPlus,
            IconSymbol.SlotMachine => SlotMachine,
            IconSymbol.SlotMachineOutline => SlotMachineOutline,
            IconSymbol.GlassMugVariant => GlassMugVariant,
            IconSymbol.ClipboardFlowOutline => ClipboardFlowOutline,
            IconSymbol.SignRealEstate => SignRealEstate,
            IconSymbol.Antenna => Antenna,
            IconSymbol.Centos => Centos,
            IconSymbol.Redhat => Redhat,
            IconSymbol.WindowShutter => WindowShutter,
            IconSymbol.WindowShutterAlert => WindowShutterAlert,
            IconSymbol.WindowShutterOpen => WindowShutterOpen,
            IconSymbol.BikeFast => BikeFast,
            IconSymbol.VolumeSource => VolumeSource,
            IconSymbol.VolumeVibrate => VolumeVibrate,
            IconSymbol.MovieEdit => MovieEdit,
            IconSymbol.MovieEditOutline => MovieEditOutline,
            IconSymbol.MovieFilter => MovieFilter,
            IconSymbol.MovieFilterOutline => MovieFilterOutline,
            IconSymbol.Diabetes => Diabetes,
            IconSymbol.CursorDefaultGesture => CursorDefaultGesture,
            IconSymbol.CursorDefaultGestureOutline => CursorDefaultGestureOutline,
            IconSymbol.Toothbrush => Toothbrush,
            IconSymbol.ToothbrushPaste => ToothbrushPaste,
            IconSymbol.HomeRoof => HomeRoof,
            IconSymbol.ToothbrushElectric => ToothbrushElectric,
            IconSymbol.AccountSupervisorOutline => AccountSupervisorOutline,
            IconSymbol.BottleTonic => BottleTonic,
            IconSymbol.BottleTonicOutline => BottleTonicOutline,
            IconSymbol.BottleTonicPlus => BottleTonicPlus,
            IconSymbol.BottleTonicPlusOutline => BottleTonicPlusOutline,
            IconSymbol.BottleTonicSkull => BottleTonicSkull,
            IconSymbol.BottleTonicSkullOutline => BottleTonicSkullOutline,
            IconSymbol.CalendarArrowLeft => CalendarArrowLeft,
            IconSymbol.CalendarArrowRight => CalendarArrowRight,
            IconSymbol.CrosshairsQuestion => CrosshairsQuestion,
            IconSymbol.FireHydrant => FireHydrant,
            IconSymbol.FireHydrantAlert => FireHydrantAlert,
            IconSymbol.FireHydrantOff => FireHydrantOff,
            IconSymbol.Ocr => Ocr,
            IconSymbol.ShieldStar => ShieldStar,
            IconSymbol.ShieldStarOutline => ShieldStarOutline,
            IconSymbol.TextRecognition => TextRecognition,
            IconSymbol.Handcuffs => Handcuffs,
            IconSymbol.GenderMaleFemaleVariant => GenderMaleFemaleVariant,
            IconSymbol.GenderNonBinary => GenderNonBinary,
            IconSymbol.MinusBoxMultiple => MinusBoxMultiple,
            IconSymbol.MinusBoxMultipleOutline => MinusBoxMultipleOutline,
            IconSymbol.PlusBoxMultipleOutline => PlusBoxMultipleOutline,
            IconSymbol.PencilBoxMultiple => PencilBoxMultiple,
            IconSymbol.PencilBoxMultipleOutline => PencilBoxMultipleOutline,
            IconSymbol.PrinterCheck => PrinterCheck,
            IconSymbol.SortVariantRemove => SortVariantRemove,
            IconSymbol.SortAlphabeticalAscendingVariant => SortAlphabeticalAscendingVariant,
            IconSymbol.SortAlphabeticalDescendingVariant => SortAlphabeticalDescendingVariant,
            IconSymbol.Dice1Outline => Dice1Outline,
            IconSymbol.Dice2Outline => Dice2Outline,
            IconSymbol.Dice3Outline => Dice3Outline,
            IconSymbol.Dice4Outline => Dice4Outline,
            IconSymbol.Dice5Outline => Dice5Outline,
            IconSymbol.Dice6Outline => Dice6Outline,
            IconSymbol.DiceD4 => DiceD4,
            IconSymbol.DiceD6 => DiceD6,
            IconSymbol.DiceD8 => DiceD8,
            IconSymbol.DiceD10 => DiceD10,
            IconSymbol.DiceD12 => DiceD12,
            IconSymbol.DiceD20 => DiceD20,
            IconSymbol.DiceMultipleOutline => DiceMultipleOutline,
            IconSymbol.PaperRoll => PaperRoll,
            IconSymbol.PaperRollOutline => PaperRollOutline,
            IconSymbol.HomeEdit => HomeEdit,
            IconSymbol.HomeEditOutline => HomeEditOutline,
            IconSymbol.ArrowHorizontalLock => ArrowHorizontalLock,
            IconSymbol.ArrowVerticalLock => ArrowVerticalLock,
            IconSymbol.WeightLifter => WeightLifter,
            IconSymbol.AccountLock => AccountLock,
            IconSymbol.AccountLockOutline => AccountLockOutline,
            IconSymbol.Pasta => Pasta,
            IconSymbol.SendCheck => SendCheck,
            IconSymbol.SendCheckOutline => SendCheckOutline,
            IconSymbol.SendClock => SendClock,
            IconSymbol.SendClockOutline => SendClockOutline,
            IconSymbol.SendOutline => SendOutline,
            IconSymbol.SendLockOutline => SendLockOutline,
            IconSymbol.PoliceBadge => PoliceBadge,
            IconSymbol.PoliceBadgeOutline => PoliceBadgeOutline,
            IconSymbol.GateArrowRight => GateArrowRight,
            IconSymbol.GateOpen => GateOpen,
            IconSymbol.BellBadge => BellBadge,
            IconSymbol.MessageImageOutline => MessageImageOutline,
            IconSymbol.MessageLockOutline => MessageLockOutline,
            IconSymbol.MessageMinus => MessageMinus,
            IconSymbol.MessageMinusOutline => MessageMinusOutline,
            IconSymbol.MessageProcessingOutline => MessageProcessingOutline,
            IconSymbol.MessageSettingsOutline => MessageSettingsOutline,
            IconSymbol.MessageCogOutline => MessageCogOutline,
            IconSymbol.MessageTextClock => MessageTextClock,
            IconSymbol.MessageTextClockOutline => MessageTextClockOutline,
            IconSymbol.MessageTextLockOutline => MessageTextLockOutline,
            IconSymbol.CheckboxBlankBadge => CheckboxBlankBadge,
            IconSymbol.FileLink => FileLink,
            IconSymbol.FileLinkOutline => FileLinkOutline,
            IconSymbol.FilePhone => FilePhone,
            IconSymbol.FilePhoneOutline => FilePhoneOutline,
            IconSymbol.Meditation => Meditation,
            IconSymbol.Yoga => Yoga,
            IconSymbol.Leek => Leek,
            IconSymbol.Noodles => Noodles,
            IconSymbol.PoundBoxOutline => PoundBoxOutline,
            IconSymbol.SchoolOutline => SchoolOutline,
            IconSymbol.BasketOutline => BasketOutline,
            IconSymbol.PhoneInTalkOutline => PhoneInTalkOutline,
            IconSymbol.Bash => Bash,
            IconSymbol.FileKey => FileKey,
            IconSymbol.FileKeyOutline => FileKeyOutline,
            IconSymbol.FileCertificate => FileCertificate,
            IconSymbol.FileCertificateOutline => FileCertificateOutline,
            IconSymbol.CertificateOutline => CertificateOutline,
            IconSymbol.Cigar => Cigar,
            IconSymbol.GrillOutline => GrillOutline,
            IconSymbol.QrcodePlus => QrcodePlus,
            IconSymbol.QrcodeMinus => QrcodeMinus,
            IconSymbol.QrcodeRemove => QrcodeRemove,
            IconSymbol.PhoneAlertOutline => PhoneAlertOutline,
            IconSymbol.PhoneBluetoothOutline => PhoneBluetoothOutline,
            IconSymbol.PhoneCancelOutline => PhoneCancelOutline,
            IconSymbol.PhoneForwardOutline => PhoneForwardOutline,
            IconSymbol.PhoneHangupOutline => PhoneHangupOutline,
            IconSymbol.PhoneIncomingOutline => PhoneIncomingOutline,
            IconSymbol.PhoneLockOutline => PhoneLockOutline,
            IconSymbol.PhoneLogOutline => PhoneLogOutline,
            IconSymbol.PhoneMessage => PhoneMessage,
            IconSymbol.PhoneMessageOutline => PhoneMessageOutline,
            IconSymbol.PhoneMinusOutline => PhoneMinusOutline,
            IconSymbol.PhoneOutgoingOutline => PhoneOutgoingOutline,
            IconSymbol.PhonePausedOutline => PhonePausedOutline,
            IconSymbol.PhonePlusOutline => PhonePlusOutline,
            IconSymbol.PhoneReturnOutline => PhoneReturnOutline,
            IconSymbol.PhoneSettingsOutline => PhoneSettingsOutline,
            IconSymbol.KeyStar => KeyStar,
            IconSymbol.KeyLink => KeyLink,
            IconSymbol.ShieldEdit => ShieldEdit,
            IconSymbol.ShieldEditOutline => ShieldEditOutline,
            IconSymbol.ShieldSync => ShieldSync,
            IconSymbol.ShieldSyncOutline => ShieldSyncOutline,
            IconSymbol.GolfCart => GolfCart,
            IconSymbol.PhoneMissedOutline => PhoneMissedOutline,
            IconSymbol.PhoneOffOutline => PhoneOffOutline,
            IconSymbol.FormatQuoteOpenOutline => FormatQuoteOpenOutline,
            IconSymbol.FormatQuoteCloseOutline => FormatQuoteCloseOutline,
            IconSymbol.PhoneCheck => PhoneCheck,
            IconSymbol.PhoneCheckOutline => PhoneCheckOutline,
            IconSymbol.PhoneRing => PhoneRing,
            IconSymbol.PhoneRingOutline => PhoneRingOutline,
            IconSymbol.ShareCircle => ShareCircle,
            IconSymbol.ReplyCircle => ReplyCircle,
            IconSymbol.FridgeOff => FridgeOff,
            IconSymbol.FridgeOffOutline => FridgeOffOutline,
            IconSymbol.FridgeAlert => FridgeAlert,
            IconSymbol.FridgeAlertOutline => FridgeAlertOutline,
            IconSymbol.WaterBoilerAlert => WaterBoilerAlert,
            IconSymbol.WaterBoilerOff => WaterBoilerOff,
            IconSymbol.AmplifierOff => AmplifierOff,
            IconSymbol.AudioVideoOff => AudioVideoOff,
            IconSymbol.ToasterOff => ToasterOff,
            IconSymbol.DishwasherAlert => DishwasherAlert,
            IconSymbol.DishwasherOff => DishwasherOff,
            IconSymbol.TumbleDryerAlert => TumbleDryerAlert,
            IconSymbol.TumbleDryerOff => TumbleDryerOff,
            IconSymbol.WashingMachineAlert => WashingMachineAlert,
            IconSymbol.WashingMachineOff => WashingMachineOff,
            IconSymbol.CarInfo => CarInfo,
            IconSymbol.CommentEdit => CommentEdit,
            IconSymbol.Printer3dNozzleAlert => Printer3dNozzleAlert,
            IconSymbol.Printer3dNozzleAlertOutline => Printer3dNozzleAlertOutline,
            IconSymbol.AlignHorizontalLeft => AlignHorizontalLeft,
            IconSymbol.AlignHorizontalCenter => AlignHorizontalCenter,
            IconSymbol.AlignHorizontalRight => AlignHorizontalRight,
            IconSymbol.AlignVerticalBottom => AlignVerticalBottom,
            IconSymbol.AlignVerticalCenter => AlignVerticalCenter,
            IconSymbol.AlignVerticalTop => AlignVerticalTop,
            IconSymbol.DistributeHorizontalLeft => DistributeHorizontalLeft,
            IconSymbol.DistributeHorizontalCenter => DistributeHorizontalCenter,
            IconSymbol.DistributeHorizontalRight => DistributeHorizontalRight,
            IconSymbol.DistributeVerticalBottom => DistributeVerticalBottom,
            IconSymbol.DistributeVerticalCenter => DistributeVerticalCenter,
            IconSymbol.DistributeVerticalTop => DistributeVerticalTop,
            IconSymbol.AlertRhombus => AlertRhombus,
            IconSymbol.AlertRhombusOutline => AlertRhombusOutline,
            IconSymbol.CrownOutline => CrownOutline,
            IconSymbol.ImageOffOutline => ImageOffOutline,
            IconSymbol.MovieSearch => MovieSearch,
            IconSymbol.MovieSearchOutline => MovieSearchOutline,
            IconSymbol.RvTruck => RvTruck,
            IconSymbol.ShoppingOutline => ShoppingOutline,
            IconSymbol.Strategy => Strategy,
            IconSymbol.NoteTextOutline => NoteTextOutline,
            IconSymbol.ViewAgendaOutline => ViewAgendaOutline,
            IconSymbol.ViewGridOutline => ViewGridOutline,
            IconSymbol.ViewGridPlusOutline => ViewGridPlusOutline,
            IconSymbol.WindowClosedVariant => WindowClosedVariant,
            IconSymbol.WindowOpenVariant => WindowOpenVariant,
            IconSymbol.CogClockwise => CogClockwise,
            IconSymbol.CogCounterclockwise => CogCounterclockwise,
            IconSymbol.ChartSankey => ChartSankey,
            IconSymbol.ChartSankeyVariant => ChartSankeyVariant,
            IconSymbol.VanityLight => VanityLight,
            IconSymbol.Router => Router,
            IconSymbol.ImageEdit => ImageEdit,
            IconSymbol.ImageEditOutline => ImageEditOutline,
            IconSymbol.BellCheck => BellCheck,
            IconSymbol.BellCheckOutline => BellCheckOutline,
            IconSymbol.FileEdit => FileEdit,
            IconSymbol.FileEditOutline => FileEditOutline,
            IconSymbol.HumanScooter => HumanScooter,
            IconSymbol.Spider => Spider,
            IconSymbol.SpiderThread => SpiderThread,
            IconSymbol.PlusThick => PlusThick,
            IconSymbol.AlertCircleCheck => AlertCircleCheck,
            IconSymbol.AlertCircleCheckOutline => AlertCircleCheckOutline,
            IconSymbol.StateMachine => StateMachine,
            IconSymbol.UsbPort => UsbPort,
            IconSymbol.CloudLock => CloudLock,
            IconSymbol.CloudLockOutline => CloudLockOutline,
            IconSymbol.RobotMowerOutline => RobotMowerOutline,
            IconSymbol.ShareAll => ShareAll,
            IconSymbol.ShareAllOutline => ShareAllOutline,
            IconSymbol.GoogleCloud => GoogleCloud,
            IconSymbol.RobotMower => RobotMower,
            IconSymbol.FastForward5 => FastForward5,
            IconSymbol.Rewind5 => Rewind5,
            IconSymbol.ShapeOvalPlus => ShapeOvalPlus,
            IconSymbol.TimelineClock => TimelineClock,
            IconSymbol.TimelineClockOutline => TimelineClockOutline,
            IconSymbol.Mirror => Mirror,
            IconSymbol.AccountMultipleCheckOutline => AccountMultipleCheckOutline,
            IconSymbol.CardPlus => CardPlus,
            IconSymbol.CardPlusOutline => CardPlusOutline,
            IconSymbol.CheckerboardPlus => CheckerboardPlus,
            IconSymbol.CheckerboardMinus => CheckerboardMinus,
            IconSymbol.CheckerboardRemove => CheckerboardRemove,
            IconSymbol.SelectSearch => SelectSearch,
            IconSymbol.SelectionSearch => SelectionSearch,
            IconSymbol.LayersSearch => LayersSearch,
            IconSymbol.LayersSearchOutline => LayersSearchOutline,
            IconSymbol.LightbulbCfl => LightbulbCfl,
            IconSymbol.LightbulbCflOff => LightbulbCflOff,
            IconSymbol.AccountMultipleRemove => AccountMultipleRemove,
            IconSymbol.AccountMultipleRemoveOutline => AccountMultipleRemoveOutline,
            IconSymbol.MagnifyRemoveCursor => MagnifyRemoveCursor,
            IconSymbol.MagnifyRemoveOutline => MagnifyRemoveOutline,
            IconSymbol.ArchiveOutline => ArchiveOutline,
            IconSymbol.BatteryHeart => BatteryHeart,
            IconSymbol.BatteryHeartOutline => BatteryHeartOutline,
            IconSymbol.BatteryHeartVariant => BatteryHeartVariant,
            IconSymbol.BusMarker => BusMarker,
            IconSymbol.ChartMultiple => ChartMultiple,
            IconSymbol.EmoticonLol => EmoticonLol,
            IconSymbol.EmoticonLolOutline => EmoticonLolOutline,
            IconSymbol.FileSync => FileSync,
            IconSymbol.FileSyncOutline => FileSyncOutline,
            IconSymbol.Handshake => Handshake,
            IconSymbol.LanguageKotlin => LanguageKotlin,
            IconSymbol.LanguageFortran => LanguageFortran,
            IconSymbol.Offer => Offer,
            IconSymbol.RadioOff => RadioOff,
            IconSymbol.TableHeadersEye => TableHeadersEye,
            IconSymbol.TableHeadersEyeOff => TableHeadersEyeOff,
            IconSymbol.TagMinusOutline => TagMinusOutline,
            IconSymbol.TagOff => TagOff,
            IconSymbol.TagOffOutline => TagOffOutline,
            IconSymbol.TagPlusOutline => TagPlusOutline,
            IconSymbol.TagRemoveOutline => TagRemoveOutline,
            IconSymbol.TagText => TagText,
            IconSymbol.VectorPolylineEdit => VectorPolylineEdit,
            IconSymbol.VectorPolylineMinus => VectorPolylineMinus,
            IconSymbol.VectorPolylinePlus => VectorPolylinePlus,
            IconSymbol.VectorPolylineRemove => VectorPolylineRemove,
            IconSymbol.BeakerAlert => BeakerAlert,
            IconSymbol.BeakerAlertOutline => BeakerAlertOutline,
            IconSymbol.BeakerCheck => BeakerCheck,
            IconSymbol.BeakerCheckOutline => BeakerCheckOutline,
            IconSymbol.BeakerMinus => BeakerMinus,
            IconSymbol.BeakerMinusOutline => BeakerMinusOutline,
            IconSymbol.BeakerPlus => BeakerPlus,
            IconSymbol.BeakerPlusOutline => BeakerPlusOutline,
            IconSymbol.BeakerQuestion => BeakerQuestion,
            IconSymbol.BeakerQuestionOutline => BeakerQuestionOutline,
            IconSymbol.BeakerRemove => BeakerRemove,
            IconSymbol.BeakerRemoveOutline => BeakerRemoveOutline,
            IconSymbol.BicycleBasket => BicycleBasket,
            IconSymbol.BarcodeOff => BarcodeOff,
            IconSymbol.DigitalOcean => DigitalOcean,
            IconSymbol.ExclamationThick => ExclamationThick,
            IconSymbol.Desk => Desk,
            IconSymbol.FlaskEmptyMinus => FlaskEmptyMinus,
            IconSymbol.FlaskEmptyMinusOutline => FlaskEmptyMinusOutline,
            IconSymbol.FlaskEmptyPlus => FlaskEmptyPlus,
            IconSymbol.FlaskEmptyPlusOutline => FlaskEmptyPlusOutline,
            IconSymbol.FlaskEmptyRemove => FlaskEmptyRemove,
            IconSymbol.FlaskEmptyRemoveOutline => FlaskEmptyRemoveOutline,
            IconSymbol.FlaskMinus => FlaskMinus,
            IconSymbol.FlaskMinusOutline => FlaskMinusOutline,
            IconSymbol.FlaskPlus => FlaskPlus,
            IconSymbol.FlaskPlusOutline => FlaskPlusOutline,
            IconSymbol.FlaskRemove => FlaskRemove,
            IconSymbol.FlaskRemoveOutline => FlaskRemoveOutline,
            IconSymbol.FolderMoveOutline => FolderMoveOutline,
            IconSymbol.HomeRemove => HomeRemove,
            IconSymbol.Webrtc => Webrtc,
            IconSymbol.SeatPassenger => SeatPassenger,
            IconSymbol.WebClock => WebClock,
            IconSymbol.FlaskRoundBottom => FlaskRoundBottom,
            IconSymbol.FlaskRoundBottomEmpty => FlaskRoundBottomEmpty,
            IconSymbol.FlaskRoundBottomEmptyOutline => FlaskRoundBottomEmptyOutline,
            IconSymbol.FlaskRoundBottomOutline => FlaskRoundBottomOutline,
            IconSymbol.Gold => Gold,
            IconSymbol.MessageStarOutline => MessageStarOutline,
            IconSymbol.HomeLightbulb => HomeLightbulb,
            IconSymbol.HomeLightbulbOutline => HomeLightbulbOutline,
            IconSymbol.LightbulbGroup => LightbulbGroup,
            IconSymbol.LightbulbGroupOutline => LightbulbGroupOutline,
            IconSymbol.LightbulbMultiple => LightbulbMultiple,
            IconSymbol.LightbulbMultipleOutline => LightbulbMultipleOutline,
            IconSymbol.ApiOff => ApiOff,
            IconSymbol.Allergy => Allergy,
            IconSymbol.ArchiveArrowDown => ArchiveArrowDown,
            IconSymbol.ArchiveArrowDownOutline => ArchiveArrowDownOutline,
            IconSymbol.ArchiveArrowUp => ArchiveArrowUp,
            IconSymbol.ArchiveArrowUpOutline => ArchiveArrowUpOutline,
            IconSymbol.BatteryOff => BatteryOff,
            IconSymbol.BatteryOffOutline => BatteryOffOutline,
            IconSymbol.Bookshelf => Bookshelf,
            IconSymbol.CashMinus => CashMinus,
            IconSymbol.CashPlus => CashPlus,
            IconSymbol.CashRemove => CashRemove,
            IconSymbol.ClipboardCheckMultiple => ClipboardCheckMultiple,
            IconSymbol.ClipboardCheckMultipleOutline => ClipboardCheckMultipleOutline,
            IconSymbol.ClipboardFile => ClipboardFile,
            IconSymbol.ClipboardFileOutline => ClipboardFileOutline,
            IconSymbol.ClipboardMultiple => ClipboardMultiple,
            IconSymbol.ClipboardMultipleOutline => ClipboardMultipleOutline,
            IconSymbol.ClipboardPlayMultiple => ClipboardPlayMultiple,
            IconSymbol.ClipboardPlayMultipleOutline => ClipboardPlayMultipleOutline,
            IconSymbol.ClipboardTextMultiple => ClipboardTextMultiple,
            IconSymbol.ClipboardTextMultipleOutline => ClipboardTextMultipleOutline,
            IconSymbol.FolderMarker => FolderMarker,
            IconSymbol.FolderMarkerOutline => FolderMarkerOutline,
            IconSymbol.FormatListText => FormatListText,
            IconSymbol.InboxArrowDownOutline => InboxArrowDownOutline,
            IconSymbol.InboxArrowUpOutline => InboxArrowUpOutline,
            IconSymbol.InboxFull => InboxFull,
            IconSymbol.InboxFullOutline => InboxFullOutline,
            IconSymbol.InboxOutline => InboxOutline,
            IconSymbol.LightbulbCflSpiral => LightbulbCflSpiral,
            IconSymbol.MagnifyScan => MagnifyScan,
            IconSymbol.MapMarkerMultipleOutline => MapMarkerMultipleOutline,
            IconSymbol.PercentOutline => PercentOutline,
            IconSymbol.PhoneClassicOff => PhoneClassicOff,
            IconSymbol.PlayBox => PlayBox,
            IconSymbol.AccountEyeOutline => AccountEyeOutline,
            IconSymbol.SafeSquare => SafeSquare,
            IconSymbol.SafeSquareOutline => SafeSquareOutline,
            IconSymbol.Scoreboard => Scoreboard,
            IconSymbol.ScoreboardOutline => ScoreboardOutline,
            IconSymbol.SelectMarker => SelectMarker,
            IconSymbol.SelectMultiple => SelectMultiple,
            IconSymbol.SelectMultipleMarker => SelectMultipleMarker,
            IconSymbol.SelectionMarker => SelectionMarker,
            IconSymbol.SelectionMultipleMarker => SelectionMultipleMarker,
            IconSymbol.SelectionMultiple => SelectionMultiple,
            IconSymbol.StarBoxMultiple => StarBoxMultiple,
            IconSymbol.StarBoxMultipleOutline => StarBoxMultipleOutline,
            IconSymbol.ToyBrick => ToyBrick,
            IconSymbol.ToyBrickMarker => ToyBrickMarker,
            IconSymbol.ToyBrickMarkerOutline => ToyBrickMarkerOutline,
            IconSymbol.ToyBrickMinus => ToyBrickMinus,
            IconSymbol.ToyBrickMinusOutline => ToyBrickMinusOutline,
            IconSymbol.ToyBrickOutline => ToyBrickOutline,
            IconSymbol.ToyBrickPlus => ToyBrickPlus,
            IconSymbol.ToyBrickPlusOutline => ToyBrickPlusOutline,
            IconSymbol.ToyBrickRemove => ToyBrickRemove,
            IconSymbol.ToyBrickRemoveOutline => ToyBrickRemoveOutline,
            IconSymbol.ToyBrickSearch => ToyBrickSearch,
            IconSymbol.ToyBrickSearchOutline => ToyBrickSearchOutline,
            IconSymbol.Tray => Tray,
            IconSymbol.TrayAlert => TrayAlert,
            IconSymbol.TrayFull => TrayFull,
            IconSymbol.TrayMinus => TrayMinus,
            IconSymbol.TrayPlus => TrayPlus,
            IconSymbol.TrayRemove => TrayRemove,
            IconSymbol.TruckCheckOutline => TruckCheckOutline,
            IconSymbol.TruckDeliveryOutline => TruckDeliveryOutline,
            IconSymbol.TruckFastOutline => TruckFastOutline,
            IconSymbol.TruckOutline => TruckOutline,
            IconSymbol.UsbFlashDrive => UsbFlashDrive,
            IconSymbol.UsbFlashDriveOutline => UsbFlashDriveOutline,
            IconSymbol.WaterPolo => WaterPolo,
            IconSymbol.BatteryLow => BatteryLow,
            IconSymbol.BatteryMedium => BatteryMedium,
            IconSymbol.BatteryHigh => BatteryHigh,
            IconSymbol.BatteryChargingLow => BatteryChargingLow,
            IconSymbol.BatteryChargingMedium => BatteryChargingMedium,
            IconSymbol.BatteryChargingHigh => BatteryChargingHigh,
            IconSymbol.Hexadecimal => Hexadecimal,
            IconSymbol.GestureTapButton => GestureTapButton,
            IconSymbol.GestureTapBox => GestureTapBox,
            IconSymbol.LanCheck => LanCheck,
            IconSymbol.KeyboardF1 => KeyboardF1,
            IconSymbol.KeyboardF2 => KeyboardF2,
            IconSymbol.KeyboardF3 => KeyboardF3,
            IconSymbol.KeyboardF4 => KeyboardF4,
            IconSymbol.KeyboardF5 => KeyboardF5,
            IconSymbol.KeyboardF6 => KeyboardF6,
            IconSymbol.KeyboardF7 => KeyboardF7,
            IconSymbol.KeyboardF8 => KeyboardF8,
            IconSymbol.KeyboardF9 => KeyboardF9,
            IconSymbol.KeyboardF10 => KeyboardF10,
            IconSymbol.KeyboardF11 => KeyboardF11,
            IconSymbol.KeyboardF12 => KeyboardF12,
            IconSymbol.KeyboardEsc => KeyboardEsc,
            IconSymbol.Toslink => Toslink,
            IconSymbol.Cheese => Cheese,
            IconSymbol.StringLights => StringLights,
            IconSymbol.StringLightsOff => StringLightsOff,
            IconSymbol.WhistleOutline => WhistleOutline,
            IconSymbol.StairsUp => StairsUp,
            IconSymbol.StairsDown => StairsDown,
            IconSymbol.EscalatorUp => EscalatorUp,
            IconSymbol.EscalatorDown => EscalatorDown,
            IconSymbol.ElevatorUp => ElevatorUp,
            IconSymbol.ElevatorDown => ElevatorDown,
            IconSymbol.LightbulbCflSpiralOff => LightbulbCflSpiralOff,
            IconSymbol.CommentEditOutline => CommentEditOutline,
            IconSymbol.TooltipEditOutline => TooltipEditOutline,
            IconSymbol.MonitorEdit => MonitorEdit,
            IconSymbol.EmailSync => EmailSync,
            IconSymbol.EmailSyncOutline => EmailSyncOutline,
            IconSymbol.ChatAlertOutline => ChatAlertOutline,
            IconSymbol.ChatProcessingOutline => ChatProcessingOutline,
            IconSymbol.SnowflakeMelt => SnowflakeMelt,
            IconSymbol.CloudCheckOutline => CloudCheckOutline,
            IconSymbol.LightbulbGroupOff => LightbulbGroupOff,
            IconSymbol.LightbulbGroupOffOutline => LightbulbGroupOffOutline,
            IconSymbol.LightbulbMultipleOff => LightbulbMultipleOff,
            IconSymbol.LightbulbMultipleOffOutline => LightbulbMultipleOffOutline,
            IconSymbol.ChatSleep => ChatSleep,
            IconSymbol.ChatSleepOutline => ChatSleepOutline,
            IconSymbol.GarageVariant => GarageVariant,
            IconSymbol.GarageOpenVariant => GarageOpenVariant,
            IconSymbol.GarageAlertVariant => GarageAlertVariant,
            IconSymbol.CloudSyncOutline => CloudSyncOutline,
            IconSymbol.GlobeLightOutline => GlobeLightOutline,
            IconSymbol.CellphoneNfcOff => CellphoneNfcOff,
            IconSymbol.LeafOff => LeafOff,
            IconSymbol.LeafMapleOff => LeafMapleOff,
            IconSymbol.MapMarkerLeft => MapMarkerLeft,
            IconSymbol.MapMarkerRight => MapMarkerRight,
            IconSymbol.MapMarkerLeftOutline => MapMarkerLeftOutline,
            IconSymbol.MapMarkerRightOutline => MapMarkerRightOutline,
            IconSymbol.AccountCancel => AccountCancel,
            IconSymbol.AccountCancelOutline => AccountCancelOutline,
            IconSymbol.FileClock => FileClock,
            IconSymbol.FileClockOutline => FileClockOutline,
            IconSymbol.FolderTable => FolderTable,
            IconSymbol.FolderTableOutline => FolderTableOutline,
            IconSymbol.HydroPower => HydroPower,
            IconSymbol.Doorbell => Doorbell,
            IconSymbol.Bulma => Bulma,
            IconSymbol.Iobroker => Iobroker,
            IconSymbol.Oci => Oci,
            IconSymbol.LabelPercent => LabelPercent,
            IconSymbol.LabelPercentOutline => LabelPercentOutline,
            IconSymbol.CheckboxBlankOff => CheckboxBlankOff,
            IconSymbol.CheckboxBlankOffOutline => CheckboxBlankOffOutline,
            IconSymbol.SquareOff => SquareOff,
            IconSymbol.SquareOffOutline => SquareOffOutline,
            IconSymbol.DragHorizontalVariant => DragHorizontalVariant,
            IconSymbol.DragVerticalVariant => DragVerticalVariant,
            IconSymbol.MessageArrowLeft => MessageArrowLeft,
            IconSymbol.MessageArrowLeftOutline => MessageArrowLeftOutline,
            IconSymbol.MessageArrowRight => MessageArrowRight,
            IconSymbol.MessageArrowRightOutline => MessageArrowRightOutline,
            IconSymbol.DatabaseMarker => DatabaseMarker,
            IconSymbol.TagMultipleOutline => TagMultipleOutline,
            IconSymbol.MapMarkerPlusOutline => MapMarkerPlusOutline,
            IconSymbol.MapMarkerMinusOutline => MapMarkerMinusOutline,
            IconSymbol.MapMarkerRemoveOutline => MapMarkerRemoveOutline,
            IconSymbol.MapMarkerCheckOutline => MapMarkerCheckOutline,
            IconSymbol.MapMarkerRadiusOutline => MapMarkerRadiusOutline,
            IconSymbol.MapMarkerOffOutline => MapMarkerOffOutline,
            IconSymbol.MoleculeCo => MoleculeCo,
            IconSymbol.JumpRope => JumpRope,
            IconSymbol.Kettlebell => Kettlebell,
            IconSymbol.AccountConvertOutline => AccountConvertOutline,
            IconSymbol.BunkBed => BunkBed,
            IconSymbol.FleurDeLis => FleurDeLis,
            IconSymbol.Ski => Ski,
            IconSymbol.SkiCrossCountry => SkiCrossCountry,
            IconSymbol.SkiWater => SkiWater,
            IconSymbol.Snowboard => Snowboard,
            IconSymbol.AccountTieVoice => AccountTieVoice,
            IconSymbol.AccountTieVoiceOutline => AccountTieVoiceOutline,
            IconSymbol.AccountTieVoiceOff => AccountTieVoiceOff,
            IconSymbol.AccountTieVoiceOffOutline => AccountTieVoiceOffOutline,
            IconSymbol.BeerOutline => BeerOutline,
            IconSymbol.GlassPintOutline => GlassPintOutline,
            IconSymbol.CoffeeToGoOutline => CoffeeToGoOutline,
            IconSymbol.CupOutline => CupOutline,
            IconSymbol.BottleWineOutline => BottleWineOutline,
            IconSymbol.EarthArrowRight => EarthArrowRight,
            IconSymbol.KeyArrowRight => KeyArrowRight,
            IconSymbol.FormatColorMarkerCancel => FormatColorMarkerCancel,
            IconSymbol.MotherHeart => MotherHeart,
            IconSymbol.CurrencyEurOff => CurrencyEurOff,
            IconSymbol.SemanticWeb => SemanticWeb,
            IconSymbol.KettleAlert => KettleAlert,
            IconSymbol.KettleAlertOutline => KettleAlertOutline,
            IconSymbol.KettleSteam => KettleSteam,
            IconSymbol.KettleSteamOutline => KettleSteamOutline,
            IconSymbol.KettleOff => KettleOff,
            IconSymbol.KettleOffOutline => KettleOffOutline,
            IconSymbol.SimpleIcons => SimpleIcons,
            IconSymbol.BriefcaseCheckOutline => BriefcaseCheckOutline,
            IconSymbol.ClipboardPlusOutline => ClipboardPlusOutline,
            IconSymbol.DownloadLock => DownloadLock,
            IconSymbol.DownloadLockOutline => DownloadLockOutline,
            IconSymbol.HammerScrewdriver => HammerScrewdriver,
            IconSymbol.HammerWrench => HammerWrench,
            IconSymbol.HydraulicOilLevel => HydraulicOilLevel,
            IconSymbol.HydraulicOilTemperature => HydraulicOilTemperature,
            IconSymbol.MedalOutline => MedalOutline,
            IconSymbol.Rodent => Rodent,
            IconSymbol.AbjadArabic => AbjadArabic,
            IconSymbol.AbjadHebrew => AbjadHebrew,
            IconSymbol.AbugidaDevanagari => AbugidaDevanagari,
            IconSymbol.AbugidaThai => AbugidaThai,
            IconSymbol.AlphabetAurebesh => AlphabetAurebesh,
            IconSymbol.AlphabetCyrillic => AlphabetCyrillic,
            IconSymbol.AlphabetGreek => AlphabetGreek,
            IconSymbol.AlphabetLatin => AlphabetLatin,
            IconSymbol.AlphabetPiqad => AlphabetPiqad,
            IconSymbol.IdeogramCjk => IdeogramCjk,
            IconSymbol.IdeogramCjkVariant => IdeogramCjkVariant,
            IconSymbol.SyllabaryHangul => SyllabaryHangul,
            IconSymbol.SyllabaryHiragana => SyllabaryHiragana,
            IconSymbol.SyllabaryKatakana => SyllabaryKatakana,
            IconSymbol.SyllabaryKatakanaHalfwidth => SyllabaryKatakanaHalfwidth,
            IconSymbol.AlphabetTengwar => AlphabetTengwar,
            IconSymbol.HeadAlert => HeadAlert,
            IconSymbol.HeadAlertOutline => HeadAlertOutline,
            IconSymbol.HeadCheck => HeadCheck,
            IconSymbol.HeadCheckOutline => HeadCheckOutline,
            IconSymbol.HeadCog => HeadCog,
            IconSymbol.HeadCogOutline => HeadCogOutline,
            IconSymbol.HeadDotsHorizontal => HeadDotsHorizontal,
            IconSymbol.HeadDotsHorizontalOutline => HeadDotsHorizontalOutline,
            IconSymbol.HeadFlash => HeadFlash,
            IconSymbol.HeadFlashOutline => HeadFlashOutline,
            IconSymbol.HeadHeart => HeadHeart,
            IconSymbol.HeadHeartOutline => HeadHeartOutline,
            IconSymbol.HeadLightbulb => HeadLightbulb,
            IconSymbol.HeadLightbulbOutline => HeadLightbulbOutline,
            IconSymbol.HeadMinus => HeadMinus,
            IconSymbol.HeadMinusOutline => HeadMinusOutline,
            IconSymbol.HeadPlus => HeadPlus,
            IconSymbol.HeadPlusOutline => HeadPlusOutline,
            IconSymbol.HeadQuestion => HeadQuestion,
            IconSymbol.HeadQuestionOutline => HeadQuestionOutline,
            IconSymbol.HeadRemove => HeadRemove,
            IconSymbol.HeadRemoveOutline => HeadRemoveOutline,
            IconSymbol.HeadSnowflake => HeadSnowflake,
            IconSymbol.HeadSnowflakeOutline => HeadSnowflakeOutline,
            IconSymbol.HeadSync => HeadSync,
            IconSymbol.HeadSyncOutline => HeadSyncOutline,
            IconSymbol.Hvac => Hvac,
            IconSymbol.PencilRuler => PencilRuler,
            IconSymbol.PipeWrench => PipeWrench,
            IconSymbol.WidgetsOutline => WidgetsOutline,
            IconSymbol.TelevisionAmbientLight => TelevisionAmbientLight,
            IconSymbol.PropaneTank => PropaneTank,
            IconSymbol.PropaneTankOutline => PropaneTankOutline,
            IconSymbol.FolderMusic => FolderMusic,
            IconSymbol.FolderMusicOutline => FolderMusicOutline,
            IconSymbol.Klingon => Klingon,
            IconSymbol.PaletteSwatchOutline => PaletteSwatchOutline,
            IconSymbol.FormTextboxLock => FormTextboxLock,
            IconSymbol.Head => Head,
            IconSymbol.HeadOutline => HeadOutline,
            IconSymbol.ShieldHalf => ShieldHalf,
            IconSymbol.StoreOutline => StoreOutline,
            IconSymbol.GoogleDownasaur => GoogleDownasaur,
            IconSymbol.BottleSodaClassicOutline => BottleSodaClassicOutline,
            IconSymbol.Sticker => Sticker,
            IconSymbol.StickerAlert => StickerAlert,
            IconSymbol.StickerAlertOutline => StickerAlertOutline,
            IconSymbol.StickerCheck => StickerCheck,
            IconSymbol.StickerCheckOutline => StickerCheckOutline,
            IconSymbol.StickerMinus => StickerMinus,
            IconSymbol.StickerMinusOutline => StickerMinusOutline,
            IconSymbol.StickerOutline => StickerOutline,
            IconSymbol.StickerPlus => StickerPlus,
            IconSymbol.StickerPlusOutline => StickerPlusOutline,
            IconSymbol.StickerRemove => StickerRemove,
            IconSymbol.StickerRemoveOutline => StickerRemoveOutline,
            IconSymbol.AccountCog => AccountCog,
            IconSymbol.AccountCogOutline => AccountCogOutline,
            IconSymbol.AccountDetailsOutline => AccountDetailsOutline,
            IconSymbol.UploadLock => UploadLock,
            IconSymbol.UploadLockOutline => UploadLockOutline,
            IconSymbol.LabelMultiple => LabelMultiple,
            IconSymbol.LabelMultipleOutline => LabelMultipleOutline,
            IconSymbol.RefreshCircle => RefreshCircle,
            IconSymbol.SyncCircle => SyncCircle,
            IconSymbol.BookmarkMusicOutline => BookmarkMusicOutline,
            IconSymbol.BookmarkRemoveOutline => BookmarkRemoveOutline,
            IconSymbol.BookmarkCheckOutline => BookmarkCheckOutline,
            IconSymbol.TrafficCone => TrafficCone,
            IconSymbol.CupOffOutline => CupOffOutline,
            IconSymbol.AutoDownload => AutoDownload,
            IconSymbol.Shuriken => Shuriken,
            IconSymbol.ChartPpf => ChartPpf,
            IconSymbol.ElevatorPassenger => ElevatorPassenger,
            IconSymbol.CompassRose => CompassRose,
            IconSymbol.SpaceStation => SpaceStation,
            IconSymbol.OrderBoolDescending => OrderBoolDescending,
            IconSymbol.SortBoolAscending => SortBoolAscending,
            IconSymbol.SortBoolAscendingVariant => SortBoolAscendingVariant,
            IconSymbol.SortBoolDescending => SortBoolDescending,
            IconSymbol.SortBoolDescendingVariant => SortBoolDescendingVariant,
            IconSymbol.SortNumericAscending => SortNumericAscending,
            IconSymbol.SortNumericDescending => SortNumericDescending,
            IconSymbol.HumanBabyChangingTable => HumanBabyChangingTable,
            IconSymbol.HumanMaleChild => HumanMaleChild,
            IconSymbol.HumanWheelchair => HumanWheelchair,
            IconSymbol.MicrosoftAccess => MicrosoftAccess,
            IconSymbol.MicrosoftExcel => MicrosoftExcel,
            IconSymbol.MicrosoftPowerpoint => MicrosoftPowerpoint,
            IconSymbol.MicrosoftSharepoint => MicrosoftSharepoint,
            IconSymbol.MicrosoftWord => MicrosoftWord,
            IconSymbol.NintendoGameBoy => NintendoGameBoy,
            IconSymbol.CableData => CableData,
            IconSymbol.CircleHalf => CircleHalf,
            IconSymbol.CircleHalfFull => CircleHalfFull,
            IconSymbol.CellphoneCharging => CellphoneCharging,
            IconSymbol.CloseThick => CloseThick,
            IconSymbol.EscalatorBox => EscalatorBox,
            IconSymbol.LockCheck => LockCheck,
            IconSymbol.LockOpenAlert => LockOpenAlert,
            IconSymbol.LockOpenCheck => LockOpenCheck,
            IconSymbol.RecycleVariant => RecycleVariant,
            IconSymbol.StairsBox => StairsBox,
            IconSymbol.HandWater => HandWater,
            IconSymbol.TableRefresh => TableRefresh,
            IconSymbol.TableSync => TableSync,
            IconSymbol.SizeXxs => SizeXxs,
            IconSymbol.SizeXs => SizeXs,
            IconSymbol.SizeS => SizeS,
            IconSymbol.SizeM => SizeM,
            IconSymbol.SizeXl => SizeXl,
            IconSymbol.SizeXxl => SizeXxl,
            IconSymbol.SizeXxxl => SizeXxxl,
            IconSymbol.TicketConfirmationOutline => TicketConfirmationOutline,
            IconSymbol.Timer => Timer,
            IconSymbol.TimerOff => TimerOff,
            IconSymbol.BookAccount => BookAccount,
            IconSymbol.BookAccountOutline => BookAccountOutline,
            IconSymbol.RocketOutline => RocketOutline,
            IconSymbol.HomeSearch => HomeSearch,
            IconSymbol.HomeSearchOutline => HomeSearchOutline,
            IconSymbol.CarArrowLeft => CarArrowLeft,
            IconSymbol.CarArrowRight => CarArrowRight,
            IconSymbol.MonitorEye => MonitorEye,
            IconSymbol.Lipstick => Lipstick,
            IconSymbol.Virus => Virus,
            IconSymbol.VirusOutline => VirusOutline,
            IconSymbol.TextSearch => TextSearch,
            IconSymbol.TableAccount => TableAccount,
            IconSymbol.TableAlert => TableAlert,
            IconSymbol.TableArrowDown => TableArrowDown,
            IconSymbol.TableArrowLeft => TableArrowLeft,
            IconSymbol.TableArrowRight => TableArrowRight,
            IconSymbol.TableArrowUp => TableArrowUp,
            IconSymbol.TableCancel => TableCancel,
            IconSymbol.TableCheck => TableCheck,
            IconSymbol.TableClock => TableClock,
            IconSymbol.TableCog => TableCog,
            IconSymbol.TableEyeOff => TableEyeOff,
            IconSymbol.TableHeart => TableHeart,
            IconSymbol.TableKey => TableKey,
            IconSymbol.TableLock => TableLock,
            IconSymbol.TableMinus => TableMinus,
            IconSymbol.TableMultiple => TableMultiple,
            IconSymbol.TableNetwork => TableNetwork,
            IconSymbol.TableOff => TableOff,
            IconSymbol.TableStar => TableStar,
            IconSymbol.CarCog => CarCog,
            IconSymbol.CarSettings => CarSettings,
            IconSymbol.CogOff => CogOff,
            IconSymbol.CogOffOutline => CogOffOutline,
            IconSymbol.CreditCardCheck => CreditCardCheck,
            IconSymbol.CreditCardCheckOutline => CreditCardCheckOutline,
            IconSymbol.FileTreeOutline => FileTreeOutline,
            IconSymbol.FolderStarMultiple => FolderStarMultiple,
            IconSymbol.FolderStarMultipleOutline => FolderStarMultipleOutline,
            IconSymbol.HomeMinusOutline => HomeMinusOutline,
            IconSymbol.HomePlusOutline => HomePlusOutline,
            IconSymbol.HomeRemoveOutline => HomeRemoveOutline,
            IconSymbol.ScanHelper => ScanHelper,
            IconSymbol.Video3dOff => Video3dOff,
            IconSymbol.ShieldBug => ShieldBug,
            IconSymbol.ShieldBugOutline => ShieldBugOutline,
            IconSymbol.EyedropperPlus => EyedropperPlus,
            IconSymbol.EyedropperMinus => EyedropperMinus,
            IconSymbol.EyedropperRemove => EyedropperRemove,
            IconSymbol.EyedropperOff => EyedropperOff,
            IconSymbol.BabyBuggy => BabyBuggy,
            IconSymbol.UmbrellaClosedVariant => UmbrellaClosedVariant,
            IconSymbol.UmbrellaClosedOutline => UmbrellaClosedOutline,
            IconSymbol.EmailOff => EmailOff,
            IconSymbol.EmailOffOutline => EmailOffOutline,
            IconSymbol.FoodVariantOff => FoodVariantOff,
            IconSymbol.PlayBoxMultipleOutline => PlayBoxMultipleOutline,
            IconSymbol.BellCancel => BellCancel,
            IconSymbol.BellCancelOutline => BellCancelOutline,
            IconSymbol.BellMinus => BellMinus,
            IconSymbol.BellMinusOutline => BellMinusOutline,
            IconSymbol.BellRemove => BellRemove,
            IconSymbol.BellRemoveOutline => BellRemoveOutline,
            IconSymbol.BeehiveOffOutline => BeehiveOffOutline,
            IconSymbol.CheeseOff => CheeseOff,
            IconSymbol.CornOff => CornOff,
            IconSymbol.EggOff => EggOff,
            IconSymbol.EggOffOutline => EggOffOutline,
            IconSymbol.EggOutline => EggOutline,
            IconSymbol.FishOff => FishOff,
            IconSymbol.FlaskEmptyOff => FlaskEmptyOff,
            IconSymbol.FlaskEmptyOffOutline => FlaskEmptyOffOutline,
            IconSymbol.FlaskOff => FlaskOff,
            IconSymbol.FlaskOffOutline => FlaskOffOutline,
            IconSymbol.FruitCherriesOff => FruitCherriesOff,
            IconSymbol.FruitCitrusOff => FruitCitrusOff,
            IconSymbol.MushroomOff => MushroomOff,
            IconSymbol.MushroomOffOutline => MushroomOffOutline,
            IconSymbol.SoySauceOff => SoySauceOff,
            IconSymbol.SeedOff => SeedOff,
            IconSymbol.SeedOffOutline => SeedOffOutline,
            IconSymbol.Tailwind => Tailwind,
            IconSymbol.FormDropdown => FormDropdown,
            IconSymbol.FormSelect => FormSelect,
            IconSymbol.Pump => Pump,
            IconSymbol.EarthPlus => EarthPlus,
            IconSymbol.EarthMinus => EarthMinus,
            IconSymbol.EarthRemove => EarthRemove,
            IconSymbol.EarthBoxPlus => EarthBoxPlus,
            IconSymbol.EarthBoxMinus => EarthBoxMinus,
            IconSymbol.EarthBoxRemove => EarthBoxRemove,
            IconSymbol.GasStationOff => GasStationOff,
            IconSymbol.GasStationOffOutline => GasStationOffOutline,
            IconSymbol.LightningBolt => LightningBolt,
            IconSymbol.LightningBoltOutline => LightningBoltOutline,
            IconSymbol.SmokingPipe => SmokingPipe,
            IconSymbol.AxisArrowInfo => AxisArrowInfo,
            IconSymbol.ChatPlus => ChatPlus,
            IconSymbol.ChatMinus => ChatMinus,
            IconSymbol.ChatRemove => ChatRemove,
            IconSymbol.ChatPlusOutline => ChatPlusOutline,
            IconSymbol.ChatMinusOutline => ChatMinusOutline,
            IconSymbol.ChatRemoveOutline => ChatRemoveOutline,
            IconSymbol.Bucket => Bucket,
            IconSymbol.BucketOutline => BucketOutline,
            IconSymbol.Pail => Pail,
            IconSymbol.ImageRemove => ImageRemove,
            IconSymbol.ImageMinus => ImageMinus,
            IconSymbol.PineTreeFire => PineTreeFire,
            IconSymbol.CigarOff => CigarOff,
            IconSymbol.CubeOff => CubeOff,
            IconSymbol.CubeOffOutline => CubeOffOutline,
            IconSymbol.DomeLight => DomeLight,
            IconSymbol.FoodDrumstick => FoodDrumstick,
            IconSymbol.FoodDrumstickOutline => FoodDrumstickOutline,
            IconSymbol.IncognitoCircle => IncognitoCircle,
            IconSymbol.IncognitoCircleOff => IncognitoCircleOff,
            IconSymbol.MicrowaveOff => MicrowaveOff,
            IconSymbol.PowerPlugOffOutline => PowerPlugOffOutline,
            IconSymbol.PowerPlugOutline => PowerPlugOutline,
            IconSymbol.PuzzleCheck => PuzzleCheck,
            IconSymbol.PuzzleCheckOutline => PuzzleCheckOutline,
            IconSymbol.SmokingPipeOff => SmokingPipeOff,
            IconSymbol.SpoonSugar => SpoonSugar,
            IconSymbol.TableSplitCell => TableSplitCell,
            IconSymbol.TicketPercentOutline => TicketPercentOutline,
            IconSymbol.FuseOff => FuseOff,
            IconSymbol.FuseAlert => FuseAlert,
            IconSymbol.HeartPlus => HeartPlus,
            IconSymbol.HeartMinus => HeartMinus,
            IconSymbol.HeartRemove => HeartRemove,
            IconSymbol.HeartPlusOutline => HeartPlusOutline,
            IconSymbol.HeartMinusOutline => HeartMinusOutline,
            IconSymbol.HeartRemoveOutline => HeartRemoveOutline,
            IconSymbol.HeartOffOutline => HeartOffOutline,
            IconSymbol.MotionSensorOff => MotionSensorOff,
            IconSymbol.PailPlus => PailPlus,
            IconSymbol.PailMinus => PailMinus,
            IconSymbol.PailRemove => PailRemove,
            IconSymbol.PailOff => PailOff,
            IconSymbol.PailOutline => PailOutline,
            IconSymbol.PailPlusOutline => PailPlusOutline,
            IconSymbol.PailMinusOutline => PailMinusOutline,
            IconSymbol.PailRemoveOutline => PailRemoveOutline,
            IconSymbol.PailOffOutline => PailOffOutline,
            IconSymbol.ClockTimeOne => ClockTimeOne,
            IconSymbol.ClockTimeTwo => ClockTimeTwo,
            IconSymbol.ClockTimeThree => ClockTimeThree,
            IconSymbol.ClockTimeFour => ClockTimeFour,
            IconSymbol.ClockTimeFive => ClockTimeFive,
            IconSymbol.ClockTimeSix => ClockTimeSix,
            IconSymbol.ClockTimeSeven => ClockTimeSeven,
            IconSymbol.ClockTimeEight => ClockTimeEight,
            IconSymbol.ClockTimeNine => ClockTimeNine,
            IconSymbol.ClockTimeTen => ClockTimeTen,
            IconSymbol.ClockTimeEleven => ClockTimeEleven,
            IconSymbol.ClockTimeTwelve => ClockTimeTwelve,
            IconSymbol.ClockTimeOneOutline => ClockTimeOneOutline,
            IconSymbol.ClockTimeTwoOutline => ClockTimeTwoOutline,
            IconSymbol.ClockTimeThreeOutline => ClockTimeThreeOutline,
            IconSymbol.ClockTimeFourOutline => ClockTimeFourOutline,
            IconSymbol.ClockTimeFiveOutline => ClockTimeFiveOutline,
            IconSymbol.ClockTimeSixOutline => ClockTimeSixOutline,
            IconSymbol.ClockTimeSevenOutline => ClockTimeSevenOutline,
            IconSymbol.ClockTimeEightOutline => ClockTimeEightOutline,
            IconSymbol.ClockTimeNineOutline => ClockTimeNineOutline,
            IconSymbol.ClockTimeTenOutline => ClockTimeTenOutline,
            IconSymbol.ClockTimeElevenOutline => ClockTimeElevenOutline,
            IconSymbol.ClockTimeTwelveOutline => ClockTimeTwelveOutline,
            IconSymbol.PrinterSearch => PrinterSearch,
            IconSymbol.PrinterEye => PrinterEye,
            IconSymbol.MinusCircleOff => MinusCircleOff,
            IconSymbol.MinusCircleOffOutline => MinusCircleOffOutline,
            IconSymbol.ContentSaveCog => ContentSaveCog,
            IconSymbol.ContentSaveCogOutline => ContentSaveCogOutline,
            IconSymbol.SetSquare => SetSquare,
            IconSymbol.CogRefresh => CogRefresh,
            IconSymbol.CogRefreshOutline => CogRefreshOutline,
            IconSymbol.CogSync => CogSync,
            IconSymbol.CogSyncOutline => CogSyncOutline,
            IconSymbol.DownloadBox => DownloadBox,
            IconSymbol.DownloadBoxOutline => DownloadBoxOutline,
            IconSymbol.DownloadCircle => DownloadCircle,
            IconSymbol.DownloadCircleOutline => DownloadCircleOutline,
            IconSymbol.AirHumidifierOff => AirHumidifierOff,
            IconSymbol.ChiliOff => ChiliOff,
            IconSymbol.FoodDrumstickOff => FoodDrumstickOff,
            IconSymbol.FoodDrumstickOffOutline => FoodDrumstickOffOutline,
            IconSymbol.FoodSteak => FoodSteak,
            IconSymbol.FoodSteakOff => FoodSteakOff,
            IconSymbol.FanAlert => FanAlert,
            IconSymbol.FanChevronDown => FanChevronDown,
            IconSymbol.FanChevronUp => FanChevronUp,
            IconSymbol.FanPlus => FanPlus,
            IconSymbol.FanMinus => FanMinus,
            IconSymbol.FanRemove => FanRemove,
            IconSymbol.FanSpeed1 => FanSpeed1,
            IconSymbol.FanSpeed2 => FanSpeed2,
            IconSymbol.FanSpeed3 => FanSpeed3,
            IconSymbol.Rug => Rug,
            IconSymbol.Lingerie => Lingerie,
            IconSymbol.WizardHat => WizardHat,
            IconSymbol.Hours24 => Hours24,
            IconSymbol.CosineWave => CosineWave,
            IconSymbol.SawtoothWave => SawtoothWave,
            IconSymbol.SquareWave => SquareWave,
            IconSymbol.TriangleWave => TriangleWave,
            IconSymbol.Waveform => Waveform,
            IconSymbol.FolderMultiplePlus => FolderMultiplePlus,
            IconSymbol.FolderMultiplePlusOutline => FolderMultiplePlusOutline,
            IconSymbol.CurrentAc => CurrentAc,
            IconSymbol.WateringCan => WateringCan,
            IconSymbol.WateringCanOutline => WateringCanOutline,
            IconSymbol.MonitorShare => MonitorShare,
            IconSymbol.LaserPointer => LaserPointer,
            IconSymbol.ViewArrayOutline => ViewArrayOutline,
            IconSymbol.ViewCarouselOutline => ViewCarouselOutline,
            IconSymbol.ViewColumnOutline => ViewColumnOutline,
            IconSymbol.ViewComfyOutline => ViewComfyOutline,
            IconSymbol.ViewDashboardVariantOutline => ViewDashboardVariantOutline,
            IconSymbol.ViewDayOutline => ViewDayOutline,
            IconSymbol.ViewListOutline => ViewListOutline,
            IconSymbol.ViewModuleOutline => ViewModuleOutline,
            IconSymbol.ViewParallelOutline => ViewParallelOutline,
            IconSymbol.ViewQuiltOutline => ViewQuiltOutline,
            IconSymbol.ViewSequentialOutline => ViewSequentialOutline,
            IconSymbol.ViewStreamOutline => ViewStreamOutline,
            IconSymbol.ViewWeekOutline => ViewWeekOutline,
            IconSymbol.CompareHorizontal => CompareHorizontal,
            IconSymbol.CompareVertical => CompareVertical,
            IconSymbol.BriefcaseVariant => BriefcaseVariant,
            IconSymbol.BriefcaseVariantOutline => BriefcaseVariantOutline,
            IconSymbol.RelationManyToMany => RelationManyToMany,
            IconSymbol.RelationManyToOne => RelationManyToOne,
            IconSymbol.RelationManyToOneOrMany => RelationManyToOneOrMany,
            IconSymbol.RelationManyToOnlyOne => RelationManyToOnlyOne,
            IconSymbol.RelationManyToZeroOrMany => RelationManyToZeroOrMany,
            IconSymbol.RelationManyToZeroOrOne => RelationManyToZeroOrOne,
            IconSymbol.RelationOneOrManyToMany => RelationOneOrManyToMany,
            IconSymbol.RelationOneOrManyToOne => RelationOneOrManyToOne,
            IconSymbol.RelationOneOrManyToOneOrMany => RelationOneOrManyToOneOrMany,
            IconSymbol.RelationOneOrManyToOnlyOne => RelationOneOrManyToOnlyOne,
            IconSymbol.RelationOneOrManyToZeroOrMany => RelationOneOrManyToZeroOrMany,
            IconSymbol.RelationOneOrManyToZeroOrOne => RelationOneOrManyToZeroOrOne,
            IconSymbol.RelationOneToMany => RelationOneToMany,
            IconSymbol.RelationOneToOne => RelationOneToOne,
            IconSymbol.RelationOneToOneOrMany => RelationOneToOneOrMany,
            IconSymbol.RelationOneToOnlyOne => RelationOneToOnlyOne,
            IconSymbol.RelationOneToZeroOrMany => RelationOneToZeroOrMany,
            IconSymbol.RelationOneToZeroOrOne => RelationOneToZeroOrOne,
            IconSymbol.RelationOnlyOneToMany => RelationOnlyOneToMany,
            IconSymbol.RelationOnlyOneToOne => RelationOnlyOneToOne,
            IconSymbol.RelationOnlyOneToOneOrMany => RelationOnlyOneToOneOrMany,
            IconSymbol.RelationOnlyOneToOnlyOne => RelationOnlyOneToOnlyOne,
            IconSymbol.RelationOnlyOneToZeroOrMany => RelationOnlyOneToZeroOrMany,
            IconSymbol.RelationOnlyOneToZeroOrOne => RelationOnlyOneToZeroOrOne,
            IconSymbol.RelationZeroOrManyToMany => RelationZeroOrManyToMany,
            IconSymbol.RelationZeroOrManyToOne => RelationZeroOrManyToOne,
            IconSymbol.RelationZeroOrManyToOneOrMany => RelationZeroOrManyToOneOrMany,
            IconSymbol.RelationZeroOrManyToOnlyOne => RelationZeroOrManyToOnlyOne,
            IconSymbol.RelationZeroOrManyToZeroOrMany => RelationZeroOrManyToZeroOrMany,
            IconSymbol.RelationZeroOrManyToZeroOrOne => RelationZeroOrManyToZeroOrOne,
            IconSymbol.RelationZeroOrOneToMany => RelationZeroOrOneToMany,
            IconSymbol.RelationZeroOrOneToOne => RelationZeroOrOneToOne,
            IconSymbol.RelationZeroOrOneToOneOrMany => RelationZeroOrOneToOneOrMany,
            IconSymbol.RelationZeroOrOneToOnlyOne => RelationZeroOrOneToOnlyOne,
            IconSymbol.RelationZeroOrOneToZeroOrMany => RelationZeroOrOneToZeroOrMany,
            IconSymbol.RelationZeroOrOneToZeroOrOne => RelationZeroOrOneToZeroOrOne,
            IconSymbol.AlertPlus => AlertPlus,
            IconSymbol.AlertMinus => AlertMinus,
            IconSymbol.AlertRemove => AlertRemove,
            IconSymbol.AlertPlusOutline => AlertPlusOutline,
            IconSymbol.AlertMinusOutline => AlertMinusOutline,
            IconSymbol.AlertRemoveOutline => AlertRemoveOutline,
            IconSymbol.Carabiner => Carabiner,
            IconSymbol.Fencing => Fencing,
            IconSymbol.Skateboard => Skateboard,
            IconSymbol.Polo => Polo,
            IconSymbol.TractorVariant => TractorVariant,
            IconSymbol.RadiologyBox => RadiologyBox,
            IconSymbol.RadiologyBoxOutline => RadiologyBoxOutline,
            IconSymbol.SkullScan => SkullScan,
            IconSymbol.SkullScanOutline => SkullScanOutline,
            IconSymbol.PlusMinusVariant => PlusMinusVariant,
            IconSymbol.SourceBranchPlus => SourceBranchPlus,
            IconSymbol.SourceBranchMinus => SourceBranchMinus,
            IconSymbol.SourceBranchRemove => SourceBranchRemove,
            IconSymbol.SourceBranchRefresh => SourceBranchRefresh,
            IconSymbol.SourceBranchSync => SourceBranchSync,
            IconSymbol.SourceBranchCheck => SourceBranchCheck,
            IconSymbol.PuzzlePlus => PuzzlePlus,
            IconSymbol.PuzzleMinus => PuzzleMinus,
            IconSymbol.PuzzleRemove => PuzzleRemove,
            IconSymbol.PuzzleEdit => PuzzleEdit,
            IconSymbol.PuzzleHeart => PuzzleHeart,
            IconSymbol.PuzzleStar => PuzzleStar,
            IconSymbol.PuzzlePlusOutline => PuzzlePlusOutline,
            IconSymbol.PuzzleMinusOutline => PuzzleMinusOutline,
            IconSymbol.PuzzleRemoveOutline => PuzzleRemoveOutline,
            IconSymbol.PuzzleEditOutline => PuzzleEditOutline,
            IconSymbol.PuzzleHeartOutline => PuzzleHeartOutline,
            IconSymbol.PuzzleStarOutline => PuzzleStarOutline,
            IconSymbol.RhombusMediumOutline => RhombusMediumOutline,
            IconSymbol.RhombusSplitOutline => RhombusSplitOutline,
            IconSymbol.RocketLaunch => RocketLaunch,
            IconSymbol.RocketLaunchOutline => RocketLaunchOutline,
            IconSymbol.SetMerge => SetMerge,
            IconSymbol.SetSplit => SetSplit,
            IconSymbol.Beekeeper => Beekeeper,
            IconSymbol.SnowflakeOff => SnowflakeOff,
            IconSymbol.WeatherSunnyOff => WeatherSunnyOff,
            IconSymbol.ClipboardEdit => ClipboardEdit,
            IconSymbol.ClipboardEditOutline => ClipboardEditOutline,
            IconSymbol.NotebookEdit => NotebookEdit,
            IconSymbol.HumanEdit => HumanEdit,
            IconSymbol.NotebookEditOutline => NotebookEditOutline,
            IconSymbol.CashLock => CashLock,
            IconSymbol.CashLockOpen => CashLockOpen,
            IconSymbol.AccountSupervisorCircleOutline => AccountSupervisorCircleOutline,
            IconSymbol.CarOutline => CarOutline,
            IconSymbol.CashCheck => CashCheck,
            IconSymbol.FilterOff => FilterOff,
            IconSymbol.FilterOffOutline => FilterOffOutline,
            IconSymbol.SpiritLevel => SpiritLevel,
            IconSymbol.WheelBarrow => WheelBarrow,
            IconSymbol.BookCheck => BookCheck,
            IconSymbol.BookCheckOutline => BookCheckOutline,
            IconSymbol.NotebookCheck => NotebookCheck,
            IconSymbol.NotebookCheckOutline => NotebookCheckOutline,
            IconSymbol.BookOpenVariant => BookOpenVariant,
            IconSymbol.SignPole => SignPole,
            IconSymbol.Shore => Shore,
            IconSymbol.ShapeSquareRoundedPlus => ShapeSquareRoundedPlus,
            IconSymbol.SquareRounded => SquareRounded,
            IconSymbol.SquareRoundedOutline => SquareRoundedOutline,
            IconSymbol.ArchiveAlert => ArchiveAlert,
            IconSymbol.ArchiveAlertOutline => ArchiveAlertOutline,
            IconSymbol.PowerSocketIt => PowerSocketIt,
            IconSymbol.SquareCircle => SquareCircle,
            IconSymbol.Symbol => Symbol,
            IconSymbol.WaterAlert => WaterAlert,
            IconSymbol.WaterAlertOutline => WaterAlertOutline,
            IconSymbol.WaterCheck => WaterCheck,
            IconSymbol.WaterCheckOutline => WaterCheckOutline,
            IconSymbol.WaterMinus => WaterMinus,
            IconSymbol.WaterMinusOutline => WaterMinusOutline,
            IconSymbol.WaterOffOutline => WaterOffOutline,
            IconSymbol.WaterPercentAlert => WaterPercentAlert,
            IconSymbol.WaterPlus => WaterPlus,
            IconSymbol.WaterPlusOutline => WaterPlusOutline,
            IconSymbol.WaterRemove => WaterRemove,
            IconSymbol.WaterRemoveOutline => WaterRemoveOutline,
            IconSymbol.Snake => Snake,
            IconSymbol.FormatTextVariantOutline => FormatTextVariantOutline,
            IconSymbol.Grass => Grass,
            IconSymbol.AccessPointOff => AccessPointOff,
            IconSymbol.CurrencyMnt => CurrencyMnt,
            IconSymbol.DockTop => DockTop,
            IconSymbol.ShareVariantOutline => ShareVariantOutline,
            IconSymbol.TransitSkip => TransitSkip,
            IconSymbol.Yurt => Yurt,
            IconSymbol.FileDocumentMultiple => FileDocumentMultiple,
            IconSymbol.FileDocumentMultipleOutline => FileDocumentMultipleOutline,
            IconSymbol.EvPlugCcs1 => EvPlugCcs1,
            IconSymbol.EvPlugCcs2 => EvPlugCcs2,
            IconSymbol.EvPlugChademo => EvPlugChademo,
            IconSymbol.EvPlugTesla => EvPlugTesla,
            IconSymbol.EvPlugType1 => EvPlugType1,
            IconSymbol.EvPlugType2 => EvPlugType2,
            IconSymbol.OfficeBuildingOutline => OfficeBuildingOutline,
            IconSymbol.OfficeBuildingMarker => OfficeBuildingMarker,
            IconSymbol.OfficeBuildingMarkerOutline => OfficeBuildingMarkerOutline,
            IconSymbol.ProgressQuestion => ProgressQuestion,
            IconSymbol.BasketMinus => BasketMinus,
            IconSymbol.BasketMinusOutline => BasketMinusOutline,
            IconSymbol.BasketOff => BasketOff,
            IconSymbol.BasketOffOutline => BasketOffOutline,
            IconSymbol.BasketPlus => BasketPlus,
            IconSymbol.BasketPlusOutline => BasketPlusOutline,
            IconSymbol.BasketRemove => BasketRemove,
            IconSymbol.BasketRemoveOutline => BasketRemoveOutline,
            IconSymbol.AccountReactivate => AccountReactivate,
            IconSymbol.AccountReactivateOutline => AccountReactivateOutline,
            IconSymbol.CarLiftedPickup => CarLiftedPickup,
            IconSymbol.VideoHighDefinition => VideoHighDefinition,
            IconSymbol.PhoneRemove => PhoneRemove,
            IconSymbol.PhoneRemoveOutline => PhoneRemoveOutline,
            IconSymbol.ThermometerOff => ThermometerOff,
            IconSymbol.TimelineCheck => TimelineCheck,
            IconSymbol.TimelineCheckOutline => TimelineCheckOutline,
            IconSymbol.TimelineMinus => TimelineMinus,
            IconSymbol.TimelineMinusOutline => TimelineMinusOutline,
            IconSymbol.TimelineRemove => TimelineRemove,
            IconSymbol.TimelineRemoveOutline => TimelineRemoveOutline,
            IconSymbol.AccessPointCheck => AccessPointCheck,
            IconSymbol.AccessPointMinus => AccessPointMinus,
            IconSymbol.AccessPointPlus => AccessPointPlus,
            IconSymbol.AccessPointRemove => AccessPointRemove,
            IconSymbol.DataMatrix => DataMatrix,
            IconSymbol.DataMatrixEdit => DataMatrixEdit,
            IconSymbol.DataMatrixMinus => DataMatrixMinus,
            IconSymbol.DataMatrixPlus => DataMatrixPlus,
            IconSymbol.DataMatrixRemove => DataMatrixRemove,
            IconSymbol.DataMatrixScan => DataMatrixScan,
            IconSymbol.TuneVariant => TuneVariant,
            IconSymbol.TuneVerticalVariant => TuneVerticalVariant,
            IconSymbol.Rake => Rake,
            IconSymbol.Shimmer => Shimmer,
            IconSymbol.TransitConnectionHorizontal => TransitConnectionHorizontal,
            IconSymbol.SortCalendarAscending => SortCalendarAscending,
            IconSymbol.SortCalendarDescending => SortCalendarDescending,
            IconSymbol.SortClockAscending => SortClockAscending,
            IconSymbol.SortClockAscendingOutline => SortClockAscendingOutline,
            IconSymbol.SortClockDescending => SortClockDescending,
            IconSymbol.SortClockDescendingOutline => SortClockDescendingOutline,
            IconSymbol.ChartBox => ChartBox,
            IconSymbol.ChartBoxOutline => ChartBoxOutline,
            IconSymbol.ChartBoxPlusOutline => ChartBoxPlusOutline,
            IconSymbol.MouseMoveDown => MouseMoveDown,
            IconSymbol.MouseMoveUp => MouseMoveUp,
            IconSymbol.MouseMoveVertical => MouseMoveVertical,
            IconSymbol.Pitchfork => Pitchfork,
            IconSymbol.VanishQuarter => VanishQuarter,
            IconSymbol.ApplicationSettingsOutline => ApplicationSettingsOutline,
            IconSymbol.DeleteClock => DeleteClock,
            IconSymbol.DeleteClockOutline => DeleteClockOutline,
            IconSymbol.Kangaroo => Kangaroo,
            IconSymbol.PhoneDial => PhoneDial,
            IconSymbol.PhoneDialOutline => PhoneDialOutline,
            IconSymbol.StarOffOutline => StarOffOutline,
            IconSymbol.TooltipCheck => TooltipCheck,
            IconSymbol.TooltipCheckOutline => TooltipCheckOutline,
            IconSymbol.TooltipMinus => TooltipMinus,
            IconSymbol.TooltipMinusOutline => TooltipMinusOutline,
            IconSymbol.TooltipRemove => TooltipRemove,
            IconSymbol.TooltipRemoveOutline => TooltipRemoveOutline,
            IconSymbol.Pretzel => Pretzel,
            IconSymbol.StarPlus => StarPlus,
            IconSymbol.StarMinus => StarMinus,
            IconSymbol.StarRemove => StarRemove,
            IconSymbol.StarCheck => StarCheck,
            IconSymbol.StarPlusOutline => StarPlusOutline,
            IconSymbol.StarMinusOutline => StarMinusOutline,
            IconSymbol.StarRemoveOutline => StarRemoveOutline,
            IconSymbol.StarCheckOutline => StarCheckOutline,
            IconSymbol.EiffelTower => EiffelTower,
            IconSymbol.Submarine => Submarine,
            IconSymbol.SofaOutline => SofaOutline,
            IconSymbol.SofaSingle => SofaSingle,
            IconSymbol.SofaSingleOutline => SofaSingleOutline,
            IconSymbol.TextAccount => TextAccount,
            IconSymbol.HumanQueue => HumanQueue,
            IconSymbol.FoodHalal => FoodHalal,
            IconSymbol.FoodKosher => FoodKosher,
            IconSymbol.KeyChain => KeyChain,
            IconSymbol.KeyChainVariant => KeyChainVariant,
            IconSymbol.Lamps => Lamps,
            IconSymbol.ApplicationCogOutline => ApplicationCogOutline,
            IconSymbol.DancePole => DancePole,
            IconSymbol.SocialDistance2Meters => SocialDistance2Meters,
            IconSymbol.SocialDistance6Feet => SocialDistance6Feet,
            IconSymbol.CalendarCursor => CalendarCursor,
            IconSymbol.EmoticonSick => EmoticonSick,
            IconSymbol.EmoticonSickOutline => EmoticonSickOutline,
            IconSymbol.HandHeartOutline => HandHeartOutline,
            IconSymbol.HandWash => HandWash,
            IconSymbol.HandWashOutline => HandWashOutline,
            IconSymbol.HumanCane => HumanCane,
            IconSymbol.Lotion => Lotion,
            IconSymbol.LotionOutline => LotionOutline,
            IconSymbol.LotionPlus => LotionPlus,
            IconSymbol.LotionPlusOutline => LotionPlusOutline,
            IconSymbol.FaceMask => FaceMask,
            IconSymbol.FaceMaskOutline => FaceMaskOutline,
            IconSymbol.Reiterate => Reiterate,
            IconSymbol.Butterfly => Butterfly,
            IconSymbol.ButterflyOutline => ButterflyOutline,
            IconSymbol.BagSuitcase => BagSuitcase,
            IconSymbol.BagSuitcaseOutline => BagSuitcaseOutline,
            IconSymbol.BagSuitcaseOff => BagSuitcaseOff,
            IconSymbol.BagSuitcaseOffOutline => BagSuitcaseOffOutline,
            IconSymbol.MotionPlay => MotionPlay,
            IconSymbol.MotionPause => MotionPause,
            IconSymbol.MotionPlayOutline => MotionPlayOutline,
            IconSymbol.MotionPauseOutline => MotionPauseOutline,
            IconSymbol.ArrowTopLeftThinCircleOutline => ArrowTopLeftThinCircleOutline,
            IconSymbol.ArrowTopRightThinCircleOutline => ArrowTopRightThinCircleOutline,
            IconSymbol.ArrowBottomRightThinCircleOutline => ArrowBottomRightThinCircleOutline,
            IconSymbol.ArrowBottomLeftThinCircleOutline => ArrowBottomLeftThinCircleOutline,
            IconSymbol.ArrowUpThinCircleOutline => ArrowUpThinCircleOutline,
            IconSymbol.ArrowRightThinCircleOutline => ArrowRightThinCircleOutline,
            IconSymbol.ArrowDownThinCircleOutline => ArrowDownThinCircleOutline,
            IconSymbol.ArrowLeftThinCircleOutline => ArrowLeftThinCircleOutline,
            IconSymbol.HumanCapacityDecrease => HumanCapacityDecrease,
            IconSymbol.HumanCapacityIncrease => HumanCapacityIncrease,
            IconSymbol.HumanGreetingProximity => HumanGreetingProximity,
            IconSymbol.HvacOff => HvacOff,
            IconSymbol.InboxRemove => InboxRemove,
            IconSymbol.InboxRemoveOutline => InboxRemoveOutline,
            IconSymbol.HandshakeOutline => HandshakeOutline,
            IconSymbol.Ladder => Ladder,
            IconSymbol.RouterWirelessOff => RouterWirelessOff,
            IconSymbol.Seesaw => Seesaw,
            IconSymbol.Slide => Slide,
            IconSymbol.CalculatorVariantOutline => CalculatorVariantOutline,
            IconSymbol.ShieldAccountVariant => ShieldAccountVariant,
            IconSymbol.ShieldAccountVariantOutline => ShieldAccountVariantOutline,
            IconSymbol.MessageFlash => MessageFlash,
            IconSymbol.MessageFlashOutline => MessageFlashOutline,
            IconSymbol.ListStatus => ListStatus,
            IconSymbol.MessageBookmark => MessageBookmark,
            IconSymbol.MessageBookmarkOutline => MessageBookmarkOutline,
            IconSymbol.CommentBookmark => CommentBookmark,
            IconSymbol.CommentBookmarkOutline => CommentBookmarkOutline,
            IconSymbol.CommentFlash => CommentFlash,
            IconSymbol.CommentFlashOutline => CommentFlashOutline,
            IconSymbol.Motion => Motion,
            IconSymbol.MotionOutline => MotionOutline,
            IconSymbol.BicycleElectric => BicycleElectric,
            IconSymbol.CarElectricOutline => CarElectricOutline,
            IconSymbol.ChartTimelineVariantShimmer => ChartTimelineVariantShimmer,
            IconSymbol.MopedElectric => MopedElectric,
            IconSymbol.MopedElectricOutline => MopedElectricOutline,
            IconSymbol.MopedOutline => MopedOutline,
            IconSymbol.MotorbikeElectric => MotorbikeElectric,
            IconSymbol.Rickshaw => Rickshaw,
            IconSymbol.RickshawElectric => RickshawElectric,
            IconSymbol.Scooter => Scooter,
            IconSymbol.ScooterElectric => ScooterElectric,
            IconSymbol.Horse => Horse,
            IconSymbol.HorseHuman => HorseHuman,
            IconSymbol.HorseVariant => HorseVariant,
            IconSymbol.Unicorn => Unicorn,
            IconSymbol.UnicornVariant => UnicornVariant,
            IconSymbol.AlarmPanel => AlarmPanel,
            IconSymbol.AlarmPanelOutline => AlarmPanelOutline,
            IconSymbol.Bird => Bird,
            IconSymbol.ShoeCleat => ShoeCleat,
            IconSymbol.ShoeSneaker => ShoeSneaker,
            IconSymbol.HumanFemaleDance => HumanFemaleDance,
            IconSymbol.ShoeBallet => ShoeBallet,
            IconSymbol.NumericPositive1 => NumericPositive1,
            IconSymbol.FaceManShimmer => FaceManShimmer,
            IconSymbol.FaceManShimmerOutline => FaceManShimmerOutline,
            IconSymbol.FaceWomanShimmer => FaceWomanShimmer,
            IconSymbol.FaceWomanShimmerOutline => FaceWomanShimmerOutline,
            IconSymbol.HomeAlertOutline => HomeAlertOutline,
            IconSymbol.LockAlertOutline => LockAlertOutline,
            IconSymbol.LockOpenAlertOutline => LockOpenAlertOutline,
            IconSymbol.SimAlertOutline => SimAlertOutline,
            IconSymbol.SimOffOutline => SimOffOutline,
            IconSymbol.SimOutline => SimOutline,
            IconSymbol.BookOpenPageVariantOutline => BookOpenPageVariantOutline,
            IconSymbol.FireAlert => FireAlert,
            IconSymbol.RayStartVertexEnd => RayStartVertexEnd,
            IconSymbol.CameraFlip => CameraFlip,
            IconSymbol.CameraFlipOutline => CameraFlipOutline,
            IconSymbol.OrbitVariant => OrbitVariant,
            IconSymbol.CircleBox => CircleBox,
            IconSymbol.CircleBoxOutline => CircleBoxOutline,
            IconSymbol.Mustache => Mustache,
            IconSymbol.CommentMinus => CommentMinus,
            IconSymbol.CommentMinusOutline => CommentMinusOutline,
            IconSymbol.CommentOff => CommentOff,
            IconSymbol.CommentOffOutline => CommentOffOutline,
            IconSymbol.EyeRemove => EyeRemove,
            IconSymbol.EyeRemoveOutline => EyeRemoveOutline,
            IconSymbol.Unicycle => Unicycle,
            IconSymbol.GlassCocktailOff => GlassCocktailOff,
            IconSymbol.GlassMugOff => GlassMugOff,
            IconSymbol.GlassMugVariantOff => GlassMugVariantOff,
            IconSymbol.BicyclePennyFarthing => BicyclePennyFarthing,
            IconSymbol.CartCheck => CartCheck,
            IconSymbol.CartVariant => CartVariant,
            IconSymbol.BaseballDiamond => BaseballDiamond,
            IconSymbol.BaseballDiamondOutline => BaseballDiamondOutline,
            IconSymbol.FridgeIndustrial => FridgeIndustrial,
            IconSymbol.FridgeIndustrialAlert => FridgeIndustrialAlert,
            IconSymbol.FridgeIndustrialAlertOutline => FridgeIndustrialAlertOutline,
            IconSymbol.FridgeIndustrialOff => FridgeIndustrialOff,
            IconSymbol.FridgeIndustrialOffOutline => FridgeIndustrialOffOutline,
            IconSymbol.FridgeIndustrialOutline => FridgeIndustrialOutline,
            IconSymbol.FridgeVariant => FridgeVariant,
            IconSymbol.FridgeVariantAlert => FridgeVariantAlert,
            IconSymbol.FridgeVariantAlertOutline => FridgeVariantAlertOutline,
            IconSymbol.FridgeVariantOff => FridgeVariantOff,
            IconSymbol.FridgeVariantOffOutline => FridgeVariantOffOutline,
            IconSymbol.FridgeVariantOutline => FridgeVariantOutline,
            IconSymbol.Windsock => Windsock,
            IconSymbol.DanceBallroom => DanceBallroom,
            IconSymbol.DotsGrid => DotsGrid,
            IconSymbol.DotsSquare => DotsSquare,
            IconSymbol.DotsTriangle => DotsTriangle,
            IconSymbol.DotsHexagon => DotsHexagon,
            IconSymbol.CardMinus => CardMinus,
            IconSymbol.CardMinusOutline => CardMinusOutline,
            IconSymbol.CardOff => CardOff,
            IconSymbol.CardOffOutline => CardOffOutline,
            IconSymbol.CardRemove => CardRemove,
            IconSymbol.CardRemoveOutline => CardRemoveOutline,
            IconSymbol.Torch => Torch,
            IconSymbol.NavigationOutline => NavigationOutline,
            IconSymbol.MapMarkerStar => MapMarkerStar,
            IconSymbol.MapMarkerStarOutline => MapMarkerStarOutline,
            IconSymbol.Manjaro => Manjaro,
            IconSymbol.FastForward60 => FastForward60,
            IconSymbol.Rewind60 => Rewind60,
            IconSymbol.ImageText => ImageText,
            IconSymbol.FamilyTree => FamilyTree,
            IconSymbol.CarEmergency => CarEmergency,
            IconSymbol.NotebookMinus => NotebookMinus,
            IconSymbol.NotebookMinusOutline => NotebookMinusOutline,
            IconSymbol.NotebookPlus => NotebookPlus,
            IconSymbol.NotebookPlusOutline => NotebookPlusOutline,
            IconSymbol.NotebookRemove => NotebookRemove,
            IconSymbol.NotebookRemoveOutline => NotebookRemoveOutline,
            IconSymbol.Connection => Connection,
            IconSymbol.LanguageRust => LanguageRust,
            IconSymbol.ClipboardMinus => ClipboardMinus,
            IconSymbol.ClipboardMinusOutline => ClipboardMinusOutline,
            IconSymbol.ClipboardOff => ClipboardOff,
            IconSymbol.ClipboardOffOutline => ClipboardOffOutline,
            IconSymbol.ClipboardRemove => ClipboardRemove,
            IconSymbol.ClipboardRemoveOutline => ClipboardRemoveOutline,
            IconSymbol.ClipboardSearch => ClipboardSearch,
            IconSymbol.ClipboardSearchOutline => ClipboardSearchOutline,
            IconSymbol.ClipboardTextOff => ClipboardTextOff,
            IconSymbol.ClipboardTextOffOutline => ClipboardTextOffOutline,
            IconSymbol.ClipboardTextSearch => ClipboardTextSearch,
            IconSymbol.ClipboardTextSearchOutline => ClipboardTextSearchOutline,
            IconSymbol.DatabaseAlertOutline => DatabaseAlertOutline,
            IconSymbol.DatabaseArrowDownOutline => DatabaseArrowDownOutline,
            IconSymbol.DatabaseArrowLeftOutline => DatabaseArrowLeftOutline,
            IconSymbol.DatabaseArrowRightOutline => DatabaseArrowRightOutline,
            IconSymbol.DatabaseArrowUpOutline => DatabaseArrowUpOutline,
            IconSymbol.DatabaseCheckOutline => DatabaseCheckOutline,
            IconSymbol.DatabaseClockOutline => DatabaseClockOutline,
            IconSymbol.DatabaseEditOutline => DatabaseEditOutline,
            IconSymbol.DatabaseExportOutline => DatabaseExportOutline,
            IconSymbol.DatabaseImportOutline => DatabaseImportOutline,
            IconSymbol.DatabaseLockOutline => DatabaseLockOutline,
            IconSymbol.DatabaseMarkerOutline => DatabaseMarkerOutline,
            IconSymbol.DatabaseMinusOutline => DatabaseMinusOutline,
            IconSymbol.DatabaseOffOutline => DatabaseOffOutline,
            IconSymbol.DatabaseOutline => DatabaseOutline,
            IconSymbol.DatabasePlusOutline => DatabasePlusOutline,
            IconSymbol.DatabaseRefreshOutline => DatabaseRefreshOutline,
            IconSymbol.DatabaseRemoveOutline => DatabaseRemoveOutline,
            IconSymbol.DatabaseSearchOutline => DatabaseSearchOutline,
            IconSymbol.DatabaseSettingsOutline => DatabaseSettingsOutline,
            IconSymbol.DatabaseSyncOutline => DatabaseSyncOutline,
            IconSymbol.DatabaseAlert => DatabaseAlert,
            IconSymbol.DatabaseArrowDown => DatabaseArrowDown,
            IconSymbol.DatabaseArrowLeft => DatabaseArrowLeft,
            IconSymbol.DatabaseArrowRight => DatabaseArrowRight,
            IconSymbol.DatabaseArrowUp => DatabaseArrowUp,
            IconSymbol.DatabaseClock => DatabaseClock,
            IconSymbol.DatabaseOff => DatabaseOff,
            IconSymbol.CalendarLock => CalendarLock,
            IconSymbol.CalendarLockOutline => CalendarLockOutline,
            IconSymbol.ContentSaveOff => ContentSaveOff,
            IconSymbol.ContentSaveOffOutline => ContentSaveOffOutline,
            IconSymbol.CreditCardRefresh => CreditCardRefresh,
            IconSymbol.CreditCardRefreshOutline => CreditCardRefreshOutline,
            IconSymbol.CreditCardSearch => CreditCardSearch,
            IconSymbol.CreditCardSearchOutline => CreditCardSearchOutline,
            IconSymbol.CreditCardSync => CreditCardSync,
            IconSymbol.CreditCardSyncOutline => CreditCardSyncOutline,
            IconSymbol.DatabaseCog => DatabaseCog,
            IconSymbol.DatabaseCogOutline => DatabaseCogOutline,
            IconSymbol.MessageOff => MessageOff,
            IconSymbol.MessageOffOutline => MessageOffOutline,
            IconSymbol.NoteMinus => NoteMinus,
            IconSymbol.NoteMinusOutline => NoteMinusOutline,
            IconSymbol.NoteRemove => NoteRemove,
            IconSymbol.NoteRemoveOutline => NoteRemoveOutline,
            IconSymbol.NoteSearch => NoteSearch,
            IconSymbol.NoteSearchOutline => NoteSearchOutline,
            IconSymbol.BankCheck => BankCheck,
            IconSymbol.BankOff => BankOff,
            IconSymbol.BankOffOutline => BankOffOutline,
            IconSymbol.BriefcaseOff => BriefcaseOff,
            IconSymbol.BriefcaseOffOutline => BriefcaseOffOutline,
            IconSymbol.BriefcaseVariantOff => BriefcaseVariantOff,
            IconSymbol.BriefcaseVariantOffOutline => BriefcaseVariantOffOutline,
            IconSymbol.GhostOffOutline => GhostOffOutline,
            IconSymbol.GhostOutline => GhostOutline,
            IconSymbol.StoreMinus => StoreMinus,
            IconSymbol.StorePlus => StorePlus,
            IconSymbol.StoreRemove => StoreRemove,
            IconSymbol.EmailRemove => EmailRemove,
            IconSymbol.EmailRemoveOutline => EmailRemoveOutline,
            IconSymbol.HeartCog => HeartCog,
            IconSymbol.HeartCogOutline => HeartCogOutline,
            IconSymbol.HeartSettings => HeartSettings,
            IconSymbol.HeartSettingsOutline => HeartSettingsOutline,
            IconSymbol.Pentagram => Pentagram,
            IconSymbol.StarCog => StarCog,
            IconSymbol.StarCogOutline => StarCogOutline,
            IconSymbol.StarSettings => StarSettings,
            IconSymbol.StarSettingsOutline => StarSettingsOutline,
            IconSymbol.CalendarEnd => CalendarEnd,
            IconSymbol.CalendarStart => CalendarStart,
            IconSymbol.CannabisOff => CannabisOff,
            IconSymbol.Mower => Mower,
            IconSymbol.MowerBag => MowerBag,
            IconSymbol.LockOff => LockOff,
            IconSymbol.LockOffOutline => LockOffOutline,
            IconSymbol.SharkFin => SharkFin,
            IconSymbol.SharkFinOutline => SharkFinOutline,
            IconSymbol.PawOutline => PawOutline,
            IconSymbol.PawOffOutline => PawOffOutline,
            IconSymbol.Snail => Snail,
            IconSymbol.PigVariantOutline => PigVariantOutline,
            IconSymbol.PiggyBankOutline => PiggyBankOutline,
            IconSymbol.RobotOutline => RobotOutline,
            IconSymbol.RobotOffOutline => RobotOffOutline,
            IconSymbol.BookAlert => BookAlert,
            IconSymbol.BookAlertOutline => BookAlertOutline,
            IconSymbol.BookArrowDown => BookArrowDown,
            IconSymbol.BookArrowDownOutline => BookArrowDownOutline,
            IconSymbol.BookArrowLeft => BookArrowLeft,
            IconSymbol.BookArrowLeftOutline => BookArrowLeftOutline,
            IconSymbol.BookArrowRight => BookArrowRight,
            IconSymbol.BookArrowRightOutline => BookArrowRightOutline,
            IconSymbol.BookArrowUp => BookArrowUp,
            IconSymbol.BookArrowUpOutline => BookArrowUpOutline,
            IconSymbol.BookCancel => BookCancel,
            IconSymbol.BookCancelOutline => BookCancelOutline,
            IconSymbol.BookClock => BookClock,
            IconSymbol.BookClockOutline => BookClockOutline,
            IconSymbol.BookCog => BookCog,
            IconSymbol.BookCogOutline => BookCogOutline,
            IconSymbol.BookEdit => BookEdit,
            IconSymbol.BookEditOutline => BookEditOutline,
            IconSymbol.BookLockOpenOutline => BookLockOpenOutline,
            IconSymbol.BookLockOutline => BookLockOutline,
            IconSymbol.BookMarker => BookMarker,
            IconSymbol.BookMarkerOutline => BookMarkerOutline,
            IconSymbol.BookMinusOutline => BookMinusOutline,
            IconSymbol.BookMusicOutline => BookMusicOutline,
            IconSymbol.BookOff => BookOff,
            IconSymbol.BookOffOutline => BookOffOutline,
            IconSymbol.BookPlusOutline => BookPlusOutline,
            IconSymbol.BookRefresh => BookRefresh,
            IconSymbol.BookRefreshOutline => BookRefreshOutline,
            IconSymbol.BookRemoveOutline => BookRemoveOutline,
            IconSymbol.BookSettings => BookSettings,
            IconSymbol.BookSettingsOutline => BookSettingsOutline,
            IconSymbol.BookSync => BookSync,
            IconSymbol.RobotAngry => RobotAngry,
            IconSymbol.RobotAngryOutline => RobotAngryOutline,
            IconSymbol.RobotConfused => RobotConfused,
            IconSymbol.RobotConfusedOutline => RobotConfusedOutline,
            IconSymbol.RobotDead => RobotDead,
            IconSymbol.RobotDeadOutline => RobotDeadOutline,
            IconSymbol.RobotExcited => RobotExcited,
            IconSymbol.RobotExcitedOutline => RobotExcitedOutline,
            IconSymbol.RobotLove => RobotLove,
            IconSymbol.RobotLoveOutline => RobotLoveOutline,
            IconSymbol.RobotOff => RobotOff,
            IconSymbol.LockCheckOutline => LockCheckOutline,
            IconSymbol.LockMinus => LockMinus,
            IconSymbol.LockMinusOutline => LockMinusOutline,
            IconSymbol.LockOpenCheckOutline => LockOpenCheckOutline,
            IconSymbol.LockOpenMinus => LockOpenMinus,
            IconSymbol.LockOpenMinusOutline => LockOpenMinusOutline,
            IconSymbol.LockOpenPlus => LockOpenPlus,
            IconSymbol.LockOpenPlusOutline => LockOpenPlusOutline,
            IconSymbol.LockOpenRemove => LockOpenRemove,
            IconSymbol.LockOpenRemoveOutline => LockOpenRemoveOutline,
            IconSymbol.LockPlusOutline => LockPlusOutline,
            IconSymbol.LockRemove => LockRemove,
            IconSymbol.LockRemoveOutline => LockRemoveOutline,
            IconSymbol.WifiAlert => WifiAlert,
            IconSymbol.WifiArrowDown => WifiArrowDown,
            IconSymbol.WifiArrowLeft => WifiArrowLeft,
            IconSymbol.WifiArrowLeftRight => WifiArrowLeftRight,
            IconSymbol.WifiArrowRight => WifiArrowRight,
            IconSymbol.WifiArrowUp => WifiArrowUp,
            IconSymbol.WifiArrowUpDown => WifiArrowUpDown,
            IconSymbol.WifiCancel => WifiCancel,
            IconSymbol.WifiCheck => WifiCheck,
            IconSymbol.WifiCog => WifiCog,
            IconSymbol.WifiLock => WifiLock,
            IconSymbol.WifiLockOpen => WifiLockOpen,
            IconSymbol.WifiMarker => WifiMarker,
            IconSymbol.WifiMinus => WifiMinus,
            IconSymbol.WifiPlus => WifiPlus,
            IconSymbol.WifiRefresh => WifiRefresh,
            IconSymbol.WifiRemove => WifiRemove,
            IconSymbol.WifiSettings => WifiSettings,
            IconSymbol.WifiSync => WifiSync,
            IconSymbol.BookSyncOutline => BookSyncOutline,
            IconSymbol.BookEducation => BookEducation,
            IconSymbol.BookEducationOutline => BookEducationOutline,
            IconSymbol.WifiStrength1LockOpen => WifiStrength1LockOpen,
            IconSymbol.WifiStrength2LockOpen => WifiStrength2LockOpen,
            IconSymbol.WifiStrength3LockOpen => WifiStrength3LockOpen,
            IconSymbol.WifiStrength4LockOpen => WifiStrength4LockOpen,
            IconSymbol.WifiStrengthLockOpenOutline => WifiStrengthLockOpenOutline,
            IconSymbol.CookieAlert => CookieAlert,
            IconSymbol.CookieAlertOutline => CookieAlertOutline,
            IconSymbol.CookieCheck => CookieCheck,
            IconSymbol.CookieCheckOutline => CookieCheckOutline,
            IconSymbol.CookieCog => CookieCog,
            IconSymbol.CookieCogOutline => CookieCogOutline,
            IconSymbol.CookiePlus => CookiePlus,
            IconSymbol.CookiePlusOutline => CookiePlusOutline,
            IconSymbol.CookieRemove => CookieRemove,
            IconSymbol.CookieRemoveOutline => CookieRemoveOutline,
            IconSymbol.CookieMinus => CookieMinus,
            IconSymbol.CookieMinusOutline => CookieMinusOutline,
            IconSymbol.CookieSettings => CookieSettings,
            IconSymbol.CookieSettingsOutline => CookieSettingsOutline,
            IconSymbol.CookieOutline => CookieOutline,
            IconSymbol.TapeDrive => TapeDrive,
            IconSymbol.Abacus => Abacus,
            IconSymbol.CalendarClockOutline => CalendarClockOutline,
            IconSymbol.ClipboardClock => ClipboardClock,
            IconSymbol.ClipboardClockOutline => ClipboardClockOutline,
            IconSymbol.CookieClock => CookieClock,
            IconSymbol.CookieClockOutline => CookieClockOutline,
            IconSymbol.CookieEdit => CookieEdit,
            IconSymbol.CookieEditOutline => CookieEditOutline,
            IconSymbol.CookieLock => CookieLock,
            IconSymbol.CookieLockOutline => CookieLockOutline,
            IconSymbol.CookieOff => CookieOff,
            IconSymbol.CookieOffOutline => CookieOffOutline,
            IconSymbol.CookieRefresh => CookieRefresh,
            IconSymbol.CookieRefreshOutline => CookieRefreshOutline,
            IconSymbol.DogSideOff => DogSideOff,
            IconSymbol.GiftOff => GiftOff,
            IconSymbol.GiftOffOutline => GiftOffOutline,
            IconSymbol.GiftOpen => GiftOpen,
            IconSymbol.GiftOpenOutline => GiftOpenOutline,
            IconSymbol.MovieCheck => MovieCheck,
            IconSymbol.MovieCheckOutline => MovieCheckOutline,
            IconSymbol.MovieCog => MovieCog,
            IconSymbol.MovieCogOutline => MovieCogOutline,
            IconSymbol.MovieMinus => MovieMinus,
            IconSymbol.MovieMinusOutline => MovieMinusOutline,
            IconSymbol.MovieOff => MovieOff,
            IconSymbol.MovieOffOutline => MovieOffOutline,
            IconSymbol.MovieOpenCheck => MovieOpenCheck,
            IconSymbol.MovieOpenCheckOutline => MovieOpenCheckOutline,
            IconSymbol.MovieOpenCog => MovieOpenCog,
            IconSymbol.MovieOpenCogOutline => MovieOpenCogOutline,
            IconSymbol.MovieOpenEdit => MovieOpenEdit,
            IconSymbol.MovieOpenEditOutline => MovieOpenEditOutline,
            IconSymbol.MovieOpenMinus => MovieOpenMinus,
            IconSymbol.MovieOpenMinusOutline => MovieOpenMinusOutline,
            IconSymbol.MovieOpenOff => MovieOpenOff,
            IconSymbol.MovieOpenOffOutline => MovieOpenOffOutline,
            IconSymbol.MovieOpenPlay => MovieOpenPlay,
            IconSymbol.MovieOpenPlayOutline => MovieOpenPlayOutline,
            IconSymbol.MovieOpenPlus => MovieOpenPlus,
            IconSymbol.MovieOpenPlusOutline => MovieOpenPlusOutline,
            IconSymbol.MovieOpenRemove => MovieOpenRemove,
            IconSymbol.MovieOpenRemoveOutline => MovieOpenRemoveOutline,
            IconSymbol.MovieOpenSettings => MovieOpenSettings,
            IconSymbol.MovieOpenSettingsOutline => MovieOpenSettingsOutline,
            IconSymbol.MovieOpenStar => MovieOpenStar,
            IconSymbol.MovieOpenStarOutline => MovieOpenStarOutline,
            IconSymbol.MoviePlay => MoviePlay,
            IconSymbol.MoviePlayOutline => MoviePlayOutline,
            IconSymbol.MoviePlus => MoviePlus,
            IconSymbol.MoviePlusOutline => MoviePlusOutline,
            IconSymbol.MovieRemove => MovieRemove,
            IconSymbol.MovieRemoveOutline => MovieRemoveOutline,
            IconSymbol.MovieSettings => MovieSettings,
            IconSymbol.MovieSettingsOutline => MovieSettingsOutline,
            IconSymbol.MovieStar => MovieStar,
            IconSymbol.MovieStarOutline => MovieStarOutline,
            IconSymbol.RobotHappy => RobotHappy,
            IconSymbol.RobotHappyOutline => RobotHappyOutline,
            IconSymbol.Turkey => Turkey,
            IconSymbol.FoodTurkey => FoodTurkey,
            IconSymbol.FanAuto => FanAuto,
            IconSymbol.AlarmLightOff => AlarmLightOff,
            IconSymbol.AlarmLightOffOutline => AlarmLightOffOutline,
            IconSymbol.Broadcast => Broadcast,
            IconSymbol.BroadcastOff => BroadcastOff,
            IconSymbol.FireOff => FireOff,
            IconSymbol.FireworkOff => FireworkOff,
            IconSymbol.ProjectorScreenOutline => ProjectorScreenOutline,
            IconSymbol.ScriptTextKey => ScriptTextKey,
            IconSymbol.ScriptTextKeyOutline => ScriptTextKeyOutline,
            IconSymbol.ScriptTextPlay => ScriptTextPlay,
            IconSymbol.ScriptTextPlayOutline => ScriptTextPlayOutline,
            IconSymbol.SurroundSound21 => SurroundSound21,
            IconSymbol.SurroundSound512 => SurroundSound512,
            IconSymbol.TagArrowDown => TagArrowDown,
            IconSymbol.TagArrowDownOutline => TagArrowDownOutline,
            IconSymbol.TagArrowLeft => TagArrowLeft,
            IconSymbol.TagArrowLeftOutline => TagArrowLeftOutline,
            IconSymbol.TagArrowRight => TagArrowRight,
            IconSymbol.TagArrowRightOutline => TagArrowRightOutline,
            IconSymbol.TagArrowUp => TagArrowUp,
            IconSymbol.TagArrowUpOutline => TagArrowUpOutline,
            IconSymbol.TrainCarPassenger => TrainCarPassenger,
            IconSymbol.TrainCarPassengerDoor => TrainCarPassengerDoor,
            IconSymbol.TrainCarPassengerDoorOpen => TrainCarPassengerDoorOpen,
            IconSymbol.TrainCarPassengerVariant => TrainCarPassengerVariant,
            IconSymbol.WebcamOff => WebcamOff,
            IconSymbol.ChatQuestion => ChatQuestion,
            IconSymbol.ChatQuestionOutline => ChatQuestionOutline,
            IconSymbol.MessageQuestion => MessageQuestion,
            IconSymbol.MessageQuestionOutline => MessageQuestionOutline,
            IconSymbol.KettlePourOver => KettlePourOver,
            IconSymbol.MessageReplyOutline => MessageReplyOutline,
            IconSymbol.MessageReplyTextOutline => MessageReplyTextOutline,
            IconSymbol.Koala => Koala,
            IconSymbol.CheckDecagramOutline => CheckDecagramOutline,
            IconSymbol.StarShooting => StarShooting,
            IconSymbol.StarShootingOutline => StarShootingOutline,
            IconSymbol.TablePicnic => TablePicnic,
            IconSymbol.Kitesurfing => Kitesurfing,
            IconSymbol.Paragliding => Paragliding,
            IconSymbol.Surfing => Surfing,
            IconSymbol.FloorLampTorchiere => FloorLampTorchiere,
            IconSymbol.MortarPestle => MortarPestle,
            IconSymbol.CastAudioVariant => CastAudioVariant,
            IconSymbol.GradientHorizontal => GradientHorizontal,
            IconSymbol.ArchiveCancel => ArchiveCancel,
            IconSymbol.ArchiveCancelOutline => ArchiveCancelOutline,
            IconSymbol.ArchiveCheck => ArchiveCheck,
            IconSymbol.ArchiveCheckOutline => ArchiveCheckOutline,
            IconSymbol.ArchiveClock => ArchiveClock,
            IconSymbol.ArchiveClockOutline => ArchiveClockOutline,
            IconSymbol.ArchiveCog => ArchiveCog,
            IconSymbol.ArchiveCogOutline => ArchiveCogOutline,
            IconSymbol.ArchiveEdit => ArchiveEdit,
            IconSymbol.ArchiveEditOutline => ArchiveEditOutline,
            IconSymbol.ArchiveEye => ArchiveEye,
            IconSymbol.ArchiveEyeOutline => ArchiveEyeOutline,
            IconSymbol.ArchiveLock => ArchiveLock,
            IconSymbol.ArchiveLockOpen => ArchiveLockOpen,
            IconSymbol.ArchiveLockOpenOutline => ArchiveLockOpenOutline,
            IconSymbol.ArchiveLockOutline => ArchiveLockOutline,
            IconSymbol.ArchiveMarker => ArchiveMarker,
            IconSymbol.ArchiveMarkerOutline => ArchiveMarkerOutline,
            IconSymbol.ArchiveMinus => ArchiveMinus,
            IconSymbol.ArchiveMinusOutline => ArchiveMinusOutline,
            IconSymbol.ArchiveMusic => ArchiveMusic,
            IconSymbol.ArchiveMusicOutline => ArchiveMusicOutline,
            IconSymbol.ArchiveOff => ArchiveOff,
            IconSymbol.ArchiveOffOutline => ArchiveOffOutline,
            IconSymbol.ArchivePlus => ArchivePlus,
            IconSymbol.ArchivePlusOutline => ArchivePlusOutline,
            IconSymbol.ArchiveRefresh => ArchiveRefresh,
            IconSymbol.ArchiveRefreshOutline => ArchiveRefreshOutline,
            IconSymbol.ArchiveRemove => ArchiveRemove,
            IconSymbol.ArchiveRemoveOutline => ArchiveRemoveOutline,
            IconSymbol.ArchiveSearch => ArchiveSearch,
            IconSymbol.ArchiveSearchOutline => ArchiveSearchOutline,
            IconSymbol.ArchiveSettings => ArchiveSettings,
            IconSymbol.ArchiveSettingsOutline => ArchiveSettingsOutline,
            IconSymbol.ArchiveStar => ArchiveStar,
            IconSymbol.ArchiveStarOutline => ArchiveStarOutline,
            IconSymbol.ArchiveSync => ArchiveSync,
            IconSymbol.ArchiveSyncOutline => ArchiveSyncOutline,
            IconSymbol.BrushOff => BrushOff,
            IconSymbol.FileImageMarker => FileImageMarker,
            IconSymbol.FileImageMarkerOutline => FileImageMarkerOutline,
            IconSymbol.FileMarker => FileMarker,
            IconSymbol.FileMarkerOutline => FileMarkerOutline,
            IconSymbol.HamburgerCheck => HamburgerCheck,
            IconSymbol.HamburgerMinus => HamburgerMinus,
            IconSymbol.HamburgerOff => HamburgerOff,
            IconSymbol.HamburgerPlus => HamburgerPlus,
            IconSymbol.HamburgerRemove => HamburgerRemove,
            IconSymbol.ImageMarker => ImageMarker,
            IconSymbol.ImageMarkerOutline => ImageMarkerOutline,
            IconSymbol.NoteAlert => NoteAlert,
            IconSymbol.NoteAlertOutline => NoteAlertOutline,
            IconSymbol.NoteCheck => NoteCheck,
            IconSymbol.NoteCheckOutline => NoteCheckOutline,
            IconSymbol.NoteEdit => NoteEdit,
            IconSymbol.NoteEditOutline => NoteEditOutline,
            IconSymbol.NoteOff => NoteOff,
            IconSymbol.NoteOffOutline => NoteOffOutline,
            IconSymbol.PrinterOffOutline => PrinterOffOutline,
            IconSymbol.PrinterOutline => PrinterOutline,
            IconSymbol.ProgressPencil => ProgressPencil,
            IconSymbol.ProgressStar => ProgressStar,
            IconSymbol.SausageOff => SausageOff,
            IconSymbol.FolderEye => FolderEye,
            IconSymbol.FolderEyeOutline => FolderEyeOutline,
            IconSymbol.InformationOff => InformationOff,
            IconSymbol.InformationOffOutline => InformationOffOutline,
            IconSymbol.StickerText => StickerText,
            IconSymbol.StickerTextOutline => StickerTextOutline,
            IconSymbol.WebCancel => WebCancel,
            IconSymbol.WebRefresh => WebRefresh,
            IconSymbol.WebSync => WebSync,
            IconSymbol.Chandelier => Chandelier,
            IconSymbol.HomeSwitch => HomeSwitch,
            IconSymbol.HomeSwitchOutline => HomeSwitchOutline,
            IconSymbol.SunSnowflake => SunSnowflake,
            IconSymbol.CeilingFan => CeilingFan,
            IconSymbol.CeilingFanLight => CeilingFanLight,
            IconSymbol.Smoke => Smoke,
            IconSymbol.Fence => Fence,
            IconSymbol.LightRecessed => LightRecessed,
            IconSymbol.BatteryLock => BatteryLock,
            IconSymbol.BatteryLockOpen => BatteryLockOpen,
            IconSymbol.FolderHidden => FolderHidden,
            IconSymbol.MirrorRectangle => MirrorRectangle,
            IconSymbol.MirrorVariant => MirrorVariant,
            IconSymbol.ArrowDownLeft => ArrowDownLeft,
            IconSymbol.ArrowDownLeftBold => ArrowDownLeftBold,
            IconSymbol.ArrowDownRight => ArrowDownRight,
            IconSymbol.ArrowDownRightBold => ArrowDownRightBold,
            IconSymbol.ArrowLeftBottom => ArrowLeftBottom,
            IconSymbol.ArrowLeftBottomBold => ArrowLeftBottomBold,
            IconSymbol.ArrowLeftTop => ArrowLeftTop,
            IconSymbol.ArrowLeftTopBold => ArrowLeftTopBold,
            IconSymbol.ArrowRightBottom => ArrowRightBottom,
            IconSymbol.ArrowRightBottomBold => ArrowRightBottomBold,
            IconSymbol.ArrowRightTop => ArrowRightTop,
            IconSymbol.ArrowRightTopBold => ArrowRightTopBold,
            IconSymbol.ArrowUDownLeft => ArrowUDownLeft,
            IconSymbol.ArrowUDownLeftBold => ArrowUDownLeftBold,
            IconSymbol.ArrowUDownRight => ArrowUDownRight,
            IconSymbol.ArrowUDownRightBold => ArrowUDownRightBold,
            IconSymbol.ArrowULeftBottom => ArrowULeftBottom,
            IconSymbol.ArrowULeftBottomBold => ArrowULeftBottomBold,
            IconSymbol.ArrowULeftTop => ArrowULeftTop,
            IconSymbol.ArrowULeftTopBold => ArrowULeftTopBold,
            IconSymbol.ArrowURightBottom => ArrowURightBottom,
            IconSymbol.ArrowURightBottomBold => ArrowURightBottomBold,
            IconSymbol.ArrowURightTop => ArrowURightTop,
            IconSymbol.ArrowURightTopBold => ArrowURightTopBold,
            IconSymbol.ArrowUUpLeft => ArrowUUpLeft,
            IconSymbol.ArrowUUpLeftBold => ArrowUUpLeftBold,
            IconSymbol.ArrowUUpRight => ArrowUUpRight,
            IconSymbol.ArrowUUpRightBold => ArrowUUpRightBold,
            IconSymbol.ArrowUpLeft => ArrowUpLeft,
            IconSymbol.ArrowUpLeftBold => ArrowUpLeftBold,
            IconSymbol.ArrowUpRight => ArrowUpRight,
            IconSymbol.ArrowUpRightBold => ArrowUpRightBold,
            IconSymbol.SelectRemove => SelectRemove,
            IconSymbol.SelectionEllipseRemove => SelectionEllipseRemove,
            IconSymbol.SelectionRemove => SelectionRemove,
            IconSymbol.HumanGreeting => HumanGreeting,
            IconSymbol.Ph => Ph,
            IconSymbol.WaterSync => WaterSync,
            IconSymbol.CeilingLightOutline => CeilingLightOutline,
            IconSymbol.FloorLampOutline => FloorLampOutline,
            IconSymbol.WallSconceFlatOutline => WallSconceFlatOutline,
            IconSymbol.WallSconceFlatVariantOutline => WallSconceFlatVariantOutline,
            IconSymbol.WallSconceOutline => WallSconceOutline,
            IconSymbol.WallSconceRoundOutline => WallSconceRoundOutline,
            IconSymbol.WallSconceRoundVariantOutline => WallSconceRoundVariantOutline,
            IconSymbol.FloorLampDualOutline => FloorLampDualOutline,
            IconSymbol.FloorLampTorchiereVariantOutline => FloorLampTorchiereVariantOutline,
            IconSymbol.LampOutline => LampOutline,
            IconSymbol.LampsOutline => LampsOutline,
            IconSymbol.Candelabra => Candelabra,
            IconSymbol.CandelabraFire => CandelabraFire,
            IconSymbol.Menorah => Menorah,
            IconSymbol.MenorahFire => MenorahFire,
            IconSymbol.FloorLampTorchiereOutline => FloorLampTorchiereOutline,
            IconSymbol.CreditCardEdit => CreditCardEdit,
            IconSymbol.CreditCardEditOutline => CreditCardEditOutline,
            IconSymbol.BriefcaseEye => BriefcaseEye,
            IconSymbol.BriefcaseEyeOutline => BriefcaseEyeOutline,
            IconSymbol.Soundbar => Soundbar,
            IconSymbol.CrownCircle => CrownCircle,
            IconSymbol.CrownCircleOutline => CrownCircleOutline,
            IconSymbol.BatteryArrowDown => BatteryArrowDown,
            IconSymbol.BatteryArrowDownOutline => BatteryArrowDownOutline,
            IconSymbol.BatteryArrowUp => BatteryArrowUp,
            IconSymbol.BatteryArrowUpOutline => BatteryArrowUpOutline,
            IconSymbol.BatteryCheck => BatteryCheck,
            IconSymbol.BatteryCheckOutline => BatteryCheckOutline,
            IconSymbol.BatteryMinus => BatteryMinus,
            IconSymbol.BatteryMinusOutline => BatteryMinusOutline,
            IconSymbol.BatteryPlus => BatteryPlus,
            IconSymbol.BatteryPlusOutline => BatteryPlusOutline,
            IconSymbol.BatteryRemove => BatteryRemove,
            IconSymbol.BatteryRemoveOutline => BatteryRemoveOutline,
            IconSymbol.ChiliAlert => ChiliAlert,
            IconSymbol.ChiliAlertOutline => ChiliAlertOutline,
            IconSymbol.ChiliHotOutline => ChiliHotOutline,
            IconSymbol.ChiliMediumOutline => ChiliMediumOutline,
            IconSymbol.ChiliMildOutline => ChiliMildOutline,
            IconSymbol.ChiliOffOutline => ChiliOffOutline,
            IconSymbol.CakeVariantOutline => CakeVariantOutline,
            IconSymbol.CardMultiple => CardMultiple,
            IconSymbol.CardMultipleOutline => CardMultipleOutline,
            IconSymbol.AccountCowboyHatOutline => AccountCowboyHatOutline,
            IconSymbol.LightbulbSpot => LightbulbSpot,
            IconSymbol.LightbulbSpotOff => LightbulbSpotOff,
            IconSymbol.FenceElectric => FenceElectric,
            IconSymbol.GateArrowLeft => GateArrowLeft,
            IconSymbol.GateAlert => GateAlert,
            IconSymbol.BoomGateUp => BoomGateUp,
            IconSymbol.BoomGateUpOutline => BoomGateUpOutline,
            IconSymbol.GarageLock => GarageLock,
            IconSymbol.GarageVariantLock => GarageVariantLock,
            IconSymbol.CellphoneCheck => CellphoneCheck,
            IconSymbol.SunWireless => SunWireless,
            IconSymbol.SunWirelessOutline => SunWirelessOutline,
            IconSymbol.LightbulbAuto => LightbulbAuto,
            IconSymbol.LightbulbAutoOutline => LightbulbAutoOutline,
            IconSymbol.LightbulbVariant => LightbulbVariant,
            IconSymbol.LightbulbVariantOutline => LightbulbVariantOutline,
            IconSymbol.LightbulbFluorescentTube => LightbulbFluorescentTube,
            IconSymbol.LightbulbFluorescentTubeOutline => LightbulbFluorescentTubeOutline,
            IconSymbol.WaterCircle => WaterCircle,
            IconSymbol.FireCircle => FireCircle,
            IconSymbol.SmokeDetectorOutline => SmokeDetectorOutline,
            IconSymbol.SmokeDetectorOff => SmokeDetectorOff,
            IconSymbol.SmokeDetectorOffOutline => SmokeDetectorOffOutline,
            IconSymbol.SmokeDetectorVariant => SmokeDetectorVariant,
            IconSymbol.SmokeDetectorVariantOff => SmokeDetectorVariantOff,
            IconSymbol.ProjectorScreenOff => ProjectorScreenOff,
            IconSymbol.ProjectorScreenOffOutline => ProjectorScreenOffOutline,
            IconSymbol.ProjectorScreenVariant => ProjectorScreenVariant,
            IconSymbol.ProjectorScreenVariantOff => ProjectorScreenVariantOff,
            IconSymbol.ProjectorScreenVariantOffOutline => ProjectorScreenVariantOffOutline,
            IconSymbol.ProjectorScreenVariantOutline => ProjectorScreenVariantOutline,
            IconSymbol.BrushVariant => BrushVariant,
            IconSymbol.CarWrench => CarWrench,
            IconSymbol.AccountInjury => AccountInjury,
            IconSymbol.AccountInjuryOutline => AccountInjuryOutline,
            IconSymbol.Balcony => Balcony,
            IconSymbol.Bathtub => Bathtub,
            IconSymbol.BathtubOutline => BathtubOutline,
            IconSymbol.BlenderOutline => BlenderOutline,
            IconSymbol.CoffeeMakerOutline => CoffeeMakerOutline,
            IconSymbol.Countertop => Countertop,
            IconSymbol.CountertopOutline => CountertopOutline,
            IconSymbol.DoorSliding => DoorSliding,
            IconSymbol.DoorSlidingLock => DoorSlidingLock,
            IconSymbol.DoorSlidingOpen => DoorSlidingOpen,
            IconSymbol.HandWave => HandWave,
            IconSymbol.HandWaveOutline => HandWaveOutline,
            IconSymbol.HumanMaleFemaleChild => HumanMaleFemaleChild,
            IconSymbol.Iron => Iron,
            IconSymbol.IronOutline => IronOutline,
            IconSymbol.LiquidSpot => LiquidSpot,
            IconSymbol.MosqueOutline => MosqueOutline,
            IconSymbol.ShieldMoon => ShieldMoon,
            IconSymbol.ShieldMoonOutline => ShieldMoonOutline,
            IconSymbol.TrafficLightOutline => TrafficLightOutline,
            IconSymbol.HandFrontLeft => HandFrontLeft,
            IconSymbol.HandBackLeftOutline => HandBackLeftOutline,
            IconSymbol.HandBackRightOutline => HandBackRightOutline,
            IconSymbol.HandFrontLeftOutline => HandFrontLeftOutline,
            IconSymbol.HandFrontRightOutline => HandFrontRightOutline,
            IconSymbol.HandBackLeftOff => HandBackLeftOff,
            IconSymbol.HandBackRightOff => HandBackRightOff,
            IconSymbol.HandBackLeftOffOutline => HandBackLeftOffOutline,
            IconSymbol.HandBackRightOffOutline => HandBackRightOffOutline,
            IconSymbol.BatterySync => BatterySync,
            IconSymbol.BatterySyncOutline => BatterySyncOutline,
            IconSymbol.FoodTakeoutBox => FoodTakeoutBox,
            IconSymbol.FoodTakeoutBoxOutline => FoodTakeoutBoxOutline,
            IconSymbol.IronBoard => IronBoard,
            IconSymbol.PoliceStation => PoliceStation,
            IconSymbol.CellphoneMarker => CellphoneMarker,
            IconSymbol.TooltipCellphone => TooltipCellphone,
            IconSymbol.TablePivot => TablePivot,
            IconSymbol.Tunnel => Tunnel,
            IconSymbol.TunnelOutline => TunnelOutline,
            IconSymbol.ArrowProjectileMultiple => ArrowProjectileMultiple,
            IconSymbol.ArrowProjectile => ArrowProjectile,
            IconSymbol.BowArrow => BowArrow,
            IconSymbol.AxeBattle => AxeBattle,
            IconSymbol.Mace => Mace,
            IconSymbol.MagicStaff => MagicStaff,
            IconSymbol.Spear => Spear,
            IconSymbol.Curtains => Curtains,
            IconSymbol.CurtainsClosed => CurtainsClosed,
            IconSymbol.HumanNonBinary => HumanNonBinary,
            IconSymbol.Waterfall => Waterfall,
            IconSymbol.EggFried => EggFried,
            IconSymbol.FoodHotDog => FoodHotDog,
            IconSymbol.Induction => Induction,
            IconSymbol.PipeValve => PipeValve,
            IconSymbol.ShippingPallet => ShippingPallet,
            IconSymbol.Earbuds => Earbuds,
            IconSymbol.EarbudsOff => EarbudsOff,
            IconSymbol.EarbudsOffOutline => EarbudsOffOutline,
            IconSymbol.EarbudsOutline => EarbudsOutline,
            IconSymbol.CircleOpacity => CircleOpacity,
            IconSymbol.SquareOpacity => SquareOpacity,
            IconSymbol.WaterOpacity => WaterOpacity,
            IconSymbol.VectorPolygonVariant => VectorPolygonVariant,
            IconSymbol.VectorSquareClose => VectorSquareClose,
            IconSymbol.VectorSquareOpen => VectorSquareOpen,
            IconSymbol.WavesArrowLeft => WavesArrowLeft,
            IconSymbol.WavesArrowRight => WavesArrowRight,
            IconSymbol.WavesArrowUp => WavesArrowUp,
            IconSymbol.CashFast => CashFast,
            IconSymbol.RadioactiveCircle => RadioactiveCircle,
            IconSymbol.RadioactiveCircleOutline => RadioactiveCircleOutline,
            IconSymbol.CctvOff => CctvOff,
            IconSymbol.FormatListGroup => FormatListGroup,
            IconSymbol.ClockPlus => ClockPlus,
            IconSymbol.ClockPlusOutline => ClockPlusOutline,
            IconSymbol.ClockMinus => ClockMinus,
            IconSymbol.ClockMinusOutline => ClockMinusOutline,
            IconSymbol.ClockRemove => ClockRemove,
            IconSymbol.ClockRemoveOutline => ClockRemoveOutline,
            IconSymbol.AccountArrowUp => AccountArrowUp,
            IconSymbol.AccountArrowDown => AccountArrowDown,
            IconSymbol.AccountArrowDownOutline => AccountArrowDownOutline,
            IconSymbol.AccountArrowUpOutline => AccountArrowUpOutline,
            IconSymbol.AudioInputRca => AudioInputRca,
            IconSymbol.AudioInputStereoMinijack => AudioInputStereoMinijack,
            IconSymbol.AudioInputXlr => AudioInputXlr,
            IconSymbol.HorseVariantFast => HorseVariantFast,
            IconSymbol.EmailFast => EmailFast,
            IconSymbol.EmailFastOutline => EmailFastOutline,
            IconSymbol.CameraDocument => CameraDocument,
            IconSymbol.CameraDocumentOff => CameraDocumentOff,
            IconSymbol.GlassFragile => GlassFragile,
            IconSymbol.MagnifyExpand => MagnifyExpand,
            IconSymbol.TownHall => TownHall,
            IconSymbol.MonitorSmall => MonitorSmall,
            IconSymbol.Diversify => Diversify,
            IconSymbol.CarWireless => CarWireless,
            IconSymbol.CarSelect => CarSelect,
            IconSymbol.AirplaneAlert => AirplaneAlert,
            IconSymbol.AirplaneCheck => AirplaneCheck,
            IconSymbol.AirplaneClock => AirplaneClock,
            IconSymbol.AirplaneCog => AirplaneCog,
            IconSymbol.AirplaneEdit => AirplaneEdit,
            IconSymbol.AirplaneMarker => AirplaneMarker,
            IconSymbol.AirplaneMinus => AirplaneMinus,
            IconSymbol.AirplanePlus => AirplanePlus,
            IconSymbol.AirplaneRemove => AirplaneRemove,
            IconSymbol.AirplaneSearch => AirplaneSearch,
            IconSymbol.AirplaneSettings => AirplaneSettings,
            IconSymbol.FlowerPollen => FlowerPollen,
            IconSymbol.FlowerPollenOutline => FlowerPollenOutline,
            IconSymbol.HammerSickle => HammerSickle,
            IconSymbol.ViewGallery => ViewGallery,
            IconSymbol.ViewGalleryOutline => ViewGalleryOutline,
            IconSymbol.UmbrellaBeach => UmbrellaBeach,
            IconSymbol.UmbrellaBeachOutline => UmbrellaBeachOutline,
            IconSymbol.CabinAFrame => CabinAFrame,
            IconSymbol.AllInclusiveBox => AllInclusiveBox,
            IconSymbol.AllInclusiveBoxOutline => AllInclusiveBoxOutline,
            IconSymbol.HandCoin => HandCoin,
            IconSymbol.HandCoinOutline => HandCoinOutline,
            IconSymbol.TruckFlatbed => TruckFlatbed,
            IconSymbol.LayersEdit => LayersEdit,
            IconSymbol.Multicast => Multicast,
            IconSymbol.HydrogenStation => HydrogenStation,
            IconSymbol.ThermometerBluetooth => ThermometerBluetooth,
            IconSymbol.Tire => Tire,
            IconSymbol.Forest => Forest,
            IconSymbol.AccountTieHat => AccountTieHat,
            IconSymbol.AccountTieHatOutline => AccountTieHatOutline,
            IconSymbol.AccountWrench => AccountWrench,
            IconSymbol.AccountWrenchOutline => AccountWrenchOutline,
            IconSymbol.BicycleCargo => BicycleCargo,
            IconSymbol.CalendarCollapseHorizontal => CalendarCollapseHorizontal,
            IconSymbol.CalendarExpandHorizontal => CalendarExpandHorizontal,
            IconSymbol.CardsClubOutline => CardsClubOutline,
            IconSymbol.CardsPlaying => CardsPlaying,
            IconSymbol.CardsPlayingClub => CardsPlayingClub,
            IconSymbol.CardsPlayingClubMultiple => CardsPlayingClubMultiple,
            IconSymbol.CardsPlayingClubMultipleOutline => CardsPlayingClubMultipleOutline,
            IconSymbol.CardsPlayingClubOutline => CardsPlayingClubOutline,
            IconSymbol.CardsPlayingDiamond => CardsPlayingDiamond,
            IconSymbol.CardsPlayingDiamondMultiple => CardsPlayingDiamondMultiple,
            IconSymbol.CardsPlayingDiamondMultipleOutline => CardsPlayingDiamondMultipleOutline,
            IconSymbol.CardsPlayingDiamondOutline => CardsPlayingDiamondOutline,
            IconSymbol.CardsPlayingHeart => CardsPlayingHeart,
            IconSymbol.CardsPlayingHeartMultiple => CardsPlayingHeartMultiple,
            IconSymbol.CardsPlayingHeartMultipleOutline => CardsPlayingHeartMultipleOutline,
            IconSymbol.CardsPlayingHeartOutline => CardsPlayingHeartOutline,
            IconSymbol.CardsPlayingSpade => CardsPlayingSpade,
            IconSymbol.CardsPlayingSpadeMultiple => CardsPlayingSpadeMultiple,
            IconSymbol.CardsPlayingSpadeMultipleOutline => CardsPlayingSpadeMultipleOutline,
            IconSymbol.CardsPlayingSpadeOutline => CardsPlayingSpadeOutline,
            IconSymbol.CardsSpadeOutline => CardsSpadeOutline,
            IconSymbol.CompareRemove => CompareRemove,
            IconSymbol.Dolphin => Dolphin,
            IconSymbol.FuelCell => FuelCell,
            IconSymbol.HandExtended => HandExtended,
            IconSymbol.HandExtendedOutline => HandExtendedOutline,
            IconSymbol.Printer3dNozzleHeat => Printer3dNozzleHeat,
            IconSymbol.Printer3dNozzleHeatOutline => Printer3dNozzleHeatOutline,
            IconSymbol.Shark => Shark,
            IconSymbol.SharkOff => SharkOff,
            IconSymbol.ShieldCrown => ShieldCrown,
            IconSymbol.ShieldCrownOutline => ShieldCrownOutline,
            IconSymbol.ShieldSword => ShieldSword,
            IconSymbol.ShieldSwordOutline => ShieldSwordOutline,
            IconSymbol.Sickle => Sickle,
            IconSymbol.StoreAlert => StoreAlert,
            IconSymbol.StoreAlertOutline => StoreAlertOutline,
            IconSymbol.StoreCheck => StoreCheck,
            IconSymbol.StoreCheckOutline => StoreCheckOutline,
            IconSymbol.StoreClock => StoreClock,
            IconSymbol.StoreClockOutline => StoreClockOutline,
            IconSymbol.StoreCog => StoreCog,
            IconSymbol.StoreCogOutline => StoreCogOutline,
            IconSymbol.StoreEdit => StoreEdit,
            IconSymbol.StoreEditOutline => StoreEditOutline,
            IconSymbol.StoreMarker => StoreMarker,
            IconSymbol.StoreMarkerOutline => StoreMarkerOutline,
            IconSymbol.StoreMinusOutline => StoreMinusOutline,
            IconSymbol.StoreOff => StoreOff,
            IconSymbol.StoreOffOutline => StoreOffOutline,
            IconSymbol.StorePlusOutline => StorePlusOutline,
            IconSymbol.StoreRemoveOutline => StoreRemoveOutline,
            IconSymbol.StoreSearch => StoreSearch,
            IconSymbol.StoreSearchOutline => StoreSearchOutline,
            IconSymbol.StoreSettings => StoreSettings,
            IconSymbol.StoreSettingsOutline => StoreSettingsOutline,
            IconSymbol.SunThermometer => SunThermometer,
            IconSymbol.SunThermometerOutline => SunThermometerOutline,
            IconSymbol.TruckCargoContainer => TruckCargoContainer,
            IconSymbol.VectorSquareEdit => VectorSquareEdit,
            IconSymbol.VectorSquareMinus => VectorSquareMinus,
            IconSymbol.VectorSquarePlus => VectorSquarePlus,
            IconSymbol.VectorSquareRemove => VectorSquareRemove,
            IconSymbol.CeilingLightMultiple => CeilingLightMultiple,
            IconSymbol.CeilingLightMultipleOutline => CeilingLightMultipleOutline,
            IconSymbol.WiperWashAlert => WiperWashAlert,
            IconSymbol.CartHeart => CartHeart,
            IconSymbol.VirusOff => VirusOff,
            IconSymbol.VirusOffOutline => VirusOffOutline,
            IconSymbol.MapMarkerAccount => MapMarkerAccount,
            IconSymbol.MapMarkerAccountOutline => MapMarkerAccountOutline,
            IconSymbol.BasketCheck => BasketCheck,
            IconSymbol.BasketCheckOutline => BasketCheckOutline,
            IconSymbol.CreditCardLock => CreditCardLock,
            IconSymbol.CreditCardLockOutline => CreditCardLockOutline,
            IconSymbol.FormatUnderlineWavy => FormatUnderlineWavy,
            IconSymbol.ContentSaveCheck => ContentSaveCheck,
            IconSymbol.ContentSaveCheckOutline => ContentSaveCheckOutline,
            IconSymbol.FilterCheck => FilterCheck,
            IconSymbol.FilterCheckOutline => FilterCheckOutline,
            IconSymbol.FlagOff => FlagOff,
            IconSymbol.FlagOffOutline => FlagOffOutline,
            IconSymbol.NavigationVariantOutline => NavigationVariantOutline,
            IconSymbol.RefreshAuto => RefreshAuto,
            IconSymbol.TildeOff => TildeOff,
            IconSymbol.FitToScreen => FitToScreen,
            IconSymbol.FitToScreenOutline => FitToScreenOutline,
            IconSymbol.WeatherCloudyClock => WeatherCloudyClock,
            IconSymbol.SmartCardOff => SmartCardOff,
            IconSymbol.SmartCardOffOutline => SmartCardOffOutline,
            IconSymbol.ClipboardTextClock => ClipboardTextClock,
            IconSymbol.ClipboardTextClockOutline => ClipboardTextClockOutline,
            IconSymbol.TeddyBear => TeddyBear,
            IconSymbol.CowOff => CowOff,
            IconSymbol.EyeArrowLeft => EyeArrowLeft,
            IconSymbol.EyeArrowLeftOutline => EyeArrowLeftOutline,
            IconSymbol.EyeArrowRight => EyeArrowRight,
            IconSymbol.EyeArrowRightOutline => EyeArrowRightOutline,
            IconSymbol.HomeBattery => HomeBattery,
            IconSymbol.HomeBatteryOutline => HomeBatteryOutline,
            IconSymbol.HomeLightningBolt => HomeLightningBolt,
            IconSymbol.HomeLightningBoltOutline => HomeLightningBoltOutline,
            IconSymbol.LeafCircle => LeafCircle,
            IconSymbol.LeafCircleOutline => LeafCircleOutline,
            IconSymbol.TagSearch => TagSearch,
            IconSymbol.TagSearchOutline => TagSearchOutline,
            IconSymbol.CarBrakeFluidLevel => CarBrakeFluidLevel,
            IconSymbol.CarBrakeLowPressure => CarBrakeLowPressure,
            IconSymbol.CarBrakeTemperature => CarBrakeTemperature,
            IconSymbol.CarBrakeWornLinings => CarBrakeWornLinings,
            IconSymbol.CarLightAlert => CarLightAlert,
            IconSymbol.CarSpeedLimiter => CarSpeedLimiter,
            IconSymbol.CreditCardChip => CreditCardChip,
            IconSymbol.CreditCardChipOutline => CreditCardChipOutline,
            IconSymbol.CreditCardFast => CreditCardFast,
            IconSymbol.CreditCardFastOutline => CreditCardFastOutline,
            IconSymbol.IntegratedCircuitChip => IntegratedCircuitChip,
            IconSymbol.ThumbsUpDownOutline => ThumbsUpDownOutline,
            IconSymbol.FoodOffOutline => FoodOffOutline,
            IconSymbol.FoodOutline => FoodOutline,
            IconSymbol.FormatPageSplit => FormatPageSplit,
            IconSymbol.ChartWaterfall => ChartWaterfall,
            IconSymbol.GamepadOutline => GamepadOutline,
            IconSymbol.NetworkStrength4Cog => NetworkStrength4Cog,
            IconSymbol.AccountSync => AccountSync,
            IconSymbol.AccountSyncOutline => AccountSyncOutline,
            IconSymbol.BusElectric => BusElectric,
            IconSymbol.Liquor => Liquor,
            IconSymbol.DatabaseEye => DatabaseEye,
            IconSymbol.DatabaseEyeOff => DatabaseEyeOff,
            IconSymbol.DatabaseEyeOffOutline => DatabaseEyeOffOutline,
            IconSymbol.DatabaseEyeOutline => DatabaseEyeOutline,
            IconSymbol.TimerSettings => TimerSettings,
            IconSymbol.TimerSettingsOutline => TimerSettingsOutline,
            IconSymbol.TimerCog => TimerCog,
            IconSymbol.TimerCogOutline => TimerCogOutline,
            IconSymbol.CheckboxMarkedCirclePlusOutline => CheckboxMarkedCirclePlusOutline,
            IconSymbol.PanoramaHorizontal => PanoramaHorizontal,
            IconSymbol.PanoramaVertical => PanoramaVertical,
            IconSymbol.Advertisements => Advertisements,
            IconSymbol.AdvertisementsOff => AdvertisementsOff,
            IconSymbol.TransmissionTowerExport => TransmissionTowerExport,
            IconSymbol.TransmissionTowerImport => TransmissionTowerImport,
            IconSymbol.SmokeDetectorAlert => SmokeDetectorAlert,
            IconSymbol.SmokeDetectorAlertOutline => SmokeDetectorAlertOutline,
            IconSymbol.SmokeDetectorVariantAlert => SmokeDetectorVariantAlert,
            IconSymbol.CoffeeMakerCheck => CoffeeMakerCheck,
            IconSymbol.CoffeeMakerCheckOutline => CoffeeMakerCheckOutline,
            IconSymbol.CogPause => CogPause,
            IconSymbol.CogPauseOutline => CogPauseOutline,
            IconSymbol.CogPlay => CogPlay,
            IconSymbol.CogPlayOutline => CogPlayOutline,
            IconSymbol.CogStop => CogStop,
            IconSymbol.CogStopOutline => CogStopOutline,
            IconSymbol.Copyleft => Copyleft,
            IconSymbol.FastForward15 => FastForward15,
            IconSymbol.FileImageMinus => FileImageMinus,
            IconSymbol.FileImageMinusOutline => FileImageMinusOutline,
            IconSymbol.FileImagePlus => FileImagePlus,
            IconSymbol.FileImagePlusOutline => FileImagePlusOutline,
            IconSymbol.FileImageRemove => FileImageRemove,
            IconSymbol.FileImageRemoveOutline => FileImageRemoveOutline,
            IconSymbol.MessageBadge => MessageBadge,
            IconSymbol.MessageBadgeOutline => MessageBadgeOutline,
            IconSymbol.NewspaperCheck => NewspaperCheck,
            IconSymbol.NewspaperRemove => NewspaperRemove,
            IconSymbol.PublishOff => PublishOff,
            IconSymbol.Rewind15 => Rewind15,
            IconSymbol.ViewDashboardEdit => ViewDashboardEdit,
            IconSymbol.ViewDashboardEditOutline => ViewDashboardEditOutline,
            IconSymbol.OfficeBuildingCog => OfficeBuildingCog,
            IconSymbol.OfficeBuildingCogOutline => OfficeBuildingCogOutline,
            IconSymbol.HandClap => HandClap,
            IconSymbol.Cone => Cone,
            IconSymbol.ConeOff => ConeOff,
            IconSymbol.Cylinder => Cylinder,
            IconSymbol.CylinderOff => CylinderOff,
            IconSymbol.Octahedron => Octahedron,
            IconSymbol.OctahedronOff => OctahedronOff,
            IconSymbol.Pyramid => Pyramid,
            IconSymbol.PyramidOff => PyramidOff,
            IconSymbol.Sphere => Sphere,
            IconSymbol.SphereOff => SphereOff,
            IconSymbol.FormatLetterSpacing => FormatLetterSpacing,
            IconSymbol.FrenchFries => FrenchFries,
            IconSymbol.Scent => Scent,
            IconSymbol.ScentOff => ScentOff,
            IconSymbol.PaletteSwatchVariant => PaletteSwatchVariant,
            IconSymbol.EmailSeal => EmailSeal,
            IconSymbol.EmailSealOutline => EmailSealOutline,
            IconSymbol.Stool => Stool,
            IconSymbol.StoolOutline => StoolOutline,
            IconSymbol.PanoramaWideAngle => PanoramaWideAngle,
            IconSymbol.AccountLockOpen => AccountLockOpen,
            IconSymbol.AccountLockOpenOutline => AccountLockOpenOutline,
            IconSymbol.AlignHorizontalDistribute => AlignHorizontalDistribute,
            IconSymbol.AlignVerticalDistribute => AlignVerticalDistribute,
            IconSymbol.ArrowBottomLeftBoldBox => ArrowBottomLeftBoldBox,
            IconSymbol.ArrowBottomLeftBoldBoxOutline => ArrowBottomLeftBoldBoxOutline,
            IconSymbol.ArrowBottomRightBoldBox => ArrowBottomRightBoldBox,
            IconSymbol.ArrowBottomRightBoldBoxOutline => ArrowBottomRightBoldBoxOutline,
            IconSymbol.ArrowTopLeftBoldBox => ArrowTopLeftBoldBox,
            IconSymbol.ArrowTopLeftBoldBoxOutline => ArrowTopLeftBoldBoxOutline,
            IconSymbol.ArrowTopRightBoldBox => ArrowTopRightBoldBox,
            IconSymbol.ArrowTopRightBoldBoxOutline => ArrowTopRightBoldBoxOutline,
            IconSymbol.BookmarkBoxMultiple => BookmarkBoxMultiple,
            IconSymbol.BookmarkBoxMultipleOutline => BookmarkBoxMultipleOutline,
            IconSymbol.BullhornVariant => BullhornVariant,
            IconSymbol.BullhornVariantOutline => BullhornVariantOutline,
            IconSymbol.Candy => Candy,
            IconSymbol.CandyOff => CandyOff,
            IconSymbol.CandyOffOutline => CandyOffOutline,
            IconSymbol.CandyOutline => CandyOutline,
            IconSymbol.CarClock => CarClock,
            IconSymbol.Crowd => Crowd,
            IconSymbol.CurrencyRupee => CurrencyRupee,
            IconSymbol.Diving => Diving,
            IconSymbol.DotsCircle => DotsCircle,
            IconSymbol.ElevatorPassengerOff => ElevatorPassengerOff,
            IconSymbol.ElevatorPassengerOffOutline => ElevatorPassengerOffOutline,
            IconSymbol.ElevatorPassengerOutline => ElevatorPassengerOutline,
            IconSymbol.EyeRefresh => EyeRefresh,
            IconSymbol.EyeRefreshOutline => EyeRefreshOutline,
            IconSymbol.FolderCheck => FolderCheck,
            IconSymbol.FolderCheckOutline => FolderCheckOutline,
            IconSymbol.HumanDolly => HumanDolly,
            IconSymbol.HumanWhiteCane => HumanWhiteCane,
            IconSymbol.IpOutline => IpOutline,
            IconSymbol.KeyAlert => KeyAlert,
            IconSymbol.KeyAlertOutline => KeyAlertOutline,
            IconSymbol.Kite => Kite,
            IconSymbol.KiteOutline => KiteOutline,
            IconSymbol.LightFloodDown => LightFloodDown,
            IconSymbol.LightFloodUp => LightFloodUp,
            IconSymbol.MicrophoneQuestion => MicrophoneQuestion,
            IconSymbol.MicrophoneQuestionOutline => MicrophoneQuestionOutline,
            IconSymbol.Cradle => Cradle,
            IconSymbol.PanoramaOutline => PanoramaOutline,
            IconSymbol.PanoramaSphere => PanoramaSphere,
            IconSymbol.PanoramaSphereOutline => PanoramaSphereOutline,
            IconSymbol.PanoramaVariant => PanoramaVariant,
            IconSymbol.PanoramaVariantOutline => PanoramaVariantOutline,
            IconSymbol.CradleOutline => CradleOutline,
            IconSymbol.FractionOneHalf => FractionOneHalf,
            IconSymbol.PhoneRefresh => PhoneRefresh,
            IconSymbol.PhoneRefreshOutline => PhoneRefreshOutline,
            IconSymbol.PhoneSync => PhoneSync,
            IconSymbol.PhoneSyncOutline => PhoneSyncOutline,
            IconSymbol.RazorDoubleEdge => RazorDoubleEdge,
            IconSymbol.RazorSingleEdge => RazorSingleEdge,
            IconSymbol.Rotate360 => Rotate360,
            IconSymbol.ShieldLockOpen => ShieldLockOpen,
            IconSymbol.ShieldLockOpenOutline => ShieldLockOpenOutline,
            IconSymbol.SitemapOutline => SitemapOutline,
            IconSymbol.SprinklerFire => SprinklerFire,
            IconSymbol.TabSearch => TabSearch,
            IconSymbol.TimerSandComplete => TimerSandComplete,
            IconSymbol.TimerSandPaused => TimerSandPaused,
            IconSymbol.Vacuum => Vacuum,
            IconSymbol.VacuumOutline => VacuumOutline,
            IconSymbol.WrenchClock => WrenchClock,
            IconSymbol.Pliers => Pliers,
            IconSymbol.SunCompass => SunCompass,
            IconSymbol.TruckSnowflake => TruckSnowflake,
            IconSymbol.CameraMarker => CameraMarker,
            IconSymbol.CameraMarkerOutline => CameraMarkerOutline,
            IconSymbol.VideoMarker => VideoMarker,
            IconSymbol.VideoMarkerOutline => VideoMarkerOutline,
            IconSymbol.WindTurbineAlert => WindTurbineAlert,
            IconSymbol.WindTurbineCheck => WindTurbineCheck,
            IconSymbol.TruckPlus => TruckPlus,
            IconSymbol.TruckMinus => TruckMinus,
            IconSymbol.TruckRemove => TruckRemove,
            IconSymbol.ArrowRightThin => ArrowRightThin,
            IconSymbol.ArrowLeftThin => ArrowLeftThin,
            IconSymbol.ArrowUpThin => ArrowUpThin,
            IconSymbol.ArrowDownThin => ArrowDownThin,
            IconSymbol.ArrowTopRightThin => ArrowTopRightThin,
            IconSymbol.ArrowTopLeftThin => ArrowTopLeftThin,
            IconSymbol.ArrowBottomLeftThin => ArrowBottomLeftThin,
            IconSymbol.ArrowBottomRightThin => ArrowBottomRightThin,
            IconSymbol.ScaleUnbalanced => ScaleUnbalanced,
            IconSymbol.DrawPen => DrawPen,
            IconSymbol.ClockEdit => ClockEdit,
            IconSymbol.ClockEditOutline => ClockEditOutline,
            IconSymbol.TruckPlusOutline => TruckPlusOutline,
            IconSymbol.TruckMinusOutline => TruckMinusOutline,
            IconSymbol.TruckRemoveOutline => TruckRemoveOutline,
            IconSymbol.CameraOffOutline => CameraOffOutline,
            IconSymbol.HomeGroupPlus => HomeGroupPlus,
            IconSymbol.HomeGroupMinus => HomeGroupMinus,
            IconSymbol.HomeGroupRemove => HomeGroupRemove,
            IconSymbol.FileSign => FileSign,
            IconSymbol.AttachmentLock => AttachmentLock,
            IconSymbol.CellphoneArrowDownVariant => CellphoneArrowDownVariant,
            IconSymbol.FileChartCheck => FileChartCheck,
            IconSymbol.FileChartCheckOutline => FileChartCheckOutline,
            IconSymbol.FileLockOpen => FileLockOpen,
            IconSymbol.FileLockOpenOutline => FileLockOpenOutline,
            IconSymbol.FolderQuestion => FolderQuestion,
            IconSymbol.FolderQuestionOutline => FolderQuestionOutline,
            IconSymbol.MessageFast => MessageFast,
            IconSymbol.MessageFastOutline => MessageFastOutline,
            IconSymbol.MessageTextFast => MessageTextFast,
            IconSymbol.MessageTextFastOutline => MessageTextFastOutline,
            IconSymbol.MonitorArrowDown => MonitorArrowDown,
            IconSymbol.MonitorArrowDownVariant => MonitorArrowDownVariant,
            IconSymbol.NeedleOff => NeedleOff,
            IconSymbol.NumericOff => NumericOff,
            IconSymbol.PackageVariantClosedMinus => PackageVariantClosedMinus,
            IconSymbol.PackageVariantClosedPlus => PackageVariantClosedPlus,
            IconSymbol.PackageVariantClosedRemove => PackageVariantClosedRemove,
            IconSymbol.PackageVariantMinus => PackageVariantMinus,
            IconSymbol.PackageVariantPlus => PackageVariantPlus,
            IconSymbol.PackageVariantRemove => PackageVariantRemove,
            IconSymbol.PaperclipLock => PaperclipLock,
            IconSymbol.PhoneClock => PhoneClock,
            IconSymbol.ReceiptTextOutline => ReceiptTextOutline,
            IconSymbol.TransmissionTowerOff => TransmissionTowerOff,
            IconSymbol.TruckAlert => TruckAlert,
            IconSymbol.TruckAlertOutline => TruckAlertOutline,
            IconSymbol.BoneOff => BoneOff,
            IconSymbol.LightbulbAlert => LightbulbAlert,
            IconSymbol.LightbulbAlertOutline => LightbulbAlertOutline,
            IconSymbol.LightbulbQuestion => LightbulbQuestion,
            IconSymbol.LightbulbQuestionOutline => LightbulbQuestionOutline,
            IconSymbol.BatteryClock => BatteryClock,
            IconSymbol.BatteryClockOutline => BatteryClockOutline,
            IconSymbol.AutorenewOff => AutorenewOff,
            IconSymbol.FolderArrowDown => FolderArrowDown,
            IconSymbol.FolderArrowDownOutline => FolderArrowDownOutline,
            IconSymbol.FolderArrowLeft => FolderArrowLeft,
            IconSymbol.FolderArrowLeftOutline => FolderArrowLeftOutline,
            IconSymbol.FolderArrowLeftRight => FolderArrowLeftRight,
            IconSymbol.FolderArrowLeftRightOutline => FolderArrowLeftRightOutline,
            IconSymbol.FolderArrowRight => FolderArrowRight,
            IconSymbol.FolderArrowRightOutline => FolderArrowRightOutline,
            IconSymbol.FolderArrowUp => FolderArrowUp,
            IconSymbol.FolderArrowUpDown => FolderArrowUpDown,
            IconSymbol.FolderArrowUpDownOutline => FolderArrowUpDownOutline,
            IconSymbol.FolderArrowUpOutline => FolderArrowUpOutline,
            IconSymbol.FolderCancel => FolderCancel,
            IconSymbol.FolderCancelOutline => FolderCancelOutline,
            IconSymbol.FolderFile => FolderFile,
            IconSymbol.FolderFileOutline => FolderFileOutline,
            IconSymbol.FolderOff => FolderOff,
            IconSymbol.FolderOffOutline => FolderOffOutline,
            IconSymbol.FolderPlay => FolderPlay,
            IconSymbol.FolderPlayOutline => FolderPlayOutline,
            IconSymbol.FolderWrench => FolderWrench,
            IconSymbol.FolderWrenchOutline => FolderWrenchOutline,
            IconSymbol.ImageRefresh => ImageRefresh,
            IconSymbol.ImageRefreshOutline => ImageRefreshOutline,
            IconSymbol.ImageSync => ImageSync,
            IconSymbol.ImageSyncOutline => ImageSyncOutline,
            IconSymbol.PercentBox => PercentBox,
            IconSymbol.PercentBoxOutline => PercentBoxOutline,
            IconSymbol.PercentCircle => PercentCircle,
            IconSymbol.PercentCircleOutline => PercentCircleOutline,
            IconSymbol.SaleOutline => SaleOutline,
            IconSymbol.SquareRoundedBadge => SquareRoundedBadge,
            IconSymbol.SquareRoundedBadgeOutline => SquareRoundedBadgeOutline,
            IconSymbol.TriangleSmallDown => TriangleSmallDown,
            IconSymbol.TriangleSmallUp => TriangleSmallUp,
            IconSymbol.NotebookHeart => NotebookHeart,
            IconSymbol.NotebookHeartOutline => NotebookHeartOutline,
            IconSymbol.BrushOutline => BrushOutline,
            IconSymbol.FruitPear => FruitPear,
            IconSymbol.Raw => Raw,
            IconSymbol.RawOff => RawOff,
            IconSymbol.WallFire => WallFire,
            IconSymbol.HomeClock => HomeClock,
            IconSymbol.HomeClockOutline => HomeClockOutline,
            IconSymbol.CameraLock => CameraLock,
            IconSymbol.CameraLockOutline => CameraLockOutline,
            IconSymbol.PlayBoxLock => PlayBoxLock,
            IconSymbol.PlayBoxLockOpen => PlayBoxLockOpen,
            IconSymbol.PlayBoxLockOpenOutline => PlayBoxLockOpenOutline,
            IconSymbol.PlayBoxLockOutline => PlayBoxLockOutline,
            IconSymbol.RobotIndustrialOutline => RobotIndustrialOutline,
            IconSymbol.GasBurner => GasBurner,
            IconSymbol.Video2d => Video2d,
            IconSymbol.BookHeart => BookHeart,
            IconSymbol.BookHeartOutline => BookHeartOutline,
            IconSymbol.AccountHardHatOutline => AccountHardHatOutline,
            IconSymbol.AccountSchool => AccountSchool,
            IconSymbol.AccountSchoolOutline => AccountSchoolOutline,
            IconSymbol.LibraryOutline => LibraryOutline,
            IconSymbol.ProjectorOff => ProjectorOff,
            IconSymbol.LightSwitchOff => LightSwitchOff,
            IconSymbol.ToggleSwitchVariant => ToggleSwitchVariant,
            IconSymbol.ToggleSwitchVariantOff => ToggleSwitchVariantOff,
            IconSymbol.AsteriskCircleOutline => AsteriskCircleOutline,
            IconSymbol.BarrelOutline => BarrelOutline,
            IconSymbol.BellCog => BellCog,
            IconSymbol.BellCogOutline => BellCogOutline,
            IconSymbol.BlindsHorizontal => BlindsHorizontal,
            IconSymbol.BlindsHorizontalClosed => BlindsHorizontalClosed,
            IconSymbol.BlindsVertical => BlindsVertical,
            IconSymbol.BlindsVerticalClosed => BlindsVerticalClosed,
            IconSymbol.BulkheadLight => BulkheadLight,
            IconSymbol.CalendarTodayOutline => CalendarTodayOutline,
            IconSymbol.CalendarWeekBeginOutline => CalendarWeekBeginOutline,
            IconSymbol.CalendarFilter => CalendarFilter,
            IconSymbol.CalendarFilterOutline => CalendarFilterOutline,
            IconSymbol.CalendarWeekOutline => CalendarWeekOutline,
            IconSymbol.CloudPercent => CloudPercent,
            IconSymbol.CloudPercentOutline => CloudPercentOutline,
            IconSymbol.CoachLampVariant => CoachLampVariant,
            IconSymbol.Compost => Compost,
            IconSymbol.CurrencyFra => CurrencyFra,
            IconSymbol.FanClock => FanClock,
            IconSymbol.FileRotateLeft => FileRotateLeft,
            IconSymbol.FileRotateLeftOutline => FileRotateLeftOutline,
            IconSymbol.FileRotateRight => FileRotateRight,
            IconSymbol.FileRotateRightOutline => FileRotateRightOutline,
            IconSymbol.FilterMultiple => FilterMultiple,
            IconSymbol.FilterMultipleOutline => FilterMultipleOutline,
            IconSymbol.Gymnastics => Gymnastics,
            IconSymbol.HandClapOff => HandClapOff,
            IconSymbol.HeatPump => HeatPump,
            IconSymbol.HeatPumpOutline => HeatPumpOutline,
            IconSymbol.HeatWave => HeatWave,
            IconSymbol.HomeOff => HomeOff,
            IconSymbol.HomeOffOutline => HomeOffOutline,
            IconSymbol.Landslide => Landslide,
            IconSymbol.LandslideOutline => LandslideOutline,
            IconSymbol.LaptopAccount => LaptopAccount,
            IconSymbol.LedStripVariantOff => LedStripVariantOff,
            IconSymbol.LightbulbNight => LightbulbNight,
            IconSymbol.LightbulbNightOutline => LightbulbNightOutline,
            IconSymbol.LightbulbOn10 => LightbulbOn10,
            IconSymbol.LightbulbOn20 => LightbulbOn20,
            IconSymbol.LightbulbOn30 => LightbulbOn30,
            IconSymbol.LightbulbOn40 => LightbulbOn40,
            IconSymbol.LightbulbOn50 => LightbulbOn50,
            IconSymbol.LightbulbOn60 => LightbulbOn60,
            IconSymbol.LightbulbOn70 => LightbulbOn70,
            IconSymbol.LightbulbOn80 => LightbulbOn80,
            IconSymbol.LightbulbOn90 => LightbulbOn90,
            IconSymbol.MeterElectric => MeterElectric,
            IconSymbol.MeterElectricOutline => MeterElectricOutline,
            IconSymbol.MeterGas => MeterGas,
            IconSymbol.MeterGasOutline => MeterGasOutline,
            IconSymbol.MonitorAccount => MonitorAccount,
            IconSymbol.PillOff => PillOff,
            IconSymbol.PlusLock => PlusLock,
            IconSymbol.PlusLockOpen => PlusLockOpen,
            IconSymbol.PoolThermometer => PoolThermometer,
            IconSymbol.PostLamp => PostLamp,
            IconSymbol.RabbitVariant => RabbitVariant,
            IconSymbol.RabbitVariantOutline => RabbitVariantOutline,
            IconSymbol.ReceiptTextCheck => ReceiptTextCheck,
            IconSymbol.ReceiptTextCheckOutline => ReceiptTextCheckOutline,
            IconSymbol.ReceiptTextMinus => ReceiptTextMinus,
            IconSymbol.ReceiptTextMinusOutline => ReceiptTextMinusOutline,
            IconSymbol.ReceiptTextPlus => ReceiptTextPlus,
            IconSymbol.ReceiptTextPlusOutline => ReceiptTextPlusOutline,
            IconSymbol.ReceiptTextRemove => ReceiptTextRemove,
            IconSymbol.ReceiptTextRemoveOutline => ReceiptTextRemoveOutline,
            IconSymbol.RollerShade => RollerShade,
            IconSymbol.RollerShadeClosed => RollerShadeClosed,
            IconSymbol.SeedPlus => SeedPlus,
            IconSymbol.SeedPlusOutline => SeedPlusOutline,
            IconSymbol.ShoppingSearchOutline => ShoppingSearchOutline,
            IconSymbol.SnowflakeCheck => SnowflakeCheck,
            IconSymbol.SnowflakeThermometer => SnowflakeThermometer,
            IconSymbol.Snowshoeing => Snowshoeing,
            IconSymbol.SolarPowerVariant => SolarPowerVariant,
            IconSymbol.SolarPowerVariantOutline => SolarPowerVariantOutline,
            IconSymbol.StorageTank => StorageTank,
            IconSymbol.StorageTankOutline => StorageTankOutline,
            IconSymbol.SunClock => SunClock,
            IconSymbol.SunClockOutline => SunClockOutline,
            IconSymbol.SunSnowflakeVariant => SunSnowflakeVariant,
            IconSymbol.TagCheck => TagCheck,
            IconSymbol.TagCheckOutline => TagCheckOutline,
            IconSymbol.TextBoxEdit => TextBoxEdit,
            IconSymbol.TextBoxEditOutline => TextBoxEditOutline,
            IconSymbol.TextSearchVariant => TextSearchVariant,
            IconSymbol.ThermometerCheck => ThermometerCheck,
            IconSymbol.ThermometerWater => ThermometerWater,
            IconSymbol.Tsunami => Tsunami,
            IconSymbol.Turbine => Turbine,
            IconSymbol.Volcano => Volcano,
            IconSymbol.VolcanoOutline => VolcanoOutline,
            IconSymbol.WaterThermometer => WaterThermometer,
            IconSymbol.WaterThermometerOutline => WaterThermometerOutline,
            IconSymbol.Wheelchair => Wheelchair,
            IconSymbol.WindPower => WindPower,
            IconSymbol.WindPowerOutline => WindPowerOutline,
            IconSymbol.WindowShutterCog => WindowShutterCog,
            IconSymbol.WindowShutterSettings => WindowShutterSettings,
            IconSymbol.AccountTieWoman => AccountTieWoman,
            IconSymbol.BriefcaseArrowLeftRight => BriefcaseArrowLeftRight,
            IconSymbol.BriefcaseArrowLeftRightOutline => BriefcaseArrowLeftRightOutline,
            IconSymbol.BriefcaseArrowUpDown => BriefcaseArrowUpDown,
            IconSymbol.BriefcaseArrowUpDownOutline => BriefcaseArrowUpDownOutline,
            IconSymbol.CashClock => CashClock,
            IconSymbol.CashSync => CashSync,
            IconSymbol.FileArrowLeftRight => FileArrowLeftRight,
            IconSymbol.FileArrowLeftRightOutline => FileArrowLeftRightOutline,
            IconSymbol.FileArrowUpDown => FileArrowUpDown,
            IconSymbol.FileArrowUpDownOutline => FileArrowUpDownOutline,
            IconSymbol.FileDocumentAlert => FileDocumentAlert,
            IconSymbol.FileDocumentAlertOutline => FileDocumentAlertOutline,
            IconSymbol.FileDocumentCheck => FileDocumentCheck,
            IconSymbol.FileDocumentCheckOutline => FileDocumentCheckOutline,
            IconSymbol.FileDocumentMinus => FileDocumentMinus,
            IconSymbol.FileDocumentMinusOutline => FileDocumentMinusOutline,
            IconSymbol.FileDocumentPlus => FileDocumentPlus,
            IconSymbol.FileDocumentPlusOutline => FileDocumentPlusOutline,
            IconSymbol.FileDocumentRemove => FileDocumentRemove,
            IconSymbol.FileDocumentRemoveOutline => FileDocumentRemoveOutline,
            IconSymbol.FileMinus => FileMinus,
            IconSymbol.FileMinusOutline => FileMinusOutline,
            IconSymbol.FilterCog => FilterCog,
            IconSymbol.FilterCogOutline => FilterCogOutline,
            IconSymbol.FilterSettings => FilterSettings,
            IconSymbol.FilterSettingsOutline => FilterSettingsOutline,
            IconSymbol.FolderLockOpenOutline => FolderLockOpenOutline,
            IconSymbol.FolderLockOutline => FolderLockOutline,
            IconSymbol.ForumMinus => ForumMinus,
            IconSymbol.ForumMinusOutline => ForumMinusOutline,
            IconSymbol.ForumPlus => ForumPlus,
            IconSymbol.ForumPlusOutline => ForumPlusOutline,
            IconSymbol.ForumRemove => ForumRemove,
            IconSymbol.ForumRemoveOutline => ForumRemoveOutline,
            IconSymbol.HeatingCoil => HeatingCoil,
            IconSymbol.ImageLock => ImageLock,
            IconSymbol.ImageLockOutline => ImageLockOutline,
            IconSymbol.LandFields => LandFields,
            IconSymbol.LandPlots => LandPlots,
            IconSymbol.LandPlotsCircle => LandPlotsCircle,
            IconSymbol.LandPlotsCircleVariant => LandPlotsCircleVariant,
            IconSymbol.LandRowsHorizontal => LandRowsHorizontal,
            IconSymbol.LandRowsVertical => LandRowsVertical,
            IconSymbol.MedicalCottonSwab => MedicalCottonSwab,
            IconSymbol.Rolodex => Rolodex,
            IconSymbol.RolodexOutline => RolodexOutline,
            IconSymbol.SortVariantOff => SortVariantOff,
            IconSymbol.TallyMark1 => TallyMark1,
            IconSymbol.TallyMark2 => TallyMark2,
            IconSymbol.TallyMark3 => TallyMark3,
            IconSymbol.TallyMark4 => TallyMark4,
            IconSymbol.TallyMark5 => TallyMark5,
            IconSymbol.AttachmentCheck => AttachmentCheck,
            IconSymbol.AttachmentMinus => AttachmentMinus,
            IconSymbol.AttachmentOff => AttachmentOff,
            IconSymbol.AttachmentPlus => AttachmentPlus,
            IconSymbol.AttachmentRemove => AttachmentRemove,
            IconSymbol.PaperclipCheck => PaperclipCheck,
            IconSymbol.PaperclipMinus => PaperclipMinus,
            IconSymbol.PaperclipOff => PaperclipOff,
            IconSymbol.PaperclipPlus => PaperclipPlus,
            IconSymbol.PaperclipRemove => PaperclipRemove,
            IconSymbol.NetworkPos => NetworkPos,
            IconSymbol.TimerAlert => TimerAlert,
            IconSymbol.TimerAlertOutline => TimerAlertOutline,
            IconSymbol.TimerCancel => TimerCancel,
            IconSymbol.TimerCancelOutline => TimerCancelOutline,
            IconSymbol.TimerCheck => TimerCheck,
            IconSymbol.TimerCheckOutline => TimerCheckOutline,
            IconSymbol.TimerEdit => TimerEdit,
            IconSymbol.TimerEditOutline => TimerEditOutline,
            IconSymbol.TimerLock => TimerLock,
            IconSymbol.TimerLockOpen => TimerLockOpen,
            IconSymbol.TimerLockOpenOutline => TimerLockOpenOutline,
            IconSymbol.TimerLockOutline => TimerLockOutline,
            IconSymbol.TimerMarker => TimerMarker,
            IconSymbol.TimerMarkerOutline => TimerMarkerOutline,
            IconSymbol.TimerMinus => TimerMinus,
            IconSymbol.TimerMinusOutline => TimerMinusOutline,
            IconSymbol.TimerMusic => TimerMusic,
            IconSymbol.TimerMusicOutline => TimerMusicOutline,
            IconSymbol.TimerPause => TimerPause,
            IconSymbol.TimerPauseOutline => TimerPauseOutline,
            IconSymbol.TimerPlay => TimerPlay,
            IconSymbol.TimerPlayOutline => TimerPlayOutline,
            IconSymbol.TimerPlus => TimerPlus,
            IconSymbol.TimerPlusOutline => TimerPlusOutline,
            IconSymbol.TimerRefresh => TimerRefresh,
            IconSymbol.TimerRefreshOutline => TimerRefreshOutline,
            IconSymbol.TimerRemove => TimerRemove,
            IconSymbol.TimerRemoveOutline => TimerRemoveOutline,
            IconSymbol.TimerStar => TimerStar,
            IconSymbol.TimerStarOutline => TimerStarOutline,
            IconSymbol.TimerStop => TimerStop,
            IconSymbol.TimerStopOutline => TimerStopOutline,
            IconSymbol.TimerSync => TimerSync,
            IconSymbol.TimerSyncOutline => TimerSyncOutline,
            IconSymbol.EarHearingLoop => EarHearingLoop,
            IconSymbol.SailBoatSink => SailBoatSink,
            IconSymbol.Lectern => Lectern,
            IconSymbol.AccountNetworkOff => AccountNetworkOff,
            IconSymbol.AccountNetworkOffOutline => AccountNetworkOffOutline,
            IconSymbol.BabyBuggyOff => BabyBuggyOff,
            IconSymbol.BorderRadius => BorderRadius,
            IconSymbol.BugPause => BugPause,
            IconSymbol.BugPauseOutline => BugPauseOutline,
            IconSymbol.BugPlay => BugPlay,
            IconSymbol.BugPlayOutline => BugPlayOutline,
            IconSymbol.BugStop => BugStop,
            IconSymbol.BugStopOutline => BugStopOutline,
            IconSymbol.FormatLetterSpacingVariant => FormatLetterSpacingVariant,
            IconSymbol.FormatLineHeight => FormatLineHeight,
            IconSymbol.FormatParagraphSpacing => FormatParagraphSpacing,
            IconSymbol.GateBuffer => GateBuffer,
            IconSymbol.PlaneCar => PlaneCar,
            IconSymbol.PlaneTrain => PlaneTrain,
            IconSymbol.TrackLightOff => TrackLightOff,
            IconSymbol.ChurchOutline => ChurchOutline,
            IconSymbol.StadiumOutline => StadiumOutline,
            IconSymbol.Synagogue => Synagogue,
            IconSymbol.SynagogueOutline => SynagogueOutline,
            IconSymbol.TempleBuddhist => TempleBuddhist,
            IconSymbol.TempleBuddhistOutline => TempleBuddhistOutline,
            IconSymbol.TempleHindu => TempleHindu,
            IconSymbol.TempleHinduOutline => TempleHinduOutline,
            IconSymbol.AccountBadge => AccountBadge,
            IconSymbol.AccountBadgeOutline => AccountBadgeOutline,
            IconSymbol.BagPersonalTag => BagPersonalTag,
            IconSymbol.BagPersonalTagOutline => BagPersonalTagOutline,
            IconSymbol.Printer3dOff => Printer3dOff,
            IconSymbol.ThermometerAuto => ThermometerAuto,
            IconSymbol.VolumeEqual => VolumeEqual,
            IconSymbol.SpeakerMessage => SpeakerMessage,
            IconSymbol.FastForward45 => FastForward45,
            IconSymbol.Rewind45 => Rewind45,
            IconSymbol.Medication => Medication,
            IconSymbol.MedicationOutline => MedicationOutline,
            IconSymbol.MotorbikeOff => MotorbikeOff,
            IconSymbol.ThermostatAuto => ThermostatAuto,
            IconSymbol.ThermostatBoxAuto => ThermostatBoxAuto,
            IconSymbol.Printer3dNozzleOff => Printer3dNozzleOff,
            IconSymbol.Printer3dNozzleOffOutline => Printer3dNozzleOffOutline,
            IconSymbol.TelevisionSpeaker => TelevisionSpeaker,
            IconSymbol.TelevisionSpeakerOff => TelevisionSpeakerOff,
            IconSymbol.FlashTriangle => FlashTriangle,
            IconSymbol.FlashTriangleOutline => FlashTriangleOutline,
            IconSymbol.DeskLampOff => DeskLampOff,
            IconSymbol.DeskLampOn => DeskLampOn,
            IconSymbol.TableQuestion => TableQuestion,
            IconSymbol.PumpOff => PumpOff,
            IconSymbol.EjectCircle => EjectCircle,
            IconSymbol.EjectCircleOutline => EjectCircleOutline,
            IconSymbol.ImageCheck => ImageCheck,
            IconSymbol.ImageCheckOutline => ImageCheckOutline,
            IconSymbol.SunAngle => SunAngle,
            IconSymbol.SunAngleOutline => SunAngleOutline,
            IconSymbol.Faucet => Faucet,
            IconSymbol.FaucetVariant => FaucetVariant,
            IconSymbol.ThermometerProbe => ThermometerProbe,
            IconSymbol.ThermometerProbeOff => ThermometerProbeOff,
            IconSymbol.TrainCarAutorack => TrainCarAutorack,
            IconSymbol.TrainCarBox => TrainCarBox,
            IconSymbol.TrainCarBoxFull => TrainCarBoxFull,
            IconSymbol.TrainCarBoxOpen => TrainCarBoxOpen,
            IconSymbol.TrainCarCaboose => TrainCarCaboose,
            IconSymbol.TrainCarCenterbeam => TrainCarCenterbeam,
            IconSymbol.TrainCarCenterbeamFull => TrainCarCenterbeamFull,
            IconSymbol.TrainCarContainer => TrainCarContainer,
            IconSymbol.TrainCarFlatbed => TrainCarFlatbed,
            IconSymbol.TrainCarFlatbedCar => TrainCarFlatbedCar,
            IconSymbol.TrainCarFlatbedTank => TrainCarFlatbedTank,
            IconSymbol.TrainCarGondola => TrainCarGondola,
            IconSymbol.TrainCarGondolaFull => TrainCarGondolaFull,
            IconSymbol.TrainCarHopper => TrainCarHopper,
            IconSymbol.TrainCarHopperCovered => TrainCarHopperCovered,
            IconSymbol.TrainCarHopperFull => TrainCarHopperFull,
            IconSymbol.TrainCarIntermodal => TrainCarIntermodal,
            IconSymbol.TrainCarTank => TrainCarTank,
            IconSymbol.PhoneIncomingOutgoing => PhoneIncomingOutgoing,
            IconSymbol.PhoneIncomingOutgoingOutline => PhoneIncomingOutgoingOutline,
            IconSymbol.ContentSavePlus => ContentSavePlus,
            IconSymbol.ContentSavePlusOutline => ContentSavePlusOutline,
            IconSymbol.ContentSaveMinus => ContentSaveMinus,
            IconSymbol.ContentSaveMinusOutline => ContentSaveMinusOutline,
            IconSymbol.FlashOffOutline => FlashOffOutline,
            IconSymbol.ImagePlusOutline => ImagePlusOutline,
            IconSymbol.ImageMinusOutline => ImageMinusOutline,
            IconSymbol.ImageRemoveOutline => ImageRemoveOutline,
            IconSymbol.FolderMinus => FolderMinus,
            IconSymbol.FolderMinusOutline => FolderMinusOutline,
            IconSymbol.FileXmlBox => FileXmlBox,
            IconSymbol.PillMultiple => PillMultiple,
            IconSymbol.SignLanguage => SignLanguage,
            IconSymbol.SignLanguageOutline => SignLanguageOutline,
            IconSymbol.ButtonCursor => ButtonCursor,
            IconSymbol.ButtonPointer => ButtonPointer,
            IconSymbol.PackageCheck => PackageCheck,
            IconSymbol.PackageVariantClosedCheck => PackageVariantClosedCheck,
            IconSymbol.CalendarStarOutline => CalendarStarOutline,
            IconSymbol.CheckboxIntermediateVariant => CheckboxIntermediateVariant,
            IconSymbol.CalendarMultiselectOutline => CalendarMultiselectOutline,
            IconSymbol.FormatListGroupPlus => FormatListGroupPlus,
            IconSymbol.AirPurifierOff => AirPurifierOff,
            IconSymbol.SelectArrowUp => SelectArrowUp,
            IconSymbol.SelectArrowDown => SelectArrowDown,
            IconSymbol.WeatherDust => WeatherDust,
            IconSymbol.CalendarLockOpen => CalendarLockOpen,
            IconSymbol.CalendarLockOpenOutline => CalendarLockOpenOutline,
            IconSymbol.RobotVacuumAlert => RobotVacuumAlert,
            IconSymbol.RobotVacuumVariantAlert => RobotVacuumVariantAlert,
            IconSymbol.MowerOn => MowerOn,
            IconSymbol.MowerBagOn => MowerBagOn,
            IconSymbol.EmailLockOutline => EmailLockOutline,
            IconSymbol.CalendarAlertOutline => CalendarAlertOutline,
            IconSymbol.CalendarCollapseHorizontalOutline => CalendarCollapseHorizontalOutline,
            IconSymbol.CalendarCursorOutline => CalendarCursorOutline,
            IconSymbol.CalendarEditOutline => CalendarEditOutline,
            IconSymbol.CalendarEndOutline => CalendarEndOutline,
            IconSymbol.CalendarExpandHorizontalOutline => CalendarExpandHorizontalOutline,
            IconSymbol.CalendarExportOutline => CalendarExportOutline,
            IconSymbol.CalendarHeartOutline => CalendarHeartOutline,
            IconSymbol.CalendarImportOutline => CalendarImportOutline,
            IconSymbol.CalendarMinusOutline => CalendarMinusOutline,
            IconSymbol.CalendarPlusOutline => CalendarPlusOutline,
            IconSymbol.CalendarQuestionOutline => CalendarQuestionOutline,
            IconSymbol.CalendarSearchOutline => CalendarSearchOutline,
            IconSymbol.CalendarStartOutline => CalendarStartOutline,
            IconSymbol.Atv => Atv,
            IconSymbol.HumanWalker => HumanWalker,
            IconSymbol.SpeakerPlay => SpeakerPlay,
            IconSymbol.SpeakerPause => SpeakerPause,
            IconSymbol.SpeakerStop => SpeakerStop,
            IconSymbol.BookmarkBox => BookmarkBox,
            IconSymbol.BookmarkBoxOutline => BookmarkBoxOutline,
            IconSymbol.DivingScuba => DivingScuba,
            IconSymbol.VectorPointMinus => VectorPointMinus,
            IconSymbol.VectorPointPlus => VectorPointPlus,
            IconSymbol.PauseBoxOutline => PauseBoxOutline,
            IconSymbol.ListBox => ListBox,
            IconSymbol.ListBoxOutline => ListBoxOutline,
            IconSymbol.StorefrontCheck => StorefrontCheck,
            IconSymbol.StorefrontCheckOutline => StorefrontCheckOutline,
            IconSymbol.StorefrontEdit => StorefrontEdit,
            IconSymbol.StorefrontEditOutline => StorefrontEditOutline,
            IconSymbol.StorefrontPlus => StorefrontPlus,
            IconSymbol.StorefrontPlusOutline => StorefrontPlusOutline,
            IconSymbol.StorefrontMinus => StorefrontMinus,
            IconSymbol.StorefrontMinusOutline => StorefrontMinusOutline,
            IconSymbol.StorefrontRemove => StorefrontRemove,
            IconSymbol.StorefrontRemoveOutline => StorefrontRemoveOutline,
            IconSymbol.Awning => Awning,
            IconSymbol.AwningOutline => AwningOutline,
            IconSymbol.MusicNoteMinus => MusicNoteMinus,
            IconSymbol.MessageCheck => MessageCheck,
            IconSymbol.MessageCheckOutline => MessageCheckOutline,
            IconSymbol.TableFilter => TableFilter,
            IconSymbol.CarSearch => CarSearch,
            IconSymbol.CarSearchOutline => CarSearchOutline,
            IconSymbol.WrenchCheck => WrenchCheck,
            IconSymbol.WrenchCheckOutline => WrenchCheckOutline,
            IconSymbol.WrenchCog => WrenchCog,
            IconSymbol.WrenchCogOutline => WrenchCogOutline,
            IconSymbol.WrenchClockOutline => WrenchClockOutline,
            IconSymbol.BedClock => BedClock,
            IconSymbol.Clouds => Clouds,
            IconSymbol.Knob => Knob,
            IconSymbol.Multimedia => Multimedia,
            IconSymbol.WaterBoilerAuto => WaterBoilerAuto,
            IconSymbol.TranslateVariant => TranslateVariant,
            IconSymbol.Artboard => Artboard,
            IconSymbol.CurrencyUah => CurrencyUah,
            IconSymbol.HandCycle => HandCycle,
            IconSymbol.CalendarBadge => CalendarBadge,
            IconSymbol.CalendarBadgeOutline => CalendarBadgeOutline,
            IconSymbol.Silo => Silo,
            IconSymbol.HomeSilo => HomeSilo,
            IconSymbol.HomeSiloOutline => HomeSiloOutline,
            IconSymbol.ProgressHelper => ProgressHelper,
            IconSymbol.WindowShutterAuto => WindowShutterAuto,
            IconSymbol.AccountCard => AccountCard,
            IconSymbol.AccountCardOutline => AccountCardOutline,
            IconSymbol.AccountCreditCard => AccountCreditCard,
            IconSymbol.AccountCreditCardOutline => AccountCreditCardOutline,
            IconSymbol.OfficeBuildingPlus => OfficeBuildingPlus,
            IconSymbol.OfficeBuildingPlusOutline => OfficeBuildingPlusOutline,
            IconSymbol.OfficeBuildingMinus => OfficeBuildingMinus,
            IconSymbol.OfficeBuildingMinusOutline => OfficeBuildingMinusOutline,
            IconSymbol.OfficeBuildingRemove => OfficeBuildingRemove,
            IconSymbol.OfficeBuildingRemoveOutline => OfficeBuildingRemoveOutline,
            IconSymbol.CartPercent => CartPercent,
            IconSymbol.SignYield => SignYield,
            IconSymbol.FlagVariantOff => FlagVariantOff,
            IconSymbol.FlagVariantOffOutline => FlagVariantOffOutline,
            IconSymbol.FlagVariantPlus => FlagVariantPlus,
            IconSymbol.FlagVariantPlusOutline => FlagVariantPlusOutline,
            IconSymbol.FlagVariantMinus => FlagVariantMinus,
            IconSymbol.FlagVariantMinusOutline => FlagVariantMinusOutline,
            IconSymbol.FlagVariantRemove => FlagVariantRemove,
            IconSymbol.FlagVariantRemoveOutline => FlagVariantRemoveOutline,
            IconSymbol.HdmiPort => HdmiPort,
